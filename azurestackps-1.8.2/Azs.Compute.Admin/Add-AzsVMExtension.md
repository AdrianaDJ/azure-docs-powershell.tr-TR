...
## Tanım
Sanal makine uzantısı görüntüsü oluşturun.
...
Yeni bir platform görüntüsü uzantısı ekleyin.
...
### -ComputeRole
Bu uzantının desteklediği rol, IaaS veya PaaS türü.
...
### -SourceBlob
Sanal makine uzantısı paketinin URI 'SI.
