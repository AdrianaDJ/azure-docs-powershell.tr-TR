...
## Tanım
New-AzDataMigrationSelectedDB cmdlet 'i, geçiş için kaynak ve hedef veritabanları hakkında bilgi içeren bir veritabanı bilgi nesnesi oluşturur. Bu cmdlet, New-AzDataMigrationTask cmdlet 'ini içeren bir parametre olarak kullanılabilir.
