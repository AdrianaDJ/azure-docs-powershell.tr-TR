...
## Tanım
Cihaz ve modül TWINS, işler ve ileti yönlendirme hakkında bilgi almak için, üstün bir SQL gibi güçlü bir dil kullanarak bir IoT Hub 'ı sorgulayın.
https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-languageDaha fazla bilgi için bkz.
...
Bir Azure IoT Hub 'ındaki tüm cihaz ikili verilerini sorgulayın.
...
Hedef aygıttaki verileri ikili.
...
Varsayılan olarak, sorgunun Cap olmaz.
