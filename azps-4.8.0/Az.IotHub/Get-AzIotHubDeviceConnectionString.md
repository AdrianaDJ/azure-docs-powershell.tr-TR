...
## Tanım
Tüm aygıtların veya Azure IoT Hub 'ındaki bir hedef IoT aygıtının bağlantı dizesini listeler.
...
Bir IoT merkezinde tüm cihazlar bağlantı dizelerini gösterin.
...
IoT aygıtının ikincil bağlantı dizesini edinin.
