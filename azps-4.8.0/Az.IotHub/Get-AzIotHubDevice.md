...
## Tanım
IoT Hub aygıtının ayrıntılarını alın veya bir IoT Hub 'ındaki tüm cihazları listeleyin.
...
IoT Hub 'ındaki tüm cihazları gösterin.
...
IoT Hub cihazının ayrıntılarını edinin.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevıces []
