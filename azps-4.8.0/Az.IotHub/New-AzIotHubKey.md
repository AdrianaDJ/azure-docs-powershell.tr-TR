...
### Örnek 1 birincil anahtarı yeniden üret
```
...
Azure IoT Hub 'ının "testKey" yetkilendirme ilkesi için birincil anahtar yeniden oluşturuldu.

### Örnek 2 takas tuşları
```
...
Azure IoT Hub 'ının "testKey" yetkilendirme ilkesi için anahtar değiştirme.
