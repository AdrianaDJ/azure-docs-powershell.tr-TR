...
## Tanım
IoT Edge dağıtımında tanımlanan bir hedef özel veya sistem ölçüsünü değerlendirin.
IoT Hub tarafından hesaplanan ve özelleştirilebilecek önceden tanımlanmış sistem ölçümleri vardır.
- "Hedefli" dağıtım hedefleme durumuyla eşleşen IoT Edge aygıtlarını gösterir.
- "Uygulandı", daha yüksek önceliğe sahip bir dağıtımın hedeflediği hedeflenen IoT Edge cihazlarını gösterir.
- "Raporlama başarısı", modüllerin başarıyla dağıtıldığını bildiren IoT Edge cihazlarını gösterir.
- "Raporlama hatası", bir veya daha fazla modülün başarıyla dağıtılamadığını bildiren IoT Edge cihazlarını gösterir. 
  Hatayı daha da araştırmak için, bu aygıtlara uzaktan bağlanın ve günlük dosyalarını görüntüleyin.
...
Özel tanımlanmış ' warningLimit ' ölçüsünü değerlendirin.
...
Sistemin raporlama başarısı ' ölçüsünü değerlendirin.
...
### -MetricName
Değerlendirme için hedef ölçümü.
...
### -MetricType
Bir ölçüyü aramak için hangi ölçüm koleksiyonunun kullanılacağını gösterir.
...
### Microsoft. Azure. Commands. Management. IotHub. modeller. PSConfigurationMetricsResult
