...
## Tanım
IoT Hub 'ında farklı kimlik doğrulama türüne sahip bir cihaz oluşturun.
...
Varsayılan yetkilendirmeyi (paylaşılan özel anahtarı) içeren bir Edge uyumlu IoT cihazı oluşturun.
...
Devre dışı durumu ve nedeni olan kök CA yetkilendirmesi içeren bir IoT cihazı oluşturun.
...
Edge 'in etkinleştirildiği bir IoT cihazı oluşturun ve buna alt aygıtlar ekleyin.
...
IoT cihazı oluşturun ve ana aygıtını ayarlayın.
...
### -Çocuklar
Alt cihaz listesi (virgülle ayrılmış) Ekle yalnızca kenara ait olmayan cihazları içerir.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevme
