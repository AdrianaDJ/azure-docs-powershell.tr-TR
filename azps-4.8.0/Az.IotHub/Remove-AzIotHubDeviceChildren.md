...
## Tanım
Alt sınır aygıtı olarak tüm veya belirtilen Kenar Çizgili olmayan cihazları kaldırın.
...
Belirtilen cihazı belirtilen cihazın alt öğesi olarak kaldırın.
...
Kenar dışındaki tüm cihazları alt öğe aygıtı olarak kaldırın.
