...
## Tanım
Edge modülü yöntemini çağırma. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsDaha fazla bilgi için bkz.
...
### -ConnectionTimeOut
Bir bağlantı başarılı olana kadar beklenecek saniye sayısı.
Varsayılan 10 ' dır.
...
### -Ad
Bu cihaz modülünde çağrılacak yöntemin adı.
...
### -Yük
Bu cihaz modülünde çağrılacak yöntemin yükü.
...
### -ResponseTimeOut
Doğrudan yöntemden bir sonuç alınana kadar beklenecek saniye sayısı.
Varsayılan 10 ' dır.
...
### Microsoft. Azure. Commands. Management. IotHub. modeller. Pscses Todevicemethodresult
