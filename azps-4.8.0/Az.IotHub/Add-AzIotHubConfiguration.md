...
## Tanım
Yapılandırma içeriği JSON ve diğer modül amacına göre değişir. Cihaz yapılandırmaları {"deviceContent" biçiminde, {...}}
Modül yapılandırmaları {"moduleContent" biçiminde, {...}}
Yapılandırmalar, isteğe bağlı değerlendirme için Kullanıcı tarafından sağlanan ölçümler ile tanımlanabilir.
Kullanıcı ölçümleri JSON ve {"queries": {...}} biçiminde veya {"ölçüler": {"queries": {...}}}.

Not: modüller için hedef durumunun "from Devices. modüller where" ile başlaması gerekir. https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-managementDaha fazla bilgi için bkz.
...
Varsayılan meta verilerle bir cihaz yapılandırması oluşturun.
...
Bir cihaz 9 ' da etiketlenmişse ve ortam ' test ' olduğunda, bir öncelik 3 olan bir cihaz yapılandırması oluşturun.
...
Kullanıcı ölçümlerine sahip bir cihaz yapılandırması oluşturun.
...
Etiketlerle bir cihaz yapılandırması oluşturun.
...
İçerikle bir cihaz yapılandırması oluşturun.
...
### -DeviceContent
IotHub aygıtlarının yapılandırması.
