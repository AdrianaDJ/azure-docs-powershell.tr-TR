...
## Tanım
Sağlanan modüller yapılandırma içeriğini belirtilen Edge aygıtına uygular.
Not: yürütme sonrasında komut, cihaza uygulanan modül koleksiyonunun çıktısını alır.
...
Hedef cihazda modüller ayarlayarak geliştirme yaparken Edge modüllerini test etme.
...
### -ModulesContent
IoT Edge cihazları için modüllerin yapılandırma içeriği.
...
### Microsoft. Azure. Commands. Management. IotHub. modeller. PSModules []
