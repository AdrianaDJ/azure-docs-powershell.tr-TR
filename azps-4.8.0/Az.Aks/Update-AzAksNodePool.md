...
### Belirtilen düğüm havuzu için en az sayımı 5 olarak değiştirme
```powershell
...
### -Force
Düğüm havuzunu sormadan Güncelleştir
...
### -ID
Yönetilen Kubernetes kümesindeki bir düğüm havuzunun kimliği
...
### -InputObject
Normalde ardışık düzen aracılığıyla iletilen PSAgentPool nesnesi.
