...
Eklentileri `HttpApplicationRouting` , `Monitoring` , `AzurePolicy` ve gibi eklentileri etkinleştirin `VirtualNode` `KubeDashboard` .
...
### -WorkspaceResourceId
Çalışma alanının kaynak kimliği.
