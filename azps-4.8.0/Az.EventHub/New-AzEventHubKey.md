...
### Örnek 1: ad alanı-AuthorizationRule PrimaryKey
```powershell
...
### Örnek 2: EventHub-AuthorizationRule PrimaryKey
```powershell
...
### Örnek 3:-adalanı-AuthorizationRule SecondaryKey
```powershell
PS C:\> New-AzEventHubKey -ResourceGroup MyResourceGroupName -Namespace MyNamespaceName -Name MyAuthRuleName -RegenerateKey SecondaryKey
```

### Örnek 4: EventHub-AuthorizationRule SecondaryKey
```powershell
