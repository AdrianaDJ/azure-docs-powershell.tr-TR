...
## Tanım
Remove-AzEventHubNamespace cmdlet 'i, belirtilen olay hub ad alanını kaldırır ve siler.
...
### Örnek 5: RESOURCEID-boru kullanarak:
```powershell
PS C:\> Get-AzResource -ResourceType Microsoft.EventHub/Namespaces | Remove-AzEventHubNamespace
```

### Örnek 6: RESOURCEID-dize kullanarak:
```powershell
