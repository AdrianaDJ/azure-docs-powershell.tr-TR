...
## Tanım
**Yeni-AzEventHubGeoDRConfiguration** cmdlet 'i yeni bir diğer ad (olağanüstü durum kurtarma yapılandırması) oluşturur
...
"SampleNamespace_Secondary" ikincil ad alanı olan "SampleNamespace_Primary" birincil ad alanına sahip "SampleDRConfigName" diğer adını oluşturur

## PARAMETRELERINE

### -AlternateName
DR yapılandırma adı birincil ad alanıyla aynı olduğunda AlternateName gereklidir
...
### -PartnerNamespace
DR yapılandırma partneri ad alanı
