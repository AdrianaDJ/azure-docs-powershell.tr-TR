...
## Tanım
Set-AzEventHubNamespace cmdlet 'i belirtilen olay hub 'Larının özelliklerini güncelleştirir.
...
\`Mynamespacename ad alanı Için etiketleri \` oluşturulur.
...
Belirtilen olay hub ad boşluğunu güncelleştirir. oluşturulmuş

```powershell <!-- Aladdin Generated Example --> 
Set-AzEventHubNamespace -Location 'WestUS' -Name MyNamespaceName -ResourceGroupName MyResourceGroupName -SkuName Basic
```

### Örnek 5: kümede kimlik alanını yönetme ile ad alanı oluşturma ve güncelleştirme 
```powershell
...
### -IdentityUserDefined
Kullanıcı tanımlı kimlik veya yok
...
### -KeyProperty
Anahtar özellikler listesi, @ (@ (KeyName, Keyvaturi, Keyversion), @ (KeyName, KeyVaultUri, Keyversion))
...
### Durumlu
Ad alanını devre dışı bırakma/etkinleştirme.
...
### System. Nullable ' 1 [[Microsoft. Azure. Commands. EventHub. modeller. NamespaceState, Microsoft. Azure. PowerShell. cmdlet. EventHub, Version = 1.4.3.0, Culture = neutral, PublicKeyToken = null]]
