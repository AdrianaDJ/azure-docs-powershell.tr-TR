...
## SYNOPSIS
Belirtilen hizmetin sorun sınıflandırmaları alın.
...
### Örnek 1: hizmet kimliği parametresini kullanan bir hizmetle ilgili tüm sorun classificaitons.
```powershell
...
### Örnek 2: ana hizmet nesnesi kullanan bir hizmetin tüm sorun classificaitons
```powershell
...
### Örnek 3: tek bir sorunun ayrıntılarını alma
```powershell
...
### -ServiceId
Tüm sorun sınıflandırmaları alınan hizmet kimliği.
...
### -ServiceObject
Sorun sınıflandırmaları alınan hizmet nesnesi.
...
### Microsoft. Azure. Commands. support. modeller. PSSupportProblemClassification
