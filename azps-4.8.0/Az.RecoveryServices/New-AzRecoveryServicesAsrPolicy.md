...
## Tanım
**New-AzRecoveryServicesAsrPolicy** cmdlet 'ı Azure Site Recovery çoğaltma ilkesi oluşturur.
...
### -AzureToAzure
Switch parametresi Azure için Azure ilke oluşturma senaryosunu belirtir.
...
### -AzureToVMware
Switch parametresi Azure 'dan vMWare ilke oluşturma senaryosunu belirtir.
