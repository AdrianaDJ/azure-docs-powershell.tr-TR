...
## Tanım
Undo-AzRecoveryServicesBackupItemDeletion cmdlet 'i, yumuşak silinmiş bir öğeyi korumanın durdurulduğu bir duruma döndürür ancak veriler sürekli tutulur.
...
Dördüncü komut, sofdeleted durumundaki öğeyi alır.
Son komut, softdeleted VM 'yi korumanın durdurulduğu bir duruma getirir ancak veriler sürekli tutulur.

### Örnek 2

Yumuşak silinmiş bir öğeyi yeniden doldurma. oluşturulmuş
...
### -Öğe
Bu cmdlet 'in silme işlemini geri aldığı yedekleme öğesini belirtir.
