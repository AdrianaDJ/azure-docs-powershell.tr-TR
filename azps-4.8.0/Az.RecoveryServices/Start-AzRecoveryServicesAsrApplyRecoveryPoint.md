...
## Tanım
**Start-AzRecoveryServicesAsrApplyRecoveryPoint** , yük devretme işlemini denemeden önce, bir süre korunmuş öğenin kurtarma noktasını değiştirir.
...
[Azure Site kurtarma cmdlet 'Leri](./Az.SiteRecovery.md)
