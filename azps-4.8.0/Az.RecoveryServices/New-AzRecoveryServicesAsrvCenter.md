...
## Tanım
**Yeni-AzRecoveryServicesAsrvCenter** cmdlet 'i, korunabilir öğeleri bulmak Için bir vCenter sunucusu ekler. Bu cmdlet, vCenter Server 'ı yapılandırma sunucusuyla bulmaya kaydeder.
...
Korunabilir öğeleri bulmak için bir vCenter sunucusu ekler. oluşturulmuş
...
### -Hesap
Kullanıcı oturum açma kimlik bilgileri hesabı.
