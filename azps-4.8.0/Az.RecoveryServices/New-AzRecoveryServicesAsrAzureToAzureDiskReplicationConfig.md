...
Çoğaltılacak Azure sanal makine disklerinin disk eşleme nesnesi oluşturma. Azure ile Azure Etkinr arası ve yeniden korumada kullanılır.
...
Çoğaltılacak Azure sanal makine disklerinin yönetilen bir disk eşleme nesnesi oluşturma. Azure ile Azure Etkinr arası ve yeniden korumada kullanılır.
...
Azure sanal makine disklerinin çoğaltılacağı bir yönetilen disk eşleme nesnesi oluşturun. Azure ile Azure Etkinr arası ve yeniden korumada kullanılır.
...
Azure sanal makine disklerinin çoğaltılması için hedef disk şifrelemesi kümesi kimliğiyle bir yönetilen disk eşleme nesnesi oluşturun. Azure ile Azure Etkinr arası ve yeniden korumada kullanılır.
...
Disk şifrelemesi gizli URL 'sini belirtir.
...
Disk şifrelemesi Anahtar Kasası
...
### -FailoverDiskName
Yerine çalışma sırasında oluşturulan diskin adını belirtir.
...
### -KeyEncryptionKeyUrl
Anahtar şifreleme URL 'Sini belirtir.
...
Anahtar şifreleme anahtarı kasa kolu kimliğini belirtir.
...
Kurtarma disklerinde kullanılacak Azure disk şifrelemesi kümesinin KIMLIĞINI belirtir.
...
### -TfoDiskName
Yük devretme testi sırasında oluşturulan diskin adını belirtir.
