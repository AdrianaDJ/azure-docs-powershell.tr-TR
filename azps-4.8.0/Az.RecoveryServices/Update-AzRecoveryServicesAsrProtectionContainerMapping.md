...
### AzureToAzureEnableAutoUpdate (varsayılan)
```
...
## Tanım
**Update-AzRecoveryServicesAsrProtectionContainerMapping** cmdlet 'i, belirtilen Azure Site Recovery koruma kapsayıcısı eşlemesini güncelleştirir.
...
Kapsayıcıyı otomatik güncelleştirmeyi devre dışı bırakmak için işlemi başlatın.
...
Kapsayıcıyı otomatik güncelleştirmeyi etkinleştir özelliğini devre dışı bırakmak için işlemi başlatın.

## PARAMETRELERINE

### -Automationaccountıd
Otomatik UDPATE kullanılan Otomasyon hesap kimliği 'ni belirtir.
...
### -AzureToAzure
Azure to Azure Protection kapsayıcısını belirtir.
...
### -Disableotomatik güncelleştirme
Otomatik güncelleştirmeyi devre dışı bırakmak için parametreyi değiştirin.
...
Otomatik güncelleştirmeyi etkinleştirmek için parametre değiştirme.
