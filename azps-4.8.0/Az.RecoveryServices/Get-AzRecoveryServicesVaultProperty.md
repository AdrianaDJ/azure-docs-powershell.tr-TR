...
## Tanım
**Get-AzRecoveryServicesVaultProperty** cmdlet 'i, bir kurtarma hizmetleri kasasındaki özelliklerini döndürür.

## ÖRNEKLERDEN

### Örnek 1: kasanın özelliklerini alma
```
...
İkinci komut kasa özelliklerini alır.
