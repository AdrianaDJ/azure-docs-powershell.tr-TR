...
## Tanım
Disable-AzRecoveryServicesBackupRPMountScript cmdlet 'i, daha önce Get-AzRecoveryServicesBackupRPMountScript cmdlet 'i kullanılarak bağlanmış olan kurtarma noktası dosyalarını çıkarır.

## ÖRNEKLERDEN

### Örnek 1: kurtarma noktasını kaldırma
```powershell
...
Kurtarma noktasının tüm dosyalarını çıkarır. oluşturulmuş
