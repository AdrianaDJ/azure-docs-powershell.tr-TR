...
Cmdlet, iş yükü MSSQL için kapsayıcı olarak bir Azure VM kaydeder.
...
### -Force
Kayıt kapsayıcısını zorunlu kılın (onay iletişim kutusu). Bu parametre isteğe bağlıdır.
...
### -WorkloadType
Kaynağın iş yükü türü. Desteklenen geçerli değer AzureVM, WindowsServer, AzureFiles, MSSQL
