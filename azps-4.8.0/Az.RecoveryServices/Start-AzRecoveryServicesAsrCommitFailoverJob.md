...
## Tanım
**Start-AzRecoveryServicesAsrCommitFailoverJob** cmdlet 'i, yük devretme işleminden sonra bir Azure Site kurtarma nesnesi için yük devretmeyi Kaydet işlemini başlatır.
...
Site kurtarma nesnesi için yük devretmeyi Yürüt eylemini başlatır. oluşturulmuş
