...
## Tanım
**Restore-Azrmstoragesshare** cmdlet 'i, yumuşak silme Paylaş etkinse geçerli bir bekletme günü içindeki silinmiş dosya paylaşımını geri yükler.

## ÖRNEKLERDEN

### Örnek 1: paylaşımı kaldırma ve geri yükleme
```powershell
...
Bu komut önce bir dosya paylaşımını silip ardından paylaşımları listeler ve silinen paylaşım sürümünü görüntüle, son olarak normal bir paylaşıma geri yükle. Paylaşımı silmeden önce Update-Azstoragefileserviceözelliğiyle, yazılım silme özelliğini etkinleştirmeniz gerekir.
...
### -DeletedShareVersion
Silinecek olan paylaşım sürümü.
...
### -Ad
Geri yüklenecek olan paylaşım adı silindi.
