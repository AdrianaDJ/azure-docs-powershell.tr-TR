...
## Tanım
**Remove-AzStorageBlob** cmdlet 'i, belirtilen blob 'u Azure 'daki bir depolama hesabından kaldırır.
...
Bu komut, VersionId ile tek bir blob Veri'yi kaldırır.
...
Get-AzStorageContainer cmdlet 'ini kullanarak edinin.
