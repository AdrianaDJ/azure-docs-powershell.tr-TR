...
Bu, hedef dosyayı Kopyala 'da çalışmalıdır.
...
### Örnek 2: kopyalama durumunu almak için kopyalama ve ardışık düzeni başlatma
```
...
İlk komut "contosofile" dosyasını "contosofile_copy" olarak başlatır ve destiantion dosya nesnesinin çıkışını başlatır. İkinci komut ardışık düzeni, dosya kopyalama durumunu almak için Get-AzStorageFileCopyState için destiantion File nesnesidir.
