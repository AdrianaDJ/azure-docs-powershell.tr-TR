...
## Tanım
**Get-Azsitiveservicesaccount** cmdlet 'ı, *resourcegroupname* parametresinde belirtilen kaynak grubundaki sağlanan öğretici hizmet hesaplarını alır.
*Resourcegroupname* parametresini belirtmezseniz, bu cmdlet geçerli aboneliğin tüm öğretici hizmet hesaplarını alır.
