...
### -Hedef
Yukarıdaki isteklerin üzerine yazılması için göreli URL 'YI tanımlayın.
...
### -PreservePath
Eşleşmeyen yolun korunup korunmayacağı.
...
### -QueryParameter
İçerilecek veya dışlanacak sorgu parametreleri (virgülle ayrılmış).
...
### -QueryStringBehavior
İstekler için QueryString davranışı
...
### -SourcePattern
Yeniden yazılabilir isteklerin türünü tanımlayan bir istek URI deseni tanımlayın. Değer boşsa, tüm dizeler eşleştirilir.
