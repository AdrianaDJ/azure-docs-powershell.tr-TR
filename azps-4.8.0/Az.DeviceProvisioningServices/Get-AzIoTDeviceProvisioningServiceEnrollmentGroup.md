...
## Tanım
Bir kayıt grubunun ayrıntılarını alın veya Azure IoT Hub cihaz hazırlama hizmetindeki tüm kayıt gruplarının listesini alın.
...
Bir Azure IoT Hub cihaz sağlama hizmetine cihaz kaydı alın.
...
Bir Azure IoT Hub cihaz sağlama hizmetindeki tüm cihaz kaydı gruplarını listeleyin.
...
### Microsoft. Azure. Commands. Management. DeviceProvisioningServices. modeller. PSEnrollmentGroups []
