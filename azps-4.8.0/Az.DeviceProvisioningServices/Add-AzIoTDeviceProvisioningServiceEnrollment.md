...
## Tanım
Bir Azure IoT Hub cihaz sağlama hizmetinde bir cihaz kaydı oluşturun.
...
Kanıtlama türü SymmetricKey ile kayıt oluşturma
...
TPM kanıtlama ile kayıt oluşturma.
...
Kanıt türü x509 ile kayıt oluşturma
...
Kanıtlama türü SymmetricKey ve ilk ikili durumunda bir kayıt oluşturun.

## PARAMETRELERINE

### -Ayıra Ilkesi
Hub 'a atanan cihazın tahsis türü.
...
### -Apıversion
Özel tahsisat isteğindeki sağlama hizmetinin API sürümü.
...
### -Onaylama
TPM cihazı için TPM onay anahtarı.
...
### -IotHub
Hedef IoT Hub 'ının adı.
Birden çok IoT Hub için boşlukla ayrılmış liste kullanın.
...
### -Iothubhostname
Hedef IoT Hub 'ının ana bilgisayar adı.
...
### -Primarycaadı
Birincil kök CA sertifikasının adı.
Kök CA sertifikasıyla kanıtlama isteniyorsa, kök CA adı sağlanmalıdır.
...
X509 Certificate. cer dosyasının veya. pem dosya yolunun Base-64 temsili.
...
### -ProvisioningStatus
Kayıt girişini etkinleştirme veya devre dışı bırakma.
...
### -ReprovisionPolicy
Farklı IoT Hub 'ına yeniden temin edilecek cihaz verileri.
...
### -RootCertificate
Kök sertifikaları kullanarak X509attestation oluşturmanıza olanak tanır.
...
### -Secondarycaadı
İkincil kök CA sertifikasının adı.
Kök CA sertifikasıyla kanıtlama isteniyorsa, kök CA adı sağlanmalıdır.
...
### -StorageRootKey
TPM cihazı için TPM depolama kökü anahtarı.
...
### -WebhookUrl
Özel tahsisat isteklerinde kullanılan Web kancası URL 'SI.
