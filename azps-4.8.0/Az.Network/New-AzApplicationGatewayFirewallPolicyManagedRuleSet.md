...
## Tanım
**Yeni-AzApplicationGatewayFirewallPolicyManagedRuleSet** , güvenlik duvarı ilkesi için yönetilen kurallar oluşturur.
...
$RuleSetType olarak ruleSetType ile birlikte bir ManagedRuleSet oluşturur, $ruleSetVersion olarak ruleSetVersion, ve $managedRuleSet $ruleGroupOverride $ruleGroupOverride RuleGroupOverrides olarak
...
### -RuleGroupOverride
Kural grubu geçersiz kılmaları.
...
### -RuleSetType
ManagedRuleSet 'te RuleSetType belirtme
...
### -RuleSetVersion
ManagedRuleSet 'te RuleSetVersion belirtme
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayFirewallPolicyManagedRuleSet
