...
## Tanım
**Yeni-Azıpallocation** cmdlet 'ı bir Azure IP ayırması oluşturur
...
### -Force
Kaynağı geçersiz kılmak istiyorsanız onay sorma
...
### -Ipamalkonumkimliği
IP ayırmanın IPAM ayırma KIMLIĞI
...
### Microsoft. Azure. Commands. Network. model. PSIpAllocation
