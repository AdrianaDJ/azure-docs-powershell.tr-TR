...
## Tanım
**Get-AzAvailableServiceAlias** cmdlet 'i sağlanan konumdaki bir alt ağın tüm kullanılabilir hizmet diğer adlarını almanıza olanak tanır.
...
### Microsoft. Azure. Commands. Network. model. PsAvailableServiceAlias
