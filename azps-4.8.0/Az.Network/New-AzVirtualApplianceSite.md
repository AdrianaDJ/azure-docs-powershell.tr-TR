...
## SYNOPSIS
Ağ sanal bir gereç ile bağlantılı bir site oluşturun.
...
## Tanım
New-AzVirtualApplianceSite komutu, ağ sanal bir gereç kaynağına bağlı sanal bir gereç sitesi oluşturur.
...
Kaynak grubunda yeni bir Sanal Gereç sitesi oluşturun: latestrg.
