...
## Tanım
**Set-AzRouteConfig** cmdlet 'i, yol için bir yol yapılandırmasını güncelleştirir.
...
Bu komut, Get-AzRouteTable cmdlet 'ini kullanarak RouteTable01 adındaki yol tablosunu alır.
Komut, ardışık düzen işlecini kullanarak bu tabloyu geçerli cmdlet 'e geçirir.
Geçerli cmdlet Route02 adlı yolu değiştirir ve sonucu, değişiklikleri yansıtmak üzere tabloyu güncelleştiren **-AzRouteTable** cmdlet 'ine geçirir.
