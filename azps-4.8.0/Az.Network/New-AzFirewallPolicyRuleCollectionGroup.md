...
## Tanım
**New-AzFirewallPolicyRuleCollectionGroup** cmdlet 'ı bir Azure Güvenlik duvarı ilkesinde bir kural koleksiyonu grubu oluşturur.
...
Bu örnek, güvenlik duvarı ilkesinde bir kural koleksiyonu grubu oluşturur $fp

### Örnek 2

Yeni bir Azure Güvenlik Duvarı Ilkesi kuralı koleksiyon grubu oluşturun. oluşturulmuş
