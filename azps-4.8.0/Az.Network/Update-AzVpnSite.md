...
### ByVpnSiteNameNoVirtualWanUpdate (varsayılan)
```
...
### Byvpnsiteobjectbyvirtualwanresourceıd
```
...
### Byvpnsiteresourceıdbyvirtualwanname
```
...
### Byvpnsiteresourceıdbyvirtualwanresourceıd
```
...
### Byvpnsiteresourceıdbyvirtualwanobject
```
...
## Tanım
**Update-AzVpnSite** cmdlet 'ı bir VPN sitesini güncelleştirir.
...
Site oluşturulduktan sonra, Set-AzVpnSite komutunu kullanarak sitenin IPAddress 'i güncelleştirir.

## PARAMETRELERINE

### -AddressSpace
Sanal ağın adres önekleri.
Bu veya AddressSpaceObject kullanın ancak ikisini birden kullanmayın.
...
### -O365Policy
Bu VpnSite için Office 365 trafiği ayırıcı ilkesi.
...
### -RESOURCEID
VPN sitesinin Azure Resource ID 'si.
...
### -Vpnsite
Bu VpnSite 'in sahip olduğu VpnSiteLinks listesi.
