...
## Tanım
**New-AzNetworkInterface** cmdlet 'ı bir Azure ağ arabirimi oluşturur.
...
İlk komut, ikinci komutta alt ağı atamak için kullanılan, mevcut belirtilen sanal ağı alır.
İkinci komut IPConfig1 adlı bir ağ arabirimi IP yapılandırması oluşturur ve $IPconfig adlı değişkende yapılandırmayı depolar.
Üçüncü komut, $IPconfig adlı değişkende depolanan ağ arabirimi IP yapılandırmasını kullanan NetworkInterface1 adlı bir ağ arabirimi oluşturur.

### Örnek 3

Ağ arabirimi oluşturur. oluşturulmuş
