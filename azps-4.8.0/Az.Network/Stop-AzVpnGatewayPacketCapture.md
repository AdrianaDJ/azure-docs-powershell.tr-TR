...
## SYNOPSIS
VPN ağ geçidinde paket yakalama Işlemini durdurur.
...
## Tanım
VPN ağ geçidinde paket yakalama Işlemini durdurur ve depolama kapsayıcısının verilen SasUrl 'sindeki sonucu karşıya yükler.
...
### -InputObject
Paket yakalama 'nın başlatılması için kullanılacak VPN ağ geçidi nesnesi.
...
### -Ad
Paket yakalama 'nın başlatılması için VPN ağ geçidi adı.
...
### -RESOURCEID
Paket yakalama 'nın başlatılması için Vpnağ geçidinin Azure Kaynak KIMLIĞI.
...
### -SasUrl
VPN ağ geçidinde SAS URL paketi yakalama.
...
### Microsoft. Azure. Commands. Network. modeller. PSVpnGatewayPacketCaptureResult

## NOTLARıNDA

## ILGILI BAĞLANTıLAR

[Başlangıç-AzVpnGatewayPacketCapture](./Start-AzVpnGatewayPacketCapture.md)