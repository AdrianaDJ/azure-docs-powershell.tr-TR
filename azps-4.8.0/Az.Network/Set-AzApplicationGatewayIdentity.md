...
## Tanım
**Set-Azapplicationgatewayıdentity** cmdlet 'i, uygulama ağ geçidine atanan bir kimliği güncelleştirir.
...
Bu örnekte, varolan bir uygulama ağ geçidine Kullanıcı tarafından atanmış bir kimlik atadık.
Not: bu kimliğin, sertifika/parolaların başvurduğu tuş kasasına erişimi olmalıdır.
