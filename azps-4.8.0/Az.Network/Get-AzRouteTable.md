...
## Tanım
**Get-AzRouteTable** cmdlet 'i Azure yol tablolarını alır.
...
### Örnek 2: filtreleme kullanarak yol tablolarını listeleme
```
...
Bu komut, adı "RouteTable" ile başlayan tüm yol tablolarını alır
