...
Yukarıdaki, Azure 'daki "testRG" kaynak grubunda Batı ABD 'deki 1 VpnSiteLinks 'e sahip bir kaynak grubu, sanal WAN, sanal ağ, sanal hub ve bir VpnSite oluşturur.
Sanal hub 'da bir VPN ağ geçidi oluşturulacaktır.
Ağ Geçidi oluşturulduktan sonra, vpnsite için 1 VpnSiteLinkConnections ile New-AzVpnConnection komutu ile VpnSite 'e bağlanır.

## PARAMETRELERINE

### -ConnectionBandwidth
Bu bağlantı tarafından, Mbps 'de işlenmesi gereken bant genişliği.
...
### -Ipsecpolicy
Bu bağlantı için değerlendirilecek IPSec Ilkesi.
...
### -SharedKey
Bu bağlantı bağlantısını ayarlamak için gereken paylaşılan anahtar.
...
Bu bağlantı için kaynak IP olarak yerel Azure IP adresini kullanın.
...
### -Vpnsite
Bağlanılacak VPN sitesi bağlantı nesnesi.
...
### Microsoft. Azure. Commands. Network. model. Psvpnsite

## ÇıKıŞLAR

### Microsoft. Azure. Commands. Network. model. PSVpnSiteLinkConnection
