...
## Tanım
**Remove-AzApplicationGatewayFirewallPolicy** cmdlet 'i uygulama ağ geçidi güvenlik ilkesini kaldırır.
...
Bu komut, ResourceGroup01 adındaki kaynak grubundaki ApplicationGatewayFirewallPolicy01 adındaki uygulama ağ geçidi güvenlik ilkesini kaldırır.
