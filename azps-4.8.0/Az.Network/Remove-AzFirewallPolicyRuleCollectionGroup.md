...
## Tanım
**Remove-AzFirewallPolicyRuleCollectionGroup** cmdlet 'i, bir Azure Güvenlik Duvarı ilkesinden bir kural koleksiyonu grubunu kaldırır.
...
Bu örnekte, güvenlik duvarı ilkesi nesnesinde "testRcGroup" adlı güvenlik duvarı ilkesi kuralı colelction grubu kaldırılır $fp
...
Bu örnekte, "testRg" kaynak adlı güvenlik duvarında "testRcGroup" adlı güvenlik duvarı ilkesi kuralı colelction grubu kaldırılır
...
### -InputObject
Güvenlik Duvarı Ilke kuralı koleksiyonu Grup nesnesi
...
### -RESOURCEID
Kural koleksiyonu grup kimliği
...
### Microsoft. Azure. Commands. Network. model. PSAzureFirewallPolicyRuleCollectionGroupWrapper
