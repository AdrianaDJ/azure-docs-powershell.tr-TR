...
## Tanım
**Get-AzApplicationGatewayFirewallPolicy** cmdlet 'i uygulama ağ geçidi güvenlik ilkesi alır..
...
Bu komut, FirewallPolicy1 adındaki kaynak grubuna ait olan ResourceGroup01 adındaki uygulama ağ geçidi güvenlik ilkesini alır ve $AppGwFirewallPolicy değişkeninde depolar.
