...
## Tanım
**Set-AzExpressRouteCrossConnection** cmdlet 'i Azure 'A değiştirilmiş ExpressRoute çapraz bağlantısını kaydeder.

## ÖRNEKLERDEN

### Örnek 1: ExpressRoute çapraz bağlantısının hizmet sağlayıcısı sağlama durumunu değiştirme
```
...
Bu cmdlet 'in değiştirdiği **Expressroutecrossconnection** nesnesini belirtir.
...
### -Peering
Çapraz bağlantı için eş bağlantılar listesi
...
Ayarlanacak hizmet sağlayıcısı sağlama durumu
