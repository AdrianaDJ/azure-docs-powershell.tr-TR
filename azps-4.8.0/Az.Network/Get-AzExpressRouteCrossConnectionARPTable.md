...
## Tanım
**Get-AzExpressRouteCrossConnectionARPTable** cmdlet 'i, bir ExpressRoute çapraz bağlantısının her IKI arabiriminden ARP tablosunu alır. ARP tablosu belirli bir eşleme için IPv4 adresini MAC adresine eşlemeyi sağlar. Katman 2 yapılandırmasını ve bağlantısını doğrulamak için ARP tablosunu kullanabilirsiniz.
