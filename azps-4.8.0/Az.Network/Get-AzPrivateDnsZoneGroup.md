...
## Tanım
**Get-AzPrivateDnsZoneGroup** cmdlet 'i bir veya daha çok özel DNS bölge grubunu alır.

## ÖRNEKLERDEN

### Örnek 1: özel DNS bölge grubunu alma
```powershell
...
Yukarıdaki örnek, kaynak grubundaki dnsgroup1 adlı özel bir DNS bölgesi grubunu alır.
