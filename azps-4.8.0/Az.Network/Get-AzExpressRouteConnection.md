...
## Tanım
ExpressRouteGateway 'e bağlı tüm ExpressRoute bağlantılarını ada göre bir ExpressRoute bağlantısını alır veya listeler.
...
Ağ Geçidi oluşturulduktan sonra, New-AzExpressRouteConnection komutunu kullanarak şirket içi ExpressRoute devresi 'e bağlanır.
...
Bu komut ExpressRoute 'ta "testExpressRoutegw" ile başlayan tüm bağlantıları alır
