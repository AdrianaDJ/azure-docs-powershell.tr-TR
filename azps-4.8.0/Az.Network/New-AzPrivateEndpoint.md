...
**New-AzPrivateEndpoint** cmdlet 'i özel bir uç nokta oluşturur.

## ÖRNEKLERDEN

### Örnek 1: özel uç nokta oluşturma

Aşağıdaki örnek, sanal ağda belirtilen alt ağda belirli bir özel bağlantı hizmeti KIMLIĞI içeren özel bir uç nokta oluşturur.
...
Bağlantıyı kurmak için el ile istek 'ı kullanın.
...
Kaynağın üzerine yazılmasını sorma.
...
Özel uç noktasının konumunu belirtir. Bu parametrenin geçerli değerlerini belirlemek için [Get-AzLocation](/powershell/module/az.resources/get-azlocation) değerini kullanın.
...
Özel uç noktayı bağlamak için kaynak KIMLIĞI.
...
### Microsoft. Azure. Commands. Network. model. PSPrivateLinkServiceConnection []

## ÇıKıŞLAR

### Microsoft. Azure. Commands. Network. model. PSPrivateEndpoint
