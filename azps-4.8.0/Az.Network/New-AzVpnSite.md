...
### Byvirtualwannamebyvpnsiteıpaddress (varsayılan)
```
...
### Byvirtualwanobjectbyvpnsiteıpaddress
```
...
### Byvirtualwanresourceıdbyvpnsiteıpaddress
```
...
### Byvirtualwanresourceıdbyvpnsitelinkobject
```
New-AzVpnSite -ResourceGroupName <String> -Name <String> -Location <String> -VirtualWanId <String>
 [-AddressSpace <String[]>] [-DeviceModel <String>] [-DeviceVendor <String>] -VpnSiteLink <PSVpnSiteLink[]>
 [-Tag <Hashtable>] [-AsJob] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
...
Yukarıdaki, Azure 'daki "nonlinkSite" kaynak grubunda bir kaynak grubu, Doğu ABD 'de sanal WAN oluşturur. 
...
Yukarıdaki, Azure 'daki "Multilink" kaynak grubunda Doğu ABD 'de 1 VpnSiteLinks 'e sahip bir kaynak grubu, sanal WAN ve bir VpnSite oluşturur.

### Örnek 3

Yeni bir Azure VpnSite kaynağı oluşturur. oluşturulmuş
