...
### ByVpnServerConfigurationName (varsayılan)
```
...
### Byvpnserverconfigurationresourceıd
```
...
Yukarıdaki komut, var olan bir Vpnserveryapılandırmasını kaldıracak.
...
### -InputObject
Silinecek vpnServerConfiguration nesnesi.
...
### -RESOURCEID
Silinecek vpnServerConfiguration için Azure Resource ID.
