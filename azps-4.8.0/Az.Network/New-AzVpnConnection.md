...
### Byvpngatewaynamebyvpnsitenesnesi (varsayılan)
```
...
### Byvpngatewaynamebyvpnsiteresourceıd
```
...
### Byvpngatewayobjectbyvpnsitenesnesi
```
...
### Byvpngatewayobjectbyvpnsiteresourceıd
```
...
### Byvpngatewayresourceıdbyvpnsitenesnesi
```
...
### Byvpngatewayresourceıdbyvpnsiteresourceıd
```
...
### -VpnSite
Bu hub sanal ağ bağlantısının bağlı olduğu uzak VPN sitesi.
...
Bu VpnConnection 'un sahip olduğu VpnSiteLinkConnections listesi.
