...
## Tanım
**Set-Azloadbalanceroutboundbir** Azure Yük dengeleyicinin giden kural yapılandırmasını ayarlar.

## ÖRNEKLERDEN

### Örnek 1: yük dengeleyicide giden kural yapılandırmasını değiştirme
```powershell
...
Üçüncü komut yük dengeleyiciden, giden kuralı yapılandırmasını kaydeden ve güncelleştiren **-AzLoadBalancerOutboundRuleConfig** değerini geçirir.
