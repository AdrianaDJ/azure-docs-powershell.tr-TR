...
## SYNOPSIS
Bir loadbalancer 'da arka uç adres havuzu oluşturur. 
...
## Tanım
Bir loadbalancer 'da arka uç adres havuzu oluşturur. PSLoadBalancerBackendAddress dizisini belirtilmenizi sağlar. 
## ÖRNEKLERDEN
...
### -ResourceGroupName
Yük dengeleyicinin kaynak grup adı.
