...
### Securitypartnerproviderresourceıdparameterset
```
...
## Tanım
**Remove-AzSecurityPartnerProvider** cmdlet 'ı bir Azure securitypartnersağlayıcısını siler
...
### -RESOURCEID
Securitypartnersağlayıcı kaynak kimliği.
...
### -Securitypartnersağlayıcı
Securitypartnersağlayıcı giriş nesnesi.
...
### Microsoft. Azure. Commands. Network. model. PSSecurityPartnerProvider
