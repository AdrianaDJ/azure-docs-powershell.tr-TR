...
## Tanım
**New-Azapplicationgatewayfirewallpolicydışlaması** cmdlet 'i güvenlik duvarı ilkesi için yeni bir dışlama kuralı listesi.
...
Bu komut, Ertheadernames ve WITH xyz adlı ad ve dosya adı Dışlama girişi $exclusionEntry kaydedilir.
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayFirewallPolicyExclusion
