...
Bu cmdlet, kaynak grubu adı, hub adı ve yol tablosu adını kullanarak bir yol tablosu kaynağını alır.
...
Bu cmdlet, kaynak grup adını ve hub adını kullanarak sanal bir hub 'daki tüm yol tablolarını listeler.
