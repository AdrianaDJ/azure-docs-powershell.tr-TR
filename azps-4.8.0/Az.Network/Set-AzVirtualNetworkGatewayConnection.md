...
## Tanım
**Set-AzVirtualNetworkGatewayConnection** cmdlet 'i sanal ağ geçidi bağlantısını yapılandırır.
...
### Örnek 2: var olan VirtualNetworkGatewayConnection 'a etiket ekleme/güncelleştirme
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
...
S2S bağlantısı için Privateıp kullanılıp kullanılmayacağını
