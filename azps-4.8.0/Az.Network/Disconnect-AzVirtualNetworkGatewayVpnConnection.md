...
## Tanım
**Bağlantı kesilmesi-AzVirtualNetworkGatewayVpnConnection** cmdlet 'i, bağlanılan bağlanılan VPN istemci bağlantısının bağlantısını kesmenizi olanaklı kılar.
