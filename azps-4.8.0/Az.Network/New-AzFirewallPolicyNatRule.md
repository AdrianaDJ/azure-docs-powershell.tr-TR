...
## Tanım
**New-AzFirewallPolicyNatRule** cmdlet 'i, bir Azure Güvenlik Duvarı ILKESI için NAT kuralı oluşturur.
...
Bu örnek, kaynak adresi, protokol, hedef adres, hedef bağlantı noktası, çevrilen adres ve çevrilen bağlantı noktası içeren bir NAT kuralı oluşturur.
...
### -DestinationAddress
Kuralın hedef adresleri. Bu, güvenlik duvarının ortak IP 'si olmalıdır.
...
### -TranslatedAddress
Bu NAT kuralı için çevrilen adres
...
### -TranslatedPort
Bu NAT kuralı için çevrilen bağlantı noktası
