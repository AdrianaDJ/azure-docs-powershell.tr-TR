...
### ByVpnServerConfigurationNameByCertificateAuthentication (varsayılan)
```
...
### Byvpnserverconfigurationresourceıdbycertificateauthentication
```
...
### Byvpnserverconfigurationresourceıdbyradiusauthentication
```
Update-AzVpnServerConfiguration -ResourceId <String> [-VpnProtocol <String[]>]
 [-VpnAuthenticationType <String[]>] [-RadiusServerAddress <String>] [-RadiusServerSecret <SecureString>]
 [-RadiusServerList <PSRadiusServer[]>] [-RadiusServerRootCertificateFilesList <String[]>]
...
### Byvpnserverconfigurationresourceıdbyaadauthentication
```
Update-AzVpnServerConfiguration -ResourceId <String> [-VpnProtocol <String[]>]
 [-VpnAuthenticationType <String[]>] [-AadTenant <String>] [-AadAudience <String>] [-AadIssuer <String>]
 [-VpnClientIpsecPolicy <PSIpsecPolicy[]>] [-Tag <Hashtable>] [-AsJob]
...
## Tanım
**Update-AzVpnServerConfiguration** cmdlet 'i, var olan vpnserverconfiguration 'ı farklı Vpnprotocols, VpnAuthenticationTypes, ıpsecpolicies ile güncelleştirmenize ve Seçilen VPN kimlik doğrulama türüyle ilgili parametrelerin, müşterinin site bağlantısı için gerekme gereksinimlerine göre ayarlanmasını olanaklı kılar.
...
Yukarıdaki komut, VpnProtocol ile mevcut bir Vpnserveryapılandırmasını Ikev2 olarak güncelleştirir.

## PARAMETRELERINE

### -AadAudience
P2S AAD kimlik doğrulaması için AAD izleyiciyi.
...
### -Aadıssuer
P2S AAD kimlik doğrulaması için AAD vericisi.
...
### -AadTenant
P2S AAD kimlik doğrulaması için AAD kiracısı.
...
### -InputObject
Değiştirilecek VPN sunucusu yapılandırma nesnesi
...
### -Radiusclientrootcertificatefileslistesi
RadiusClientRootCertificate dosyalarının yollarının listesi
...
### -RadiusServerList
Dış çoklu RADIUS sunucularını P2S.
...
### -Radiusserverrootcertificatefileslistesi
RadiusClientRootCertificate dosyalarının yollarının listesi
...
### -RESOURCEID
VPN sunucusu yapılandırması için Azure Resource ID.
...
VpnServerConfiguration için IPSec ilkelerinin listesi.
...
### -Vpnclientgeri
Dosyaların yollarını iptal edilecek VpnClientCertificates listesi
...
### -Vpnclientrootcertificatefileslistesi
Dosya yollarının ekleneceği VpnClientRootCertificates listesi
...
### Microsoft. Azure. Commands. Network. model. PSVpnServerConfiguration
System. String Microsoft. Azure. Commands. Network. modeller. PSIpsecPolicy []
