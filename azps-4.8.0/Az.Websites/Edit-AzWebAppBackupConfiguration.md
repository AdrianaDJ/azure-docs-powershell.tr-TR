...
## Tanım
**Edit-AzWebAppBackupConfiguration** cmdlet 'ı Azure Web App için geçerli yapılandırma yedeklemesini düzenler.

## ÖRNEKLERDEN

### Örnek 1

Edit-AzWebAppBackupConfiguration cmdlet 'i bir Azure Web App için geçerli yapılandırma yedeklemesini düzenler. oluşturulmuş
...
### -Nepatleastonebackup
En az bir yedekleme seçeneği tutma
