...
Aşağıdaki örnek, SCM sitesindeki ana sitenin erişim kısıtlama yapılandırmasını kullanmak için MyResourceGroup kaynak grubuna ait ıprule adlı bir Web uygulamasını güncelleştirir.
