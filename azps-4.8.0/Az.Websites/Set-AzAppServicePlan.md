...
## Tanım
**Set-AzAppServicePlan** cmdlet 'ı bir Azure App hizmet planı ayarlar.

## ÖRNEKLERDEN

### Örnek 1: App Service planını değiştirme
```powershell
...
Bir Azure App Service planı ayarlar. oluşturulmuş
