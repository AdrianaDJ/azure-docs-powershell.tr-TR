...
### Örnek 1: ada göre bir işlev uygulaması alın ve yeniden başlatın.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

Bu komut bir işlev uygulamasını adıyla alır ve yeniden başlatır.

### Örnek 2: bir işlev uygulamasını adıyla yeniden başlatın.
```powershell
PS C:\> Restart-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Bu komut bir işlev uygulamasını adıyla yeniden başlatır.
...
### -Force
Cmdlet 'i, onay istemeden işlev uygulamasını yeniden başlatmaya zorlar.
