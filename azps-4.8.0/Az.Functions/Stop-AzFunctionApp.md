...
### Örnek 1: ada göre bir işlev uygulaması alın ve durdurun.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

Bu komut bir işlev uygulamasını adıyla alır ve durdurur.

### Örnek 2: ada göre bir işlev uygulaması durdurma.
```powershell
PS C:\> Stop-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Bu komut bir işlev uygulamasını adıyla durdurur.
...
### -Force
Cmdlet 'i, onay istemeden işlev uygulamasını durdurmaya zorlar.
