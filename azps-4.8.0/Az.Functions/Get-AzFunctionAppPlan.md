...
### Örnek 1: tüm işlev uygulaması planlarını alın.
```powershell
...
Bu komut, tüm işlev uygulaması planlarını alır.

### Örnek 2: kaynak grubu adına göre işlev uygulama planlarını alın.
```powershell
...
Bu komut, kaynak grubu adına göre işlev uygulama planlarını alır.

### Örnek 3: verilen abonelikler için işlev uygulama planları alın.
```powershell
...
Bu komut, verilen abonelikler için işlev uygulama planlarını alır.

### Örnek 4: konuma göre işlev uygulaması planlarını alın.
```powershell
...
Bu komut, App planlarını konuma göre alır.
...
### -Konum
İşlev uygulaması planının konumu.
