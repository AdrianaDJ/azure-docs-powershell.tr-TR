...
## Tanım
Set-AzAnalysisServicesServer cmdlet 'i Analysis Services sunucusunun bir örneğini değiştirir
...
### -DisassociateGateway
Ağ Geçidi kaynağının çözümleme sunucusundan ilişkisini kaldırma
