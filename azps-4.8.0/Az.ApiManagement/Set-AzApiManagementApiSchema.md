...
## Tanım
**Set-AzApiManagementApiSchema** cmdlet 'ı BIR Azure API yönetim API şemasını değiştirir.

## ÖRNEKLERDEN

### Örnek 1: bir API şemasını değiştirme
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementApiSchema -Context $ApiMgmtContext -ApiId "echo-api" -SchemaId "2"
```

Örnekte API şeması güncelleştirilir

### Örnek 2

Bir API şemasını değiştirir. oluşturulmuş
...
### -RESOURCEID
Tanılama veya API şemasının ARM RESOURCEID. Bu parametre gereklidir.
...
### -SchemaDocument
Dize olarak API şema belgesi. Bu parametre gereklidir-SchemaDocumentFile belirtilmemiş.
...
API şemasının ContentType. Bu parametre isteğe bağlıdır.
...
API şema belge dosyası yolu. Bu parametre gereklidir-SchemaDocument belirtilmemiş.
...
### -SchemaId
Var olan şemanın tanımlayıcısı.
Bu parametre gereklidir.
