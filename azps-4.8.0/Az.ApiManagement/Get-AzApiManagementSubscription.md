...
Anahtarlar sonuç ayrıntılarına dahil olmaz. Anahtarları almak için **Get-Azapsananagementsubscriptionkey** seçeneğini kullanın.
...
### Örnek 6: bir ürünün ve Kullanıcı kapsamının tüm aboneliklerini alma
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
