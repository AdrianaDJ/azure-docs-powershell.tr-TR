...
## Tanım
**Yeni-Azapsananagementnamedvalue** cmdlet 'ı BIR Azure API Yönetimi **adı değeri** oluşturur.

## ÖRNEKLERDEN

### Örnek 1: etiketleri içeren adlandırılmış bir değer oluşturma
```
...
İkinci komut, adlandırılmış bir değer oluşturur ve $Tags dizelere etiket olarak ekler.

### Örnek 2: gizli değeri olan bir adlandırılmış değer oluşturma
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementNamedValue -Context $apimContext -NamedValueId "Property12" -Name "Secret Property" -Value "Secret Property Value" -Secret
```

Bu komut şifrelenmiş bir değeri olan **adlandırılmış bir değer** oluşturur.
...
### Namedvalueıd
Yeni adlandırılan değerin tanıtıcısı.
...
### Etiketli
Adlandırılan değer ile ilişkilendirilecek Etiketler.
Bu parametre isteğe bağlıdır.
