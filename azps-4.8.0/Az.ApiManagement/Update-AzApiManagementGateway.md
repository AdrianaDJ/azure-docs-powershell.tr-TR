...
## Tanım
**Update-Azapsananagementgateway** cmdlet 'ı bir API yönetim ağ geçidi yapılandırır.
...
Bu komut ağ geçidini yapılandırır.
...
### -InputObject
PsApiManagementGateway örneği. Bu parametre gereklidir.
...
### -Geçiş
Bu sonra, değiştirilmiş ağ geçidini temsil eden Microsoft. Azure. Commands. Apsananaitid.
...
### -RESOURCEID
Ağ geçidinin Kolonu. Bu parametre gereklidir.
...
### Microsoft. Azure. Commands. Apsananamedi. ServiceManagement. modeller. Psapsananagementresourcelocation

### System. Management. Automation. SwitchParameter

## ÇıKıŞLAR

### Microsoft. Azure. Commands. Apsananamedi. ServiceManagement. modeller. Psapsananagementgateway
