...
## Tanım
**Set-Azapsananagementsubscription** cmdlet 'i var olan abonelik ayrıntılarını ayarlar.
...
### -InputObject
Psapsananagementsubscription örneği. Bu parametre gereklidir.
...
### -UserID
Aboneliğin sahibi. Bu parametre isteğe bağlıdır.
