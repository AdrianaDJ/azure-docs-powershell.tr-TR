...
## Tanım
**Remove-Azapsananagementapifromgateway** cmdlet 'INE bir API ekler.

## ÖRNEKLERDEN

### Örnek 1: ağ geçidinden API kaldırma
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromGateway -Context $ApiMgmtContext -GatewayId "0123456789" -ApiId "0001" -PassThru
```

Bu komut ağ geçidinden belirtilen API 'yi kaldırır.

## PARAMETRELERINE

### -Apııd
Ağ geçidinden kaldırılacak mevcut API 'lerin tanıtıcısı.
...
### -Gatewayıd
API 'yi kaldırmak için mevcut ağ geçidinin tanıtıcısı.
Bu parametre gereklidir.
