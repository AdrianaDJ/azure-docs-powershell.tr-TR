...
## Tanım
**Get-Azapsananagementgateway** cmdlet 'i ya da belirli API yönetim ağ geçidini alır.

## ÖRNEKLERDEN

### Örnek 1: tüm ağ geçitlerini al
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext
```

Bu komut tüm ağ geçitlerini alır.

### Örnek 2: KIMLIĞE göre ağ geçidi alma
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext -GatewayId "0123456789"
```

Bu komut, 0123456789 ağ geçidini alır.
...
### -Gatewayıd
Ağ geçidinin tanımlayıcısı.
Belirtilmişse tanımlayıcı tarafından ağ geçidini bulmaya çalışır.
