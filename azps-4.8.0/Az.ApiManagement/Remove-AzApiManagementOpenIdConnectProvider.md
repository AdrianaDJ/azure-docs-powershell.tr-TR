...
## Tanım
**Remove-Azapsananagementopenıdconnectprovider** cmdlet 'ı Azure API Yönetimi Için OpenID Connect sağlayıcısını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: sağlayıcıyı kaldırma
```
...
Bu komut, KIMLIĞI OICProvider01 olan sağlayıcıyı kaldırır.
