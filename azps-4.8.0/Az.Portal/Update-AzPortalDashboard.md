...
## SYNOPSIS
Var olan panoyu güncelleştirir.
...
### Örnek 1: Pano etiketlerini güncelleştirme
```powershell
...
Panodaki etiketleri güncelleştirin.
Etiketler satır içi Hashtable olarak temsil edilir.

### Örnek 2: ardışık düzeni kullanarak Pano etiketlerini güncelleştirme
```powershell
...
Get-AzPortalDashboard kullanılarak yeniden denenen panodaki etiketleri güncelleştirme.
Bu, etiketleri tek bir panoda veya birden çok dashboardfs güncelleştirmek için kullanılabilir.
