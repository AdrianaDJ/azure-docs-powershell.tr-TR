...
### Örnek 1: Windows sanal masaüstü HostPool adını adıyla edinme
```powershell
...
Bu komut, kaynak grubunda Windows sanal masaüstü HostPool 'i alır.

### Örnek 2: Windows sanal masaüstü HostPools listesi
```powershell
...
Bu komut, kaynak grubunda Windows sanal masaüstü HostPools.
