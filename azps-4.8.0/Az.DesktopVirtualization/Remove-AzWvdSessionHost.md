...
### Örnek 1: Windows sanal masaüstü SessionHost adını adıyla silme
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Bu komut, bir konak havuzundaki Windows sanal masaüstü SessionHost öğesini siler.
...
### -Force
Kullanıcı oturumu var olsa da bayrağı sessionHost silinmeye zorlar.
