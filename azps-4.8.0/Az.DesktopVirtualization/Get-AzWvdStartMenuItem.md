...
### Örnek 2: Windows sanal masaüstü Başlat menüsü öğelerini listele
```powershell
...
Bu komut, bir grup grubundaki Windows sanal masaüstü Başlat menüsü öğelerini listeler.
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. Istartmenuıtem
