...
### Örnek 1: Windows sanal masaüstü kayıt belirtecini alma
```powershell
...
Bu komut, bir konak havuzunda Windows sanal masaüstü kayıt belirtecini alır.
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. RegistrationInfo
