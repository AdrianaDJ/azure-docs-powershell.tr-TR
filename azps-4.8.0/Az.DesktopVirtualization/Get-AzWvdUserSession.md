...
### Örnek 1: ada göre bir Windows sanal masaüstü Kullanıcı oturumu alın
```powershell
...
Bu komut, bir oturum ana bilgisayarında Windows sanal masaüstü Kullanıcı oturumunu alır.

### Örnek 2: Windows sanal masaüstü kullanıcı oturumlarını Listele
```powershell
...
Bu komut, bir oturum ana bilgisayarındaki Windows sanal masaüstü kullanıcı oturumlarını listeler.

### Örnek 3: konak havuzundaki Windows sanal masaüstü kullanıcı oturumlarını listeleme
```powershell
...
Bu komut, bir konak havuzundaki oturum ana bilgisayarında Windows sanal masaüstü kullanıcı oturumlarını listeler.
...
Filtreleme için geçerli özellikler userPrincipalName ve sessionState.
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. ıusersession
