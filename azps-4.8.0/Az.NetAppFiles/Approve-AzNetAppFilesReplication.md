...
## Tanım
Kaynak birimdeki çoğaltma bağlantısını onaylama
...
Bu komut, MyAnfVolume 'teki yinelemeyi onaylar.

## PARAMETRELERINE

### -AccountName
Çoğaltma kaynak biriminin ANF hesabının adı
...
### -Dataprotectionvolumeıd
Hedef veri koruma biriminin dosya sistemi kimliği
...
### -InputObject
Çoğaltma hedefine yetki veren ANF kaynak birim nesnesi
...
### -Ad
ANF çoğaltma kaynak biriminin adı
...
### -Geçiş
Belirtilen birimin çoğaltma yetkilendirmesi gerçekleştirilip gerçekleştirilmeyeceğini döndürme
...
### -PoolName
Çoğaltma kaynak biriminin ANF havuzunun adı
...
### -ResourceGroupName
ANF çoğaltma kaynak biriminin kaynak grubu
...
### -RESOURCEID
ANF çoğaltma kaynak biriminin kaynak kimliği
