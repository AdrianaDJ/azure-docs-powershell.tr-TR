...
## Tanım
**Yeni-AzNetAppFilesVolume** cmdlet 'ı BIR ANF birimi oluşturur.

## ÖRNEKLERDEN

### Örnek 1: ANF birimi oluşturma
```
...
Bu komut, "MyAnfPool" havuzunda yeni ANF birimi "MyAnfVolume" oluşturur.
...
### -CreationToken
Birim için benzersiz bir dosya yolu
...
### -ExportPolicy
Dışarı aktarma ilkesini temsil eden bir Hashtable dizisi
...
### -ReplicationObject
Replication nesnesini temsil eden bir Hashtable dizisi
...
### -Anlık anlık kimliği
Anlık görüntüden birim oluşturma. Anlık görüntüyü tanımlamakta kullanılan UUID v4 veya kaynak tanımlayıcısı
...
### -SubnetId
Atanmış bir alt ağ için Azure Resource URI 'SI
...
### -UsageThreshold
Bayt cinsinden bir dosya sistemi için izin verilen maksimum depolama kotası
