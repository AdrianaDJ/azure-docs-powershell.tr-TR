...
### Örnek 1: yay bulut hizmetini adıyla güncelleştir.
```powershell
...
Spring bulut hizmetini adıyla güncelleyin.

### Örnek 2: yay bulut hizmetini kanaldan güncelleştir.
```powershell
...
Yay bulut hizmetini kanaldan güncelleştir.
...
### -Traceappınsider.
Hedef uygulama Insight alet anahtarı
...
### -TraceEnabled
İzleme işlevinin etkinleştirilip etkinleştirilmeyeceğini gösterir
...
### Microsoft. Azure. PowerShell. cmdlet. SpringCloud. modeller. Api20190501Preview. IServiceResource
