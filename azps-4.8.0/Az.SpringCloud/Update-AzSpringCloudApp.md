...
### Örnek 1: yay bulut uygulamasını ada göre güncelleştir.
```powershell
...
Yay bulut uygulamasını ada göre güncelleştir.

### Örnek 2: yay bulut uygulamasını kanaldan güncelleştir.
```powershell
...
Yay bulut uygulamasını kanaldan güncelleştir.

## PARAMETRELERINE

### -ActiveDeploymentName
Uygulamanın etkin dağıtımının adı
...
### -HttpsOnly
Yalnızca https olup olmadığını gösterir.
...
### -Konum
Uygulamanın COĞRAFI konumu, her zaman üst kaynağıyla aynı olan
...
GB cinsinden kalıcı diskin boyutu
...
### -Genel
Uygulamanın genel uç noktayı gösterir
...
GB cinsinden geçici diskin boyutu
...
### Microsoft. Azure. PowerShell. cmdlet. SpringCloud. modeller. Api20190501Preview. ıappresource
