...
### Örnek 1: yay bulut dağıtımını adıyla güncelleştirin.
```powershell
...
Yay bulut dağıtımını adıyla güncelleştirin.

### Örnek 2: yay bulut dağıtımını kanaldan güncelleştir.
```powershell
...
Yay bulut dağıtımını kanaldan güncelleştir.
...
### -EnvironmentVariable
Ortam değişkenleri koleksiyonu
...
### -MemoryInGb
GB cinsinden gerekli bellek boyutu
...
### -SourceArtifactSelector
Çoklu modül projelerinin dağıtımında kullanılacak yapının seçici.
Bu, hedef modülün/projenin göreli yoludur.
...
### -SourceRelativePath
Kaynağı depolayan depolamanın göreli yolu
...
### Microsoft. Azure. PowerShell. cmdlet. SpringCloud. modeller. Api20190501Preview. ıdeploymentresource
