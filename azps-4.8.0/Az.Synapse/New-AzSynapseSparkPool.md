...
### Createbynaik Denableautoscaleparameterset (varsayılan)
```
...
### Createbynaik Vseçdisableautoscaleparameterset
```
New-AzSynapseSparkPool [-ResourceGroupName <String>] -WorkspaceName <String> -Name <String> [-Tag <Hashtable>]
...
## Tanım
**New-AzSynapseSparkPool** cmdlet 'ı bir Azure SYNAPSE Analytics Spark havuzu oluşturur.
...
Bu komut, ardışık düzen aracılığıyla bir Azure SYNAPSE Analytics Spark havuzu oluşturur.
...
Bu komut, ardışık düzen aracılığıyla otomatik ölçek etkinleştirilmiş bir Azure SYNAPSE Analytics Spark havuzu oluşturur.
