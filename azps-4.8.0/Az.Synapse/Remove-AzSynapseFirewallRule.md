...
## Tanım
**Remove-AzSynapseFirewallRule** cmdlet 'ı bir Azure SYNAPSE Analytics güvenlik duvarı kuralını kalıcı olarak siler.
...
Bu komut ContosoFirewallRule adındaki güvenlik duvarı kuralını çalışma alanı ContosoFirewallRule adıyla siler.
...
Bu komut, ContosoFirewallRule adındaki güvenlik duvarı kuralını ardışık düzen aracılığıyla siler.
