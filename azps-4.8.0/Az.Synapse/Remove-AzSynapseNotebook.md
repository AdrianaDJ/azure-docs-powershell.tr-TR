...
## Tanım
**Remove-AzSynapseNotebook** cmdlet 'i çalışma alanından bir not defterini kaldırır.
...
Çalışma alanı olan ContosoNotebook adındaki bir not defterini kaldırın.
...
Çalışma alanı 'nda ContosoNotebook adındaki bir not defterini kaldırma.
