...
### Waitparlak Jobbyidparameterset (varsayılan)
```
...
## Tanım
**Wait-AzSynapseSparkJob** cmdlet 'ı bir Azure SYNAPSE Analytics işinin tamamlamasını bekler.
...
Bu komut belirtilen KIMLIğIN tamamlanma işine yönelik bekler.
...
### -Timeoutınseconds
Hata vermeden önce beklenecek en uzun süre. Varsayılan değer asla zaman aşımına uğramayacak.
...
Saniye cinsinden iş durumu denetimleri arasındaki yoklama aralığı.
