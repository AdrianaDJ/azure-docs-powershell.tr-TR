...
## Tanım
**Stop-AzSynapsePipelineRun** cmdlet 'i, ARDıŞıK düzen kodu ile belirtilen çalışma alanında bir ardışık düzeni durdurur.
...
Bu komut, çalışma alanı contoso
...
Bu komut çalışma alanı 'nda b9730a13-AA12-4926-a8b3-8e3a974ab0bd kimliği olan ardışık düzen çalışmasını ardışık düzen aracılığıyla durdurur.
