...
## Tanım
**Remove-AzSynapseIntegrationRuntime** cmdlet 'i Integration Runtime 'ı kaldırır.
...
Bu komut, ' test edilmiş-IR ' adlı tümleştirme çalışma zamanını, ContosoWorkspace adlı çalışma alanından kaldırır.
