...
## Tanım
**Update-AzSynapseIntegrationRuntime** cmdlet 'i Integration Runtime özelliklerini günceller. Şu anda cmdlet, self-hosted Integration Runtime için yalnızca ' otomatik güncelleştirme ' ve ' AutoUpdateDelayOffset ' güncelleştirmesini destekliyor.
...
Self-hosted Integration Runtime otomatik güncelleştirmesi için günün saati.
