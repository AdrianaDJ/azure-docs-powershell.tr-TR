...
## Tanım
**Set-AzSynapseLinkedService** cmdlet 'i bir veri deposunu veya bulut hizmetini çalışma alanına bağlar.
...
Bu komut, ContosoWorkspace adlı çalışma alanında ContosoLinkedService adlı bir bağlantılı hizmet oluşturur.
...
Bu komut, ContosoLinkedService adında, bir çalışma alanında, ardışık düzen aracılığıyla.
