...
### Createbynameallowtalpparameterset
```
...
### Createbyparentobjectallowtalpparameterset
```
...
## Tanım
**New-AzSynapseFirewallRule** cmdlet 'ı bir Azure SYNAPSE Analytics güvenlik duvarı kuralı oluşturur.
...
Bu komut ContosoFirewallRule adlı bir güvenlik duvarı kuralı çalışma alanı adı ContosoFirewallRule ile oluşturulur.
...
Bu komut, ardışık düzen aracılığıyla ContosoFirewallRule adlı güvenlik duvarı kuralı oluşturur.
...
Bu komut, bir çalışma alanı altındaki tüm Azure IP 'lerinin bulunduğu güvenlik duvarı kuralı oluşturur.

## PARAMETRELERINE

### -AllowAllAzureIP
Tüm Azure IP 'Lerinin erişimine izin veren özel bir güvenlik duvarı kuralı oluşturur.
...
### -Endıadaddress
Güvenlik duvarı kuralının bitiş IP adresi.
IPv4 biçiminde olmalıdır.
Startıpaddress 'den büyük veya buna eşit olmalıdır.
...
### -Ad
Çalışma alanı için firerduvar kuralı adı.
...
### -Startıpaddress
Güvenlik duvarı kuralının başlangıç IP adresi.
IPv4 biçiminde olmalıdır.
...
### Microsoft. Azure. Commands. SYNAPSE. modeller. PSSynapseIpFirewallRule
