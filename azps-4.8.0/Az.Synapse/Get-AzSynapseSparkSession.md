...
## Tanım
**Get-AzSynapseSparkSession** cmdlet 'ı bir Azure SYNAPSE Analytics Spark oturumu hakkında bilgi alır.
...
Bu komut, belirtilen Spark havuzunun altındaki tüm Spark oturumlarını alır.
...
Bu komut, belirtilen Livy KIMLIĞIYLE Spark oturumunu alır.
...
Bu komut, belirtilen Spark havuzunun altındaki tüm Spark oturumlarını ardışık düzen aracılığıyla alır.
