...
## Tanım
**Start-AzSynapseSparkSession** cmdlet 'ı SYNAPSE Analytics Spark oturumunu başlatır.
...
Bu komut, bir Azure SYNAPSE Analytics Spark oturumu başlatır.
...
Bu komut, ardışık düzen aracılığıyla Azure SYNAPSE Analytics Spark oturumunu başlatır.
