...
## Tanım
**Update-AzSynapseFirewallRule** cmdlet 'ı bir Azure SYNAPSE Analytics güvenlik duvarı kuralını izler.
...
Bu komut ContosoFirewallRule adındaki güvenlik duvarı kuralını çalışma alanı ContosoFirewallRule adıyla güncelleştirir.
...
Bu komut, ContosoFirewallRule adındaki güvenlik duvarı kuralını ardışık düzen aracılığıyla güncelleştirir.
