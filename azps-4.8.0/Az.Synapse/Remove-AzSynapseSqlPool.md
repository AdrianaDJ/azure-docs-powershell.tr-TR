...
## Tanım
**Remove-AzSynapseSqlPool** cmdlet 'i, bir Azure SYNAPSE Analytics SQL havuzunu kalıcı olarak siler.
...
Bu komut bir Azure SYNAPSE Analytics SQL havuzunu siler.
...
Bu komut bir Azure SYNAPSE Analytics SQL havuzunu ardışık düzen aracılığıyla siler.
...
Bu komut, belirtilen kaynak KIMLIĞIYLE bir Azure SYNAPSE Analytics SQL havuzunu siler.
