...
## Tanım
**Remove-AzSynapseTrigger** cmdlet 'i çalışma alanından bir tetikleyiciyi kaldırır.
...
Contosotrigger adındaki bir tetikleyiciyi çalışma alanı contoso
...
Çalışma alanı 'nda ContosoTrigger adındaki bir tetikleyiciyi ardışık düzen aracılığıyla kaldırma.
