...
## SYNOPSIS
SYNAPSE Analytics SQL veritabanının varlığını denetler.

## INDEKI

### TestByNameParameterSet (varsayılan)
```
...
## Tanım
**Test-AzSynapseSqlDatabase** cmdlet 'ı SYNAPSE Analytics SQL veritabanının varlığını denetler.
...
Bu komut belirtilen SQL veritabanının varlığını denetler.
