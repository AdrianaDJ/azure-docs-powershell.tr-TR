...
## Tanım
**Remove-AzSynapseDataset** cmdlet 'i çalışma alanından bir veri kümesini kaldırır.
...
Bu komut, ContosoDataset adlı veri kümesini ContosoWorkspace adlı çalışma alanından kaldırır.
