...
## Tanım
**Remove-AzSynapseTriggerSubscription** cmdlet 'i tetik tanımı 'ndan belirtilen dış hizmet olaylarına olay tetiği aboneliğini kaldırır.
...
Bu komut, ContosoTrigger adındaki tetik adındaki tetik 'i tetik tanımı
...
Bu komut, Contosotetikleyicisi adındaki bir etkinlik aboneliğini, belirtilen olaylarla ardışık düzen aracılığıyla tetikleyerek tetikler.
