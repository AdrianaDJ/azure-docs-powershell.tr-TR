...
## Tanım
**Add-AzSynapseTriggerSubscription** cmdlet 'i tetik tanımı 'ndan belirtilen dış hizmet olaylarına olay tetikleyicisini abone olur.
...
Bu komut, ContosoTrigger adındaki tetik 'i tetik tanımı 'ndan belirtilen olaylara abone olur.
...
Bu komut, ContosoTrigger adındaki tetikleyiciye, ardışık düzene göre tetik ile belirtilen olaylara abone olur.
