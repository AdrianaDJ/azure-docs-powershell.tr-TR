...
### Örnek 1: bir makinenin tüm uzantılarını listeleme
```powershell
...
Belirli bir makine için tüm uzantıları listeler.

### Örnek 2: bir makinede belirli bir uzantı alma
```powershell
...
Bir makinedeki belirli bir uzantıyı alır.
