...
### Örnek 1: bir abonelikteki tüm bağlı makineleri listeleme
```powershell
...
Bir abonelikteki tüm bağlı makineleri listeler.
Abonelik belirtilmezse, abonelik geçerli Azure PowerShell içeriğinden kullanılır.

### Örnek 2: kaynak grubundaki tüm bağlı makineleri listeleme
```powershell
...
Kaynak grubundaki tüm bağlı makineleri listeler.

### Örnek 3: ada göre kaynak grubunda bağlı bir makine edinme
```powershell
...
Kaynak grubunda ada göre bağlı bir makine edinin.
...
### -Genişletme
İşlemde uygulanacak genişletme ifadesi.
...
### Microsoft. Azure. PowerShell. cmdlet. ConnectedMachine. modeller. Api20200802. IMachine
