...
## Tanım
Bağlantı anahtarları listesini alın.
...
CosmosDB hesabı anahtarlarını listeler. Anahtar türü: ConnectionString, anahtarlar ve ReadOnlyKeys değerleri olabilir. Anahtarlar varsayılan.
...
### -Tür
Değer: {ConnectionStrings, anahtarlar, ReadOnlyKeys}.
Anahtarlar varsayılan.
...
### Microsoft.Azure.Commands.CosmosDB.Models.PSDAtabaseaccountlistconnectionstring
