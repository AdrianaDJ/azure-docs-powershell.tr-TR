...
## SYNOPSIS
PSSqlConflictResolutionPolicy türünde yeni bir nesne oluşturur. Set-AzCosmosDBSqlContainer için parametre değeri olarak iletilebilir.
...
## Tanım
SQL API 'ın ConflictResolutionPolicy öğesine karşılık gelen nesne.
