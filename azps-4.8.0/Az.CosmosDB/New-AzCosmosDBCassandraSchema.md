...
## SYNOPSIS
Yeni bir CosmosDB Cassandra şeması oluşturur.
...
## Tanım
**New-AzCosmosDBCassandraSchema** , yeni bir Cosmosdb Cassandra şeması oluşturur.
...
### -PartitionKey
Bölüm anahtarlarını içeren dizeler dizisi.
