...
## SYNOPSIS
MongoDB koleksiyonunun CosmosDB aktarımı özelliklerini alır.
...
## Tanım
**Get-Azcosmosdbmongodbcollectionüretiminin** cmdlet 'ı MongoDB koleksiyonunun üretilen iş özelliklerini alır.
...
### -InputObject
Sağlanmışsa, cmdlet, ilgili üretilen iş değerini içeren koleksiyonu döndürür.
