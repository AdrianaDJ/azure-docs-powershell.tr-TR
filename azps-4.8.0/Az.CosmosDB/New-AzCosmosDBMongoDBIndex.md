...
## SYNOPSIS
Yeni bir CosmosDB MongoDB dizini oluşturur.
...
## Tanım
**New-AzCosmosDBMongoDBIndex** , yeni bir Cosmosdb MongoDB dizini oluşturur.
...
### -Tuşlu
Anahtar değerler dizeler olarak dizi.
...
### -Ttlinsaniye
Dizinin süre sonundan sonraki saniye sayısı.
...
### -Benzersiz
Bool, dizinin benzersiz olup olmadığını belirtecek şekilde Boole.
...
### Microsoft. Azure. Commands. CosmosDB. modeller. Psmte Goındex
