...
### Örnek 5: zaman çizgisi ve birden çok kategoriyi etkinleştirme
```powershell
...
### Örnek 6: ardışık düzen kullanma
```powershell
...
### -EnableLog
Tanılama günlüklerinin etkinleştirilip etkinleştirilmeyeceğini gösteren değer
...
### -EnableMetrics
Tanılama ölçümlerinin etkinleştirilip etkinleştirilmeyeceğini belirten değer
