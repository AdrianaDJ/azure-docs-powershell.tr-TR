...
## Tanım
Yerine koyma semantiği

## ÖRNEKLERDEN

### Örnek 1: kural adına göre ayarlama
```powershell
...
### Örnek 2: giriş nesnesine göre ayarlama
```powershell
...
### Örnek 3: kaynak kimliğiyle ayarlama
```powershell
...
### -Eylem
Zamanlanmış sorgu kuralı uyarısı eylemi
...
### -Zamanlama
Zamanlanmış sorgu kuralı zamanlaması
