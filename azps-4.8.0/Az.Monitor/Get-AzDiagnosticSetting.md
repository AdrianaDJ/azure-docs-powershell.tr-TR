...
## Tanım
**Get-AzDiagnosticSetting** cmdlet 'i, kaynak için günlüğe kaydedilen kategorileri ve zaman gratileri alır.
...
### -Ad
Tanılama ayarının adı. Verilmezse, önceki API 'da olduğu gibi "hizmet" için çağrı yapın.
