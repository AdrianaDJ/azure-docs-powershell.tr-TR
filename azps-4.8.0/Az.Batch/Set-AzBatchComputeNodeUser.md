...
## Tanım
**Set-AzBatchComputeNodeUser** cmdlet 'i, bir Azure toplu işlem düğümündeki Kullanıcı hesabının özelliklerini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: Kullanıcı hesabını güncelleştirme
```
...
Bu komut, ContosoPool adlı havuzda belirtilen KIMLIĞE sahip işlem düğümündeki PFuller adındaki Kullanıcı hesabını değiştirir.
Komut hesap parolasını ve son kullanma süresini değiştirir.
...
### -Computenodeıd
Bu cmdlet 'in üzerinde yaptığı işlem düğümünün KIMLIĞINI belirtir.
...
### -ExpiryTime
Kullanıcı hesabı için son kullanma süresini belirtir.
...
### -Ad
Bu cmdlet 'in değiştirdiği Kullanıcı hesabının adını belirtir.
...
### -Parola
Kullanıcı hesabının parolasını belirtir.
...
### -PoolId
Bu cmdlet 'in üzerinde çalıştırıldığı COMPUTE düğümünü içeren havuzun KIMLIĞINI belirtir.
