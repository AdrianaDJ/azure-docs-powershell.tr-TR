...
### Örnek 1: belirtilen PostgreSql sunucusundaki tüm sanal ağ kurallarını listeler
```powershell
...
Bu cmdlet, belirtilen PostgreSql sunucusundaki tüm sanal ağ kurallarını listeler.
