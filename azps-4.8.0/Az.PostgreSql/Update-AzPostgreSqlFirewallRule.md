...
Bu cmdlet PostgreSql güvenlik duvarı kuralını adıyla güncelleştirir.
...
Bu cmdlet 'ler, posta yoluyla PostgreSql güvenlik duvarı kuralını güncelleştirir.

### Örnek 3: PostgreSql güvenlik duvarı kuralını-ClientIpAddress olarak güncelleyin.
```powershell
...
Bu cmdlet 'ler, PostgreSql güvenlik duvarı kuralını, tarafından açılır.
