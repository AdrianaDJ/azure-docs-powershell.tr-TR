...
### Örnek 1: PostgreSql Server sanal ağ kuralını ada göre kaldırma
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Bu cmdlet, PostgreSql Server sanal ağ kuralını adıyla kaldırır.

### Örnek 2: http Resql Server sanal ağ kuralını kimlikle kaldırma
```powershell
