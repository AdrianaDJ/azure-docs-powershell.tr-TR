...
### Örnek 1: resourceGroup ve sunucu adına göre PostgreSql sunucusunu kaldır
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Bu cmdlet, resourceGroup ve sunucu adına göre PostgreSql sunucusunu kaldırır.

### Örnek 2: kimliği kullanarak PostgreSql sunucusunu kaldırma
```powershell
