...
## Tanım
**Remove-Azdatasharesynmadizationsetting** cmdlet 'i, datashare eşitleme ayarını kaldırır
...
Bu komut, paylaşımapaylaşımı ayarı adlı bir eşitleme ayarını Share AdsShare dizininden kaldırır. 
...
### -InputObject
Azure veri paylaşımı eşitleme ayarı.
...
### -RESOURCEID
Eşitleme ayarının kaynak kimliği
