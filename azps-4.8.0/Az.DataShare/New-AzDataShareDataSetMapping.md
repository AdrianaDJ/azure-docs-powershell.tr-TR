...
## Tanım
**New-AzDataShareDataSetMapping** cmdlet 'i, paylaşım aboneliğindeki kaynak veri kümeleri ve havuz depolama hesabı arasında veri kümesi eşlemesi oluşturur.
...
Bu komut, veri paylaşımı hesabı WikiAdsAccount ' deki paylaşım aboneliği Adsshar, Share aboneliğinin
