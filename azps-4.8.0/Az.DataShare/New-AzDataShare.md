...
## Tanım
**New-AzDataShare** cmdlet 'i, kaynak grubu adı, hesap adı, paylaşım adı ve paylaşım türü gibi belirli bir Azure veri paylaşımı hesabında veri paylaşımı oluşturur. Açıklama ve kullanım şartları, veri paylaşımı oluşturulurken ayarlanabilir isteğe bağlı parametrelerdir.

## ÖRNEKLERDEN

### Örnek 1: veri paylaşımı oluşturma
```
...
Bu komut, kaynak grup REKLAMLARı ile ilgili açıklama ve kullanım şartları altındaki veri paylaşımı hesap WikiAdsAccount altında, tür Copyshare adlı bir veri paylaşımı oluşturur.
...
### -Açıklama
Azure veri paylaşımı 'nın açıklaması
...
### -TermsOfUse
Azure veri paylaşımı için kullanım şartları
