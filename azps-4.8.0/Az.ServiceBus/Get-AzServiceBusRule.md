...
## SYNOPSIS
Verilen bir konu aboneliğindeki mevcut bir kuralın tanımını getirir. 
...
## Tanım
**Get-AzServiceBusRule** cmdlet 'i, belirtilen kuralın söz konusu aboneliğindeki açıklamasını alır.
...
Belirtilen aboneliğin belirtilen kural açıklamasını döndürür.
...
Belirtilen aboneliğin kural açıklamaları listesini döndürür.  Varsayılan olarak 100 kuralı döndürülecek, 100 taneden fazla kural döndürülürse, lütfen-MaxCount parametresini kullanın.
...
Belirtilen bir aboneliğin ilk 150 kuralı açıklamalarının listesini döndürür.
...
### -MaxCount
Döndürülecek kural sayısının üst sınırını belirleme.
...
### Microsoft. Azure. Commands. ServiceBus. modeller. PSRulesAttributes
