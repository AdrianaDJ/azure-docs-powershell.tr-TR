...
## SYNOPSIS
Namespace/Queue/topic için Azure ServiceBus yetkilendirme kuralı için SAS Tolen oluşturur. 
...
## Tanım
New-AzServiceBusAuthorizationRuleSASToken cmdlet 'i Azure Eventhub ad sapce veya Azure Eventhub için paylaşılan bir erişim Imzası (SAS) belirteci oluşturur
...
Başlangıç ve bitiş tarihi olan ad alanı için verilen authorixation kuralı için SAS belirteci oluştur..
...
Son kullanma tarihi olan ad alanı için verilen authorixation kuralı için SAS belirteci oluşturun.

## PARAMETRELERINE

### -Authorizationruleıd
Yetki kuralının KOLUNU
...
### Microsoft. Azure. Commands. ServiceBus. modeller. Pssharedaccesstifreattributes
