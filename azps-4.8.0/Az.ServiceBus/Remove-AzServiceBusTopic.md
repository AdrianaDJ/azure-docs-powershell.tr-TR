...
## Tanım
**Remove-AzServiceBusTopic** cmdlet 'i, konuyu belirtilen hizmet veri yolu ad boşluğundan kaldırır.
...
Başlığı `SB-Topic_exampl1` ad alanından kaldırır `SB-Example1` .
...
### Örnek 4: değişken kullanan RESOURCEID:
```powershell
PS C:\> $resourceid = Get-AzServiceBusTopic <params>
PS C:\> Remove-AzServiceBusTopic -ResourceId $resourceid.Id
```

### Örnek 5: dize değeri kullanan RESOURCEID
```powershell
...
### -RESOURCEID
Hizmet veri yolu başlığı kaynak kimliği
