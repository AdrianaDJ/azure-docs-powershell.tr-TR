...
Kayıt tanımı ayrıntıları olmadan bir kayıt atamasını alır.
...
Kayıt tanımı ayrıntılarını içeren bir kayıt atamasını alır.
...
Tam nitelikli kaynak kimliği için kayıt atamasını alır.
...
### -ID
Kayıt atama tanımlayıcısı (örneğin, b0c052e5-c437-4771-A476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
...
### -RESOURCEID
Kayıt atama RESOURCEID (örneğin,/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationAssignments/b0c052e5-c437-4771-a476-8b1201158a57)
```yaml
Type: System.String
