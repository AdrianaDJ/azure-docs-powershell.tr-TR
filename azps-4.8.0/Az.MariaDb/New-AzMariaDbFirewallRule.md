...
### Örnek 1: MariaDB altında güvenlik duvarı kuralı oluşturma
```powershell
...
Bu komut bir MariaDB altında bir güvenlik duvarı kuralı oluşturur.

### Örnek 2:-ClientIpAddress kullanarak yeni bir MariaDB güvenlik duvarı kuralı oluşturun.
```powershell
...
Bu cmdlet 'ler-ClientIpAddress kullanan bir MariaDB güvenlik duvarı kuralı oluşturur.
...
Bu cmdlet 'ler tüm IP 'Lere izin veren yeni bir güvenlik duvarı kuralı oluşturur.
