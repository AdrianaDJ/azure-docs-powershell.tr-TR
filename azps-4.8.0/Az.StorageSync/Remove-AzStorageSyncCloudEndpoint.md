...
## Tanım
Bu komut, belirtilen bulut uç noktasını bir eşitleme grubundan siler. Azure dosya paylaşımı bulut uç noktası başvuruları bu işlemle değişmeden kalır. Bu komut yalnızca yetki alma amaçlıdır. Bulut uç noktasını kaldırmak bozucu bir işlemdir. Sunucu uç noktaları, en az bir bulut uç noktası olmadan eşitlenemiyor. Bu işlem, eşitleme sorunlarını çözmek için gerçekleştirilmemelidir. Bu Azure dosya paylaşımı, bulut uç noktası olarak aynı eşitleme grubuna yeniden eklenirse, çakışma dosyalarına ve diğer istenmeyen sonuçlara yol açabilir.
...
Bu komut, bulut uç noktasını kaldırır.
...
### -InputObject
Genellikle ardışık düzen aracılığıyla iletilen Cloudenvseçpoint giriş nesnesi.
