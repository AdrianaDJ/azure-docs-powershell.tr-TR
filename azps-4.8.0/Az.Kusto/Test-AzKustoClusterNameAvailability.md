...
### Örnek 1: kullanımda olan bir kusto küme adının kullanılabilirliğini denetleme
```powershell
...
Yukarıdaki komut, "testnewkustocluster" adlı kusto kümesinin "Doğu US" bölgesinde bulunup bulunmadığını döndürür.

### Örnek 2: kullanımda olmayan bir kusto küme adının kullanılabilirliğini denetleme
```powershell
...
Yukarıdaki komut, "availablekustocluster" adlı kusto kümesinin "Doğu US" bölgesinde bulunup bulunmadığını döndürür.
...
### -Tür
Kaynak türü olan Microsoft. kusto/kümeler.
