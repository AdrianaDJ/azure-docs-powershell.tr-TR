...
### Örnek 1: kullanımda olan bir küme principalassignment adının uygunluk durumunu denetleme
```powershell
...
Yukarıdaki komut, "myprincipal" adındaki bir PrincipalAssignment "testnewkustocluster" kümesinde var olup olmadığını döndürür.

### Örnek 2: kullanımda olmayan bir küme principalassignment adının uygunluk durumunu denetleme
```powershell
...
Yukarıdaki komut "testnewkustocluster" kümesinde "NewPrincipal" adında bir PrincipalAssignment olup olmadığını döndürür.
...
### -Tür
Kaynak türü, Microsoft. kusto/kümeler/Princıpalas,.
