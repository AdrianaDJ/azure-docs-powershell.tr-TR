...
### Örnek 1: kümedeki tüm AttachedDatabaseConfigurations 'ı listeleme
```powershell
...
Yukarıdaki komut, "testnewkustoclusterf" kümesindeki tüm AttachedDatabaseConfigurations 'ı listeler.

### Örnek 2: kümede belirli bir AttachedDatabaseConfiguration alma
```powershell
...
Yukarıdaki komut, "testnewkustoclusterf" kümesinde "myizleme" adlı AttachedDatabaseConfigurations 'ı döndürür.
