...
### Örnek 1: kullanımda olan bir veri bağlantısı adının uygunluk durumunu denetleme
```powershell
...
Yukarıdaki komut, "mykustodatabase" veritabanında "mykustodataconnection" adlı bir veri bağlantısının bulunup bulunmadığını döndürür.

### Örnek 2: kullanımda olmayan bir veri bağlantısı adının uygunluk durumunu denetleme
```powershell
...
Yukarıdaki komut "mydataconnection" adlı bir veri bağlantısının "mykustodatabase" veritabanında bulunup bulunmadığını döndürür.
...
### -Tür
Kaynak, Microsoft. kusto/kümeler/veritabanları/veri bağlantıları türü.
