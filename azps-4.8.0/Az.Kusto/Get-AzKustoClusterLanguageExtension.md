...
### Örnek 1: kümenin tüm dil uzantılarını listeleme
```powershell
...
Yukarıdaki komut, KQL sorgularında çalıştırılabilecek dil uzantılarının listesini döndürür.
...
### Microsoft. Azure. PowerShell. cmdlet. kusto. modeller. Api20200614. ılanguageextension
