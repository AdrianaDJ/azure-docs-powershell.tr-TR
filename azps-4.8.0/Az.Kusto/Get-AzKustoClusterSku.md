...
### Örnek 1: uygun SKU 'Ları listeler
```powershell
...
Yukarıdaki komut uygun SKU 'Ları listeler.

### Örnek 2: belirli küme için uygun SKU 'Ları listeler
```powershell
...
Yukarıdaki komut, belirli küme için uygun SKU 'Ları listeler
...
### Microsoft. Azure. PowerShell. cmdlet. kusto. modeller. Api20200614. IAzureResourceSku

### Microsoft. Azure. PowerShell. cmdlet. kusto. modeller. Api20200614. ıskudescription
