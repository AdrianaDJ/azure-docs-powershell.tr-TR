...
### Örnek 1: kullanımda olan bir veritabanı principalassignment adının uygunluk durumunu denetleme
```powershell
...
Yukarıdaki komut, "myprincipal" adındaki bir PrincipalAssignment "testnewkustocluster" kümesinden "mykustodatabase" veritabanında bulunup bulunmadığını döndürür.

### Örnek 2: kullanımda olmayan bir veritabanı principalassignment adının uygunluk durumunu denetleme
```powershell
...
### -Tür
Kaynak türü, Microsoft. kusto/kümeler/veritabanları/Principalas,.
