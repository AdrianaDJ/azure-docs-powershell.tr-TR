...
### Örnek 1: kümedeki tüm kusto veritabanlarını ada göre listeler
```powershell
...
### Örnek 2: adla belirli bir kusto veritabanı alma
```powershell
...
Yukarıdaki komut, "mykustodatabase" adlı kusto veritabanını, "testrg" kaynak grubunda bulunan "testnewkustocluster" kümesinde döndürür.
