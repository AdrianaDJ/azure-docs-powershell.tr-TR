...
### Örnek 1: kaynak grubundaki tüm kusto kümelerini listeleme
```powershell
...
### Örnek 2: adla belirli bir kusto kümesi edinme
```powershell
...
Yukarıdaki komut, "testrg" kaynak grubunda "testnewkustocluster" adlı kusto kümesini döndürür.
