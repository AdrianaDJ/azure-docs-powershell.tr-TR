...
## Tanım
**Yeni-AzContainerGroup** cmdlet 'leri bir kapsayıcı grubu oluşturur.
...
Bu komutlar, en son Nginx görüntüsünü kullanarak sistem tarafından atanan kimlik ile bir kapsayıcı grubu oluşturur ve bağlantı noktası 8000 ' i açan genel bir IP adresi ister.
...
Bu komutlar, en son Nginx görüntüsünü kullanarak sistem atanmış ve Kullanıcı tarafından atanmış bir kapsayıcı grubu oluşturur ve bağlantı noktası 8000 ' i açan genel bir IP adresi ister.

## PARAMETRELERINE

### -Atama kimliği
Sistemin atadığı kimliği etkinleştirme
...
### -IdentityId
Kullanıcının kimlik kimlikleri
