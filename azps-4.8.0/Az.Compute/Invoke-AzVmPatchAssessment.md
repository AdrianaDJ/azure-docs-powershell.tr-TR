...
## Tanım
Assesses bir VM 'in düzeltme durumunu bildirir ve tüm algılanan düzeltme eklerini yükleme için kullanılabilir.
...
### -RESOURCEID
Sanal makinenizin kaynak KIMLIĞI.
...
### -VM
PowerShell sanal makine nesnesi
...
### Microsoft. Azure. Commands. COMPUTE. Automation. modeller. PSVirtualMachinePatchAssessmentResult
