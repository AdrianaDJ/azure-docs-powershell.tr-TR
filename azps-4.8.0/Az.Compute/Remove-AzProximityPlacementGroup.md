...
## Tanım
Bu cmdlet, yakınlık Yerleşim grubu kaynağını silecek.
...
Bu komut, verilen yakınlık Yerleşim grubunu kaldırır.

### Örnek 2

Bu komut, verilen yakınlık Yerleşim grubunu kaldırır. oluşturulmuş
...
### -InputObject
PS yakınlık Yerleşim grubu nesnesi
