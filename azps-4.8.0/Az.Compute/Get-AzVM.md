...
## Tanım
**Get-azıvm** cmdlet 'i, bir Azure sanal makinesinin model görünümünü veya örnek görünümünü alır.
...
Varsayılan olan model görünümü yerine sanal makinenin örnek görünümünü almak için *durum* parametresini belirtin.
...
### Örnek 6: filtreleme kullanarak tüm sanal makineleri alma
```
...
Bu komut aboneliğinizdeki "test" ile başlayan tüm sanal makineleri alır.
