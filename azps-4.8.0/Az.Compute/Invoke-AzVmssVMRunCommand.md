...
## Tanım
Sanal makine ölçek kümesi VM 'de bir Run komutunu çağırın.
...
' sample.ps1 ' komut dosyasını geçersiz kılarak RunPowerShellScript 'in Run komutunu çağırın ve ' RgName ' kaynak grubunda yer alan sanal makine ölçeği '
...
### -InstanceId
Sanal makine ölçek kümesi VM 'sinin örnek KIMLIĞI.
...
### -ScriptPath
Yürütülecek komut dosyasının yolu.  Bu değer verildiğinde, verilen komut dosyası komutun varsayılan komut dosyasını geçersiz kılar.
...
PS sanal makine ölçeği kümesi VM nesnesi.
...
### -VMScaleSetName
Sanal makine ölçek kümesi VM 'sinin adı.
...
### Microsoft. Azure. Commands. COMPUTE. Automation. modeller. PSRunCommandResult
