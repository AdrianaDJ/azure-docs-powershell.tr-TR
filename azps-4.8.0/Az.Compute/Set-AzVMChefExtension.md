...
## Tanım
**Set-AzVMChefExtension** cmdlet 'i sanal makineye Chef uzantısını ekler.
...
Görev: Chef-istemciyi, arka planda zamanlanmış görev olarak otomatik olarak çalışacak şekilde yapılandırır.
