...
## Tanım
Bu cmdlet, yakınlık Yerleşim grubu kaynakları 'nı alır veya listeler.
...
Bu komut, yakınlık Yerleşim grubunu alır
...
Bu komut, verilen kaynak grubunun altındaki tüm yakınlık Yerleşim gruplarını listeler.
...
Bu komut aboneliğin altındaki tüm yakınlık Yerleşim gruplarını listeler.

## PARAMETRELERINE

### -Kolombiya Cationstatus
Yakınlık yerleşimi grubundaki bir kaynağın ayırma durumunu gösterir.
...
### -Ad
Yakınlık Yerleşim grubunun adı.
...
### -RESOURCEID
Yakınlık Yerleşim grubu için kaynak kimliği.
...
### Microsoft. Azure. Commands. COMPUTE. Automation. modeller. PSProximityPlacementGroup
