...
- `Add-AzKeyVaultCertificate`Sertifika imzalama isteği oluşturmak ve sertifika yetkilisine göndermek için kullanın. Öğrenmek https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[Anahtar Kasası 'nda CSR oluşturma ve birleştirme](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)