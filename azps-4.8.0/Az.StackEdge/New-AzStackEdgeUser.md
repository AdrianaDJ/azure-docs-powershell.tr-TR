...
## Tanım
**New-AzStackEdgeUser** cmdlet 'ı yığın uç aygıtı için yeni bir kullanıcı oluşturur. Yalnızca türü kullanıcıların oluşturulması `Share` desteklenir.
...
### -Parola
Parola, güvenli dize olarak sağla
