...
## Tanım
**Yeni-AzStackEdgeOrder** cmdlet 'ı yığın uç aygıtı için yeni bir sıra oluşturur. Bir sıra oluşturmadan önce bir yığın uç cihaz kaynağının oluşturulması gerekir. İlgili kişi, şirket adı, e-posta, adres vb. gibi ayrıntıları, siparişi oluşturmaya yönelik parametreler olarak belirtebilirsiniz.
...
### Microsoft. Azure. PowerShell. cmdlet. StackEdge. modeller. PSStackEdgeOrder
