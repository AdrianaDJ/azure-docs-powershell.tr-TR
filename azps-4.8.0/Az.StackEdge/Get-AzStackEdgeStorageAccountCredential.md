...
## Tanım
**Get-AzStackEdgeStorageAccountCredential** cmdlet 'ı, yığın uç cihazında ilgili depolama hesabının depolama hesabı kimlik bilgilerini alır. Belirli bir depolama hesabı kimlik bilgisi hakkında bilgi almak için ad, kaynak grubu adı ve cihaz adı parametrelerini belirtebilirsiniz.
