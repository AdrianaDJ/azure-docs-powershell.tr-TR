...
### FileEventTriggerParameterSet (varsayılan)
```
...
## Tanım
**New-AzStackEdgeTrigger** cmdlet 'ı yığın uç cihazında bir tetik yapılandırır. 
...
### -FileEvent
FileEvent tetikleyicisini yapılandırmak için bu Switch parametresini iletin
...
### -Dönembir TimerEvent
Bu Switch parametresini, Dönemtimerevent tetikleyicisini yapılandırmak için geçir
...
### -RoleName
Hangi olayların yükseltilecektir rol.
...
### -Zamanlama
Süreölçer olayının oluşturulması gereken dönemsel sıklık. Gün (1 ve 365 arasında), saat (1 ile 23 arasında) veya dakika (1 ile 59 arasında) arasında bir zamanlama belirtin.
...
### -Shareıd
Dosya olay tetikleyicisinde geçirilecek dosya paylaşımı KIMLIĞI
...
### -Başlangıçsaati
Geçerli tetik sonucu veren günün saati. Zamanlama, saniye ile belirtilen zamanın başvurusuyla hesaplanır. Saat dilimi belirtilmezse, süre Device saat diliminde olduğu kabul edilir. Değer her zaman UTC saati olarak döndürülür.
...
### -Konu
Dönemsel olayların IoT cihazında yayımlandığı konu.
...
### Microsoft. Azure. PowerShell. cmdlet. StackEdge. model. PSStackEdgeTrigger
