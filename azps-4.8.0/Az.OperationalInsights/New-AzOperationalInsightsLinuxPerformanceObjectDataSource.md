...
## Tanım
**New-Azoperationalınsightslinuxperformanceobjectdatasource** cmdlet 'i bir çalışma alanındaki tüm Linux bilgisayarlara veri topladığı performans sayaçlarını ekler.
