...
## Tanım
**Disable-Azoperationalınsightslinuxperformancecbir** cmdlet, bir çalışma alanındaki bağlı Linux bilgisayarlarından performans sayaçlarının toplanmasını durdurur.
