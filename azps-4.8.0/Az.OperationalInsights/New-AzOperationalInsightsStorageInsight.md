...
İkinci komut $Storage Depolama hesabını, belirtilen depolama hesabı anahtarını almak için ardışık düzen işlecini kullanarak Get-AzStorageAccountKey cmdlet 'ine geçirir ve ardından $StorageKey değişkeninde depolar. Bu örnek ilk anahtarı alır. Diğerini geri almak için [0] değeri yerine [1] değerini kullanın.
...
Üçüncü komut Get-AzStorageAccountKey $Storage Depolama hesabını, ardışık düzen işlecini kullanarak belirtilen anahtarı elde edin ve ardından $StorageKey değişkeninde depolar. Bu örnek ilk anahtarı alır. Diğerini geri almak için [0] değeri yerine [1] değerini kullanın.
