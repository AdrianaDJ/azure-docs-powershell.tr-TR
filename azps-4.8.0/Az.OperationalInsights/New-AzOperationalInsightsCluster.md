...
### -IdentityType
kimlik türü; değer ' SystemAssigned ', ' none ' olabilir.
...
### -Konum
Kümenin dağıtılacağı coğrafi bölge.
...
### -Skukapasitesi
STB kapasitesi, değerin 100 ve 1000-2000 aralığında olması gerekir.
...
### -SkuName
SKU adı, şimdi yalnızca ' Capacityreservatıon ' olabilir
...
### Microsoft. Azure. Commands. Operationalınsights. model. PSCluster
