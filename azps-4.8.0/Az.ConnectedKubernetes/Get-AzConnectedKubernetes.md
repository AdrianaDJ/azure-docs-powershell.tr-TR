...
## SYNOPSIS
Ad, kimlik, Özellikler ve ek küme ayrıntıları da içinde olmak üzere, belirtilen bağlı kümenin özelliklerini döndürür.
...
### Örnek 1: aboneliğin altındaki tüm bağlı kererleri alma
```powershell
...
Bu komut, bir aboneliğin altındaki tüm bağlı kuberleri alır.

### Örnek 2: kaynak grubu altındaki tüm bağlı kuberleri alma
```powershell
...
Bu komut, kaynak grubu altındaki tüm bağlı kuberleri alır.
...
Bu komut, bağlı kubererleri alır.

### Örnek 4: nesneye göre bağlı bir kuberertes alma
```powershell
...
Bu komut, bağlı bir kubererleri nesneye göre alır.
...
### Microsoft. Azure. PowerShell. cmdlet. ConnectedKubernetes. modeller. Api202001Preview. IConnectedCluster
