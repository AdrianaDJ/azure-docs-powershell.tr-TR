...
### Örnek 1: taşıma koleksiyonundaki tüm kaynakların ayrıntılarını alma.
```powershell
...
Taşıma koleksiyonundaki tüm kaynakların ayrıntılarını edinin.

### Örnek 2: kaynak adını taşı kullanarak taşıma koleksiyonundaki belirli bir kaynağın ayrıntılarını alma.
```powershell
...
Kaynak adını taşı kullanarak taşıma koleksiyonundaki belirli bir kaynağın ayrıntılarını alma.

### Örnek 3: SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState gibi filtreler kullanarak, taşıma koleksiyonundaki belirli bir kaynağın ayrıntılarını alma
```powershell
...
Armid, moveStatusMoveState gibi filtre kullanarak, taşıma koleksiyonundaki belirli bir kaynağın ayrıntılarını alın.
...
Örneğin, $filter = Özellikler/ProvisioningState EQ ' tamamlandı ' kullanabilirsiniz.
