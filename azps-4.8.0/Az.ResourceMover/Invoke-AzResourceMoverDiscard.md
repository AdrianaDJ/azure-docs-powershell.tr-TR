...
### Örnek 1: kaynakları atmadan önce bağımlıları doğrulayın.
```powershell
...
Kaynakları atmadan önce bağımlıları doğrulayın.

### Örnek 2: giriş olarak "MoveResource" kullanarak kaynakların taşınmasını atar
```powershell
...
Giriş olarak "MoveResource adı" kullanarak kaynakların taşınmasını atar.

### Örnek 3: giriş olarak "SourceARMID" kullanarak kaynakların taşınmasını atar
```powershell
...
Kaynak olarak "SourceARMID" kullanarak kaynakların taşınmasını atar.
