...
### Örnek 1: belirtilen ortamın altındaki tüm başvuru veri kümelerini listeler
```powershell
...
Bu komut, belirtilen ortamdaki tüm başvuru veri kümelerini listeler.

### Örnek 2: adla ayarlanan bir başvuru verilerini alma
```powershell
...
Bu komut, belirli bir başvuru verileri kümesi alır.

### Örnek 3: nesne kümesi
```powershell
...
### -Ad
Belirtilen ortamla ilişkili saat serisi öngörüleri başvuru veri kümesinin adı.
