...
### Örnek 1: belirtilen başvuru verilerini adla ayarlayarak kaldırma
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Bu komut, belirtilen başvuru veri kümesini kaldırır.

### Örnek 2: nesne kümesini belirtilen başvuru verilerini kaldırma
```powershell
