...
### Örnek 1: belirtilen ortamdaki tüm olay kaynaklarını listeler
```powershell
...
Bu komut, belirtilen ortamların altındaki tüm olay kaynaklarını listeler.

### Örnek 2: adla belirtilen bir olay kaynağını alma
```powershell
...
Bu komut belirli bir olay kaynağını alır.

### Örnek 3: belirli bir olay kaynağını nesneye alma
```powershell
