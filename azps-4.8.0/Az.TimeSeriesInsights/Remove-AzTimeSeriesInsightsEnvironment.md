...
### Örnek 1: zaman serisi Insights ortamını ada göre kaldırma
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Bu komut, zaman serisi Öngörüler ortamını kaldırır.

### Örnek 2: nesne bazında bir zaman serisi Öngörüler ortamını kaldırma
```powershell
