...
### Örnek 1: zaman serisi Öngörüler ortamı alma
```powershell
...
Bu komut, zaman serisi öngörüleri ortamını alır.

### Örnek 2: tüm zaman serisi Öngörüler ortamlarını listeleyin
```powershell
...
Bu komut, bir kaynak grubundaki tüm bir dizi öngörü ortamlarını listeler.

### Örnek 3: nesneye göre zaman serisi Öngörüler
```powershell
...
Bu komut, zaman serisi öngörüleri ortamlarını alır.
...
### -Genişletme
$Expand = durum ayarı, zaman serisi öngörüleri hizmetindeki ortamın iç hizmetlerinin durumunu içerir.
