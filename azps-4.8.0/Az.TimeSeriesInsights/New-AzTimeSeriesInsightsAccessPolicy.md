...
### Örnek 1: belirtilen bir ortamda erişim ilkesi oluşturma
```powershell
...
Bu komut, belirli bir ortam için bir erişim ilkesi oluşturur.
...
### -Sprincipalobjectid
Azure Active Directory 'de anaparanın ObjectID.
...
### -Role
Anapara atanan rollerin listesi.
