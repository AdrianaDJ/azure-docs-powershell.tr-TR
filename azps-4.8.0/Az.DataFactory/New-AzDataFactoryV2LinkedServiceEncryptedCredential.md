...
## Tanım
New-AzDataFactoryV2LinkedServiceEncryptedCredential cmdlet 'i, bağlantılı hizmette belirtilen tümleştirme çalışma zamanına sahip kimlik bilgilerini şifreler.

## ÖRNEKLERDEN

### Örnek 1: bağlantılı hizmette kimlik bilgilerini şifreleme

Bu komut C:\samples\WikiSample\TaxiDemo1.jsdosyadaki kimlik bilgilerini, test-Selfhost-IR adlı tümleştirme çalışma zamanıyla şifreler.
