...
## Tanım
Remove-AzDataFactoryV2Pipeline cmdlet 'i Azure Veri Fabrikası 'ndan ardışık düzeni kaldırır.
...
### -InputObject
Potansiyel satış nesnesini belirtir.
Bu cmdlet, bu parametrenin belirttiği ardışık düzeni kaldırır.
...
### -RESOURCEID
Kaldırılacak ardışık düzenin Azure Kaynak KIMLIĞI.
