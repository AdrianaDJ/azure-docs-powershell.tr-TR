...
### Örnek 1: MySql yapılandırmasını adıyla güncelleştirme
```powershell
...
Bu cmdlet, MySql yapılandırmasını adıyla günceller.

### Örnek 2: MySql yapılandırmasını kimlik ile güncelleştirin.
```powershell
...
Bu cmdlet 'ler, kimliğe göre MySql yapılandırmasını güncelleştirir.
