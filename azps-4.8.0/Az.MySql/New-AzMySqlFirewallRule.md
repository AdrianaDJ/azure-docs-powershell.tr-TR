...
### Örnek 1: yeni bir MySql Server güvenlik duvarı kuralı oluşturma
```powershell
...
Bu cmdlet 'ler bir MySql sunucusu güvenlik duvarı kuralı oluşturur.

### Örnek 2:-ClientIpAddress kullanarak yeni bir MySql güvenlik duvarı kuralı oluşturun.
```powershell
...
Bu cmdlet 'ler-ClientIpAddress kullanarak bir MySql güvenlik duvarı oluşturur.

### Örnek 3: tüm IP 'Lerin
```powershell
...
Bu cmdlet 'ler tüm IP 'Lere izin veren yeni bir MySql güvenlik duvarı kuralı oluşturur.
...
Belirtilmezse, varsayılan değer tanımsızdır.
AllowAll varsa, varsayılan ad AllowAll_yyyy-AA-dd_HH-AA-nn olur.
