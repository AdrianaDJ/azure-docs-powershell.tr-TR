...
### Örnek 1: belirtilen MySql sunucusundaki tüm sanal ağ kurallarını listeler
```powershell
...
Bu cmdlet belirtilen MySql sunucusundaki tüm sanal ağ kurallarını listeler.

### Örnek 2: ada göre sanal ağ kuralı alın
```powershell
...
Bu cmdlet sanal ağ kuralını adıyla alır.

### Örnek 3: kimliğe göre sanal ağ kuralı alın
```powershell
...
Bu cmdlet sanal ağ kuralını kimliğe göre alır.
...
### Microsoft. Azure. PowerShell. cmdlet. MySql. modeller. Api20171201. ıvirtualnetworkrule
