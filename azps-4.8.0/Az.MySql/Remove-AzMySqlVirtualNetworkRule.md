...
### Örnek 1: MySql Server sanal ağ kuralını ada göre kaldırma
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Bu cmdlet MySql sunucusu sanal ağ kuralını adıyla kaldırır.

### Örnek 2: MySql Server sanal ağ kuralını kimliğe göre kaldırma
```powershell
...
Bu cmdlet 'ler MySql sunucusu sanal ağ kuralını kimliğe göre kaldırır.
