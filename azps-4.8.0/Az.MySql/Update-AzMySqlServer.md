...
### Örnek 1: kaynak grubuna ve sunucu adına göre MySql sunucusunu güncelleştirme
```powershell
...
Bu cmdlet, MySql sunucusunu kaynak grubuna ve sunucu adına göre güncelleştirir.

### Örnek 2: MySql sunucusunu Identity olarak güncelleyin.
```powershell
...
Bu cmdlet, MySql sunucusunu kimliğe göre güncelleştirir.

## PARAMETRELERINE

### -\Administrators
Yönetici oturumunun parolası.
...
Gün sayısı 7 ile 35 arasındadır.
...
### -Skukapasitesi
İzleme/çıkış kapasitesi, sunucunun hesaplama birimleri 'ni temsil eder.
...
### -SkuTier
Özel SKU 'nun katmanı, örneğin. temel.
...
### -SslEnforcement
SSL zorlamayı etkinleştirme veya sunucuya bağlanırken kullanmayın.
...
### -StorageAutogrow
Otomatik büyüme özelliğini etkinleştirin.
...
### -StorageInMb
Sunucuda izin verilen maks depolama alanı.
