...
### Örnek 1: MySql sanal ağ kuralını adıyla Güncelleştir
```powershell
...
Bu cmdlet, MySql sanal ağ kuralını ada göre güncelleştirir.

### Örnek 2: MySql sanal ağ kuralını Identity olarak güncelleyin.
```powershell
...
Bu cmdlet 'ler, MySql sanal ağ kuralını Identity olarak güncelleştirir.
