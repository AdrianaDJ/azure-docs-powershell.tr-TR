...
### Örnek 1: varsayılan içerikle MySql sunucusu edinin
```powershell
...
Bu cmdlet, MySql sunucusunu varsayılan içerikle alır.

### Örnek 2: kaynak grubuna göre MySql sunucusunu ve sunucu adını alın
```powershell
...
Bu cmdlet, kaynak grubu ve sunucu adına göre MySql sunucusunu alır.

### Örnek 3: belirtilen kaynak grubundaki tüm MySql sunucularını listeler
```powershell
...
Bu cmdlet, belirtilen kaynak grubundaki tüm MySql sunucularını listeler.

### Örnek 4: kimliğe göre MySql sunucusunu alma
```powershell
...
Bu cmdlet listeleri, MySql sunucusunu kimliğe göre alır.
