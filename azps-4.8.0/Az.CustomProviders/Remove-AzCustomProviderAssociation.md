...
### Örnek 1: özel bir sağlayıcı ilişkisini kaldırma.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Özel bir sağlayıcı ilişkisini kaldırma.

### Örnek 2: boru ile özel bir sağlayıcı ilişkisini kaldırma
```powershell
...
Başarı veya başarısızlığı belirtmek için boruları ve geçiş özelliğini kullanarak özel bir sağlayıcı ilişkilendirmesini kaldırın.
