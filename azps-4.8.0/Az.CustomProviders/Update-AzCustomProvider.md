...
### Örnek 1: özel sağlayıcıya etiket ekleme
```powershell
...
Özel sağlayıcının etiketlerini güncelleştirme.

### Örnek 2: boru ile özel sağlayıcıyı Güncelleştir
```powershell
...
Boru kullanarak özel sağlayıcıyı güncelleştirme.
