...
## SYNOPSIS
İstekte listelenen NSG 'ler üzerinde verilen kuralları zorunlu tutar
...
## Tanım
Uyarlamalı ağ Hardenings otomatik olarak Azure Güvenlik Merkezi tarafından hesaplandığından, istekte listelenen NSG 'ler üzerinde verilen kuralları zorunlu kılan bu cmdlet 'i kullanın.
...
Uyarlamalı ağ sağlamlaştırma kaynağının adı.
...
Uyarlamalı ağ sağlamlaştırma kurallarından oluşturulan güvenlik kurallarıyla güncelleştirilecek geçerli ağ güvenliği gruplarının Azure kaynak kimlikleri.
...
### Microsoft. Azure. Commands. Securitcenter. modeller. AdaptiveNetworkHardenings. PSSecurityAdaptiveNetworkHardeningsRule
