...
## Tanım
AzIotSecuritySolutionRecommendationConfigurationObject, IoT güvenlik çözümü için yeni bir öneri yapılandırma nesnesi oluşturur.
Bu şekilde, öneri durumu, etkinleştirilmiş veya devre dışı bırakılmış olsun yapılandırılır.
...
Öneri türü için "IoT_ACRAuthentication"
...
### Microsoft. Azure. Commands. Security. modeller. ıotsecuritysolutions. PSRecommendationConfiguration
