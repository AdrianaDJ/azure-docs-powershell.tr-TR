...
## Tanım
Get-AzIotSecurityAnalyticsAggregatedAlert cmdlet, IoT Hub aygıtlarında bir veya birden çok Birleşik öneri döndürür. Toplanmış bir önerisinin adı türü
...
"IoT_OpenPorts" güvenlik çözümünde "MyResourceGroup" ve kaynak grubu "MyResourceGroup" toplanmış önerisini alma
...
"MyResourceGroup" güvenlik çözümünde toplu önerilerin listesini alma
...
### Microsoft. Azure. Commands. Security. model. ıotsecuritysolutionanalytics. Psiotsecurityaggregotönerisi
