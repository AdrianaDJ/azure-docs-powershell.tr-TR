...
## SYNOPSIS
Bir abonelikle alt değerlendirme sonuçlarını alır.
...
Bir abonelikteki tüm alt değerlendirme sonuçlarını alır.
...
### Microsoft. Azure. Commands. Security. modeller. SubAssessments. PSSecuritySubAssessment
