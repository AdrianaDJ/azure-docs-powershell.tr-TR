...
## SYNOPSIS
Aboneliğin kaynakları arasında izin verilen trafiği görüntülemek için kullanılır
...
## Tanım
Abonelik ve konum kaynakları arasındaki olası tüm trafiğin listesini, bağlantı türüne göre alır.
...
### Microsoft. Azure. Commands. Security. model. AllowedConnection. Pssecurityallodilimlerin Connection
