...
## Tanım
Get-AzIotSecurityAnalytics cmdlet 'i, belirli bir IoT güvenlik çözümünün güvenlik çözümlemelerini döndürür
...
"MyResourceGroup" güvenlik çözümünün "myresourcegroup" güvenlik çözümünün

## PARAMETRELERINE

### -Varsayılan
Varsa, varsayılan analitik kümesini alın; Aksi takdirde tüm analitik kümelerin listesini alın.
...
### Microsoft. Azure. Commands. Security. model. ıotsecuritysolutionanalytics. PSIotSecuritySolutionAnalytics
