...
## SYNOPSIS
Genişletilmiş kaynağın kapsamındaki Uyarlamalı ağ Hardenings kaynaklarının listesini alır.
...
```
## Tanım
Uyarlamalı ağ Hardenings otomatik olarak Azure Güvenlik Merkezi tarafından hesaplanır, genişletilmiş bir kaynağın kapsamındaki Uyarlamalı ağ Hardenings kaynaklarının listesini almak için bu cmdlet 'i kullanın.
...
/subscriptions/3eeab341-f466-499c-a8be-85427e154baf7612f869/resourceGroups/myService1/providers/Microsoft.Compute/virtualMachines/myResource1/providers/Microsoft.Security/adaptiveNetworkHardenings/default default Microsoft.Security/adaptiveNetworkHardenings Microsoft.Azure.Commands.SecurityCenter.Models…
```
Tek bir uyarlamalı ağ Hardenings kaynağı edinme
...
### Microsoft. Azure. Commands. Security. modeller. AdaptiveNetworkHardenings. PSSecurityAdaptiveNetworkHardenings
