...
## SYNOPSIS
Abonelik için uygulama denetimi VM/sunucu gruplarının bir listesini alır.
...
## Tanım
Uyarlamalı uygulama denetimleri otomatik olarak Azure Güvenlik Merkezi tarafından hesaplanıyorsa, aboneliğin kapsamındaki Uyarlamalı uygulama denetimleri kaynaklarının listesini almak için bu cmdlet 'i kullanın.
...
### -Includepathönerilerine
İlke kurallarını ekleyin.
...
### -Özet
Özet formda çıkışı geri döndürme.
