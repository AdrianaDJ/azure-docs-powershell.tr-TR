...
### Örnek 1: Kubernetes kümesini adıyla yapılandırma
```powershell
...
Bu komut, Kubernetes kümesinin adını adıyla kaldırır.

### Örnek 2: Kubernetes kümesini nesneye göre yapılandırma
```powershell
...
Bu komut, Kubernetes kümesini nesneye göre yapılandırma öğesini kaldırır.
