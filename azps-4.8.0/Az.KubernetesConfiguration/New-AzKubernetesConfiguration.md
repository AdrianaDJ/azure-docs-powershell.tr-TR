...
### Örnek 1: Kubernetes kümesi için yapılandırma oluşturma
```powershell
...
Bu komut, Kubernetes kümesi için bir yapılandırma oluşturur.
...
### -Clusterkapsamlıdır
Geçirilen yapılandırmanın kapsamını kümeye ayarla (varsayılan olarak ad alanıdır).
...
### -EnableHelmOperator
Bu git yapılandırması için Helm Işlecini etkinleştirme seçeneği.
...
İşleç grafiği için değerler geçersiz kılınır.
...
Operatör Helm grafiğinin sürümü.
...
Belirli bir yapılandırmayı tanımlayan işlecin örnek adı.
...
### -OperatorNamespace
Bu işlecin yüklendiği ad alanı.
En fazla 253 küçük harf alfasayısal karakter, kısa çizgi ve yalnızca nokta.
...
### -OperatorParameters
Dize biçiminde Işleç örneği için tüm parametreler.
...
### -Depotorurl
SourceControl deposunun URL 'si.
