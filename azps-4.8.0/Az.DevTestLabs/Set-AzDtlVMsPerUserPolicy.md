...
## Tanım
**Set-AzDtlVMsPerUserPolicy** cmdlet 'i, bir laboratuarın Kullanıcı başına sanal makine sayısını ayarlar; Kullanıcı başına izin verilen en fazla sanal makine sayısını ayarlar.
...
### -Enable
Bu cmdlet 'in laboratuvar için ilke etkinleştirdiğini gösterir.
...
### -LabName
Bu cmdlet 'in Kullanıcı başına sanal makineleri ayarladığı laboratuarın adını belirtir.
