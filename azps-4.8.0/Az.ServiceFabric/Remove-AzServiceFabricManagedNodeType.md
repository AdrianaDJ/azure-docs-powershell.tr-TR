...
### DeleteNodeTypeByObj (varsayılan)
```
...
## Tanım
Düğüm türünü veya düğüm türü içindeki belirli düğümleri kaldırın. Paremter-DüğümAdı kullanılırsa yalnızca belirtilen düğümler kaldırılacaktır.
...
Boru ile düğüm türünü kaldırın.
...
Düğüm türünden 2 düğümü kaldırma.
...
Düğüm türünden 2 düğümü, boruları ile kaldırın.
...
Bu durum, düğümlerde durum bilgisi olan iş yükleri çalışıyorsa veri kaybına neden olabileceğinden ya da opeardan sonra yeterli tohum düğümü olmazsa kümeyi aşağı
