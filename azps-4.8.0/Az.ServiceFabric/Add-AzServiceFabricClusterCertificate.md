...
## Tanım
**Add-AzServiceFabricClusterCertificate** öğesini kullanarak, var olan bir Azure Anahtar Kasası 'ndan veya varolan bir sertifikayı veya yeni bir otomatik olarak imzalanan sertifikadan oluşturulan bir Azure Anahtar Kasası oluşturun. Varsa ikincil kümeyi geçersiz kılacaktır.
...
Bu komut, var olan Azure Key kasasına ikincil küme sertifikası olarak bir sertifika ekler.
...
Bu komut, Azure Anahtar Kasası 'nda otomatik olarak imzalanan bir sertifika oluşturur ve kümeyi ikincil bir küme sertifikası olarak kullanmak üzere yükseltir.
...
### -Parmak izi
Sertifikanın parmak izi SecretIdentifier 'a daha fazla. Anahtar Kasası yalnızca sertifika gizli olarak saklanabileceği ve cmdlet 'in parmak izini doğrulayamadığından, bunu kullanın.
