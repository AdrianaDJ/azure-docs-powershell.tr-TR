...
## Tanım
Kümedeki hizmet doku ayarlarını eklemek veya güncelleştirmek için **set-AzServiceFabricSetting** kullanın.
...
Bu komut, ' NamingService ' bölümünün altındaki ' MaxFileOperationTimeout ' değerini ' 5000 ' olarak ayarlar.
...
### -Değer
Doku ayarının parametre değeri
