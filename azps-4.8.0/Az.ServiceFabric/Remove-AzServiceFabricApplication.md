...
## Tanım
Bu cmdlet, kümedeki bir uygulamayı kaldırır. Bu işlem, varsa uygulama kaynağının altındaki tüm hizmetleri kaldırır.
...
Bu örnekte, "testRG" kaynak grubunun altındaki "testApp" uygulaması ve "testCluster" uygulaması kaldırılır.
