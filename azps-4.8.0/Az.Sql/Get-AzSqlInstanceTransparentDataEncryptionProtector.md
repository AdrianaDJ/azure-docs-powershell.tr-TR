...
## Tanım
Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet 'i belirtilen SQL yönetilen örneğinin tın koruyucusunu alır.
...
Bu komut, ContosoResourceGroup adlı kaynak grubunda Contosomanagedınstancename adlı yönetilen örnek için TDE koruyucusunu alır.
