...
## Tanım
**Set-Azsqlelaunpool** cmdlet 'ı, Azure SQL veritabanında esnek bir havuzun özelliklerini ayarlar. Bu cmdlet, havuz başına eDTU ( *DTU* ), havuz başına depolama sınırı ( *storagemb* ), veritabanı başına en fazla eDTU ( *databaseval* ) ve en az eDTU ( *databasedtumın* ).
...
Azure SQL veritabanında elastik bir veritabanı havuzunun özelliklerini değiştirir. oluşturulmuş
...
### -DatabaseVCoreMax
Havuzda en yüksek sayıda SqlAzure veritabanı kullanılabilir.
...
### -StorageMB
Esnek havuz için, megabayt cinsinden depolama sınırını belirtir. Daha fazla bilgi için New-AzSqlElasticPool cmdlet 'ine bakın.
...
### -Etiketler
Bu cmdlet 'in karma tablo biçimindeki esnek havuz ile ilişki kurduğu anahtar değer çiftlerinin sözlüğünü belirtir. Örneğin: `@{key0="value0";"key 1"=$null;key2="value2"}`
