...
### Örnek 2: sunucu kaynağından yönetilen örnek gelişmiş veri güvenliğini etkinleştirme
```powershell
...
Yönetilen örnekte gelişmiş veri güvenliğini verir. oluşturulmuş
