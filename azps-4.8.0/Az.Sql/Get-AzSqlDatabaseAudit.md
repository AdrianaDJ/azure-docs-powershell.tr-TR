...
## Tanım
**Get-AzSqlDatabaseAudit** cmdlet 'ı BIR Azure SQL veritabanının denetleme ayarlarını alır.
Cmdlet 'i kullanmak için, *Resourcegroupname* , *ServerName* ve *DatabaseName* parametrelerini kullanarak veritabanını belirleyin.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL veritabanının denetim ayarlarını alma
```
...
### Örnek 2: Azure SQL veritabanının denetim ayarlarını ardışık düzen ile edinme
```
...
### Örnek 3: Azure SQL veritabanının denetim ayarlarını alma
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
