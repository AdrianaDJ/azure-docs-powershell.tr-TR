...
## Tanım
**Get-AzSqlSyncAgentLinkedDatabase** cmdlet 'i bir eşitleme ARACıSıYLA bağlantılı SQL Server veritabanları hakkında bilgi döndürür.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL eşitleme aracısının bağlantılı SQL Server veritabanlarını edinin.

Aşağıdaki örnekte, bir Azure SQL eşitleme Aracısı ile bağlantılı olan bağlantılı SQL Server veritabanları döndürülür.
