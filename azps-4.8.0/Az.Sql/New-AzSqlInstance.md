...
### Newbyınstancepoolparentobjectparameterset
```
...
### Newbyınstancepoolresourceıdparameterset
```
...
## Tanım
**New-Azsqlınstance** cmdlet 'ı BIR Azure SQL veritabanı yönetilen örneği oluşturur.
...
Bu komut, SkuName parametresini kullanarak yeni bir örnek oluşturur.
...
### Örnek 3: örnek havuz nesnesi kullanarak örnek havuzunda yeni bir örnek oluşturma
```powershell
...
Bu komut, örnek havuzu nesnesini kullanan bir örnek havuzunda yeni bir örnek oluşturur.

### Örnek 4: örnek havuz kaynak tanımlayıcısını kullanarak örnek havuzda yeni bir örnek oluşturma
```powershell
...
Bu komut, örnek havuzunun kaynak tanımlayıcısını kullanarak örnek havuzda yeni bir örnek oluşturur.

### Örnek 5: örnek havuzda yeni bir örnek oluşturma
```powershell
...
Bu komut, instancePool0 adında örnek havuzda yeni bir örnek oluşturur
...
SQL Azure yönetilen örneğinin yedeklerini depolamak için kullanılan yedek depolama yedeği. Seçenekler şunlardır: yerel, bölge ve coğrafi
...
### -Harmanlama
Kullanılacak Azure SQL yönetilen örneğinin harmanlaması.
...
### -Dnszoneiş ortağı
Yönetilen örnek oluşturulurken DnsZone özelliğini devralmak için iş ortağı yönetilen sunucusunun kaynak kimliği
...
### -Instancepoolname
Bu örneği yerleştirmek için örnek havuz.
...
### -Instancepoolresourceıd
Örnek havuz kaynak kimliği.
...
### -LicenseType
Hangi lisans türünün kullanılacağını belirler. Olası değerler:
- Temel fiyat-Azure Karma avantajı (AHB) mevcut SQL Server lisans sahiplerinin indirimli fiyatlandırması uygulanır. Yönetilen örnek hizmeti fiyatı var olan SQL Server lisans sahipleri için düşülecektir.
- Licenseeklenmiş-Azure Karma avantajı (AHB) mevcut SQL Server lisans sahiplerinin indirim fiyatlandırması uygulanmaz. Yönetilen örnek hizmeti fiyatı Yeni bir SQL Server lisans maliyetleri içerir.
...
### -MinimalTlsVersion
Yönetilen örneğe uygulanacak en az TLS sürümü 
...
Örnek için genel veri uç noktasının etkinleştirilip etkinleştirilmediğini.
...
### -TimeZoneId
Ayarlanacak örnek için saat dilimi kimliği. Saat dilimi kimliklerinin listesi sys.time_zone_info (Transact-SQL) görünümünde gösterilir.
