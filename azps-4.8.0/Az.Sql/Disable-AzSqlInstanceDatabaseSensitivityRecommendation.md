...
## Tanım
Disable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet, Azure SQL yönetilen örnek veritabanındaki sütunlarda duyarlılık önerilerini devre dışı bırakır.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL yönetilen örnek veritabanındaki belirli bir sütunda duyarlılık önerilerini devre dışı bırakın.
```powershell
...
### Örnek 2: yöneltme ile Azure SQL yönetilen örnek veritabanında, duyarlılık önerilerini içeren sütunlarda duyarlılık önerilerini devre dışı bırakın.
```powershell
...
### Örnek 3: yöneltme ile Azure SQL yönetilen örnek veritabanındaki belirli bir sütunda duyarlılık önerilerini devre dışı bırakın.
```powershell
