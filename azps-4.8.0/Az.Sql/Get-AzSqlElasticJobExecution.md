...
### Withjobexecutionıdusingparentobject
```
Get-AzSqlElasticJobExecution [-ParentObject] <AzureSqlElasticJobAgentModel> -JobName <String>
...
### Withjobexecutionidusingparentresourceıd
```
...
## Tanım
Get-AzSqlElasticJobExecution cmdlet 'i bir veya daha fazla iş yürütmelerini alır

## ÖRNEKLERDEN

### Örnek 1: tüm işlerde bir veya daha fazla iş yürütmelerini alır
```powershell
...
### Örnek 2: bir iş için bir veya daha fazla iş yürütmelerini alır
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Bir veya daha fazla iş yürütmelerini alır. oluşturulmuş
