...
## Tanım
**Askıya al-AzSqlDatabase** cmdlet 'ı Azure SQL veri ambarı veritabanını askıya alır.
...
## NOTLARıNDA
* **Suspend-AzSqlDatabase** cmdlet 'ı yalnızca Azure SQL veri ambarı veritabanlarında çalışır. Bu işlem, Azure SQL veritabanı temel, Standard ve Premium sürümlerinde desteklenmez.
