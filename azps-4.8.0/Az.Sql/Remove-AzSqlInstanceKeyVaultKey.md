...
## Tanım
Remove-AzSqlInstanceKeyVaultKey cmdlet 'i, belirtilen yönetilen örnekten anahtar kasa anahtarını kaldırır. SQL yönetilen örneğinin Anahtar Kasası izinlerinin değiştirilmediğini unutmayın. İzinleri değiştirmek için set-AzKeyVaultAccessPolicy seçeneğini kullanın. Bu cmdlet 'in anahtar kasada hiçbir değişiklik yapmaz. Anahtar kasasından anahtar kaldırmak için Remove-AzureKeyVaultKey kullanın.
...
Bu komut, belirtilen yönetilen örnekten kimliği ' ' olan Anahtar Kasası öğesini kaldırır https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 . 
