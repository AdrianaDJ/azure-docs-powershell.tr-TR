...
## Tanım
**Yeni-AzSqlDatabaseSecondary** cmdlet 'i, veritabanında coğrafi çoğaltma ayarlamak için kullanıldığında Start-AzSqlDatabaseCopy cmdlet 'ini değiştirir. Coğrafi çoğaltma bağlantı nesnesini birincili ikincil veritabanına döndürür.

## ÖRNEKLERDEN

### Örnek 1: etkin Geo-Replication oluştur
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
$database | New-AzSqlDatabaseSecondary -PartnerResourceGroupName $secondaryresourcegroupname -PartnerServerName $secondaryservername -AllowConnections "All"
```

### Örnek 2: etkin Geo-Replication oluşturun ve iş ortağı veritabanı adını kaynak veritabanı adından farklı olacak şekilde belirtin
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
...
### -PartnerDatabaseName
Oluşturulacak ikincil veritabanının adı.
...
Azure SQL veritabanı ikincili için üretim oluşturma işlemi.
...
### -SecondaryVCore
Azure SQL veritabanı ikincil 'ın Vcore numaraları.
...
### -Etiketler
SQL veritabanı çoğaltma bağlantısıyla ilişkilendirilecek karma tablo biçimindeki anahtar değer çiftlerini belirtir. Örneğin: @ {Key0 = "value0"; anahtar = $null; anahtar2 = "değer2"}
