...
## Tanım
**Get-AzSqlServerAudit** cmdlet 'i, BIR Azure SQL Server 'ın denetim ayarlarını alır.
...
### Örnek 2: Azure SQL Server 'ın denetim ayarlarını ardışık düzen ile edinme
```
...
### Örnek 3: Azure SQL Server 'ın denetim ayarlarını alma
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
