...
## Tanım
**New-AzSqlDatabase** cmdlet 'ı BIR Azure SQL veritabanı oluşturur.
...
Bu komut, Database02 adındaki elastik havuzda ElasticPool01 Server server01 adlı bir veritabanı oluşturur.

### Örnek 3: belirtilen sunucuda Vcore veritabanı oluşturma
```
...
Bu komut, Database03 adında bir Vcore veritabanı oluşturur.

### Örnek 4: belirtilen sunucuda bir sunucusuz veritabanı oluşturma
```
...
Bu komut, Database04 adlı sunucuda server01 adında bir sunucusuz veritabanı oluşturur.
...
### -ComputeModel
Azure SQL veritabanı için işlem modeli. Sunucusuz veya sağlanan
...
### -ReadReplicaCount
ReadOnly uygulama hedefi bağlantılarının yönlendirilebilmesi veritabanıyla ilişkili salt okunur ikincil çoğaltmaların sayısı. Bu özellik yalnızca Hiperscale sürümü veritabanları için ayarlanabilir.
...
### -Etiketler
Bu cmdlet 'in yeni veritabanıyla ilişki kurduğu karma tablo biçimindeki anahtar-değer çiftleri sözlüğünü belirtir. Örneğin: @ {Key0 = "value0"; anahtar = $null; anahtar2 = "değer2"}
