...
## Tanım
Add-AzSqlElasticJobTarget cmdlet 'i hedef bir gruba hedef kaynak ekler

## ÖRNEKLERDEN

### Örnek 1: sunucu hedefi ekleme
```powershell
...
### Örnek 2: veritabanı hedefi ekleme
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Örnek 3: esnek havuz hedefi ekleme
```powershell
...
### Örnek 4: üst harita Haritası hedefi ekleme
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Hedef gruba hedef (sunucu, esnek havuz, veritabanı ve Shard Haritası) ekler
