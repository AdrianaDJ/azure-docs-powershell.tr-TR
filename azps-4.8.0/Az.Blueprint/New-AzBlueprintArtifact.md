...
### CreateTemplateArtifact (varsayılan)
```
...
## Tanım
Yeni bir yapı oluşturun. Yapı oluşturmak için iki yol vardır: giriş dosyası olarak bir yapıt veya yapıt için satır içi parametreler sağlama. JSON yöntemi, sağlanan yapıt türünün, satır içi parametre yönteminin sağlanması için kullanıcının, yapıt türü parametre türünü sağlaması gerekir.
...
Bir yapıt JSON dosyası aracılığıyla yeni bir yapı oluşturun.
...
Satır içi parametreler aracılığıyla yeni bir yapı oluşturun.
...
ARM şablon dosyası aracılığıyla yeni bir yapı oluşturun.
