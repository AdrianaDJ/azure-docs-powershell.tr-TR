...
### SetByHostNameAndPort (varsayılan)
```
...
## Tanım
Set-AzDataLakeAnalyticsCatalogCredential cmdlet 'i Azure Data Lake Analytics kataloğu ile ilişkilendirilmiş bir kimlik bilgisi parolasını değiştirir.

## ÖRNEKLERDEN

### Örnek 1: bir hesabın kimlik bilgilerinin parolasını değiştirme
```
...
Bu komut, kimlik bilgileri parolasını NewPassword 'de belirtilen parolayla ayarlar.
...
### -Credential
Değiştirilecek kimlik bilgisinin adını ve geçerli parolasını belirtir.
...
### -CredentialName
Değiştirilecek kimlik bilgisinin adını belirtir
...
### -DatabaseName
Kimlik bilgilerini tutan Data Lake Analytics hesabındaki veritabanının adını belirtir.
...
### -YeniParola
Kimlik bilgisinin yeni parolasını belirtir
