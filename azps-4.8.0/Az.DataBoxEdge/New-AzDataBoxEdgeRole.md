...
### ConnectionStringParameterSet (varsayılan)
```
...
## Tanım
**New-AzDataBoxEdgeRole** cmdlet 'ı bir veri kutusu uç aygıtı için yeni bir rol oluşturur.
...
### -ConnectionString
Bağlantı dizelerini sağlamak için
...
### -DeviceProperty
Cihaz özelliklerini sağlamak için
...
### -Şifrelemetuşu
Edge aygıtının şifreleme anahtarı
...
Lütfen ıOT cihazı bağlantı dizesini sağlayın
...
IoT Edge aygıtının erişim anahtarı
...
Lütfen sınır aygıtının bağlantı dizesini sağlayın
...
### -Platform
Ex: Linux için platformu sağlama
...
### -Roldurumu
Durumu etkinleştirme/devre dışı bırakma
