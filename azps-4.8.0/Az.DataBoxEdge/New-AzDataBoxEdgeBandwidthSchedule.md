...
### BandwidthParameterSet (varsayılan)
```
...
## Tanım
**New-AzDataBoxEdgeBandwidthSchedule** cmdlet 'ı, bant genişliği kullanımını yönetmeye yardımcı olmak Için bir veri kutusu uç aygıtı için yeni bir bant genişliği çizelgesi oluşturur.
...
Sınırsız bant genişliği ayarlar; false olarak ayarlanırsa varsayılan değer 20 Mbps olarak ayarlanır
