...
## Tanım
**Get-AzDataBoxEdgeStorageAccount** cmdlet 'i, bir veri kutusu uç cihazında kullanılabilen Edge depolama hesaplarını alır. Belirli bir Edge depolama hesabının bilgilerini almak için adı cmdlet 'te parametre olarak belirtebilirsiniz.
