...
## Tanım
**New-Azıntegrationaccountagreement** cmdlet 'i bir tümleştirme hesabı anlaşması oluşturur.
Bu cmdlet, tümleştirme hesap anlaşmasını temsil eden bir nesne döndürür.
Tümleştirme hesap adını, kaynak grubu adını, anlaşma adını, türü, iş ortağı adını, iş ortağı niteleyicileri ve anlaşma içeriğini belirtin.
...
### Örnek 1: Tümleştirme hesap anlaşması oluşturma
```powershell
...
Bu komut, belirtilen Azure Resource grubunda bir tümleştirme hesabı anlaşması oluşturur.

### Örnek 2

Bir tümleştirme hesabı anlaşması oluşturur. oluşturulmuş
...
Bu parametreyi veya *AgreementContentFilePath* parametresini belirtin.
...
Bu parametreyi veya *AgreementContent* parametresini belirtin.
...
### -AgreementName
Tümleştirme hesabı sözleşmesi için bir ad belirtir.
...
### -AgreementType
Tümleştirme hesabı anlaşma türünü belirtir. Bu parametre için kabul edilebilir değerler şunlardır:
- X12 
- AS2
- Ediolgu
