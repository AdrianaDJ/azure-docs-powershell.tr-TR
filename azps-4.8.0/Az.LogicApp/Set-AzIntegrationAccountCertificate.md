...
## Tanım
**Set-Azıntegrationaccountcertificate** cmdlet 'i bir tümleştirme hesabı sertifikasını değiştirir.
Bu cmdlet, tümleştirme hesabı sertifikasını temsil eden bir nesne döndürür.
Tümleştirme hesap adını, kaynak grubu adını ve sertifika adını belirtme.
...
### Örnek 1: Tümleştirme hesabı sertifikasını değiştirme
```
...
Bu komut, belirtilen kaynak grubundaki tümleştirme hesabı sertifikasını değiştirir.

## PARAMETRELERINE

### -CertificateName
Tümleştirme hesabı sertifikasının adını belirtir.
