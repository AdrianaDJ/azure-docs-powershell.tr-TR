...
## Tanım
**Get-AzIntegrationAccountAssembly** cmdlet 'i bir tümleştirme hesabında yeni bir derleme oluşturur.

## ÖRNEKLERDEN

### Örnek 1: yerel dosya kullanarak yeni derleme oluşturma
```powershell
...
"$LocalAssemblyFilePath" içinde yer alan dosya yolundaki yerel dosyayı kullanarak yeni bir derleme oluşturur.

### Örnek 2: bayt verilerini kullanarak yeni derleme oluşturma
```powershell
...
"$AssemblyContent" içinde bulunan bir bayt dizisini kullanarak yeni bir derleme oluşturur.

### Örnek 3: içerik bağlantısını kullanarak yeni derleme oluşturma
```powershell
...
"$AssemblyUrl" URL 'sinde bulunan bayt verilerini kullanarak yeni bir derleme oluşturur. Büyük boyutlu derlemeler oluşturmak için önerilen yöntem budur.
