...
## Tanım
Update-AzAutomationSourceControl cmdlet 'i, Azure Otomasyonu 'nda kaynak denetimindeki bir alanın değerini değiştirir.

## ÖRNEKLERDEN

### Örnek 1
Bu komutlar, Devrunbook alanını, Devsnative adlı hesap adındaki VSTSNative için false olarak ayarlar.
...
Azure Otomasyonu kaynak denetimini güncelleştirir. oluşturulmuş
