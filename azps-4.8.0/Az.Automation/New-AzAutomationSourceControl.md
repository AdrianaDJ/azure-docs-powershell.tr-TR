...
## Tanım
New-AzAutomationSourceControl cmdlet, Azure Otomasyonu hesabımı VSTS TFVC, VSTS git veya GitHub 'my bağlantısı oluşturmak için bir yapılandırma oluşturur.

## ÖRNEKLERDEN

### Örnek 1
Azure Otomasyonu hesabımı VSTS TFVC projenizle ilişkilendirmek için bir kaynak denetimi yapılandırması oluşturun. TFVC projelerinin dalları yoktur ve bu nedenle, Branch parametresi belirtilmez.
...
### Örnek 2
Azure Otomasyonu hesabımı VSTS git projenizle ilişkilendirmek için bir kaynak denetimi yapılandırması oluşturun.
...
### Örnek 3
Azure Otomasyonu hesabımı GitHub projeceğim ile bağlantılandırmak için bir kaynak denetimi yapılandırması oluşturun.
...
### -AccessToken
Kaynak denetimi erişim belirteci.
...
### -DoNotPublishRunbook
Kaynak denetiminin publishRunbook özelliği.
DoNotPublishRunbook ayarlanmışsa, bu, Kullanıcı runbook 'ların ' taslak ' olarak aktarılacağı anlamına gelir.
...
### -EnableAutoSync
Kaynak denetimin autoSync özelliği.
