...
## Tanım
**Get-AzFrontDoorRulesEngine** cmdlet 'i belirli bir kural altyapısı yapılandırmasını alır veya ön kapılarla ilişkilendirilmiş tüm kural altyapısı yapılandırmalarını alır. 
...
Belirli kural altyapısı yapılandırmasını edinin.
...
Tüm kural altyapısı yapılandırmalarını ön kapıda edinin.
...
Varolmayan bir kural altyapısı alınırken beklenen çıktı. 
...
### Microsoft. Azure. Commands. Frontkapısı. modeller. PSRulesEngine
