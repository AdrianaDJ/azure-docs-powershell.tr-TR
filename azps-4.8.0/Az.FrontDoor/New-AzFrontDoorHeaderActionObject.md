...
## Tanım
PSRulesEngineAction nesnesinin oluşturulması için PSHeaderAction nesnesi oluşturur.
...
### -HeaderActionType
Üstbilgiye uygulanacak düzenleme türü.
...
### -HeaderName
Bu eylemin uygulanacağı başlığın adı.
...
### -Değer
Belirtilen üst bilgi adını ile güncelleştirilecek değer.
ActionType Delete ise bu değer kullanılmaz.
...
### Microsoft. Azure. Commands. Frontkapısı. modeller. PSHeaderAction
