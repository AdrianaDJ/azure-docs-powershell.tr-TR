...
### Örnek 1: uygulama yapılandırma deposundaki yeniden oluşturma anahtarı
```powershell
...
Bu komut, uygulama yapılandırma deposu 'nun anahtarını yeniden üretin.

### Örnek 2: nesne tarafından uygulama yapılandırma deposunu yeniden oluşturma
```powershell
...
Bu komut, nesne tarafından uygulama yapılandırma deposu 'nun anahtarını yeniden üret.
...
### -ID
Yeniden üretmek için anahtarın kimliği.
...
### Microsoft. Azure. PowerShell. cmdlet. AppConfiguration. modeller. Api20200601. ıapıkey
