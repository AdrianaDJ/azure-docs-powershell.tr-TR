...
## Tanım
New-AzSqlVMGroup cmdlet 'i bir Azure SQL sanal makine grubu oluşturur.
...
ResourceGroup01 kaynak grubunda test-Group VM ile yeni bir Azure SQL sanal makine grubu oluşturur.
$profile, Microsoft. Azure. Management. SqlVirtualMachine. modeller. WsfcDomainProfile türünde bir nesnedir
...
Küme oluştururken kullanılan ad
...
İşletim kümesi için kullanılan ad
...
### -DomainFqdn
Etki alanının tam nitelikli adı
...
### -Filesharewnesspath
FileShare tanığı için isteğe bağlı yol
...
### -Teklif
SQL sanal makine grubu teklifi.
...
### -OuPath
Düğümlerin ve kümenin sunulabilecek kuruluş birimi yolu
...
### -SKU
SQL sanal makine grubu sürüm türü.
...
### -SqlServiceAccount
SQL hizmetinin kümedeki tüm katılan SQL sanal makinelerinde çalışacağı ad
...
Tanık depolama hesabının birincil anahtarı
...
### Etiketli
SQL sanal makine grubuyla ilişkilendirilecek Etiketler.
