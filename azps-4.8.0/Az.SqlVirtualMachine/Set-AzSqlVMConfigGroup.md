...
## Tanım
Set-AzSqlVMConfigGroup cmdlet, SQL sanal makine yapılandırması için SQL sanal makine grubuna katılmak amacıyla gereken bilgileri ayarladı.
...
SQL sanal makine yapılandırmasının grup listesini güncelleyin.

## PARAMETRELERINE

### -ClusterBootstrapAccountPassword
Küme önyükleme hesabının parolası
...
Küme işletmeni hesabının parolası
...
SQL hizmeti hesabının parolası
...
### -SqlVM
SQL sanal makine yapılandırması
...
### -SqlVMGroup
SQL sanal makinesinin bir parçası olacak Grup
