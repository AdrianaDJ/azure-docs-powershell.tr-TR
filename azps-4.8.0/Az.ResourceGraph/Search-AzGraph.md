...
## Tanım
Sorgu söz dizimi hakkında daha fazla bilgi edinin: https://aka.ms/resource-graph/learntoquery
...
Basit kaynaklar kaynak alanlarının alt kümesini isteyen sorgu.
...
Alan seçimi, filtreleme ve özetleme özelliklerine sahip kaynaklar üzerinde karmaşık bir sorgu.
...
```
Yönetilen diskleri kullanmayan ve abonelik görünen adlarını içeren tüm sanal makineleri sağlayan bir sorgu.
...
```
Kiracının ve abonelik görünen adlarının kaynak sayısını görüntüleyen bir sorgu.
...
### -Abonelik
Sorgu çalıştırmada kullanılacak abonelikler.
...
### -Önce
Döndürülecek en fazla nesne sayısı. İzin verilen değerler: 1-5000.
