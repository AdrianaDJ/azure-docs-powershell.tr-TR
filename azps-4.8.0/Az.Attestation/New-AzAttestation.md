...
Birkaç etiketli *pshtest4* adlı bir kanıt sağlayıcısının yeni örneğini oluşturun ve bu Ilke için AAD güveni 'ni kullanın.
...
Bir PEM dosyası aracılığıyla güvenilir bir imza anahtarı kümesi belirleyerek, yönetim için ısoded güveni kullanan, *pshtest3* ' adlı bir kanıt sağlayıcısının yeni örneğini oluşturun.
...
### -Konum
Kanıtlama sağlayıcısının oluşturulacağı Azure bölgesini belirtir. Seçimlerinizi görmek için komut Get-AzResourceProvider ProviderNamespace parametresiyle birlikte kullanın.
...
Tek bir sertifika dosyasındaki verme ilkesi için güvenilen İmzalama anahtarları kümesini belirtir.
