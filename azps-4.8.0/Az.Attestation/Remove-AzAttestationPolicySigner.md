...
## Tanım
Remove-AzAttestationPolicySigner cmdlet 'i Azure kanıtlama 'ndaki bir kiracı için güvenilen ilke imzacısını kaldırır.
...
*Pshtest* adındaki kanıtlama sağlayıcısı için güvenilen İmzalayanın kaldırma.
...
### -İmzalayan
Değeri, "Maa-policyCertificate" adlı bir talep içeren ve değeri, kaldırmak üzere güvenilir bir imzalama anahtarı içeren bir RFC7517 JSON Web anahtarı olan RFC7519 JSON Web belirtecini belirtir.
RFC7519 JWT, mevcut güvenilen imzalama anahtarlarından biriyle imzalanmalıdır.
