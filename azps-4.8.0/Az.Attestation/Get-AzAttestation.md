...
Kaynak Grup *PSH-test-RG* Için kanıt sağlayıcı *pshtest* alın.
...
Kullanılabilir tüm kanıtlama varsayılan sağlayıcılarını edinin
...
*Doğu US 2* konumundan kanıt varsayılan sağlayıcısını al
