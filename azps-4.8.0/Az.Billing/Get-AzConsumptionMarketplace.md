...
## Tanım
**Get-Aztüketimptionmarket** cmdlet 'inin Pazar konumlarını alır.

## ÖRNEKLERDEN

### Örnek 1: Pazar yerleri kullanımını alma
```powershell
...
### Örnek 2: tarih aralığıyla Market kullanımını alma
```powershell
...
### Örnek 3: BillingPeriodName Market kullanımını alma
```powershell
...
### Örnek 4: InstanceName filtresi ile Market kullanımını alma
```powershell
...
### -BillingPeriodName
Satış pazarında ilişki kurmak için belirli bir faturalandırma döneminin adı.
...
### -EndDate
Filtrelemek için Pazar yerlerin bitiş tarihi (UTC).
...
### -InstanceId
Filtrelemek için Pazar Places örnek kimliği.
...
### -InstanceName
Filtrelemek için Pazar Places örnek adı.
...
### -ResourceGroup
Filtrelemek için pazar yerleri kaynak grubu.
...
### -StartDate
Filtrelemek için Pazar yerlerin başlangıç tarihi (UTC).
...
### Microsoft. Azure. Commands. tüketim. modeller. PSMarketplace
