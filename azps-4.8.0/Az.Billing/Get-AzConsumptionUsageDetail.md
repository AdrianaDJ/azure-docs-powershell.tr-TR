...
## Tanım
**Get-Aztüketimptionusagedetail** cmdlet 'inin kullanım ayrıntılarını alır. 

## ÖRNEKLERDEN

### Örnek 1: MeterDetails ile kullanım ayrıntılarını alma
```powershell
...
### Örnek 2: tarih aralığıyla kullanım ayrıntılarını alma
```powershell
...
### -EndDate
Filtre uygulanacak kullanımlarının bitiş tarihi (UTC).
...
### -Genişletme
MeterDetails veya AdditionalInfo tabanlı kullanımları genişletin.
...
### -InstanceId
Filtre uygulanacak kullanımlarının örnek kimliği.
...
### -InstanceName
Filtre uygulanacak kullanımlarının örnek adı.
...
### -ResourceGroup
Filtre uygulanacak kullanımlarının kaynak grubu.
...
### -StartDate
Filtre uygulanacak kullanımlarının başlangıç tarihi (UTC).
...
### Etiketli
Filtre uygulama kullanımlarının etiketi.
...
### Microsoft. Azure. Commands. tüketim. modeller. PSUsageDetail
