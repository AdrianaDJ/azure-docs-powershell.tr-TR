...
## Tanım
**Get-Azsarf Mptionrezervationsummary** cmdlet 'i günlük veya aylık grelük özetlerini alır.

## ÖRNEKLERDEN

### Örnek 1: aylık grenin RESERVATION Order ID ile rezervasyon özetlerini alma
```powershell
...
### Örnek 2: bir aylık grenin rezervasyonu
```powershell
...
### Örnek 3: günlük noktalı, rezervasyon sipariş kimliği
```powershell
...
### Örnek 4: rezervasyon düzeni kimliği ve rezervasyon kimliği
```powershell
...
### -EndDate
Rezervasyon özetinin son verileri (YYYY-AA-DD); yalnızca günlük greiçin gereklidir.
...
### Noktalı
Ayırma özetinin zaman çizgisi, günlük veya aylık olabilir.
...
### -Rezervationıd
Rezervasyon sırasındaki rezervasyonun tanımlayıcısı.
...
### -Rezervationorderıd
Bir rezervasyon satınalmanın tanımlayıcısı.
...
### -StartDate
Rezervasyon özetinin başlangıç verileri (YYYY-AA-DD); yalnızca günlük greiçin gereklidir.
...
### Microsoft. Azure. Commands. tüketim. modeller. Psrezervationsummary
