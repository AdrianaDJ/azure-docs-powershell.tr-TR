...
## SYNOPSIS
Belirtilen Azure adanmış HSM 'yi alır.
...
### Örnek 1: bir aboneliğin altındaki tüm adanmış HSM 'yi alma
```powershell
...
Bu komut bir aboneliğin altındaki tüm adanmış HSM 'yi alır

### Örnek 2: kaynak grubu altındaki tüm adanmış HSM 'yi alma.
```powershell
...
Bu komut, kaynak grubu altındaki tüm adanmış HSM 'yi alır.

### Örnek 3: ada göre adanmış bir HSM alma
```powershell
...
Bu komut adanmış bir HSM adını alır.

### Örnek 4: nesneye göre adanmış bir HSM alma
```powershell
...
Bu komut, adanmış bir HSM nesnesini alır.
...
### -ResourceGroupName
Adanmış HSM 'nin ait olduğu kaynak grubunun adı.
