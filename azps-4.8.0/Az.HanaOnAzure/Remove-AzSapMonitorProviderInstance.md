...
### Örnek 1: SAP izleyicisini ada göre kaldırma
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Bu komut SAP İzleyicisi örneğini ada göre kaldırır.

### Örnek 2: SAP monitörü 'nün nesne örneğini kaldırma
```powershell
...
Bu komut SAP İzleyicisi örneğini nesneye göre kaldırır.
