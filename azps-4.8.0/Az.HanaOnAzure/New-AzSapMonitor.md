...
Bu komut bir SAP monitörü oluşturur.
...
### -Enablecustomeranalitik
Microsoft 'a analitik gönderilip gönderilmeyeceğini gösteren değer
...
### -Loganalyzer Tics
İzleme için kullanılacak Log Analytics çalışma alanının çalışma alanı KIMLIĞI
...
İzleme için kullanılan Log Analytics çalışma alanının ARM KIMLIĞI
...
İzleme için kullanılan Log Analytics çalışma alanının paylaşılan anahtarı
...
### -Monitorsubnetresourceıd
SAP izlemenin dağıtılacağı alt ağ.
Bu, HANA veritabanının aynı alt ağıyla olmalıdır.
