...
## Tanım
Bu **restart-AzHDInsightHost** cmdlet 'i HDInsight kümesinin belirli konaklarını yeniden başlatır.
...
Bu komut, kümenin iki ana bilgisayarını yeniden başlatır: worknode1, worknode2.
...
Bu komut, ' Get-AzHDInsightHost ' cmdlet 'ine birlikte çalışmayı gösterir.
...
Konağın adını alır veya ayarlar.
...
### System. Koleksiyonlar. Generic. IList ' 1 [[Microsoft. Azure. Commands. HDInsight. modeller. Management. AzureHDInsightHostInfo, Microsoft. Azure. PowerShell.
