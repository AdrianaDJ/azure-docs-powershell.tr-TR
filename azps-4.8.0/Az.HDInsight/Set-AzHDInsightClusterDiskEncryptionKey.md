...
## Tanım
Belirtilen HDInsight kümesinin disk şifreleme anahtarını döndürün. Bu işlem için, kümenin hem geçerli anahtara hem de hedeflenen yeni anahtara erişimi olmalıdır, aksi takdirde anahtar Döndür işlemi başarısız olur.
...
[Müşteri tarafından yönetilen anahtar disk şifrelemesi](https://docs.microsoft.com/en-us/azure/hdinsight/disk-encryption)
