...
### Örnek 2: müşteri tarafından yönetilen anahtar disk şifrelemesi ile küme oluşturma
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Örnek 3: aktarma sırasında şifrelemeyi sağlayan bir Azure HDInsight kümesi oluşturma
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Örnek 4: özel bağlantı özelliğiyle bir Azure HDInsight kümesi oluşturma
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Örnek 5: konakta şifrelemeyi sağlayan bir Azure HDInsight kümesi oluşturma
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Örnek 6: otomatik ölçeklendirme sağlayan bir Azure HDInsight kümesi oluşturun.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
Giden erişim türünü genel ağa alır veya ayarlar.
...
Genel ağ erişim türünü alır veya ayarlar.
