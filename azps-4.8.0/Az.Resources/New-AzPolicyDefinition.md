...
### Örnek 5: mod ile satır içi bir ilke tanımı oluşturma
```
...
Bu komut, bu ilkenin, yalnızca etiketleri ve konumu destekleyen kaynak türleri için değerlendirilmelidir.
