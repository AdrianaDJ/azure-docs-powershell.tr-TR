...
## Tanım
**Test-Azdağıtım** cmdlet 'i, dağıtım şablonunun ve parametre değerlerinin geçerli olup olmadığını belirler.
...
Bu komut, belirli bir şablon dosyasından ve bir parametre dosyasından oluşturulmuş bir bellek içi Hashtable kullanarak geçerli abonelik kapsamındaki bir dağıtımı sınar.
