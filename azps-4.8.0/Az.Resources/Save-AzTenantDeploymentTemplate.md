...
## Tanım
**Save-AzTenantDeploymentTemplate** cmdlet 'i, kiracı kapsamındaki bir dağıtım için bir DAĞıTıM şablonunu JSON dosyasına kaydeder.
...
Bu komut, geçerli kiracı kapsamındaki "RolesDeployment" dağıtımını alır ve şablonunu kaydeder.
