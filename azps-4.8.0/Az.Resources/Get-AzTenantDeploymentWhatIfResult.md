...
## Tanım
**Get-Aztenantdeploymentwhaınresult** cmdlet 'i, belirtilen kiracı kapsamındaki bir şablon DAĞıTıMı için ARM şablonunu What-If sonucunu alır. Gerçek kaynaklarda hiçbir değişiklik yapılmadan dağıtım uygulandığında hangi kaynakların güncelleştirileceğini gösteren değişikliklerin listesini döndürür. Döndürme sonucunun biçimini belirtmek için, *RESULTFORMAT* parametresini kullanın.

## ÖRNEKLERDEN

### Örnek 1: kiracı kapsamında What-If sonucu alma
```powershell
...
Bu komut, özel bir şablon dosyası ve diskte bir parametre dosyası kullanarak kiracı kapsamında bir What-If sonucu alır.
...
### Örnek 2: yalnızca Resourceıdile kiracı kapsamına bir What-If sonucu alın
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
