...
## Tanım
**Remove-Azdeploymentscrıpt** cmdlet 'i, dağıtım betiğini ve ilişkili kaynaklarını kaldırır.
...
Kaynak Grup DS-TestRG 'daki Mydeploymentscrıpt adıyla bir dağıtım betiği siler.
