...
Bu komut, özel bir şablon ve diskte bir şablon dosyası, tanımlı Etiketler parametresi kullanılarak yeni bir dağıtım oluşturur.
...
Bu komut, bir bellek içi karma diske dönüştürülen diskte özel ve bir şablon dosyası kullanarak yeni bir dağıtım oluşturur.
İlk iki komut diskteki şablon dosyasının metnini okur ve bunu bellek içi bir Hashtable 'a dönüştürür.
Son komut, parametre ve parametre değerleri içeren bir dosyayı belirtmek için Hashtable ve *Templateparameterfile* parametresini belirtmek üzere *templateobject* parametresini kullanır.

### Örnek 3

Kaynak grubuna Azure dağıtımı ekler. oluşturulmuş
...
- Tamamlandı: Kaynak Yöneticisi, kaynak grubunda bulunan ancak şablonda belirtilmeyen kaynakları siler. 
- Artımlı: artımlı modda, kaynak yöneticisi kaynak grubunda bulunan ancak şablonda belirtilmeyen kaynakları bırakır.
