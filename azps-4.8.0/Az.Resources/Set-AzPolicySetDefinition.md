...
## Tanım
**Set-AzPolicySetDefinition** cmdlet 'i bir ilke tanımını değiştirir.
...
İlk komut, Get-AzPolicySetDefinition cmdlet 'ini kullanarak bir ilke kümesi tanımı alır.
...
### Örnek 2: ilke kümesi tanımının meta verilerini güncelleştirme
```
...
Bu komut, VMPolicySetDefinition adındaki bir ilke kümesi tanımının meta verilerini, kategorisinin "sanal makine" olduğunu belirtecek şekilde güncelleştirir.

### Örnek 3: ilke kümesi tanımının gruplarını güncelleştirme
```
...
Bu komut, VMPolicySetDefinition adlı bir ilke kümesi tanımının gruplarını güncelleştirir.

### Örnek 4: karma tablo kullanarak ilke kümesi tanımının gruplarını güncelleştirme
```
$groupsJson = ConvertTo-Json @{ name = "group1", displayName = "Virtual Machine Security" }, @{ name = "group2" }
PS C:\> Set-AzPolicySetDefinition -Name 'VMPolicySetDefinition' -GroupDefinition $groupsJson
```

Bu komut, VMPolicySetDefinition adındaki bir ilke kümesi tanımının gruplarını, grup oluşturmak için karma tablo kullanarak güncelleştirir.
...
### -GroupDefinition
Güncelleştirilmiş ilke kümesi tanımının ilke tanımı grupları. Bu, grupları içeren bir dosyanın yolu veya JSON dizesi olarak gruplar olabilir.
...
### -InputObject
Başka bir cmdlet 'ten çıktı olan güncelleştirilecek ilke kümesi tanım nesnesi.
...
### -ManagementGroupName
Güncelleştirilecek ilke kümesi tanımının yönetim grubunun adı.
...
### -Metadata
Güncelleştirilmiş ilke kümesi tanımının meta verileri. Bu, meta verileri içeren bir dosya adının yolu veya JSON dizesi olarak meta veri olabilir.
...
### -Parametre
Güncelleştirilmiş ilke kümesi tanımının parametreler bildirimi. Bu, parametre bildirimini içeren bir dosya adı veya URI veya JSON dizesi olarak parametre bildirimi olabilir.
...
### -SubscriptionID
Güncelleştirilecek ilke kümesi tanımının abonelik KIMLIĞI.
