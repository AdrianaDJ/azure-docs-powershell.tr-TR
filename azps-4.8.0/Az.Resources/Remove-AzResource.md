...
## Tanım
**Remove-AzResource** cmdlet 'ı bir Azure kaynağını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: Web sitesi kaynağını kaldırma
```
PS C:\>Remove-AzResource -ResourceId "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/ResourceGroup11/providers/Microsoft.Web/sites/ContosoSite" -Force
```

Bu komut, ContosoSite adlı Web sitesi kaynağını kaldırır.
Örnekte, abonelik KIMLIĞI için yer tutucu değeri kullanılır.
...
Bu cmdlet 'in kaldırdığı kaynağın uzantı kaynağının adını belirtir.
...
Kaynağın uzantı kaynak türünü belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in kaynağı kaldırdığı kaynak grubunun adını belirtir.
...
### -RESOURCEID
Bu cmdlet 'in kaldırdığı kaynağın tam nitelikli kaynak KIMLIĞINI belirtir.
...
### -ResourceName
Bu cmdlet 'in kaldırdığı kaynağın adını belirtir.
...
### -ResourceType
Bu cmdlet 'in kaldırdığı kaynağın türünü belirtir.
