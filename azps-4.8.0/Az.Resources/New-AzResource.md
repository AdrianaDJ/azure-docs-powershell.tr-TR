...
## Tanım
**New-AzResource** cmdlet 'i, bir kaynak grubundaki Web sitesi, Azure SQL veritabanı sunucusu veya Azure SQL veritabanı gibi bir Azure kaynağı oluşturur.
...
Kaynağı, bu türdeki kaynakları destekleyen herhangi bir konuma yerleştirebilirsiniz. Kaynak gruplarında farklı konumlardaki kaynaklar bulunabilir. Hangi konumların her kaynak türünü desteklerini belirlemek için Get-AzLocation cmdlet 'ini kullanın.
