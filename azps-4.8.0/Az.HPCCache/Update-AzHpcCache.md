...
## Tanım
**Güncelleştirme-AzHpcCache** cmdlet 'ı BIR Azure HPC önbelleğini güncelleştirir.
...
### -Force
Cmdlet 'in sizden onay istemez olmadığını gösterir. Varsayılan olarak, bu cmdlet önbelleği güncelleştirmek istediğinizi onaylamanızı ister.
...
### -InputObject
Güncelleştirilecek önbellek nesnesi.
...
### -ResourceGroupName
Önbelleğini güncelleştirmek istediğiniz kaynak grubunun adı.
