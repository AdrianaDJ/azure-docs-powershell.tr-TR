...
## Tanım
**Remove-AzHpcCache** cmdlet 'ı BIR Azure HPC önbelleğini kaldırır.
...
### -Force
Cmdlet 'in sizden onay istemez olmadığını gösterir. Varsayılan olarak, bu cmdlet önbelleğin kaldırılmasını onaylamanızı ister.
...
### -ResourceGroupName
Önbelleğini kaldırmak istediğiniz kaynak grubunun adı.
