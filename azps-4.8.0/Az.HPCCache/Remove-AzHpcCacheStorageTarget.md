...
## Tanım
**Remove-AzHpcCacheStorageTarget** cmdlet 'ı Azure HPC Cache 'Den bir depolama hedefini kaldırır.
...
### -Force
Cmdlet 'in sizden onay istemez olmadığını gösterir. Varsayılan olarak, bu cmdlet depolama hedefini kaldırmak istediğinizi onaylamanızı ister.
...
### -ResourceGroupName
Depolama hedefini önbellekten kaldırmak istediğiniz kaynak grubunun adı.
