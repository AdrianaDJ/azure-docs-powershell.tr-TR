...
### Örnek 1 Application Insights kaynağı için Application Insights API 'sini kaldırma
```
...
"TestGroup" kaynak grubundaki "dd173f38-4fd1-4C75-8af5-9 9c29aa0f867" kaynak grubundaki belirli Application Insights API 'sini kaldır.
...
### -Geçiş
Belirtilirse, çalışması işlemi başarılı olduğunda doğru yazılır. Bu parametre isteğe bağlıdır. Varsayılan değer: false.
