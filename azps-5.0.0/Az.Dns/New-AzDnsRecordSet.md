...
## Tanım
**New-AzDnsRecordSet** cmdlet 'i belirtilen ada sahip yeni bir etki alanı adı SISTEMI (DNS) kaydı oluşturur ve belirtilen bölgeye yazın.
...
Bu parametre, New-AzDnsRecordConfig kullanılarak oluşturulan bir dizi DNS kaydını alır.
...
DNS kayıt nesneleri oluşturmak için New-AzDnsRecordConfig cmdlet 'ini kullanabilirsiniz.
...
Meta veriler karma tablolar olarak temsil edilen ad değeri çiftleri kullanılarak belirtilmiştir; örneğin @ {"Bölüm" = "alışveriş"; " env "=" üretim "}.
