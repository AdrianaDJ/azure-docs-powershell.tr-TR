...
## Tanım
Var olan bir Web hizmeti için Azure makine Learning bölgesel özelliklerini oluşturur.

## ÖRNEKLERDEN

### Örnek 1: Batı merkezi ABD için yeni bölgesel özellikler ekleme

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

Bu örnek komut, "Batı merkezi" bölgesindeki bir Web hizmeti için bölgesel özellik oluşturur.
...
### -Bölge
Web hizmeti özelliklerinin oluşturulacağı bölge.
...
### -ResourceGroupName
Web servisinin ait olduğu kaynak grubu.
