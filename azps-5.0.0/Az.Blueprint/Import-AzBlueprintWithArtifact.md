...
### -Includealt klasörler
True olarak ayarlandığında, alt klasörlerdeki yapıt dahil edilir.
...
### -Geçiş
Ayarlandığında cmdlet, içeri aktarılan şeması tanımını temsil eden bir nesne döndürür. Varsayılan olarak, bu cmdlet hiçbir çıkış üretmez.
