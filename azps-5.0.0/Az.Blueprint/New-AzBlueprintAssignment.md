...
`$blueprintObject`Tanımlı parametreyi kullanarak belirtilen yönetim grubundaki belirtilen aboneliği hedefleyen şeması tanımının yeni bir şeması atamasını oluşturun.
