...
Eşleştirme için sağlayıcıya özgü giriş.
...
### -Targetprotectioncontainerıd
Hedef benzersiz koruma kapsayıcısı adı.
...
### Microsoft. Azure. PowerShell. cmdlet. Api20180110. ıprotectioncontainermapping
...
PROVIDERSPECIFICıNPUT <IReplicationProviderSpecificContainerMappingInput> : eşleştirme için sağlayıcıya özgü giriş.
