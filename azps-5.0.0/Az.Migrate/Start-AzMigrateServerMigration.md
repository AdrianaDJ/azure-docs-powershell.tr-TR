...
### -InputObject
Geçişin başlatılması gereken çoğaltma sunucusunu belirtir.
...
### -TargetObjectID
Geçişin başlatılması gereken repltonlu sunucuyu belirtir.
...
### -TurnOffSourceServer
Kaynak sunucunun geçiş sonrası özelliğinin kapatılıp kapatılmaması gerektiğini belirtir.
...
INPUTOBJECT <IMigrationItem> : geçişin başlatılması gereken çoğaltma sunucusunu belirtir. Sunucu nesnesi Get-AzMigrateServerReplication cmdlet kullanılarak alınabilir.
