...
## SYNOPSIS
Çoğaltma sunucusunun ayrıntılarını alır.
...
### Örnek 1: kimliğe göre ayrıntıları alma
```powershell
...
### Örnek 2: tüm Project 'i kimliğe göre listeler.
```powershell
...
### Örnek 2: tüm Project 'te ada göre listeler.
```powershell
...
### -Discoveredmachineıd
Keşfedilen sunucunun makine KIMLIĞINI belirtir.
...
### -ProjectName
Geçerli abonelikteki Azure geçiş projesini belirtir.
...
### Microsoft. Azure. PowerShell. cmdlet. Api20180110.
