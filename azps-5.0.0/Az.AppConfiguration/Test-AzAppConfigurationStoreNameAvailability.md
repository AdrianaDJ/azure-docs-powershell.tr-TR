...
### Örnek 1: uygulama yapılandırma deposu adının test kullanılabilirliği
...
Bu komut, uygulama yapılandırma deposu adının kullanılabilirliğini sınar.
...
### Microsoft. Azure. PowerShell. cmdlet. AppConfiguration. modeller. Api20200601. INameAvailabilityStatus
