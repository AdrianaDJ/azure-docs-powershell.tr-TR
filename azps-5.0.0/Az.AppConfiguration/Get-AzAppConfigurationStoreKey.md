...
### Örnek 1: uygulama yapılandırma deposundaki tüm depolama anahtarlarını listeler
```powershell
...
Bu komut, uygulama yapılandırma deposundaki tüm mağaza anahtarlarını listeler.
