...
## Tanım
Bu cmdlet, Service Fabric 'ı kümeden kaldırır. Bu komutu çalıştırmadan önce bu kaynağın altındaki tüm uygulamalar kaldırılmalıdır.
...
Bu örnekte, "testAppType" türünün altındaki "v1" sürümü kaldırılacaktır. Bu kaynak altında herhangi bir uygulama vardır komut bir özel durum oluşturur.
...
### -RESOURCEID
Uygulama türü sürümünün Kolonu.
