...
## Tanım
Bu cmdlet, belirtilen kaynak grubundaki ve kümedeki uygulama ayrıntılarını alır.
...
Bu örnekte, "testApp" uygulamasının uygulama kaynağı ayrıntıları alınır.
...
Bu örnekte, "testCluster" kümesi altındaki uygulamaların listesi yer alır.
