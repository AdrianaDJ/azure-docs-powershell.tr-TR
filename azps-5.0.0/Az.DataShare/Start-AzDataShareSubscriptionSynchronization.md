...
## Tanım
**Start-AzDataShareSubscriptionSynchronization** cmdlet 'i, bir paylaşım aboneliği için eşitleme başlatır
...
Bu komut, hesap WikiAds 'daki AdsShareSubscription adlı bir paylaşım için eşitlemeyi başlatır. 
...
### -SynchronizationMode
Eşitleme modu (FullSync veya artımlı)
