...
## Tanım
**New-AzDataShareDataSet** cmdlet 'i veri paylaşımı hesabının Azure veri paylaşımında veri kümeleri ekler. Blob, ADLS Gen2 ve ADLS Gen1 türündeki veri kümeleri ekleyebilirsiniz.
...
Bu komut, Azure veri paylaşımı AdsShare türünde, blob kapsayıcı türündeki bir veri kümesi ekler.
...
### -AdlsGen1FolderPath
Azure Storage ADLS Gen1 klasör yolu
...
### Kapsayıcı
Azure depolama hesabı kapsayıcısı adı
...
### -Dosya adı
Azure Storage ADLS Gen1 dosya adı
...
### -FileSystem
Azure ADLS Gen2 dosya sistemi adı
...
Azure depolama hesabı RESOURCEID
