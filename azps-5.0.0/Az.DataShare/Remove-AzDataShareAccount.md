...
## Tanım
**Remove-AzDataShareAccount** cmdlet 'i, datashare hesabını kaldırır.
...
Bu komut, ADS adlı kaynak grubundaki WikiADS adlı datashare hesabını kaldırır.
...
### -InputObject
Azure veri paylaşımı hesap nesnesi.
