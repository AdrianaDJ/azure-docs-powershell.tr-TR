...
## Tanım
**Yeni-Azverisharesyntarihçe ayarı** , belirli bir zamanda günlük veya saatlik olarak saat yinelemesi için paylaşım hesabında paylaşım için bir eşitleme ayarı oluşturur.
...
Bu 9:00 komut, veri paylaşımı hesap kutucuğundaki Share AdsShare.
...
### -Recurrenceınterval
Eşitleme ayarının tekrarlama aralığı (gün veya saat)
...
### -SynchronizationTime
Zamanlanan eşitleme ayarının başlangıç saati
