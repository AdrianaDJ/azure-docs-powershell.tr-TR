...
## Tanım
Kaynağın bakım yapılandırmasını kaydettirme.
...
Adanmış ana bilgisayar için bakım yapılandırmasını kaydettirme.
...
### -Configurationatamaadı
Yapılandırma atama adı, MaintenanceConfigurationName eşleşmelidir.
...
Tam nitelikli MaintenanceConfiguration.
...
### Microsoft. Azure. Commands. Maintenance. modeller. Psconfigurationödev
