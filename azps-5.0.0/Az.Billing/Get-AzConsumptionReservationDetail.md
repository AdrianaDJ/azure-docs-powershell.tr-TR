...
## Tanım
**Get-Azsarf Mptionrezervationdetail** cmdlet 'i, sağlanan tarih aralığı için rezervasyonlar ayrıntılarını alır.

## ÖRNEKLERDEN

### Örnek 1: sağlanan tarih aralığı için rezervasyon sipariş kimliğiyle rezervasyon ayrıntılarını alma
```powershell
...
### Örnek 2: sağlanan tarih aralığı için rezervasyon
```powershell
...
### -EndDate
Ayırma detaysının son verileri (UTC 'deki YYYY-AA-GG).
...
### -StartDate
Ayırma detaysının başlangıç verileri (UTC 'deki YYYY-AA-GG).
...
### Microsoft. Azure. Commands. tüketim. model. Psrezervationdetail
