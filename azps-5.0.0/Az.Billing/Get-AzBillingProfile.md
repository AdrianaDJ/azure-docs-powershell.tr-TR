...
## Tanım
**Get-AzBillingProfile** cmdlet 'i, belirtilen faturalandırma hesabı altında fatura profilleri alır. 
...
Belirtilen faturalandırma hesabı altında tüm faturalama profillerini alın.
...
Belirtilen adla Faturalandırma profili alın.
...
Belirtilen fatura hesabı altındaki tüm faturalama profillerini alın ve fatura bölümlerini de ekleyin.
...
Belirtilen adla faturalandırma profilini alın ve fatura bölümlerini de ekleyin.
...
Fatura profili altında fatura bölümlerini ekleyin.
...
### -Ad
Belirli bir faturalandırma profilinin adı.
...
### Microsoft. Azure. Commands. faturalandırma. modeller. PSBillingProfile
