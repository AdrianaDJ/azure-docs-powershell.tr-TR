...
## Tanım
**Get-Azfaturasection** cmdlet 'i, fatura bölümlerini belirtilen faturalandırma profilinin altında alır. 
...
Belirtilen fatura profilinin altındaki tüm fatura bölümlerini alın.
...
Belirtilen ada sahip fatura bölümünü alın.
...
### -Ad
Belirli bir fatura bölümünün adı.
...
### Microsoft. Azure. Commands. faturalandırma. modeller. Psınvoicesection
