...
## SYNOPSIS
Belirtilen Azure adanmış HSM 'yi siler.
...
### Örnek 1: adanmış bir HSM 'yi adla kaldırma
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Bu işlem, bir donanım güvenlik modülünü (HSM) ada göre kaldırır.

### Örnek 2: adanmış bir HSM 'yi nesneye kaldırma
```powershell
...
Bu işlem, adanmış bir HSM nesnesini kaldırır.
