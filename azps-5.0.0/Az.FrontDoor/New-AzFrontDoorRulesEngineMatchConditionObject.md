...
Yeni bir PSRulesEngineMatchCondition Greate.
...
### -Eşleşme değeri
Eşlenecek değerleri eşleştirin.
İşleç, buradaki veya semantiklerle her değere uygulanır.
Herhangi birinin verilen işleç ile değişkenle eşleşmesi durumunda, bu eşleşme koşulu eşleşme olarak kabul edilir.
...
### -MatchVariable
Değişkeni eşle.
Olası değerler IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestBody, RequestScheme
...
### -NegateCondition
Bunun Negate koşulu olup olmadığını açıklar
...
### -İşleç
Eşleştirme koşuluna uygulanacak işleç açıklanır.
Olası değerler, IPMatch, GeoMatch, eşittir, Contains, LessThan, GreaterThan, Lessıal, GreaterThanOrEqual, BeginsWith, EndsWith.
...
### -Dönüştürme
Eşleştirme öncesinde hangi dönüşümlerin uygulandığını gösteren liste. Olası tek tek dönüştürme değerleri küçük, büyük, Kırp, Urlçözemiyor, UrlEncode, RemoveNulls.
...
### Microsoft. Azure. Commands. Frontkapısı. modeller. PSRulesEngineMatchCondition
