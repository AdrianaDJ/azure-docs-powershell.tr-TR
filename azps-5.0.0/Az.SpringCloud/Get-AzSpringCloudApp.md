...
### Örnek 1: yay bulut uygulamasını ada göre alın.
```powershell
...
Yay bulut uygulamasını ada göre edinin.

### Örnek 2: verilen yay bulut hizmeti altındaki tüm uygulamayı listeleyin.
```powershell
...
Verilen yay bulutu hizmeti altındaki tüm uygulamaları listeleyin.
