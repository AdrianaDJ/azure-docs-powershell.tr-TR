...
### Örnek 1: yay bulut uygulaması Deploymeng 'yi ada göre alın.
```powershell
...
Yay bulut uygulaması Deploymeng 'yi ada göre edinin.

### Örnek 2: verilen yay bulutu uygulamasının altındaki tüm dağıtımı listeler.
```powershell
...
Verilen yay bulutu uygulamasının altındaki tüm dağıtımı listeler.
