...
Bir Azure IoT Hub 'ı olan bir Azure IoT Hub 'ı bir

## PARAMETRELERINE

### -Ayırağırlığı
IoT Hub 'ının tahsis ağırlığı
...
### -Applyalkonumilkesi
IoT Hub 'ına ayırma ilkesi uygulanıp uygulanmayacağınızı gösteren Boole değeri
...
IoT Hub kaynağının bağlantı dizesi.
