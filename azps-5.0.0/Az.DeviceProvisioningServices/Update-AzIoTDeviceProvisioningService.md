...
"Myıotdps" Azure IoT Hub cihaz sağlama hizmetinden "bir
...
" @tags " Öğesini Azure IoT Hub cihaz sağlama hizmetinin "myıotdps" etiketine ekleyin.
...
@tagsArdışık düzen kullanan "myıotdps" adlı Azure IoT Hub cihaz sağlama hizmeti etiketine ve yeni "" etiketini silin.

## PARAMETRELERINE

### -Ayıra Ilkesi
IoT cihaz sağlama hizmeti ayırma ilkesi
...
### -Reset
IoT cihaz sağlama hizmeti etiketlerini sıfırlama
...
### Etiketli
IoT cihazı sağlama hizmeti etiket koleksiyonu
