...
## Tanım
**Set-AzAutomationConnectionFieldValue** cmdlet 'ı, Azure Otomasyonu 'ndaki bir bağlantı içindeki bir alanın değerini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: bağlantıda alan değeri değiştirme
```
...
Bu komut, AutomationAccount01 adlı Otomasyon hesabındaki ContosoConnection adlı Azure bağlantısının abonelik KIMLIĞINI değiştirir.

## PARAMETRELERINE

### -AutomationAccountName
Bu cmdlet 'in bir bağlantı içinde bir alanı değiştirdiği Otomasyon hesabının adını belirtir.
...
### -ConnectionFieldName
Bu cmdlet 'in değiştirdiği alanın adını belirtir.
...
### -Ad
Bu cmdlet 'in bir alanı değiştirdiği bağlantının adını belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in bir bağlantı içinde bir alanı değiştirdiği kaynak grubunun adını belirtir.
...
### -Değer
Bağlantı alanında değiştirilecek değeri belirtir.
