...
## Tanım
**Unregister-AzAutomationScheduledRunbook** cmdlet 'i, bir Azure Otomasyonu runbook ile zamanlama arasındaki ilişkilendirmeyi kaldırır.
Zamanlama artık runbook 'u başlatmayacaktır.

## ÖRNEKLERDEN

### Örnek 1: runbook ile zamanlama arasındaki ilişkiyi kaldırma
```
...
Bu komut, Runbk01 adındaki runbook ile Runbk01Sched adlı zamanlama arasındaki ilişkiyi kaldırır.
...
### -Jobscheduleıd
Zamanlanmış bir runbook 'un KIMLIĞINI belirtir.
...
### -RunbookName
Bu cmdlet 'in bir zamanlamaya dahil olduğu runbook 'un adını belirtir.
...
### -ScheduleName
Bu cmdlet 'in bir runbook 'un ilişkisini kaldırdıkları zamanlamanın adını belirtir.
