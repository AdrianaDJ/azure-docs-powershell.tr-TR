...
## Tanım
**Set-AzAutomationCertificate** cmdlet 'ı Azure Otomasyonu 'nda bir sertifikanın yapılandırmasını değiştirir.
...
İkinci komut, Contososertifikası adlı sertifikayı değiştirir.
...
### -Açıklama
Bu cmdlet 'in değiştirdiği sertifikanın açıklamasını belirtir.
...
### -Ad
Bu cmdlet 'in değiştirdiği sertifikanın adını belirtir.
...
### -Yol
Karşıya yüklenecek bir komut dosyasının yolunu belirtir.
Dosya. cer dosyası veya. pfx dosyası olabilir.
