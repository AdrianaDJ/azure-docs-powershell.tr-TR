...
## Tanım
**New-AzBatchPool** cmdlet 'ı, Azure Batch hizmetinde *batchcontext* parametresinde belirtilen hesap altında bir havuz oluşturur.

## ÖRNEKLERDEN

### Örnek 1: CloudServiceConfiguration kullanarak Targetadanmış parametre kümesini kullanarak yeni havuz oluşturma
```
...
Havuz, Aile dörtte işletim sistemi sürümü ile STANDARD_D1_V2 sanal makineleri kullanacak şekilde yapılandırılmıştır.

### Örnek 2: VirtualMachineConfiguration kullanarak Targetadanmış parametre kümesini kullanarak yeni bir havuz oluşturma
```
...
Havuz, Windows-2016-Datacenter işletim sistemi görüntüsüyle STANDARD_D1_V2 sanal makineleri kullanacak şekilde yapılandırılmıştır.

### Örnek 3: otomatik ölçeklendirme parametre kümesini kullanarak yeni havuz oluşturma
```
PS C:\>$imageReference = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSImageReference" -ArgumentList @("WindowsServer", "MicrosoftWindowsServer", "2016-Datacenter", "*")
PS C:\>$configuration = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSVirtualMachineConfiguration" -ArgumentList @($imageReference, "batch.node.windows amd64")
...
Havuz, Windows-2016-Datacenter işletim sistemi görüntüsüyle STANDARD_D1_V2 sanal makineleri kullanacak şekilde yapılandırılmıştır ve hedef sayısı hedef sayısı otomatik ölçeklendirme formülüyle belirlenir.

### Örnek 4: alt ağda düğümleri bulunan havuz oluşturma
```
PS C:\>$imageReference = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSImageReference" -ArgumentList @("WindowsServer", "MicrosoftWindowsServer", "2016-Datacenter", "*")
PS C:\>$configuration = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSVirtualMachineConfiguration" -ArgumentList @($imageReference, "batch.node.windows amd64")
...
### Örnek 5: özel kullanıcı hesaplarıyla havuz oluşturma
```
PS C:\>$imageReference = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSImageReference" -ArgumentList @("WindowsServer", "MicrosoftWindowsServer", "2016-Datacenter", "*")
PS C:\>$configuration = New-Object -TypeName "Microsoft.Azure.Commands.Batch.Models.PSVirtualMachineConfiguration" -ArgumentList @($imageReference, "batch.node.windows amd64")
...
### -Applicationlisansları
Toplu hizmet, havuzdaki her bir işlem düğümünde kullanılabilir olacak uygulama lisanslarının listesi.
...
### -Mountyapılandırması
Havuzdaki her düğüme takılacak dosya sistemlerinin listesi. Bu, Azure dosyalarını, NFS, CIFS/SMB ve Blobsigortası destekler.
...
### -TARGETTE
Havuza ayrılacak adanmış işlem düğümlerinin hedef sayısını belirtir.
...
Havuza ayrılacak düşük öncelikli işlem düğümlerinin hedef sayısını belirtir.
