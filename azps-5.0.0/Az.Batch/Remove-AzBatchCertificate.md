...
## Tanım
**Remove-AzBatchCertificate** cmdlet 'ı belirtilen Azure toplu hesabındaki bir sertifikayı çıkarır.
...
Bu komut belirtilen parmak izine sahip sertifikayı kaldırır.

### Örnek 2: tüm etkin sertifikaları kaldırma
```
PS C:\>Get-AzBatchCertificate -Filter "state eq 'active'" -BatchContext $Context | Remove-AzBatchCertificate -Force -BatchContext $Context
```

Bu komut, Get-AzBatchCertificate cmdlet 'i kullanarak etkin olan tüm sertifikaları alır.
Komut, ardışık düzen işlecini kullanarak etkin sertifikaları geçerli cmdlet 'e geçirir.
Bu cmdlet her sertifikayı kaldırır.
...
### -Parmak izi
Bu cmdlet 'in sildiği sertifikanın parmak izini belirtir.
