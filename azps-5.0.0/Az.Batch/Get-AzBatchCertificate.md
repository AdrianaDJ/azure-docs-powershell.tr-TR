...
## Tanım
**Get-AzBatchCertificate** cmdlet 'ı, Azure toplu hesabındaki sertifikaları, *batchcontext* parametresinin belirttiği sertifikaları alır.
Belirli bir sertifika edinmek için, *Thumbprintalgorithm* ve *parmak izi* parametrelerini belirtin.
Açık bir veri Protokolü (OData) filtresiyle eşleşen sertifikaların alınacağı *filtre* parametresini belirtin.

## ÖRNEKLERDEN

### Örnek 1: parmak iziyle sertifika alma
```
...
Bu komut belirtilen parmak izine sahip tek bir sertifikayı alır.
Sertifika parmak izi algoritması SHA1.

### Örnek 2: filtrelenmiş Sertifikalar alma
```
...
Bu komut, etkin durumdaki tüm sertifikaları toplu Iş hesabından alır.
*Filter* parametresi durumu belirtir.
...
Bu parametreyi belirtirseniz, bu cmdlet filtreyle eşleşen sertifikaları alır.
...
### -MaxCount
Döndürülecek en fazla sertifika sayısını belirtir.
...
### -Parmak izi
Bu cmdlet 'in aldığı sertifikanın parmak izini belirtir.
...
### Microsoft.Azure.Commands.Batch. Modeller. Pscercertificate
