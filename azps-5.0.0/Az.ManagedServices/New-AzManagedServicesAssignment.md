...
Kayıt tanım tanımlayıcısını kullanarak varsayılan kapsamda bir kayıt ataması oluşturur.
...
Giriş olarak kayıt tanımı nesnesini içeren bir kayıt ataması oluşturur.
...
Kayıt atamasını kayıt tanımı tanımlayıcısı ve adıyla güncelleştirir.
...
### -Registrationdefinitionıd
Kayıt tanımının tam kaynak kimliği.
