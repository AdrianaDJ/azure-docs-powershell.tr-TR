...
Roledefinitionıd ve PrincipalId değerleri doğrudan verilen bir kayıt tanımı oluşturur.
...
Yetkilendirme ayrıntılarını içeren bir kayıt tanımı oluşturur veya güncelleştirir.
...
Kayıt tanımını, yetkilendirme ayrıntılarını ve kayıt tanımının adını kullanarak güncelleştirir.

## PARAMETRELERINE

### -Yetkilendirme
PrincipalId-Roledefinitionıd ile yetkilendirme eşleme listesi.
...
### -Roledefinitionıd
Temel tanımlayıcıya izin vermek için rol tanımı tanımlayıcısı.
