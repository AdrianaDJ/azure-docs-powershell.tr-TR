...
### ByNameSimplifiedPatch (varsayılan)
```
...
## Tanım
**Update-AzActionRule** cmdlet güncelleştirme eylem kuralı Özellikler-durum ve Etiketler.
...
Bu cmdlet eylem kuralını devre dışı bırakır. 
...
### -RESOURCEID
Eylem kuralının kaynak kimliği
