...
Bu cmdlet, abonelik kapsamıyla Supression için bir eylem kuralı oluşturur.
...
Bu cmdlet, kaynak grupları kapsamının listesini içeren eylem grubu için bir eylem kuralı oluşturur.
...
Bu cmdlet, bir kaynak kapsamıyla Tanılama ayarları için bir eylem kuralı oluşturur.
...
Beklenen biçim: \<operation\> Örneğin, \<comma separated list of values\> Örneğin.
İçerir: smartgroups
