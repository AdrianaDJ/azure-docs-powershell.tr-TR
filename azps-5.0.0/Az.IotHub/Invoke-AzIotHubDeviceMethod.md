...
## Tanım
Bir cihazda doğrudan yöntem çağırma. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsDaha fazla bilgi için bkz.
...
### -Ad
Bu cihazda çağrılacak yöntemin adı.
...
### -Yük
Bu cihazda çağrılacak yöntemin yükü.
