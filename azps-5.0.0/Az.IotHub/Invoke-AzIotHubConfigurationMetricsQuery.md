...
## Tanım
IoT cihaz yapılandırmasında tanımlanan bir hedef özel veya sistem ölçüsünü değerlendirin.
IoT Hub tarafından hesaplanan ve özelleştirilebilecek önceden tanımlanmış sistem ölçümleri vardır.
- "Hedefli" hedef koşulla eşleşen aygıt TWINS sayısını belirtir.
- "Uygulandı" belirtildi, yapılandırma tarafından değiştirilmiş olan aygıt TWINS sayısı. 
...
Sistemin "uyguladığı" ölçüsünü değerlendirin.
