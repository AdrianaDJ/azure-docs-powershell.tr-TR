...
## Tanım
IoT Hub 'ındaki bir IoT uç dağıtımının veya liste IoT uç dağıtımlarının ayrıntılarını edinin.
...
IoT Edge dağıtımının ayrıntılarını edinin.
...
IoT Hub 'ındaki tüm IoT Edge dağıtımlarını listeleyin.
