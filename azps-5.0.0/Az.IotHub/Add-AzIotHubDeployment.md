...
## Tanım
Edge dağıtımları, isteğe bağlı değerlendirme için Kullanıcı tanımlı ölçümler ile oluşturulabilir.
...
Varsayılan meta veriler içeren bir kenar dağıtımı oluşturun.
...
Bir cihaz 9 ' un içinde etiketlenmişse ve ortam ' test ' olduğunda, bir öncelik 3 olan bir kenar dağıtımı oluşturun.
...
Kullanıcı ölçümlerine sahip bir kenar dağıtımı oluşturun.
...
Etiketlerle bir kenar dağıtımı oluşturun.
...
İçerikle bir kenar dağıtımı oluşturun.
...
### -ModulesContent
IoT Edge cihazları için modüllerin dağıtım içeriği.
