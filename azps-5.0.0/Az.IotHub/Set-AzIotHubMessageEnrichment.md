...
## Tanım
Azure IoT Hub 'ındaki ileti zenginleştirme hakkında ayrıntılı bir açıklama için bkz. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
"Yenianahtar" anahtarının "updatedValue" şeklinde zenginleştirme değerini güncelleştirir.
Azure IoT Hub 'ındaki ileti zenginleştirme hakkında ayrıntılı bir açıklama için bkz. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
"Yenianahtar" anahtarının "endpoint1, endpoint2, endpoint3" için zenginleştirme uç noktasını güncelleştirir.
Azure IoT Hub 'ındaki ileti zenginleştirme hakkında ayrıntılı bir açıklama için bkz. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
