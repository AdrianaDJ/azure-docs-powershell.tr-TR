...
### ResourceSetForStatus (varsayılan)
```
...
Cihaz için Edge özelliklerini açma.
...
Cihaz durumunu devre dışı bırakın.
...
IoT Hub aygıtının Yetkilendirme türünü güncelleştirme.
