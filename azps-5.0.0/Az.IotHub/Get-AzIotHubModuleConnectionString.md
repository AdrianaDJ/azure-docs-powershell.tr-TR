...
## Tanım
Tüm modüllerin veya Azure IoT Hub 'ındaki bir hedef IoT aygıtının belirtilen modülünün bağlantı dizesi.
...
Bir IoT merkezi 'nde hedef IoT aygıtının tüm modüller bağlantı dizelerini gösterin.
...
Bir IoT Hub 'ında hedef IoT aygıtının ikincil modül bağlantı dizesini edinin.
...
### -KeyType
Kimlik doğrulama için paylaşılan erişim ilkesi anahtarı türü.
...
### Microsoft. Azure. Commands. Management. IotHub. modeller. PSModuleConnectionString
