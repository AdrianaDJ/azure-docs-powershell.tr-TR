...
### [Get-Azoperationalınsightscluster](Get-AzOperationalInsightsCluster.md)
Kümeleri alma veya listeleme
...
### [Get-Azoperationalınsightsdeletedworkspace](Get-AzOperationalInsightsDeletedWorkspace.md)
Silinmiş çalışma alanlarını listeler.
...
### [Get-Azoperationalınsightslinkedservice](Get-AzOperationalInsightsLinkedService.md)
Çalışma alanı için bağlantılı hizmeti alma veya listeleme

### [Get-Azoperationalınsightslinkedstorageaccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
Bağlantılı depolama hesabı alma veya listeleme
...
### [New-Azoperationalınsightscluster](New-AzOperationalInsightsCluster.md)
Küme Oluştur
...
### [New-Azoperationalınsightslinkedstorageaccount](New-AzOperationalInsightsLinkedStorageAccount.md)
Çalışma alanı için bağlantılı depolama hesabı oluşturma
...
### [Remove-Azoperationalınsightscluster](Remove-AzOperationalInsightsCluster.md)
Kümeyi Sil

### [Remove-Azoperationalınsightsdatasource](Remove-AzOperationalInsightsDataSource.md)
Veri kaynağını siler.

### [Remove-Azoperationalınsightslinkedservice](Remove-AzOperationalInsightsLinkedService.md)
Çalışma alanı için hizmeti bağlantısını kes

### [Remove-Azoperationalınsightslinkedstorageaccount](Remove-AzOperationalInsightsLinkedStorageAccount.md)
Çalışma alanı için bağlantılı depolama hesabını silme
...
### [Restore-Azoperationalınsightsworkspace](Restore-AzOperationalInsightsWorkspace.md)
Silinmiş çalışma alanını geri yükleme.
...
### [Set-Azoperationalınsightslinkedservice](Set-AzOperationalInsightsLinkedService.md)
çalışma alanı için bağlantı hizmeti

### [Set-Azoperationalınsightslinkedstorageaccount](Set-AzOperationalInsightsLinkedStorageAccount.md)
Çalışma alanı için bağlantılı depolama hesabını ayarlama
...
### [Güncelleştirme-Azoperationalınsightscluster](Update-AzOperationalInsightsCluster.md)
kümeyi Güncelleştir
