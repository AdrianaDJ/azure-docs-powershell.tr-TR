...
## Tanım
**New-Azoperationalınsightscomputergroup** cmdlet 'i bir kaynak grubunda ve konumda bir bilgisayar grubu oluşturur.

## ÖRNEKLERDEN

### Örnek 1

Bilgisayar grubu oluşturur. oluşturulmuş
...
### -Kategori
Bilgisayar grubunun kategorisini belirtir.
...
### -DisplayName
Bilgisayar grubunun görünen adını belirtir.
...
### -Sorgu
Bilgisayar grubunun sorgusunu belirtir.
...
Cmdlet, bu kaynak grubunda bilgisayar grubu oluşturur.
...
### -Savedsearchıd
Bilgisayar grubunun KIMLIĞINI belirtir.
