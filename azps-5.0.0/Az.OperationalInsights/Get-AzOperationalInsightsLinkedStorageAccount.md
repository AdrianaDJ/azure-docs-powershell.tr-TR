...
## Tanım
Bağlı depolama hesabını al, "-DataSourceType" belirtilmediği zaman tüm bağlantılı depolama hesaplarını listeler
...
çalışma alanı için bağlantılı depolama accoons listesi {Workspace-Name}

## PARAMETRELERINE

### -DataSourceType
Veri kaynağı türü ' CustomLogs ', ' AzureWatson ' değerinden biri olmalıdır.
...
### Microsoft. Azure. Commands. Operationalınsights. modeller. PSLinkedStorageAccountsResource
