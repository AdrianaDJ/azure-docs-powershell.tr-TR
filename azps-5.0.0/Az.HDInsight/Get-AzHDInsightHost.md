...
## Tanım
**Get-AzHDInsightHost** cmdlet 'i HDInsight kümesinin konaklarını listeler.
...
Bu komut küme adı içeren kümenin ana bilgisayarlarının listesini listeler.
...
Bu komut kümesinin ardışık düzeni
...
### Microsoft. Azure. Commands. HDInsight. model. Management. AzureHDInsightHostInfo
