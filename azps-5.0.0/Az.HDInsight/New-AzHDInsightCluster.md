...
### Örnek 7: Kafka Rest proxy ile bir Azure HDInsight kümesi oluşturun.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Örnek 8: Azure Data Lake Gen2 Storage ile Azure HDInsight kümesi oluşturun.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Örnek 9: kuruluş güvenlik paketi (ESP) içeren bir Azure HDInsight kümesi oluşturun ve HDInsight ID Broker 'ı etkinleştirin.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### -Enableıdbroker
HDInsight kimlik Aracısı özelliğini etkinleştirmiştir.
...
### -KafkaClientGroupId
Kafka Rest proxy erişimi için istemci grubu kimliğini alır veya ayarlar.
...
Kafka Rest proxy erişimi için istemci grubu adını alır veya ayarlar.
...
Kafka yönetim düğümünün boyutunu alır veya ayarlar.
...
### -StorageAccountKey
Depolama hesabı için depolama hesabı erişim anahtarını alır veya ayarlar.
...
### -Storageaccountmanagedıdentity
Depolama hesabı yönetilen kimliğini alır veya ayarlar.
...
Depolama hesabının depolama kaynak kimliğini alır veya ayarlar.
...
### -StorageAccountType
Depolama hesabının türünü alır veya ayarlar.
...
### -StorageContainer
Varsayılan Azure depolama hesabı için StorageContainer adını alır veya ayarlar
...
### -StorageFileSystem
Varsayılan Azure Data Lake Storage Gen2 hesabı için dosya sistemini alır veya ayarlar.
...
### -StorageRootPath
Varsayılan Data Lake Store hesabındaki kümenin kökünün yolunu alır veya ayarlar.
...
### -SubnetName
Bu HDInsight kümesi için alt ağ adını alır veya ayarlar.
