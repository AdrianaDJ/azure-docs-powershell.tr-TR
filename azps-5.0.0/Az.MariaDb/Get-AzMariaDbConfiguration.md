...
---
# <span data-ttu-id="d0b22-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="d0b22-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="d0b22-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="d0b22-102">SYNOPSIS</span></span>
<span data-ttu-id="d0b22-103">Sunucu yapılandırması hakkında bilgi alır.</span><span class="sxs-lookup"><span data-stu-id="d0b22-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="d0b22-104">INDEKI</span><span class="sxs-lookup"><span data-stu-id="d0b22-104">SYNTAX</span></span>

### <span data-ttu-id="d0b22-105">Liste (varsayılan)</span><span class="sxs-lookup"><span data-stu-id="d0b22-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="d0b22-106">Al</span><span class="sxs-lookup"><span data-stu-id="d0b22-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="d0b22-107">Getviaıdentity</span><span class="sxs-lookup"><span data-stu-id="d0b22-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="d0b22-108">Tanım</span><span class="sxs-lookup"><span data-stu-id="d0b22-108">DESCRIPTION</span></span>
<span data-ttu-id="d0b22-109">Sunucu yapılandırması hakkında bilgi alır.</span><span class="sxs-lookup"><span data-stu-id="d0b22-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="d0b22-110">ÖRNEKLERDEN</span><span class="sxs-lookup"><span data-stu-id="d0b22-110">EXAMPLES</span></span>

### <span data-ttu-id="d0b22-111">Örnek 1: bir Mari</span><span class="sxs-lookup"><span data-stu-id="d0b22-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="d0b22-112">Bu komut, bir MariaDB 'ın altındaki tüm yapılandırmaları listeler.</span><span class="sxs-lookup"><span data-stu-id="d0b22-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="d0b22-113">Örnek 2: MariaDB 'nin yapılandırmasını alma</span><span class="sxs-lookup"><span data-stu-id="d0b22-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="d0b22-114">Bu komut, MariaDB 'nin yapılandırmasını alır.</span><span class="sxs-lookup"><span data-stu-id="d0b22-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="d0b22-115">PARAMETRELERINE</span><span class="sxs-lookup"><span data-stu-id="d0b22-115">PARAMETERS</span></span>

### <span data-ttu-id="d0b22-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="d0b22-116">-DefaultProfile</span></span>
<span data-ttu-id="d0b22-117">Azure ile iletişim için kullanılan kimlik bilgileri, hesap, kiracı ve abonelik.</span><span class="sxs-lookup"><span data-stu-id="d0b22-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="d0b22-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="d0b22-118">-InputObject</span></span>
<span data-ttu-id="d0b22-119">Yapı Için IDENTITY parametresi, ıNPUTOBJECT özellikleri için Notlar bölümüne bakın ve karma tablo oluşturur.</span><span class="sxs-lookup"><span data-stu-id="d0b22-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="d0b22-120">-Ad</span><span class="sxs-lookup"><span data-stu-id="d0b22-120">-Name</span></span>
<span data-ttu-id="d0b22-121">Sunucu yapılandırmasının adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="d0b22-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="d0b22-122">-ResourceGroupName</span></span>
<span data-ttu-id="d0b22-123">Kaynağı içeren kaynak grubunun adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="d0b22-124">Bu değeri Azure Resource Manager API 'dan veya portalınızdan edinebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="d0b22-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="d0b22-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="d0b22-125">-ServerName</span></span>
<span data-ttu-id="d0b22-126">Sunucunun adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-126">The name of the server.</span></span>
...
### <span data-ttu-id="d0b22-127">-SubscriptionID</span><span class="sxs-lookup"><span data-stu-id="d0b22-127">-SubscriptionId</span></span>
<span data-ttu-id="d0b22-128">Bir Azure aboneliğini tanımlayan abonelik KIMLIĞI.</span><span class="sxs-lookup"><span data-stu-id="d0b22-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="d0b22-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="d0b22-129">CommonParameters</span></span>
<span data-ttu-id="d0b22-130">Bu cmdlet ortak parametreleri destekler:-Debug,-ErrorAction,-ErrorVariable,-ınformationaction,-ınformationvariable,-OutVariable,-OutBuffer,-Pipelinedeğişken,-verbose,-WarningAction ve-Warningdeğişken.</span><span class="sxs-lookup"><span data-stu-id="d0b22-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="d0b22-131">Daha fazla bilgi için [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)bakın.</span><span class="sxs-lookup"><span data-stu-id="d0b22-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="d0b22-132">GÖLGELENDIRICI</span><span class="sxs-lookup"><span data-stu-id="d0b22-132">INPUTS</span></span>

### <span data-ttu-id="d0b22-133">Microsoft. Azure. PowerShell. cmdlet. MariaDb. modeller. Sanarladbıdentity</span><span class="sxs-lookup"><span data-stu-id="d0b22-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="d0b22-134">ÇıKıŞLAR</span><span class="sxs-lookup"><span data-stu-id="d0b22-134">OUTPUTS</span></span>

### <span data-ttu-id="d0b22-135">Microsoft. Azure. PowerShell. cmdlet. MariaDb. modeller. Api20180601Preview. Iconation</span><span class="sxs-lookup"><span data-stu-id="d0b22-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="d0b22-136">NOTLARıNDA</span><span class="sxs-lookup"><span data-stu-id="d0b22-136">NOTES</span></span>

<span data-ttu-id="d0b22-137">DIĞER adları</span><span class="sxs-lookup"><span data-stu-id="d0b22-137">ALIASES</span></span>

<span data-ttu-id="d0b22-138">KARMAŞıK PARAMETRE ÖZELLIKLERI</span><span class="sxs-lookup"><span data-stu-id="d0b22-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="d0b22-139">Aşağıda açıklanan parametreleri oluşturmak için uygun özellikleri içeren bir karma tablo oluşturun.</span><span class="sxs-lookup"><span data-stu-id="d0b22-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="d0b22-140">Karma tablolar hakkında bilgi için Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="d0b22-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="d0b22-141">INPUTOBJECT <IMariaDbIdentity> : IDENTITY parametresi</span><span class="sxs-lookup"><span data-stu-id="d0b22-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="d0b22-142">`[ConfigurationName <String>]`: Sunucu yapılandırmasının adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="d0b22-143">`[DatabaseName <String>]`: Veritabanının adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="d0b22-144">`[FirewallRuleName <String>]`: Sunucu güvenlik duvarı kuralının adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="d0b22-145">`[Id <String>]`: Kaynak kimliği yolu</span><span class="sxs-lookup"><span data-stu-id="d0b22-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="d0b22-146">`[LocationName <String>]`: Konumun adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="d0b22-147">`[ResourceGroupName <String>]`: Kaynağı içeren kaynak grubunun adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="d0b22-148">Bu değeri Azure Resource Manager API 'dan veya portalınızdan edinebilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="d0b22-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="d0b22-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Güvenlik uyarısı ilkesinin adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="d0b22-150">`[ServerName <String>]`: Sunucunun adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="d0b22-151">`[SubscriptionId <String>]`: Azure aboneliğini tanımlayan abonelik KIMLIĞI.</span><span class="sxs-lookup"><span data-stu-id="d0b22-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="d0b22-152">`[VirtualNetworkRuleName <String>]`: Sanal ağ kuralının adı.</span><span class="sxs-lookup"><span data-stu-id="d0b22-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="d0b22-153">ILGILI BAĞLANTıLAR</span><span class="sxs-lookup"><span data-stu-id="d0b22-153">RELATED LINKS</span></span>
