...
## Tanım
**Get-AzStorageFileServiceProperty** cmdlet 'ı, Azure depolama dosya hizmetleri için hizmet özelliklerini alır.

## ÖRNEKLERDEN

### Örnek 1: belirtilen depolama hesabının Azure depolama dosya Hizmetleri özelliğini alma
```powershell
...
Bu komut, belirtilen depolama hesabının dosya Hizmetleri özelliğini alır.
