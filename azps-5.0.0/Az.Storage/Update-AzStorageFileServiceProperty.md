...
### Fileservicepropertiesresourceıd
```
...
## Tanım
**Update-AzStorageFileServiceProperty** cmdlet 'ı, Azure depolama dosya hizmeti 'nin hizmet özelliklerini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: dosya paylaşımı yazılım silinmesini etkinleştirme
```powershell
...
Bu komut dosya paylaşımı yazılım
...
Depolama hesabı için paylaşım silme bekletme Ilkesini $true olarak ayarlayarak, $false olarak ayarlayarak paylaşım silme bekletme Ilkesini devre dışı bırakın.
...
### -ShareRetentionDays
Paylaşım KayıtSayısı Ilkesi için bekletme günü sayısını ayarlar.
Değer yalnızca paylaşım silme bekletme Ilkesi etkinleştir Ilkesine göre ayarlanmalıdır.
...
### Microsoft. Azure. Commands. Management. Storage. model. PSFileServiceProperties
