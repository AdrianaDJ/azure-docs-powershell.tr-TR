...
### AccountNamePolicyRule (varsayılan)
```
...
## Tanım
**Set-AzStorageAccountManagementPolicy** cmdlet 'i, bir Azure depolama hesabının yönetim ilkesini oluşturur veya değiştirir.

## ÖRNEKLERDEN

### Örnek 1: yönetim ilkesi kural nesneleri olan bir depolama hesabının yönetim ilkesini oluşturun veya güncelleştirin.
```
...
Bu komut önce 2 Yönetim Ilkesi kural nesneleri oluşturur, ardından 2 ManagementPolicy kural nesneleriyle bir depolama hesabının yönetim ilkesini oluşturur veya güncelleştirir.

### Örnek 2: JSON biçim ilkesiyle depolama hesabının yönetim ilkesini oluşturun veya güncelleştirin.
```
...
Bu komut, JSON biçim ilkesiyle depolama hesabının yönetim ilkesini oluşturur veya güncelleştirir.

### Örnek 3: depolama hesabından yönetim ilkesini alın ve sonra bunu başka bir depolama hesabına ayarlayın.
```
...
Bu komut önce bir depolama hesabındaki yönetim ilkesini alır, ardından başka bir depolama hesabına ayarlayın.
...
### -İlke
Ayarlanacak yönetim Ilkesi nesnesi
...
### -Kural
Yönetim Ilkesi kuralları. Nesneye New-AzStorageAccountManagementPolicyRule cmdlet ile erişin.
...
### Microsoft. Azure. Commands. Management. Storage. model. PSManagementPolicy
