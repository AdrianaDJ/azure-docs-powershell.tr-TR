...
## Tanım
**Yeni-Azrmstoragesshare** cmdlet 'ı bir depolama dosya paylaşımını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: depolama hesabı adı ve paylaşım adıyla depolama dosya paylaşımını kaldırma
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

Bu komut, depolama hesabı adı ve paylaşım adıyla bir depolama dosya paylaşımını kaldırır.

### Örnek 2: depolama hesabı nesnesiyle depolama dosya paylaşımını ve paylaşım adını kaldırma
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Bu komut depolama hesabı nesnesiyle depolama dosya paylaşımını ve paylaşım adını kaldırır.

### Örnek 3: ardışık düzen ile depolama hesabındaki tüm depolama dosyası paylaşımlarını kaldırma
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

Bu komut, ardışık düzene sahip bir depolama hesabındaki tüm depolama dosyası paylaşımlarını kaldırır.
