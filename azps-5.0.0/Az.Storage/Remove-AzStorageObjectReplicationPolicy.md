...
## Tanım
**Remove-AzStorageObjectReplicationPolicy** cmdlet 'i, belirtilen nesne çoğaltma ilkesini depolama hesabından kaldırır.

## ÖRNEKLERDEN

### Örnek 1: bir depolama hesabındaki belirli bir PolicyId ile nesne çoğaltma ilkesini kaldırma.
```
Remove-AzStorageObjectReplicationPolicy -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount" -PolicyId $policyId
```

Bu komut, bir depolama hesabındaki belirli bir PolicyId ile nesne çoğaltma ilkesini kaldırır.
...
### -InputObject
Silinecek nesne çoğaltma Ilkesi nesnesi.
