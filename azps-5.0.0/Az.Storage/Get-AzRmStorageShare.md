...
## Tanım
**Get-Azrmstoragesshares** cmdlet 'ı, depolama dosya paylaşımlarını alır veya listeler.

## ÖRNEKLERDEN

### Örnek 1: depolama hesabı adı ve paylaşım adıyla bir depolama dosya paylaşımı alın
```
...
Bu komut, depolama hesabı adı ve paylaşım adıyla bir depolama dosya paylaşımı alır.

### Örnek 2: depolama hesabının tüm depolama dosyası paylaşımlarını listeler
```
...
Bu komut, depolama hesabı adı olan depolama hesabının tüm depolama dosyası paylaşımlarını listeler.
...
### Örnek 4: kullanımdaki paylaşım kullanımıyla bir depolama dosya paylaşımı alın
```
...
Bu komut, depolama hesabı adı ve paylaşım adı olan bir depolama dosya paylaşımını alır ve paylaşım kullanımını bayt olarak ekler.

### Örnek 5: depolama hesabının tüm depolama dosyası paylaşımlarını liste, silinmiş paylaşımları içer
```
...
Bu komut tüm depolama dosya paylaşımlarına, depolama hesabı adı bulunan bir depolama hesabının silinmiş paylaşımlarını içerir.
...
### -GetShareUsage
Paylaşım kullanımını bayt cinsinden almak için bu parametreyi belirtin.
...
### -Includedeleted
Silinmiş paylaşımları içer varsayılan olarak, liste paylaşımları silinmiş paylaşımları içermez
