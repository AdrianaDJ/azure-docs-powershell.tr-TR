...
Copy Destination blob 'undan çalışmalıdır.
...
### Örnek 4: kopyalama durumunu almak için kopyalama ve ardışık düzeni başlatma
```
...
İlk komut "ContosoPlanning2015" blob 'unu "ContosoPlanning2015_copy" olarak başlatır ve destiantion blob nesnesinin çıkışını başlatır. İkinci komut ardışık düzeni, blob kopyalama durumunu almak için, Get-AzStorageBlobCopyState 'i alma. 
