...
### Örnek 1: nesne çoğaltma ilkesini hem hedef hem de kaynak hesaba ayarlayın.
```
...
İlk önce 2 nesne çoğaltma ilkesi kuralı oluşturun ve kuralı hedef hesapla 2 kuralla ayarlayın. Ardından, nesne çoğaltma ilkesini hedef hesaptan kaynak hesaba ayarlayın.
...
### -DestinationAccount
Nesne çoğaltma Ilkesi DestinationAccount.
...
### -InputObject
Belirtilen hesaba ayarlanacak nesne çoğaltma Ilkesi nesnesi.
...
### -PolicyId
Nesne çoğaltma Ilkesi kimliği. GUID veya ' default ' olmalıdır.
PolicyId 'nin girişi yoksa, yeni ilke oluşturmak ve oluşturulan ilkede yeni ilkenin kimliği geri döndürülürsünüz.
...
### -Kural
Nesne çoğaltma Ilkesi kuralları.
...
### -SourceAccount
Nesne çoğaltma Ilkesi SourceAccount.
