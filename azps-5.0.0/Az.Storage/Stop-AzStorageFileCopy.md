...
## Tanım
**Stop-AzStorageFileCopy** cmdlet 'i bir dosyayı hedef dosyaya kopyalamayı durdurur.

## ÖRNEKLERDEN

### Örnek 1: kopyalama işlemini durdurma
```
PS C:\>Stop-AzStorageFileCopy -ShareName "ContosoShare" -FilePath "FilePath" -CopyId "CopyId"
```

Bu komut, belirtilen ada sahip bir dosyayı kopyalamayı durdurur.
...
### -Copyıd
Kopyalama işleminin KIMLIĞINI belirtir.
