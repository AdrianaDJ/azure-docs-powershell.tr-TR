...
## Tanım
**Stop-AzHpcCache** cmdlet 'ı BIR Azure HPC önbelleğini durdurur.
...
### -Force
Cmdlet 'in sizden onay istemez olmadığını gösterir. Varsayılan olarak, bu cmdlet önbelleğin durmasını istediğinizi onaylamanızı ister.
...
### -ResourceGroupName
Önbelleğini durdurmak istediğiniz kaynak grubunun adı.
