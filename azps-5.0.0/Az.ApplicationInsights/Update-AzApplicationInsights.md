...
### Örnek 1 Application Insights bileşenini Güncelleştir
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

Application Insights bileşenini "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery ile birlikte "Disabled" olarak güncelleyin
...
Uygulama öngörülerini uygulamaya erişmek için ağ erişim türü.
Değer ' Enabled ' veya ' Disabled ' olmalıdır
...
Application Insights sorgusuna erişmek için ağ erişim türü.
Değer ' Enabled ' veya ' Disabled ' olmalıdır
