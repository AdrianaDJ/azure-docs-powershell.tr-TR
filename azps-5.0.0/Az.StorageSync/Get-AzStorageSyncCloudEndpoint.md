...
## Tanım
Bu komut, verilen eşitleme grubundaki tüm bulut uç noktalarını listeler. Her bulut uç noktasının özniteliklerini de listelemek için kullanılabilir.
...
Bu komut, belirtilen eşitleme grubundaki tüm bulut uç noktalarını alır. Belirli bir tane döndürmek için-Cloudenvseçpointname belirtin.
