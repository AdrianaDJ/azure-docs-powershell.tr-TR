...
## Tanım
Bu komut bir Azure dosya eşitlemesi bulut uç noktası oluşturur. Bulut uç noktası, var olan bir Azure dosya paylaşımına başvurudur. Dosya paylaşımını temsil eder ve eşitleme grubunun tüm dosyalar bölümünü eşitlemeye katılımınızı tanımlar; bulut uç noktası oluşturulmuştur.
...
Bulut uç noktası, eşitleme grubunun integral bir üyesidir; bu, "mySyncGroupName" adlı mevcut bir eşitleme grubunun içinde bir örnek oluşturur.
...
### -AzureFileShareName
Depolama hesabı paylaşımı adı (Azure dosya paylaşımı adı)
...
### -Ad
Bulut uç noktasının adı. Azure portalı aracılığıyla oluşturulduğunda, ad, başvurduğu Azure dosyasının adına ayarlanır.
...
### -Storageaccounttenantıd
Depolama hesabı Kiracı kimliği (Şirket dizin kimliği)
...
### Microsoft. Azure. Commands. Storagesehd. modeller. PSCloudEndpoint
