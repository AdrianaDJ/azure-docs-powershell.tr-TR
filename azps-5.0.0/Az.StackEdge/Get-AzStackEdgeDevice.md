...
## Tanım
**Get-AzStackEdgeDevice** cmdlet 'ı kullanılabilir yığın uç aygıtlarıyla ilgili bilgileri alır. Belirli bir cihazda bilgileri almak için kaynak grubu adıyla birlikte aygıtın adını belirtebilirsiniz. 
...
### -Uyarı
Yığındaki uç/ağ geçidi cihazında uyarıları getirme
...
### -Extendeınfo
Belirtilen yığın kenarı/yığın ağ geçidi cihazı için ek bilgi alır
...
### -NetworkSetting
Belirtilen yığın kenarı/yığını ağ geçidi aygıtının ağ ayarlarını alır
