...
## Tanım
**Get-AzStackEdgeUser** cmdlet 'ı yığın uç aygıtı için yapılandırılmış kullanıcıları listeler. Belirli bir kullanıcının ayrıntılarını almak için parametrelerde adın bahsetmeye başlayabilirsiniz.
