...
## Tanım
**Get-Azstackedgesshares** cmdlet 'ı, yığın uç aygıtının kullanılabilir paylaşımlarını alır. Ad sağlanmışsa, paylaşım adına göre paylaşım alır.
...
### Microsoft. Azure. PowerShell. cmdlet. yığın
