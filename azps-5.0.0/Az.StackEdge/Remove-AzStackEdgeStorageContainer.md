...
## Tanım
**Remove-AzStackEdgeStorageContainer** cmdlet 'ı, yığın uç cihazında Edge depolama hesabı için ilişkili bir depolama kapsayıcısını kaldırır. Parametre olarak kaldırılacak depolama kapsayıcısının adını belirtebilirsiniz.
