...
## Tanım
**Remove-AzDataBoxJob** cmdlet 'i, veri kutusu işleri listesinden tamamlanmış bir veri kutusu işini silmek için kullanılır.
...
Belirtilen databox işini siler
...
Belirtilen veri kutusu işini onaysız olarak silme
