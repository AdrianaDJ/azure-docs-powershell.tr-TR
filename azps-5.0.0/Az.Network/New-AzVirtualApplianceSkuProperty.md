...
## SYNOPSIS
Kaynak için bir ağ sanal gereç SKU 'su tanımlayın.
...
## Tanım
New-AzVirtualApplianceSkuProperties komutu, ağ sanal gereç kaynağı için bir SKU tanımlar.
...
New-AzNetworkVirtualAppliance komutuyla kullanılacak sanal bir gereç özellik nesnesi oluşturun. 

## PARAMETRELERINE

### -Paketleme
Paketlenmiş ölçeklendirme birimi.
