...
### Örnek 1: ExpressRoute devresini alma
```
...
"Testrg" adlı özel bir ExpressRoute devresini ve ResourceGroupName "test"

### Örnek 2: filtreleme kullanarak ExpressRoute devrelerini listeleme
```
...
Adı "test" ile başlayan tüm ExpressRoute devrelerini edinin.
