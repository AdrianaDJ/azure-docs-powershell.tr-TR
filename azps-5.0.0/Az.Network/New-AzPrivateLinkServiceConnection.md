...
## Tanım
**Yeni-AzPrivateLinkServiceConnection** cmdlet 'i özel bağlantı hizmeti bağlantı yapılandırması oluşturur.
...
Bu örnek, Özel uç nokta oluştururken kullanmak üzere bellekte özel bir bağlantı hizmeti bağlantı nesnesi oluşturur.

### Örnek 2

Özel bağlantı hizmeti bağlantı yapılandırması oluşturur. oluşturulmuş
...
### -Privatelinkserviceıd
Özel bağlantı hizmeti kimliği.
