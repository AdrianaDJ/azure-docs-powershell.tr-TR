...
## Tanım
**Yeni-AzApplicationGatewayFirewallPolicySetting** , güvenlik duvarı ilkesi için ilke ayarları oluşturur.
...
Bu komut, MaxRequestBodySizeInKb olarak mod, $enabledMode olarak mod, RequestBodyCheck, FileUploadLimitInMb 'yi $fileUploadLimitInMb ve as $ $maxRequestBodySizeInKb $enabledState ile bir ilke ayarı oluşturur.
Yeni policySettings $condition depolanır.
...
Güvenlik Duvarı ilkesinin ilke ayarlarında requestBodyCheck Diables.
...
### -MaxFileUploadInMb
MB cinsinden en büyük fileUpload boyutu.
...
### Durumlu
Güvenlik Duvarı ilkesinin ilke ayarlarındaki durum değişkeni.
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayFirewallPolicySettings
