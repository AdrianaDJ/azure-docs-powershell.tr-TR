...
ExpressRouteGateway Set-AzExpressRouteGateway
...
Yukarıdaki, Azure 'daki "testRG" kaynak grubunda bir kaynak grubu, sanal WAN, sanal ağ, Batı ABD 'deki sanal hub 'ı oluşturur. Daha sonra 3 ölçek birimi ile değiştirilecek şekilde sanal hub 'da bir ExpressRoute ağ geçidi oluşturulur
...
### -ResourceGroupName
Güncelleştirilecek ExpressRouteGateway 'in kaynak grubu adı.
