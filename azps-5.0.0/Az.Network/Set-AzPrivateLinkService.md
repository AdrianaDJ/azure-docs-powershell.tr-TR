...
## Tanım
**Set-AzPrivateLinkService** cmdlet 'i özel bir bağlantı hizmetini güncelleştirir.

## ÖRNEKLERDEN

### 1: özel bir bağlantı hizmeti oluşturur ve
```
...
Bu örnek, mypls. Ardından onun IP yapılandırmalarını bellek içi ıpconfiguratiuon nesnesinden değiştirin. Ardından, hizmet tarafında değiştirilmiş özel bağlantı hizmeti durumunu yazmak için Set-AzPrivateLinkService cmdlet 'i kullanılır. 
...
### -PrivateLinkService
Özel bağlantı hizmetinin ayarlanması gereken durumu temsil eden bir özel bağlantı hizmeti nesnesi belirtir.
