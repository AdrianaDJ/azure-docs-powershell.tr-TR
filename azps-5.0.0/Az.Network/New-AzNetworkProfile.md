...
## Tanım
**New-AzNetworkProfile** cmdlet 'i, yeni bir ağ profili üst düzey kaynağı oluşturur.
...
Bu, yeni bir ağ profili üst düzey kaynağı oluşturur

### Örnek 2

Yeni ağ profili oluşturur. oluşturulmuş
...
### -ContainerNicConfig
Bu ağ profiline eklenecek kapsayıcı ağ arabirimi yapılandırmaları.
