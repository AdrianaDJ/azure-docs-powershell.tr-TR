...
## Tanım
New-AzTrafficSelectorPolicy cmdlet 'i sanal ağ geçidi bağlantısında kullanılacak bir trafik Seçicisi ilke teklifi oluşturur.
...
Bir Ikev2 protokolüyle sanal ağ geçidi oluştururken, bir akış seçici ilkesinin bir örneğini oluşturur ve bunu parametre olarak ekler.
...
### -LocalAddressRange
CıDR adres aralıkları koleksiyonu
