...
Yukarıdaki, Azure 'daki "testRG" kaynak grubunda, Batı merkezi 'nde ABD Merkezi Daha sonra 2 ölçekli birim içeren sanal hub 'da bir ExpressRoute ağ geçidi oluşturulur.

Ardından, The resourceGroupName ve ağ geçidi adını kullanarak ExpressRouteGateway 'i alır.
...
Bu komut, "test" ile başlayan tüm Expressroutegeçitleri alır
