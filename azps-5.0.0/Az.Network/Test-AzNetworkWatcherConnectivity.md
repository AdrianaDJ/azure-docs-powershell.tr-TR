...
## Tanım
Test-AzNetworkWatcherConnectivity cmdlet 'i, belirli bir kaynak VM ve bir hedefin bağlantı bilgilerini döndürür. Kaynak ile hedef arasındaki bağlantı kurulamazsa, cmdlet sorun hakkında ayrıntılı bilgi verir.

## ÖRNEKLERDEN

### Örnek 1: VM 'den Web sitesine ağ Izleyicisi bağlantısını sınama
```powershell
...
Belirtilen kaynak VM ve bir hedefin bağlantı bilgilerini döndürür. oluşturulmuş
...
Denetim bağlantısının gerçekleştirileceği iletişim kuralı yapılandırması.
