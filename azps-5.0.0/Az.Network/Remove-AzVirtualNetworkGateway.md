...
### Örnek 1: sanal ağ geçidini silme
```powershell
Remove-AzVirtualNetworkGateway -Name myGateway -ResourceGroupName myRG
```

Sanal ağ geçidinin, "myRG" kaynak grubundaki "myGateway" adıyla olan nesnesini siler. öncelikle **Remove-AzVirtualNetworkGatewayConnection** cmdlet 'Ini kullanarak sanal ağ ağ geçitindeki tüm bağlantıları silmelisiniz.
...
### -Ad
Bu cmdlet 'in kaldırdığı sanal ağ geçidinin adını belirtir.
...
### -ResourceGroupName
Sanal ağ geçidini içeren kaynak grubunun adını belirtir.
