...
## SYNOPSIS
VPN bağlantısındaki paket yakalama Işlemini durdurur
...
## Tanım
VPN bağlantısındaki paket yakalama Işlemini durdurur ve depolama kapsayıcısının verilen SasUrl 'sindeki sonucu karşıya yükler.
...
### -InputObject
Paket yakalama 'nın başlatılması için kullanılacak VPN bağlantısı nesnesi.
...
### -Ad
Paket yakalama 'nın başlatılması gerektiği VPN bağlantısı adı.
...
### -RESOURCEID
Paket yakalama 'nın başlatılması için VpnConnection 'un Azure Kaynak KIMLIĞI.
...
### -SasUrl
VPN 'de paket yakalamayı durdurma için SAS URL 'Si.
...
### Microsoft. Azure. Commands. Network. modeller. PSVpnPacketCaptureResult

## NOTLARıNDA

## ILGILI BAĞLANTıLAR

[Başlangıç-AzVpnConnectionPacketCapture](./Start-AzVpnConnectionPacketCapture.md)