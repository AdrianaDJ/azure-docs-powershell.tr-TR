...
## Tanım
**Set-AzPrivateDnsZoneGroup** CMDLET 'i DNS bölge grubunu güncelleştirir.
...
Yukarıdaki örnekte, dnsgroup1 adlı DNS bölgesi, başka bir DNS bölgesine bağlanan yeni bir dnsconfig ile güncelleştirilir.
