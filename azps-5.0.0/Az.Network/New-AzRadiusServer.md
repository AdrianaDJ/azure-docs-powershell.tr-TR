...
## Tanım
New-AzRadiusServer cmdlet 'i sanal ağ geçidi ve VPN sunucusu yapılandırmasında kullanılacak bir dış RADIUS sunucu yapılandırması oluşturur.
...
Yeni sanal ağ geçidinde P2S yapılandırmak için kullanılacak birden çok dış RADIUS sunucusu yapılandırması oluşturma.
...
### Microsoft. Azure. Commands. Network. model. PSRadiusServer
