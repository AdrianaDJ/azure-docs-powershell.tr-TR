...
## Tanım
**Add-AzApplicationGatewayTrustedRootCertificate** cmdlet 'ı bir Azure uygulama ağ geçidine güvenilen kök sertifikası ekler.
...
İkinci komut, kök sertifikanın giriş yolunu gösteren uygulama ağ geçidi 'ne yeni bir güvenilen kök sertifika ekler.
...
Dördüncü komut, uygulama ağ geçidini güncelleştirir.
