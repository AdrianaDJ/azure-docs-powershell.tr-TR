...
## Tanım
**Get-AzExpressRouteCrossConnectionRouteTableSummary** cmdlet 'i, belirli bir YÖNLENDIRME bağlamının BGP komşu bilgilerinin özetini alır. Bu bilgiler, yönlendirme bağlamının ne kadar sürdüğünü ve eşleme yönlendiricisi tarafından tanıtılan yol öneklerinin sayısını belirlemek için kullanışlıdır.
...
### Microsoft. Azure. Commands. Network. model. Psexpressroutecrossconnectionkabatestablesummary
