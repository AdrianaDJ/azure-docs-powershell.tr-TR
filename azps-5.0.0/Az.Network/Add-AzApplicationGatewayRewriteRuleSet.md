...
## Tanım
**Add-AzApplicationGatewayRewriteRuleSet** cmdlet 'i, uygulama ağ geçidine yeniden yazma kuralı ekler.
...
İkinci komut, yeniden yazma kuralı 'nı uygulama ağ geçidine ekler.
