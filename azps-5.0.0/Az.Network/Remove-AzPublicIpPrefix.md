...
## Tanım
**Remove-Azpublicıpprefix** cmdlet 'i, kendisinden herhangi BIR genel IP adresi olmadığı sürece bir Azure genel IP önekini kaldırır.
...
$prefixName $rgName kaynak grubundan ortak IP önekini kaldırır
...
### -RESOURCEID
Kaldırılacak kaynağın RESOURCEID
