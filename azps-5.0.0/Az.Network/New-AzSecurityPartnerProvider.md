...
## Tanım
**Yeni-AzSecurityPartnerProvider** cmdlet 'ı bir Azure securitypartnerprovider oluşturur
...
### -VirtualHub
Güvenlik ortağı sağlayıcısının bağlı olduğu sanal hub kimliği
