...
## SYNOPSIS
VirtualHub ile ilişkili bir hub yol tablosu kaynağını silme.

## INDEKI

### ByVHubRouteTableName (varsayılan)
```powershell
...
## Tanım
Belirtilen sanal hub ile ilişkili belirtilen hub yol tablosunu siler.
...
Bu komut sanal hub 'ın hub yol tablosunu siler.
...
### -InputObject
Kaldırılacak vhubroutetable kaynağı.
...
### -RESOURCEID
Kaldırılacak vhubroutetable kaynağının kaynak kimliği.
