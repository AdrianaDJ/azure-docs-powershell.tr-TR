...
## Tanım
New-AzNetworkWatcherConnectionMonitorTestGroupObject cmdlet 'i bir bağlantı İzleyicisi test grubu oluşturur.

## ÖRNEKLERDEN

### Örnek 1:2 testConfigurations, w Source ve 2 varış uç noktası içeren bir test grubu oluşturma
...
### -Devre dışı bırak
Test grubunun devre dışı bırakılıp bırakılmadığını belirten bayrak.
...
### Microsoft. Azure. Commands. Network. modeller. PSNetworkWatcherConnectionMonitorTestGroupObject
