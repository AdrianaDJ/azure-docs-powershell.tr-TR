...
## Tanım
**Add-AzApplicationGatewayAuthenticationCertificate** cmdlet 'ı bir Azure uygulama ağ geçidine kimlik doğrulama sertifikası ekler.

## ÖRNEKLERDEN

### Örnek 1: uygulama ağ geçidine kimlik doğrulama sertifikası ekleme
```
...
İkinci komut cert01 adlı kimlik doğrulama sertifikasını uygulama ağ geçidine ekler.
Üçüncü komut, uygulama ağ geçidini güncelleştirir.

## PARAMETRELERINE

### -ApplicationGateway
Bu cmdlet 'in kimlik doğrulama sertifikası eklediği uygulama ağ geçidi adını belirtir.
...
### -CertificateFile
Bu cmdlet 'in eklediği kimlik doğrulama sertifikasının yolunu belirtir.
...
### -Ad
Bu cmdlet 'in uygulama ağ geçidine eklediği sertifikanın adını belirtir.
