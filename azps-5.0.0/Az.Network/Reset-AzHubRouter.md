...
## SYNOPSIS
VirtualHub kaynağının RoutingState durumunu sıfırlar.
...
## Tanım
Yalnızca sanal hub 'ın yönlendirme durumu sağlanmadıysa, var olan VirtualHub kaynağının yönlendirme durumunu sıfırlar.
...
Sanal hub 'ın yönlendirme durumunu, ResourceGroupName ve ResourceName kullanarak sıfırlayın.
...
Sanal hub 'ın RESOURCEID 'sini kullanarak yönlendirme durumunu sıfırlayın.
...
Bir giriş nesnesi kullanarak sanal hub 'ın yönlendirme durumunu sıfırlayın. Giriş nesnesi PSVirtualHub türünde.
...
Var olan bir sanal hub nesnesinin alınıp sıfırlanması için giriş nesnesi olarak sıfırlanması gerekebilir.
