...
### ByVirtualHubNameByVpnServerConfigurationObject (varsayılan)
```
...
### Byvirtualhubnamebyvpnserverconfigurationresourceıd
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### Byvirtualhubobjectbyvpnserverconfigurationresourceıd
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### Byvirtualhubresourceıdbyvpnserverconfigurationnesnesi
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
### Byvirtualhubresourceıdbyvpnserverconfigurationresourceıd
```
New-AzP2sVpnGateway -ResourceGroupName <String> -Name <String> -VpnGatewayScaleUnit <UInt32>
...
## Tanım
**New-AzP2sVpnGateway** cmdlet 'i, site Istemcilerinden Azure virtualwan 'a noktadan site bağlanabilirliğinin üzerine gelmek Için virtualhub 'ın altında yeni bir P2SVpnGateway oluşturmanıza imkan verir.
...
**New-AzP2sVpnGateway** cmdlet 'i, site bağlantısının üzerine gelmek Için virtualhub altında yeni bir P2SVpnGateway oluşturmanıza imkan verir.
...
### -VirtualHub
Bu P2SVpnGateway 'in ilişkilendirildiği VirtualHub.
...
### -Virtualhubıd
Bu P2SVpnGateway ile ilişkilendirilmesi gerektiği VirtualHub kimliği.
