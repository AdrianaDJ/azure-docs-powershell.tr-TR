...
## SYNOPSIS
Sanal bir gereç sitesini ağ sanal bir gereç kaynağından kaldırma.
...
## Tanım
Remove-AzVirtualApplianceSite komutu sanal bir gereç sitesini ağ sanal bir gereç kaynağından kaldırır.
...
Sanal bir gereç sitesi kaynağını silme. 
...
Bu siteyle ilişkilendirilmiş ağ sanal aygıtının kaynak KIMLIĞI.
