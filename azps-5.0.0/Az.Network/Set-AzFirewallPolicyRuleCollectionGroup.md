...
## Tanım
**Set-AzFirewallPolicyRuleCollectionGroup** cmdlet 'i, bir Azure Güvenlik duvarı ilkesinde bir kural koleksiyonu gruplarını güncelleştirir.
...
Bu örnekte, güvenlik duvarı ilkesinde bir kural koleksiyonu grubu güncelleştirilir $fp

### Örnek 2

değiştirilmiş bir Azure Güvenlik duvarı ilkesi kuralı koleksiyon grubunu kaydeder. oluşturulmuş
...
### -RuleCollection
Kural koleksiyonlarının listesi
