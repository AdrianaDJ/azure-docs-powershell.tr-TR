...
## Tanım
Tüm bağlanılan VPN istemcisi bağlantı durumunu listeleyin. Bu da dahildir: Vpnconnectionıd vpnConnectionDuration vpnConnectionTime Publicıpaddress Privateıpaddress, Kullanıcı adı ço, testransferred Spacketlersbytestransferred maxPacketsPerSecond
...
Kaynak grubu resourceGroup içinde GatewayName adlı Azure sanal ağ geçidi için, OpenVpn kullanarak bağlı olan VPN istemcisi bağlantısını alır. 

### Örnek 2

VPN istemci bağlantısı için bir Azure sanal ağ ağ geçidinin VPN istemcisi bağlantı durumu listesini alın. oluşturulmuş
...
```
### -RESOURCEID
Sanal ağ geçidi kaynak kimliği
