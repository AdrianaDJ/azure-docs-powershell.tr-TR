...
## SYNOPSIS
Belirli bir sanal yönlendirici eşi tarafından tanıtılan yolların listesi

## INDEKI

### VirtualRouterPeerNameParameterSet (varsayılan)
```
...
## Tanım
Ada veya nesneye göre sanal yönlendirici eşi verildiğinde, belirli bir sanal yönlendirici tarafından bu eşe tanıtılan yolları numaralandırır.
...
### -ResourceGroupName
Sanal yönlendirici eşi kaynak grubu adı
...
### Microsoft. Azure. Commands. Network. modeller. PSPeerRoute
