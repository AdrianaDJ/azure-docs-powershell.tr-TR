...
## Tanım
**Set-AzApplicationGatewayRequestRoutingRule** cmdlet 'i yeniden yönlendirme yapılandırmasını değiştirir.
...
Varolan bir uygulama ağ geçidinde yeniden yönlendirme yapılandırmasını ayarlar. oluşturulmuş
