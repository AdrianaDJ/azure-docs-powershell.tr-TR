...
### Örnek 2:2. Threatıntel moduyla boş bir ilke oluşturma
```powershell
...
### Örnek 3:3. Threatıntel Whitelist ile boş bir ilke oluşturma
```powershell
...
Bu örnek, tehdit Intel Whitelist ile Azure Güvenlik duvarı ilkesi oluşturur
