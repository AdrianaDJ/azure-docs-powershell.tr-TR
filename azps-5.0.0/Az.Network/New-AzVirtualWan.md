...
## Tanım
Yeni bir Azure VirtualWAN kaynağı oluşturur.
...
Yukarıdaki "Batı ABD" adresindeki "testRG" adlı bir kaynak grubu ve Azure 'daki bu kaynak grubunda şubeye dallanan bir Azure sanal WAN 'si oluşturulur.
