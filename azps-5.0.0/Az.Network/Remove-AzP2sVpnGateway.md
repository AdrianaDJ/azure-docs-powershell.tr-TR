...
## Tanım
**Remove-AzP2sVpnGateway** cmdlet 'ı virtualhub altındaki mevcut bir P2SVpnGateway kaldırmanıza imkan verir. P2SVpnGateway kaldırıldıktan sonra tüm site istemcileri için bağlantı başarısız olur.
...
**Remove-AzP2sVpnGateway** cmdlet 'ı virtualhub altındaki mevcut bir P2SVpnGateway kaldırmanıza imkan verir.
...
### -InputObject
Silinecek p2sVpnGateway nesnesi.
...
### -RESOURCEID
Silinecek p2sVpnGateway için Azure Resource ID.
