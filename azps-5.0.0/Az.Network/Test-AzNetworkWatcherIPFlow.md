...
## Tanım
Belirli bir VM kaynağı ve yerel ve uzak, IP adresleri ve bağlantı noktaları kullanılarak belirtilen yöne sahip bir paket için Test-AzNetworkWatcherIPFlow cmdlet, pakete izin verilip verilmediğini döndürür.

## ÖRNEKLERDEN

### Örnek 1: Test-AzNetworkWatcherIPFlow çalışma
```
...
Bu abonelik için Batı merkezi 'ndeki ağ Izleyicisi 'ni alır, ardından VM 'yi ve ilişkili ağ arabirimlerini alır. Ardından ilk ağ arabiriminde, internet 'teki bir IP 'ye giden bağlantı için ilk ağ arabiriminden ilk IP 'yi kullanarak Test-AzNetworkWatcherIPFlow çalışır.
