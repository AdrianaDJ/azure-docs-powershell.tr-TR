...
## SYNOPSIS
VPN ağ geçidinde paket yakalama Işlemini başlatır.
...
### -FilterData
VPN ağ geçidinde start Packet Capture için filtreleme seçenekleri.
...
### -Ad
Paket yakalama 'nın başlatılması gerektiği VPN ağ geçidi adı.
...
[Dur-AzVpnGatewayPacketCapture](./Stop-AzVpnGatewayPacketCapture.md)