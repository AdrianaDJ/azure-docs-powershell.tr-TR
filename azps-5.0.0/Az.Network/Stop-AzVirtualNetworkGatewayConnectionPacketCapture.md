...
## Tanım
Sanal ağ geçidi bağlantısında paket yakalama Işlemini durdurur ve depolama kapsayıcısının verilen SasUrl 'sindeki sonucu karşıya yükler.
...
### -InputObject
Paket yakalama 'nın başlatılması için kullanılacak sanal ağ geçidi bağlantı nesnesi.
...
### -Ad
Paket yakalama 'nın başlatılması gerektiği sanal ağ geçidi bağlantı adı.
...
### -RESOURCEID
Paket yakalama 'nın başlatılması için VirtualNetworkGatewayConnection 'un Azure Resource ID 'si.
...
### -SasUrl
Sanal ağ geçidinde paket yakalamayı durdurma için SAS URL 'Si.
