...
## Tanım
**Set-AzLoadBalancerProbeConfig** cmdlet 'i bir yük dengeleyicinin yoklama yapılandırmasını güncelleştirir.
...
İkinci komut, yük dengeleyiciyi bir şekilde geçirmek için $slb ' a yeni bir yoklama yapılandırması ekleyen-Azloadbalancerloadbalancerconfig öğesini kullanır.
Üçüncü komut, yük dengeleyici **Ayarla-AzLoadBalancerProbeConfig** 'e geçirir ve yeni yapılandırmayı ayarlar.
...
Bu cmdlet, bu parametrenin belirttiği yük dengeleyicinin yoklama yapılandırmasını güncelleştirir.
