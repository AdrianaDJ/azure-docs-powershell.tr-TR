...
## SYNOPSIS
Ağ sanal bir gereç kaynağına bağlı sanal bir gereç sitesini değiştirme veya değiştirme.
...
## Tanım
Update-AzVirtualApplianceSite komutu sanal bir gereç sitesi kaynağını değiştirir.
...
Sanal bir gereç sitesi kaynağının adres önekini değiştirin.
...
Bu sitenin bağlı olduğu ağ sanal uygulaması.
