...
## Tanım
**Get-AzVpnServerConfiguration** cmdlet 'i site bağlantısı noktası için var olan vpnserverconfiguration 'ı döndürür.
...
Yukarıdaki komut, var olan Vpnserveryapılandırmasını alır.
