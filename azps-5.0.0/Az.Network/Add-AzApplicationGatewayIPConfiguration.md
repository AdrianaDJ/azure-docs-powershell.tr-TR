...
İlk komut sanal bir ağ alır.
İkinci komut, önceden oluşturulmuş sanal ağı kullanan bir alt ağ alır.
Üçüncü komut, uygulama ağ geçidini alır ve $AppGw değişkeninde depolar.
Dördüncü komut, $AppGw depolanan uygulama ağ geçidine IP yapılandırmasını ekler.
