...
## Tanım
**Bağlantı kesilemedi-AzP2sVpnGatewayVpnConnection** cmdlet 'i P2SVpnGateway 'tan gelen geçerli noktadan siteye bağlantıyı kesemenizi mümkün kılar.
...
### -RESOURCEID
P2s sanal ağ geçidi kaynak kimliği
