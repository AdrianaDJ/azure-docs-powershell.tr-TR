...
## Tanım
**Get-AzPrivateEndpoint** cmdlet 'i bir veya daha çok özel uç nokta alır.

## ÖRNEKLERDEN

### Örnek 1: özel uç noktayı alma
```powershell
...
Bu komut TestResourceGroup kaynak grubundaki MyPrivateEndpoint1 adındaki özel uç noktasını alır

### Örnek 2: ResourceGroup
```powershell
...
Bu komut TestResourceGroup kaynak grubundaki tüm özel bitiş noktalarını alır
