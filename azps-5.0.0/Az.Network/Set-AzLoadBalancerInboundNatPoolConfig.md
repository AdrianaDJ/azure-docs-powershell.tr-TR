...
## Tanım
**Set-AzLoadBalancerInboundNatPoolConfig** cmdlet 'i, bir yük DENGELEYICININ gelen NAT havuzu yapılandırmasını ayarlar.
...
### -Enabsolloatingip
SQL AlwaysOn kullanılabilirlik grubunu yapılandırmak için gereken kayan IP yeteneği için sanal makinenin uç noktasını yapılandırır. SQL Server 'da SQL AlwaysOn kullanılabilirlik grupları kullanılırken bu ayar gereklidir. Uç noktayı oluşturduktan sonra bu ayar değiştirilemez.
...
### -Idfaizzamansayısı
TCP boştaki bağlantı için zaman aşımı. Değer 4 ile 30 dakika arasında ayarlanabilir. Varsayılan değer 4 dakikadır. Bu öğe yalnızca protokol TCP olarak ayarlandığında kullanılır.
