...
### Örnek 1: verieşleri için VNET eşlemesi oluşturma
```powershell
...
Bu komut, verieşleri için VNET eşlemesi oluşturur.

## PARAMETRELERINE

### -AllowForwardedTraffic
Yerel sanal ağdaki VM 'Ler 'den iletilen trafiğin uzak sanal ağda izin verilip verilmeyeceğini denetler.
...
### -AllowGatewayTransit
Bu sanal ağa bağlanmak için uzak sanal ağda ağ geçidi bağlantıları kullanılabilir.
...
Yerel sanal ağ alanındaki VM 'Lerin uzak sanal ağ alanındaki VM 'Lere erişip erişemeyeceğini.
...
CıDR gösteriminde bu sanal ağa ayrılan adres bloklarının listesi.
...
### -Veriricksvirtualnetworkıd
Veriricks sanal ağının kimliği.
...
### -Ad
Çalışma alanı vNet eşlemesi adı.
...
### -UseRemoteGateway
Bu sanal ağda uzak ağ geçitleri kullanılabilir.
