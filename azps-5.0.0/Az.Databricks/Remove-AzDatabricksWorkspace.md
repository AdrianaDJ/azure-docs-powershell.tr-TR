...
### Örnek 1: Veriricks çalışma alanını kaldırma
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Bu komut, kaynak grubundan Veriricks çalışma alanını kaldırır.

### Örnek 2: nesneleri nesne bazında Veriricleri kaldırma
```powershell
