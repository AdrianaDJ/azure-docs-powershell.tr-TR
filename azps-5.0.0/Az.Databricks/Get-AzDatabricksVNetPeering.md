...
### Örnek 1: bir verieşleri altındaki tüm VNET eşliğini listeler
```powershell
...
Bu komut, bir verieşleri altındaki tüm VNET eşliğini listeler.

### Örnek 2: VNET eşlemesi alma
```powershell
...
Bu komut VNET eşlemesi alır.

### Örnek 3: nesneye göre VNET eşlemesi alma
```powershell
...
Bu komut, nesneden bir VNET eşlemesi alır.
