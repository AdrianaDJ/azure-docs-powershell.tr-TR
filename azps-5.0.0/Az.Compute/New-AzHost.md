...
Bu komut, verilen konak grubunda ve verilen konumda verilen SKU 'nun bir konağını oluşturur.
...
### -Autoreplacenfailure
Bir başarısızlık durumunda konağın otomatik olarak değiştirilip değiştirilmeyeceğini belirtir. Değer sağlanmadıysa ' true ' olarak ayarlanır.
...
### -LicenseType
Konakta dağıtılan VM 'lere uygulanacak yazılım lisansı türünü belirtir. Olası değerler: None, Windows_Server_Hybrid ve Windows_Server_Perpetual.  Varsayılan değer yok 'Tur.
...
### -PlatformFaultDomain
Konağın platform hatası etki alanı sayısını belirtir.  En küçük değer 0 ve en büyük değer 2 ' dir.
...
### Microsoft. Azure. Commands. COMPUTE. Automation. modeller. PSHost
