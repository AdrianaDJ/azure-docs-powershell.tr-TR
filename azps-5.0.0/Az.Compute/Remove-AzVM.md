...
## Tanım
**Remove-AzVM** cmdlet 'i Azure 'dan bir sanal makineyi kaldırır.
...
Bu komut, kaynak grubundaki VirtualMachine07 adındaki sanal makineyi kaldırır ResourceGroup11.
