...
## Tanım
**Set-AzVmssVM** cmdlet 'ı sanal makine ölçeği KÜMESI (VMSS) örneğinin durumunu değiştirir.

## ÖRNEKLERDEN

### Örnek 1

Bir VMSS örneğinin durumunu değiştirir. oluşturulmuş
...
### -SimulateEviction
Bu cmdlet 'in, VM Ölçek kümesinde spot sanal makinenin çıkarmasına benzediğini belirtir.
Çıkarma işlemi, API 'YI çağırırken 30 dakika içinde olacaktır.
