...
## Tanım
**Set-AzVmss** cmdlet 'ı sanal makine ölçek kümesinde belirli eylemleri ayarlar (VMSS).
...
Belirtilen bir VMSS 'de belirli eylemleri ayarlar. oluşturulmuş
...
### -PerformMaintenance
Bu cmdlet 'in VMSS 'de bir veya birden çok sanal makine olduğunu gösterir.
...
### -Yeniden dağıtma
Cmdlet 'in VMSS 'de bir veya daha fazla sanal makineyi geri dağıttığını gösterir.
...
### -TempDisk
Geçici diske yeniden görüntü uygulanıp gösterilmeyeceğini belirtir.
