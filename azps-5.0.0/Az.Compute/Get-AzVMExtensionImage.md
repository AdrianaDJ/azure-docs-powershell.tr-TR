...
## Tanım
**Get-Azvmextensionımage** cmdlet 'ı bir Azure uzantısı için tüm sürümleri alır.
...
### Örnek 2: sürüm üzerinde filtre uygulama
```
...
Bu komut, 12 ile başlayan belirtilen konum, yayıncı, tür ve sürüm için uzantı görüntüsünün tüm sürümlerini alır.

### Örnek 3: sürüm üzerinde filtre uygulama
```
...
Bu komut, belirtilen konum, yayıncı, tür ve sürüm için uzantı resminin tüm sürümlerini alır.
...
Uzantı türü edinmek için Get-AzVMExtensionImageType cmdlet 'ini kullanın.
