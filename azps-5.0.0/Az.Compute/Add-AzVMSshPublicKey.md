...
## Tanım
**Add-AzVMSshPublicKey** cmdlet 'ı, güvenli kabuk (SSH) üzerinden Linux sanal makinesine bağlanmak için kullanabileceğiniz ortak anahtarları ekler. Bu, VM oluşturulduktan sonra, VM oluşturulduktan sonra Update-AzVM olmadan bu komutu kullanmaya çalışırsanız, hata olmaz, komutu Update-AzVM ile birlikte kullanıyorsanız komut hatası olur.
