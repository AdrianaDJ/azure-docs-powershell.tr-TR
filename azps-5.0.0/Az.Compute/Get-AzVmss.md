...
## Tanım
**Get-AzVmss** cmdlet 'ı sanal makine ölçek kümesinin (VMSS) modelini ve örnek görünümünü alır.
...
### Örnek 2: kaynak grubundaki tüm VMSS 'leri alma
```
...
"Group001" kaynak grubundaki tüm VMSS 'leri alma

### Örnek 3: abonelikteki tüm VMSS 'leri alma
```
PS C:\> Get-AzVmss
...
Tüm VMSS 'leri abonelikle edinin.

### Örnek 4: filtreleme kullanarak tüm VMSS 'leri alma
```
...
"VMSS00" ile başlayan tüm VMSS 'leri edinin.
