...
## Tanım
**Set-AzVmssDiskEncryptionExtension** CMDLET 'i VM ölçeklendirme kümesinde şifrelemeyi olanaklı kılar. Bu cmdlet, VM ölçeklendirme kümesine disk şifrelemesi uzantısını yükleyerek şifrelemeyi mümkün kılar.

Linux sanal makinelerde, *Birimtürü* parametresi olmalıdır ve "veriler" olarak ayarlanmalıdır
...
Bu komut, bir VM Ölçek kümesindeki tüm Windows VM 'Lerde şifrelemeyi mümkün kılar.
...
Bu komut, bir VM Ölçek kümesindeki tüm Linux VM 'lerin veri disklerinde şifrelemeyi mümkün kılar.
...
Linux: **Birimtürü** parametresi bulunmalıdır ve veri olarak ayarlanmalıdır. 

Windows: varsa, **Birimtürü** parametresi Tümü veya işletim sistemine ayarlanmalıdır. **Birimtürü** parametresi atlanırsa, varsayılan olarak "tümü" olur.
