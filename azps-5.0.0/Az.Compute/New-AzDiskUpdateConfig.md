...
### -DiskMBpsReadOnly
Tüm VM 'lerde izin verilen toplam işleme (MBps) paylaşılan diski ReadOnly olarak bağlama. MB/sn, 10 ' un en yüksek bit sayısı olan ISO gösterimini kullanır.
...
### -MaxSharesCount
Diske aynı anda iliştirileceği en fazla VM sayısı. Birden büyük değer aynı anda birden fazla VM 'ye takılacak bir diski belirtir.
...
### -NetworkAccessPolicy
{{Fill NetworkAccessPolicy açıklama}}
