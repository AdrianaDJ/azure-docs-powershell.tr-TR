...
Disk görüntüsü şifrelemesiyle bir galeri görüntü sürümü oluşturun.
...
### -DataDiskImage
Veri diski görüntüleri.   Örneğin @ {Source = @ {ID =<source_id>}; LUN = 1; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -Osdiskımage
İşletim sistemi disk görüntüsü örneğin @ {Source = @ {ID =<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -Sourceımageıd
Görüntü sürümünün oluşturulduğu kaynak görüntünün KIMLIĞI.
...
### -StorageAccountType
Yansımayı depolamak için kullanılacak depolama hesabı türünü belirtir. Bu özellik güncelleştirilmez. Kullanılabilir değerler Standard_LRS, Standard_ZRS ve Premium_LRS.
