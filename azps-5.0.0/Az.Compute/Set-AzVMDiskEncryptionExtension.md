...
## Tanım
**Set-AzVMDiskEncryptionExtension** cmdlet 'i, çalışan bir altyapıda Azure 'da hizmet (IaaS) sanal makinesi olarak şifrelemeyi olanaklı kılar.  Sanal makineye disk şifrelemesi uzantısını yükleyerek şifrelemeyi mümkün kılar. 
...
Linux: Linux sanal makineler şifrelenirken **Volumetype** parametresi gereklidir ve Linux dağılımının desteklediği bir değer ("OS", "Data" veya "All") olarak ayarlanmalıdır. 

Windows: **Volumetype** parametresi atlanabilir; bu durumda işlem tümü için varsayılan olarak; Windows sanal makinesi için Birimtürü parametresi varsa, tümü veya işletim sistemine ayarlanmalıdır.
...
Bu örnek, AD kimlik bilgilerini belirtmeden bir VM 'de şifrelemeyi olanaklı kılar.
...
Bu örnek, AD kimlik bilgilerini belirtmeden bir VM 'de şifrelemeyi etkinleştirmek için ardışık düzen kullanan girişleri kullanarak parametreleri gönderir.
...
Bu örnekte, bir VM 'de şifrelemeyi etkinleştirmek için Azure AD istemci KIMLIĞI ve istemci parolası kullanılır.
...
Bu örnekte, bir VM 'de şifrelemeyi etkinleştirmek için Azure AD istemci KIMLIĞI ve istemci sertifikası parmak izleri kullanılmaktadır.
...
Bu örnekte, bir VM 'de şifrelemeyi etkinleştirmek için Azure AD istemci KIMLIĞI ve istemci parolası kullanılır ve disk şifrelemesi anahtarı anahtar şifreleme anahtarı kullanılarak kaydırılır.
...
Bu örnekte, bir VM 'de şifrelemeyi etkinleştirmek için Azure AD istemci KIMLIĞI ve istemci sertifikası parmak izi kullanılır ve disk şifrelemesi anahtarı anahtar şifreleme anahtarı kullanılarak kaydırılır.
...
### -Ad
Uzantıyı temsil eden Azure Resource Manager kaynağının adını belirtir. *Name* parametresi atlanırsa, yüklü uzantı Windows sanal makinelerinde AzureDiskEncryption olarak adlandırılacaktır ve Linux sanal makinelerinde AzureDiskEncryptionForLinux.
...
### -Birimtürü
Şifreleme işleminin gerçekleştirileceği sanal makine birimlerinin türünü belirtir: işletim sistemi, veri veya tümü. 
