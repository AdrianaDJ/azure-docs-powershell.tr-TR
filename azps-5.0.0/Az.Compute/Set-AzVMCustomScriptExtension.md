...
### ByNameWithContainerAndFileNamesParameterSet (varsayılan)
```
...
### Byresourceıdwithcontainerand Filenamesparameterset
```
...
### Byresourceıdwithfileuriparameterset
```
...
Sanal makineye özel bir komut dosyası uzantısı ekler. oluşturulmuş
...
### -Dosya adı
Komut dosyasının adını belirtir. Dosya Azure Blob depolamada depolanıyorsa, dosya adı büyük/küçük harfe duyarlıdır. Azure dosya depolaması 'nda depolanan dosyaların dosya adları büyük/küçük harfe duyarlı değildir.
...
Sürümü edinmek için, Get-AzVMExtensionImage cmdlet 'i, *tür* parametresine yönelik *PublisherName* parametresi ve customscriptextension ile çalıştırın.
