...
### Belirli bir SignalR hizmetinin erişim anahtarlarını alma
```powershell
...
### Yöneltme 'de bir SignalR hizmet nesnesinden erişim tuşları alma
...
### Microsoft. Azure. Commands. SignalR. modeller. PSSignalRKeys
## NOTLARıNDA
