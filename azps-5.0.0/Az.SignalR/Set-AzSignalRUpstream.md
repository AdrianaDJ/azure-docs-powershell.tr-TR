...
### Sıralı iki ters yöndeki şablon ayarlama
```powershell
...
Aşağıdaki JSON, ayarlanan gerçek şablonları temsil eder. 
...
### Tüm yukarı akış ayarlarını Temizleme
```powershell
...
### -Clear
Tüm yukarı akış ayarlarını temizleyin.
...
### -Şablon
Yukarı akış ayarları için şablon öğeleri.
Gerekli anahtar: UrlTemplate.
İsteğe bağlı tuşlar: HubPattern, EventPattern, CategoryPattern.
Şablon parametresini geçirmek için splatın sözdizimini kullanan örnek: @ {Urlşablonu = ' http://host-connections1.com ', hubpattern = ' sohbet '; EventPattern = ' Broadcast '}, @ {UrlTemplate = ' http://host-connections2.com '}
...
### Microsoft. Azure. Commands. SignalR. modeller. PSServerlessUpstreamSettings

## NOTLARıNDA

## ILGILI BAĞLANTıLAR

[PowerShell 'deki komutlara parametreleri geçirmek için splatın kullanma](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
