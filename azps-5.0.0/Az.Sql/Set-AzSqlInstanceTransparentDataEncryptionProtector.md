...
### Azures, Rmmanagedınstancetransparentdataencryptionkorunabilir (varsayılan)
```
...
### Azuressınrmmanagedınstancetransparentdataencryptionkoruyucuinputobjectparameterset
```
Set-AzSqlInstanceTransparentDataEncryptionProtector [-Type] <EncryptionProtectorType> [[-KeyId] <String>]
...
### Azures, Rmmanagedınstancetransparentdataencryptionkorunabilir
```
Set-AzSqlInstanceTransparentDataEncryptionProtector [-Type] <EncryptionProtectorType> [[-KeyId] <String>]
...
## Tanım
Set-AzSqlInstanceTransparentDataEncryptionProtector cmdlet 'i bir SQL yönetilen örneğinin TDE koruyucusunu ayarlar. TDE koruyucu türü değiştirildiğinde, koruyucu döndürülür.

## ÖRNEKLERDEN

### Örnek 1: saydam veri şifreleme (TDE) koruyucu türünü ServiceManaged olarak ayarlama
```powershell
...
Bu komut yönetilen bir örneğin TDE koruyucu türünü hizmet yönetimli olarak güncelleştirir.

### Örnek 2: saydam veri şifreleme koruyucusu türünü Azure Anahtar Kasası olarak ayarlama
```powershell
...
Bu komut belirtilen yönetilen örneği, TDE koruyucusu olarak kimliği ' ' olan yönetilen örnek Anahtar Kasası kullanacak şekilde güncelleştirir https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 .

### Örnek 3: yönetilen örnek nesnesini kullanarak saydam veri şifreleme koruyucusunu Azure Anahtar Kasası olarak ayarlama
```powershell
...
### Örnek 4: kaynak kimliğini kullanarak saydam veri şifreleme koruyucusu türünü Azure Anahtar Kasası olarak ayarlama
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### Örnek 5: boru kullanarak saydam veri şifreleme koruyucusu türünü Azure Anahtar Kasası olarak ayarlama
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### -Tür
Azure SQL veritabanı saydam veri şifreleme koruyucusu türü.
...
### Microsoft. Azure. Commands. Sql. TransparentDataEncryption. model. Azurermsqlmanagedınstancetransparentdataencryptionspartormodel
