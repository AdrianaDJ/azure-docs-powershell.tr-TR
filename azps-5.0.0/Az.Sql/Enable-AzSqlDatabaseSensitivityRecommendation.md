...
## Tanım
Enable-AzSqlDatabaseSensitivityRecommendation cmdlet, veritabanındaki sütunlarda duyarlılık önerilerini etkin kılar.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL veritabanındaki belirli bir sütunda duyarlılık önerilerini etkinleştirme.
```powershell
...
### Örnek 2: boru kullanarak belirli bir sütunda Azure SQL veritabanında duyarlılık önerilerini etkinleştirme.
```powershell
