...
## Tanım
**Invoke-Azsqlınstancefailover** cmdlet 'ı Azure SQL yönetimli bir örneği yerine çalışma.
...
Bu komut, "ManagedInstance01" adlı örneğin birincil yinelemesi yükünü devreedecektir.
...
Bu komut, "ManagedInstance01" yönetilen örneğinin okunabilir ikincil çoğaltmasının yükünü devreedecektir.
...
### -Ad
Kaldırılacak Azure SQL örneğinin adı.
