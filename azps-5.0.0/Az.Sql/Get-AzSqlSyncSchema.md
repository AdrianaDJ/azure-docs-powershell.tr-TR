...
## Tanım
**Get-AzSqlSyncSchema** cmdlet 'i, bir üye veritabanının veya hub veritabanının eşitleme şemasıyla ilgili bilgileri döndürür.

## ÖRNEKLERDEN

### Örnek 1: hub veritabanı için eşitleme şemasını alma
```powershell
...
### Örnek 2: bir hub veritabanı için eşitleme şemasını alma ve tabloları genişletme
```powershell
...
### Örnek 3: üye veritabanı için eşitleme şemasını alma
```powershell
