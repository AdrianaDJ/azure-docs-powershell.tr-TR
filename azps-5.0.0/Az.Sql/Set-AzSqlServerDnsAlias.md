...
## Tanım
Bu komut, sunucunun diğer adına işaret etmekte olduğunu güncelleştiriyor. Bu komutun, diğer adın gittiği yeni sunucunun bulunduğu abonede oturumu açıkken verilmesi gerekmektedir.
...
Bu komut, daha önce eski sunucu 'ya
...
### -SourceServerName
Diğer adın işaret etmekte olduğu Azure SQL Server 'ın adı.
...
Kaynak sunucunun kaynak grubunun adı.
...
### -Sourceserversubscriptionıd
Kaynak sunucunun abonelik kimliği
...
### -TargetServerName
Diğer adın işaret edeceği Azure SQL Server 'ın adı.
