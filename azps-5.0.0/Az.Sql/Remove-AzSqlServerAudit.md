...
## Tanım
**Remove-AzSqlServerAudit** cmdlet 'i, BIR Azure SQL Server 'ın denetleme ayarlarını kaldırır.
Sunucuyu tanımlayan *Resourcegroupname* ve *ServerName* parametrelerini belirtin.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL Server 'ın denetim ayarlarını kaldırma
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Örnek 2: Azure SQL Server 'ın denetim ayarlarını ardışık düzen aracılığıyla kaldırma
```
