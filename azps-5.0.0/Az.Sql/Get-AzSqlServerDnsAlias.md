...
## Tanım
Tüm Azure SQL Server DNS diğer adlarını alın veya sunucunun tüm sunucu DNS diğer adlarını listeler
...
Belirli bir sunucunun tüm sunucu DNS diğer adlarını listeler
...
Sunucu ve diğer ad tarafından belirtilen sunucu DNS diğer adını alır
...
"Dnsaliasname" ile başlayan belirli sunucu DNS diğer adlarını listeler.
