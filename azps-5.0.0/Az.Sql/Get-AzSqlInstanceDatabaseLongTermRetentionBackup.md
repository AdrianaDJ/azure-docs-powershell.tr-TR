...
Belirli bir veritabanı için tüm uzun süreli bekletme yedeklemelerini alır.  Kaynak grubu isteğe bağlıdır. 
...
### -DatabaseName
Yedeklemelerin altında olduğu yönetilen veritabanının adı.
...
### -InstanceName
Yedeklemelerin altında olduğu yönetilen örneğin adı.
