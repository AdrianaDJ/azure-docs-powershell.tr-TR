...
## Tanım
**Update-AzSqlServerAdvancedThreatProtectionSetting** cmdlet 'i, BIR Azure SQL Server 'da Gelişmiş tehdit koruması ayarlarını ayarlar.
...
Sunucuda Gelişmiş tehdit koruması ayarlarını ayarlar. oluşturulmuş
