...
## Tanım
**Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** cmdlet 'i, bu veritabanına kaydedilen kısa süreli bekletme ilkesini alır.
...
Bu komut, database01 için kısa süreli bekletme ilkesini 35 güne ayarlar.
...
Bu komut, database01 için kısa süreli bekletme ilkesini bir veritabanı nesnesinin boruları aracılığıyla 35 gün içinde ayarlar.
...
Bu komut, silinmiş bir veritabanı nesnesinde DB1 adındaki tüm silinmiş veritabanları için kısa süreli bekletme ilkesini ayarlar. Not yalnızca silinen veritabanlarında bekletme süresini azaltabilirsiniz.
