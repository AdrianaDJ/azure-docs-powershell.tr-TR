...
### Örnek 1: DTU elastik havuz oluşturma
...
### Örnek 2: vCore esnek havuzu oluşturma
...
Bu komut, ElasticPool01 adlı Gengeralamaç hizmet katmanında esnek bir havuz oluşturur. ResourceGroup01 adındaki bir Azure Kaynak grubuna atanan server01 adlı sunucu, ' da esnek havuzu barındırır. Komut havuz için vCore özellik değerlerini ve havuzdaki veritabanları belirtir.

### Örnek 3

SQL veritabanı için elastik bir veritabanı havuzu oluşturur. oluşturulmuş
