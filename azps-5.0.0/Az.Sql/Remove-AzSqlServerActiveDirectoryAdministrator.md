...
## Tanım
**Remove-AzSqlServerActiveDirectoryAdministrator** cmdlet 'i, geçerli abonelikteki AzureSQL Server Için Azure Active Directory (Azure AD) yöneticisini kaldırır.
...
Bu komut, kaynak grubuyla ilişkili server01 adlı sunucu için Azure AD yöneticisi 'ni kaldırır.
...
### -ServerName
Bu cmdlet 'in bir yöneticiyi kaldırdığı SQL Server 'ın adını belirtir.
