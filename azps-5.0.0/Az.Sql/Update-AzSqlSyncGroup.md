...
## Tanım
**Update-AzSqlSyncGroup** cmdlet 'ı BIR Azure SQL veritabanı eşitleme grubunun özelliklerini değiştirir.
...
Bu eşitleme grubunun hub 'ına bağlanırken özel bağlantı bağlantısının kullanılıp kullanılmayacağını.
