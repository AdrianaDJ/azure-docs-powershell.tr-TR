...
### Sqldatabaseusingparentresourceıd
```
...
### Sqlshardmapusingparentresourceıd
```
...
## Tanım
Remove-AzSqlElasticJobTarget cmdlet 'i hedef bir kaynağı hedef gruba çıkarır

## ÖRNEKLERDEN

### Örnek 1: sunucu hedefini kaldırma
```powershell
...
### Örnek 2: veritabanı hedefini kaldırma
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Örnek 3: elastik havuz hedefini kaldırma
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Örnek 4: Shard harita hedefini kaldırma
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Hedef gruptan hedef (sunucu, esnek havuz, veritabanı ve Shard Haritası) kaldırır

## PARAMETRELERINE

### -AgentName
SQL veritabanı Aracısı adı.
...
### -AgentServerName
SQL veritabanı Aracısı sunucusu adı.
...
### Microsoft. Azure. Management. Sql. modeller. JobTarget
