...
## Tanım
**Get-Azsqlınstance** cmdlet 'i, bir veya daha fazla Azure SQL yönetilen örneği hakkında bilgi döndürür.
Yalnızca bu örneğin bilgilerini görmek için bir örnek adı belirtin.

## ÖRNEKLERDEN

### Örnek 1: kaynak grubuna atanan tüm örnekleri alma
```powershell
...
Bu komut, ResourceGroup01 kaynak grubuna atanmış tüm örnekler hakkında bilgi alır.

### Örnek 2: örnek hakkında bilgi alma
```powershell
...
Bu komut, managedInstance1 adlı örnek hakkında bilgi alır.

### Örnek 3: filtreleme kullanarak kaynak grubuna atanan tüm örnekleri alma
```powershell
...
Bu komut, "ManagedInstance" ile başlayan kaynak grubu ResourceGroup01 atanan tüm örnekler hakkında bilgi alır.

### Örnek 4: örnek havuzundaki tüm örnekleri alma
```powershell
...
Bu komut, "instancePool0" örnek havuzunun tüm örnekleri hakkında bilgi alır.

### Örnek 5: örnek havuz nesnesini kullanarak örnek havuzundaki tüm örnekleri alma
```powershell
...
### Örnek 6: örnek havuzu kaynak tanımlayıcısını kullanarak örnek havuzundaki tüm örnekleri alma
```powershell
...
### Örnek 7: kaynak tanımlayıcısını kullanarak yönetilen bir örnek alma
```powershell
...
### -RESOURCEID
Yönetilen örnek kaynak tanımlayıcısı.
