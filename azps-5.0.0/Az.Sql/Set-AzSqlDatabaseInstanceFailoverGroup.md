...
### Setınstancefailovergroupdefaultset (varsayılan)
```
...
### Setınstancefailovergroupbyresourceıdset
```
...
### Setınstancefailovergroupbyazurestarınstancefailovergroupmodelset
```
...
## Tanım
Bu komut, bir örnek yük devretme grubunun yapılandırmasını değiştirir.
...
Yük devretme grubunun yük devretme ilkesini, yük devretme grubunda boru tarafından ' Manual ' olarak ayarlar.

## PARAMETRELERINE

### -AllowReadOnlyFailoverToPrimary
İkincil sunucudaki kesintilerin salt okunur uç noktasının otomatik yük devretmesini tetiklemesini sağlamalıdır.
...
### -InputObject
Ayarlanacak örnek yük devretme grubu nesnesi
...
### -RESOURCEID
Ayarlanacak örnek yük devretme grubunun kaynak KIMLIĞI.
