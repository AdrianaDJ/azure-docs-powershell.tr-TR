...
## Tanım
**Yeni-AzDeploymentManagerService** cmdlet 'i hizmet topolojisi altında bir hizmet oluşturur ve bu hizmeti temsil eden bir nesne döndürür.
Hizmeti adına, hizmet topolojisine ve kaynak grubu adına göre belirtin. 

Cmdlet bir hizmet nesnesi döndürür. Bu nesneyi yerel olarak değiştirebilir ve Set-AzDeploymentManagerService cmdlet 'ini kullanarak değişiklikleri hizmete uygulayabilirsiniz.
...
Hizmet topolojisi altında ad ContosoService1 içeren yeni bir hizmet oluştururken, ABD 'deki konum Merkezi TargetLocation özelliği, hizmet ContosoService1 'in belirtilen abonelikteki Doğu US bölgesine dağıtılması gerektiğini belirtir.
...
### -ServiceTopologyName
Bu hizmetin ait olduğu hizmet topolojisinin adı.
...
### -TargetLocation
Hizmetin altındaki kaynakların dağıtılacağı konumu belirler.
...
Hizmetin altındaki kaynakların dağıtılacağı aboneliği belirler.
