...
### Örnek 1: bağlı kubererleri güncelleştirme
```powershell
...
Bu komut, bağlı bir kuberneika 'ı güncelleştirir.

### Örnek 2: bağlantılı bir kubererleri nesneye göre güncelleştirme
```powershell
...
Bu komut, bağlı bir kubererleri nesneye göre güncelleştirir.
