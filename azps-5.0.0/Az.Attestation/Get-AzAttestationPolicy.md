...
## Tanım
Get-AzAttestationPolicy cmdlet 'i Azure kanıtlama 'ndaki bir kiracıdan ilkeyi alır.
...
T türü *SgxEnclave* Için kanıtlama sağlayıcı *pshtest* ilkesini alır.
...
En fazla% t tür *SgxEnclave* Için, *İngiltere* varsayılan sağlayıcısının ilkesini alır.
...
Bu cmdlet, bu parametrenin belirttiği kiracı için kanıtlama ilkesini alır.
...
### Microsoft. Azure. Commands. kanıtlama. modeller. PSPolicy
