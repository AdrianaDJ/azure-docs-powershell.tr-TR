...
## Tanım
**Backup-azın** cmdlet 'ı BIR Azure API yönetim hizmeti örneğini yedekler.
...
Bu cmdlet, aşağıdaki desene dayalı olarak varsayılan bir değer oluşturur: {Name}-{yyyy-aa-dd-ss-dd}. apsanbackup
