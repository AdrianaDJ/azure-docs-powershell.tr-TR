...
## Tanım
**Set-Azapsananagementapı** cmdlet 'ı BIR Azure API yönetim API 'sini değiştirir.
...
### Örnek 2: var olan bir Apıversionset 'e API ekleme
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Örnek 3: API 'nin üzerine geldiği arka uç ServiceUrl 'Sini değiştirme
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Bu örnek, işaret eden ServiceUrl 'Sini güncelleştirir `echo-api` .
