...
## Tanım
**Yeni-Azapsananagementgatewayhostnameconfiguration** cmdlet 'ı mevcut ağ geçidi için bir ana bilgisayar yapılandırması oluşturur.

## ÖRNEKLERDEN

### Örnek 1: varolan ağ geçidi için bir ana bilgisayar yapılandırması oluşturma
```powershell
...
Bu komut, "G01" ağ geçidi için "H01" konak adı yapılandırması oluşturur.

## PARAMETRELERINE

### -CertificateResourceId
Var olan sertifika kimliği için bir kaynak tanımlayıcısı. Bu parametre gereklidir.
...
Yeni ağ geçidi ana bilgisayar adı yapılandırması
...
### -Gatewayıd
Mevcut ağ geçidinin tanıtıcısı.
Bu parametre gereklidir.
...
NegotiateClientCertificate 'i zorunlu kılma bayrağı.
Bu parametre isteğe bağlıdır.
