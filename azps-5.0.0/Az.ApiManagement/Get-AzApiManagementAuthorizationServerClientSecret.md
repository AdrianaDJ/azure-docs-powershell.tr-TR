...
## Tanım
**Get-Azapsananagementauthorizationserverclientsecret** cmdlet 'ı Azure API yönetim yetkilendirme sunucusunun istemci gizliliğini alır.

## ÖRNEKLERDEN

### Örnek 1: kimlik doğrulaması
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Bu komut, belirtilen yetkilendirme sunucusu gizli gizliliğini alır.
...
### -RESOURCEID
Yetkilendirme sunucusunun ARM kaynak tanımlayıcısı.
Belirtilirse, tanımlayıcı tarafından yetkilendirme sunucusunu bulmaya çalışır.
Bu parametre gereklidir.
...
### -SunucuKimliği
Yetkilendirme sunucusunun tanıtıcısı.
Belirtilmişse, kimlik doğrulama sunucusunu tanımlayıcı tarafından bulur.
