...
**Set-Azapsananaveya** cmdlet, BIR Azure API Yönetim hizmetini güncelleştirir.

## ÖRNEKLERDEN

### Örnek 1: bir API yönetim hizmeti alma ve Premium 'a ölçeklendirme ve bölge ekleme
```powershell
...
### Örnek 2: güncelleştirme dağıtımı (dış VNET)
```powershell
...
### Örnek 3: Keykasa kaynağından parola kullanarak PsApiManagementCustomHostNameConfiguration örneğini oluşturma ve başlatma
```powershell
...
### Örnek 4: Publisher e-postasını, NotificationSender e-postasını ve kuruluş adını güncelleştirme
```powershell
...
### -Geçiş
İşlem başarılı olursa, güncelleştirilmiş Psapımana'yi ardışık düzene gönderir.
...
### -Useratandidentity
Azure Keykasa gibi temel yönetim hizmetleriyle kullanmak için Kullanıcı kimliklerini bu sunucuya atayın.
