...
## Tanım
**Get-AzApiManagementTenantGitAccess** cmdlet 'i kiracının git erişim yapılandırmasını alır.
Anahtarlar sonuç ayrıntılarına dahil olmaz. İstemci gizliliğini almak için **Get-Azapsananagementtenantgitaccesssecret** seçeneğini kullanın.
