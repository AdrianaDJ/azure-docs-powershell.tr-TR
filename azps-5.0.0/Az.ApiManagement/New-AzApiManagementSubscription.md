...
### OldSubscriptionModel (varsayılan)
```
...
## Tanım
**Yeni-Azapsananagementsubscription** cmdlet 'i abonelik oluşturur.
...
### Örnek 2: tüm API kapsamları için abonelik oluşturma
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -AllowTracing
Izlemenin abonelik düzeyinde etkinleştirilip etkinleştirilmeyeceğini belirleyen bayrak. Bu isteğe bağlı bir parametredir ve varsayılan $null.
...
### -Kapsam
Bu, API kapsamı/apis/{apiId} veya ürün kapsamı/Products/{productivseç} veya genel API Scope/API 'leri veya genel Scope/. Bu parametre gereklidir.
...
### System. Nullable ' 1 [[Microsoft. Azure. Commands. Apsananamedi. ServiceManagement. modeller. Psapsananagementsubscriptionstate, Microsoft. Azure. PowerShell. cmdlet
