...
### Byresourceıdparameterset (varsayılan)
```
...
## Tanım
**Remove-Azapsananagementdiagnostic** cmdlet 'i `DiagnosticId` genel kapsamdan veya bir kapsamdan belirtilen tanılama varlığını kaldırır `ApiId`

## ÖRNEKLERDEN

### Örnek 1: Tanılama varlığını kaldırma
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

Bu örnekte, tanılama `applicationinsights` API yönetimi hizmetinden kaldırılır.
...
### -InputObject
PsApiManagementDiagnostic örneği. Bu parametre gereklidir.
...
### -RESOURCEID
Tanının kullanımı Bu parametre gereklidir.
