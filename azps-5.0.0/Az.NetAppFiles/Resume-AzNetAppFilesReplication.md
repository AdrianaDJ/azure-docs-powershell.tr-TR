...
## Tanım
Hedef birimdeki bağlantıyı sürdürme/yeniden eşitleme
...
Bu komut, "MyDestinationAnfVolume" birimindeki ANF çoğaltma bağlantısını sürdürür.

## PARAMETRELERINE

### -AccountName
Çoğaltma biriminin ANF hesabının adı
...
### -InputObject
Yeniden eşitlenmesi için ANF çoğaltma hedef birim nesnesi
...
### -Ad
ANF çoğaltma hedef biriminin adı
...
### -Geçiş
Belirtilen çoğaltma biriminin yeniden eşitlemediği
...
### -PoolName
Çoğaltma biriminin ANF havuzunun adı
...
### -ResourceGroupName
ANF çoğaltma hedef biriminin kaynak grubu
...
### -RESOURCEID
ANF çoğaltma hedef biriminin kaynak kimliği
