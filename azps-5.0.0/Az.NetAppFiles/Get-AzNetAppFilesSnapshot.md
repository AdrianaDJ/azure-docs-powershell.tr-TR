...
## Tanım
**Get-AzNetAppFilesSnapshot** cmdlet 'inin ayrıntılarını alır.

## ÖRNEKLERDEN

### Örnek 1: anl anlık görüntü alın
```
...
Bu komut, "MyAnfVolume" biriminden MyAnfSnapshot adındaki anlık görüntüyü alır.
...
### -VolumeObject
Döndürülecek anlık görüntüyü içeren birim nesnesi
