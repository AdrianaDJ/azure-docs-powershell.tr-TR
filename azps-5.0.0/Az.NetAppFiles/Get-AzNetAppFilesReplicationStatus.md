...
Bu komut MyVol üzerindeki çoğaltmanın durumunu alır.

## PARAMETRELERINE

### -AccountName
Çoğaltma hedef biriminin ANF hesabının adı
...
### -InputObject
Yineleme durumunu almak için ANF çoğaltma hedef birim nesnesi
...
### -PoolName
Çoğaltma hedef biriminin ANF havuzunun adı
...
### Microsoft. Azure. Commands. NetAppFiles. modeller. PSNetAppFilesReplicationStatus
