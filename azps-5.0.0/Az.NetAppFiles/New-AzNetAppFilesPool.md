...
## Tanım
**New-AzNetAppFilesPool** cmdlet 'ı BIR ANF havuzu oluşturur.

## ÖRNEKLERDEN

### Örnek 1: ANF havuzu oluşturma
```
...
Bu komut, "MyAnfAccount" hesabında yeni bir "MyAnfPool" oluşturur.
