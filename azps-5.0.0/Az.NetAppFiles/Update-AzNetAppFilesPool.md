...
## Tanım
**Update-AzNetAppFilesPool** cmdlet 'i ANF havuzunu değiştirir.

## ÖRNEKLERDEN

### Örnek 1: ANF havuzunu değiştirme
```
...
Bu komut, "MyAnfPool" ANF havuzunu verilen boyut ve ServiceLevel 'e dönüştürür.
...
### -AccountObject
Güncelleştirilecek havuzu içeren hesap nesnesi
...
### -InputObject
Güncelleştirilecek havuz nesnesi
