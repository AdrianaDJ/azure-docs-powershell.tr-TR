...
## Tanım
**Update-AzNetAppFilesVolume** cmdlet 'i ANF sesini güncelleştirir.

## ÖRNEKLERDEN

### Örnek 1: ANF sesini güncelleştirme
```
...
Bu komut, ANF birimini "MyAnfVolume" yeni UsageThreshold boyutuyla güncelleştirir.
...
### -InputObject
Güncelleştirilecek birim nesnesi
...
### -PoolObject
Güncelleştirilecek birimi içeren havuz nesnesi
