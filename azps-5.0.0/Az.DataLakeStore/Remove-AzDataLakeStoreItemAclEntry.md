...
## Tanım
**Remove-AzDataLakeStoreItemAclEntry** cmdlet 'ı, Data Lake Store 'daki bir dosyanın veya klasörün erişim denetim LISTESINDEN (ACL) bir GIRIŞI (ACE) kaldırır.
...
### Örnek 2: Kullanıcı girişini yinelemeli olarak kaldırma
```
...
### Örnek 3: ACL nesnesini kullanarak bir ACE 'yi yinelemeli olarak kaldırma
```
...
Bu komut, Patara için Kullanıcı ACE 'sini kömden kaldırır ve hesap ContosoADL.
...
### -Recurse
Alt dizinlere ve dosyalara yinelemeli olarak kaldırılacak ACL 'yi gösterir
...
### -ShowProgress
Bu durumda ilerleme durumu görüntülenir. Yalnızca özyinelemeli ACL kaldırma işlemi yapıldığında uygulanabilir.
