...
## Tanım
**Set-AzDataLakeStoreVirtualNetworkRule** cmdlet 'ı belirtilen veri Lake Store 'da belirtilen sanal ağ kuralını değiştirir.
...
"DLS" hesabındaki "myVNET" sanal ağ kuralının alt ağ kimliğini "Güncelleştirmegerçekleşti" olarak güncelleştirir
...
### -SubnetId
Sanal ağ kuralı için geçerli IP aralığının başlangıcı
