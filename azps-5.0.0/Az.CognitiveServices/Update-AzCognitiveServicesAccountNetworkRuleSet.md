...
## Tanım
**Güncelleştirme-Azöğretici Iveservicesaccountnetworkruleset** cmdlet 'i, bir öğretici hizmet hesabının networkrule özelliğini güncelleştirir
...
### Örnek 3: bir öğretici hizmet hesabının NetworkRule kurallarını Temizleme
```
...
Bu komut, bir öğretici hizmet hesabının (diğer özellikler değiştirmeyeceği) NetworkRule kurallarını temizler.

## PARAMETRELERINE

### -DefaultAction
Öğretici hizmetler hesap NetworkRule Defaultatransaction. Varsayılan değer `Deny` .
...
### -Iprule
Öğrenme Hizmetleri hesap NetworkRule ıprules.
...
### -VirtualNetworkRule
Öğretici Hizmetler hesabı NetworkRule VirtualNetworkRules.
...
### Microsoft. Azure. Commands. Management. öğretici Bveservices. modeller. Psıprule []

### Microsoft. Azure. Commands. Management. öğretici ınitialveservices. modeller. PSVirtualNetworkRule []

## ÇıKıŞLAR

### Microsoft. Azure. Commands. Management. öğretici ınitialveservices. modeller. PSNetworkRuleSet
