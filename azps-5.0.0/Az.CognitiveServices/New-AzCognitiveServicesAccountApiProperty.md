...
## SYNOPSIS
Yeni bir örnek oluşturma hizmetleri hesap Apıproperties örneği
...
## Tanım
Öğretici hizmet hesabı Apıproperties 'in yeni bir örneğini oluşturun.
Apıproperties, yeni bir hesap oluştururken veya mevcut bir hesabı güncelleştirirken kullanılabilir.
Apıproperties bazı hesap türleri için gereklidir.
...
Yukarıdaki örnek, "QnaRuntimeEndpoint" API özelliğiyle bir QnAMaker hesabı oluşturur.
...
### Microsoft. Azure. Management. öğretici Bveservices. modeller.
