...
### AddAddNetworkRuleWithoutInputObject (varsayılan)
```
...
## Tanım
Ağ kural kümesi oluşturma veya güncelleştirme
...
Yeni bir ağ kuralı kümesi oluşturun.

## PARAMETRELERINE

### -DefaultAction
Varsayılan eylem ' Izin ver ' veya ' Reddet ' olabilir
...
### Microsoft. Azure. Commands. ContainerRegistry. modeller. PSNetworkRuleSet
