...
## Tanım
**New-AzServiceBusGeoDRConfiguration** cmdlet 'i yeni bir diğer ad (olağanüstü durum kurtarma yapılandırması) oluşturur
...
### -PartnerNamespace
DR yapılandırma partneri ad alanı (PARTNERIN adalanı
