...
## Tanım
**New-AzServiceBusQueue** cmdlet 'i, belirtilen hizmet veri yolu ad boşluğunda bir hizmet veri yolu kuyruğu oluşturur.
...
Belirtilen hizmet veri yolu ad alanında hizmet veri yolu kuyruğu oluşturur. oluşturulmuş
...
Standart = TimeSpan. Max ve BASIC = 14 gün için
...
Yinelenen saptama geçmişinin süresini tanımlayan bir [TimeSpan](https://msdn.microsoft.com/library/system.timespan.aspx) değeri yineleme algılama geçmişi zamanı penceresini belirtir. Varsayılan değer 10 dakikadır.
...
### -Maxsizeınmega
Maxsizeınmegabaytlık-sıra için ayrılan belleğin megabayt cinsinden megabayt cinsinden en büyük boyutu. Varsayılan 1024 ' dır. Standart SKU için maks 5120 ve Premium SKU için 81920, Izin verilen değerler: 1024, 2048, 3072, 4096, 5120, 10240, 20480, 40960, 81920
...
### -RequiresSession
RequiresSession-bu sıranın oturumları kullandığını belirten değer
