...
## Tanım
**New-AzServiceBusSubscription** cmdlet 'i, belirtilen hizmet veri yolu konusuna yeni bir abonelik oluşturur.
...
Bir aboneliğin filtre değerlendirme özel durumları üzerinde atılacak mektup desteğinin bulunup bulunmadığını belirten değer.
...
### -RequiresSession
RequiresSession-bu sıranın yinelenen algılama gerektirip gerektirmediğini belirten değer.
