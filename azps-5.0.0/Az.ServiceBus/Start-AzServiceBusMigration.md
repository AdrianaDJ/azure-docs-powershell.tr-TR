...
' TestingNamespaceStandardMigration ' için ' TestingNamespacePremiumMigration ' ad alanlarına yeni bir geçiş yapılandırması oluşturur
...
### -PostMigrationName
Geçiş sırasında standart ad alanı için geçiş sonrası adı
