...
### Örnek 1: ada göre bir işlev uygulaması alın ve başlatın.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Bu komut, bir işlev uygulamasını adıyla alır ve başlatır.

### Örnek 2: ada göre bir işlev uygulaması başlatın.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Bu komut bir işlev uygulamasını adıyla başlatır.
