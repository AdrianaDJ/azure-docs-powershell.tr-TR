...
### Örnek 1: Batı Avrupa 'da bir Windows Premium App planı oluşturma
```powershell
...
Bu komut, Batı Avrupa 'da bir Windows Premium App planı oluşturur ve en fazla 10 örneği
...
### -WorkerType
Planın çalışan türü.
Geçerli girdiler: Windows veya Linux.
