...
### Örnek 1: ada göre bir işlev uygulaması alın ve silin.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Remove-AzFunctionApp -Force
```

Bu komut bir işlev uygulamasını adıyla alır ve siler.

### Örnek 2: ada göre bir işlev uygulaması silme.
```powershell
PS C:\> Remove-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Bu komut bir işlev uygulamasını adıyla siler.
...
### -Force
Cmdlet 'i, onay istemeden işlev uygulamasını kaldırmaya zorlar.
