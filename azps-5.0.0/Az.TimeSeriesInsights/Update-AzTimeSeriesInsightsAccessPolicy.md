...
### Örnek 1: belirtilen Access ilkesini adıyla güncelleştirme
```powershell
...
Bu komut belirtilen bir Access ilkesini güncelleştirir.

### Örnek 2: nesne ile belirtilen bir Access ilkesini güncelleştirme
```powershell
