...
### Örnek 1: belirtilen ortamda bir eventhub olay kaynağı oluşturma
```powershell
...
Bu komut, belirtilen ortamda bir eventhub olay kaynağı oluşturur.

### Örnek 2: belirtilen ortam altında bir iothub olay kaynağı oluşturma
```powershell
...
Bu komut, belirtilen ortamın altında bir iothub olay kaynağı oluşturur.

## PARAMETRELERINE

### -ConsumerGroupName
Olayların okunacağı bölümleri tutan olay/IoT Hub tüketici grubunun adı.
...
### -Eventsourceresourceıd
Azure Resource Manager 'daki olay kaynağının kaynak kimliği.
...
### -AnahtarAdı
Olay/IoT Hub 'ına saat serisi öngörüleri hizmeti izni veren SAS anahtarının adı.
...
### -SharedAccessKey
Saat serisi öngörüleri hizmetine olay/IoT Hub 'a okuma erişimi veren paylaşılan erişim anahtarının değeri.
...
Olay kaynağının zaman damgası olarak kullanılacak olay özelliği.
