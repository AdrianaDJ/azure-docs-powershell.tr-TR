...
### Örnek 1: kusto küme veritabanı oluşturma principalAssignment
```powershell
...
Yukarıdaki komut kusto küme veritabanı oluşturur principalAssignment
...
### -PrincipalId
Veritabanına atanan sorumlu KIMLIĞI.
Bir kullanıcı e-postası, uygulama KIMLIĞI veya güvenlik grubu adı olabilir.
