...
### DataExpandedEventHub (varsayılan)
```
...
### Örnek 1: EventHub veri bağlantısı parametrelerini doğrulama
```powershell
...
Yukarıdaki komut, "testnewkustocluster" kümesinde "mykustodatabase" veritabanı için "myeventhubdc" adlı EventHub veri bağlantısını doğrular.

### Örnek 2: EventGrid veri bağlantı parametrelerini doğrulama
```powershell
...
Yukarıdaki komut, "testnewkustocluster" kümesinde "mykustodatabase" veritabanı için "myeventgriddc" adlı EventGrid veri bağlantısını doğrular.

### Örnek 3: IotHub veri bağlantısı parametrelerini doğrulama
```powershell
...
Yukarıdaki komut, "testnewkustocluster" kümesinde "mykustodatabase" veritabanı için "myıothubdc" adlı IotHub veri bağlantısını doğrular.

### Örnek 4: kimlik aracılığıyla EventHub veri bağlantısı parametrelerini doğrulama
```powershell
...
### Örnek 5: kimlik aracılığıyla EventGrid veri bağlantısı parametrelerini doğrulama
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase"
...
### Örnek 6: kimlik aracılığıyla IotHub veri bağlantısı parametrelerini doğrulama
```powershell
PS C:\> $database = Get-AzKustoDatabase -ResourceGroupName "testrg" -ClusterName "testnewkustocluster" -DatabaseName "mykustodatabase" 
...
### Microsoft. Azure. PowerShell. cmdlet. kusto. modeller. Api20200614. ıdataconnectionvalidationresult
