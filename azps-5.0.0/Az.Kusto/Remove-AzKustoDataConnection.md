...
### Örnek 1: varolan bir veri bağlantısını adla silme
```powershell
...
Yukarıdaki komut, "mykustodataconnection" adlı "mykustodatabase" veritabanındaki "" adlı veri bağlantısını, "testrg" kaynak grubunda bulundu
