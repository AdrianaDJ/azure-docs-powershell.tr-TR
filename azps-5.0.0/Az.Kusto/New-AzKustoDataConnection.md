...
### CreateExpandedEventHub (varsayılan)
```
...
### Örnek 1: yeni bir EventHub veri bağlantısı oluşturma
```powershell
...
Yukarıdaki komut, "testnewkustocluster" kümesinde "mykustodatabase" veritabanı için "myeventhubdc" adlı yeni bir EventHub veri bağlantısı oluşturur.

### Örnek 2: yeni bir EventGrid veri bağlantısı oluşturma
```powershell
...
Yukarıdaki komut, "testnewkustocluster" kümesinde "mykustodatabase" veritabanı için "myeventgriddc" adlı yeni bir EventGrid veri bağlantısı oluşturur.

### Örnek 3: yeni bir IotHub veri bağlantısı oluşturma
```powershell
...
Yukarıdaki komut "mykustodatabase" veritabanında "testnewkustocluster" adlı yeni bir IotHub veri bağlantısı oluşturur.
