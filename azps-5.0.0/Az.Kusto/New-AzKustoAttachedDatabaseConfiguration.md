...
### Örnek 1: yeni bir AttachedDatabaseConfiguration oluşturma
```powershell
...
Yukarıdaki komut "testnewkustoclusterf" kümesinde "mykustodatabase" salt okunur bir veritabanı oluşturur.
"Mykustodatabase" kümesinden "testnewkustocluster" veritabanı
...
### -Clusterresourceıd
İliştirmek istediğiniz veritabanlarının bulunduğu kümenin kaynak kimliği.
...
### -DatabaseName
Eklemek istediğiniz veritabanının adı tüm geçerli ve gelecekteki veritabanlarını izlemek istiyorsanız * kullanın.
...
### -Defaultsprincipalsmodificationkind
Varsayılan asıl öğe değiştirme türü
...
### Microsoft. Azure. PowerShell. cmdlet. kusto. modeller. Api20200614. ıattacheddatabaseconfiguration
