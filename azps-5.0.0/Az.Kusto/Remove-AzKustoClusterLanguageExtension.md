...
### Örnek 1: kümeden dil uzantılarının listesini kaldırma
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Yukarıdaki komut, KQL sorgularında çalıştırılabilecek dil uzantılarının listesini kaldırır.
...
DEĞER <ılanguageextension [] >: dil uzantılarının listesi.
