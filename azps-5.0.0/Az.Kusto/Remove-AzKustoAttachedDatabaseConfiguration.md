...
### Örnek 1: var olan AttachedDatabaseConfiguration 'ı adıyla silme
```powershell
...
Yukarıdaki komut, [testnewkustoclusterf "kümesinden AttachedDatabaseConfiguration" myizleme "dizininde tanımlanan izleme veritabanını siler.
