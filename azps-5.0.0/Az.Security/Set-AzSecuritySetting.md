...
## SYNOPSIS
Azure Güvenlik Merkezi 'nde güvenlik ayarını güncelleştirme

## INDEKI

### Genelkapsam (varsayılan)
```
...
## Tanım
Set-AzSecuritySetting cmdlet 'i, Azure Güvenlik Merkezi 'nde belirli bir güvenlik ayarını güncelleştirir.
...
Bir MCAS veri dışarı aktarma ayarını güncelleştirir   
...
### System. String
### Microsoft. Azure. Commands. Security. model. Settings. PSSecuritySetting
### Microsoft. Azure. Commands. Security. model. Settings. PSSecurityDataExportSetting
