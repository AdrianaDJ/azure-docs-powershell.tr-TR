...
## Tanım
Update-AzIotSecuritySolution cmdlet 'i, belirli bir IoT güvenlik çözümünde aşağıdaki özelliklerden bir veya daha fazlasını güncelleştirin: Etiketler, öneri yapılandırması, Kullanıcı tanımlı kaynaklar.
IoT güvenlik çözümünün içinde yalnızca belirtilen özellikler güncelleştirilir.
IoT güvenlik çözümü, tehditlere karşı korunmaya ve saptamasını engellemeye yardımcı olmak için IoT aygıtlarından ve IoT Hub 'dan güvenlik verilerini ve olayları toplar.
...
IoT güvenlik çözümünü "MyResourceGroup" kaynak grubundan öneri yapılandırması ve Kullanıcı tanımlı kaynaklar ile güncelleştirme
