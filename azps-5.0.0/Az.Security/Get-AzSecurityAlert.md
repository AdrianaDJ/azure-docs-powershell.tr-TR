...
ms.openlocfilehash: a54ca16715b4688b95d085fa8a92819404a7ae6a
ms.sourcegitcommit: b4a38bcb0501a9016a4998efd377aa75d3ef9ce8
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 10/27/2020
ms.locfileid: "94279465"
---
# <span data-ttu-id="ef220-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="ef220-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="ef220-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="ef220-102">SYNOPSIS</span></span>
<span data-ttu-id="ef220-103">Azure Güvenlik Merkezi tarafından algılanan güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="ef220-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="ef220-104">INDEKI</span><span class="sxs-lookup"><span data-stu-id="ef220-104">SYNTAX</span></span>

### <span data-ttu-id="ef220-105">SubscriptionScope (varsayılan)</span><span class="sxs-lookup"><span data-stu-id="ef220-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ef220-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="ef220-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ef220-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="ef220-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="ef220-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="ef220-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="ef220-109">Içermiyor</span><span class="sxs-lookup"><span data-stu-id="ef220-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="ef220-110">Tanım</span><span class="sxs-lookup"><span data-stu-id="ef220-110">DESCRIPTION</span></span>
<span data-ttu-id="ef220-111">Azure Güvenlik Merkezi tarafından algılanan güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="ef220-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="ef220-112">ÖRNEKLERDEN</span><span class="sxs-lookup"><span data-stu-id="ef220-112">EXAMPLES</span></span>

### <span data-ttu-id="ef220-113">Örnek 1</span><span class="sxs-lookup"><span data-stu-id="ef220-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="ef220-114">Aboneliğin içindeki kaynaklarda algılanan tüm güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="ef220-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="ef220-115">Örnek 2</span><span class="sxs-lookup"><span data-stu-id="ef220-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="ef220-116">"MyService1" kaynak grubu içindeki kaynaklarda algılanan tüm güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="ef220-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="ef220-117">Örnek 3</span><span class="sxs-lookup"><span data-stu-id="ef220-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="ef220-118">"MyService1" kaynak grubu içindeki kaynaklarda algılanan belirli bir güvenlik uyarısını alır</span><span class="sxs-lookup"><span data-stu-id="ef220-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="ef220-119">PARAMETRELERINE</span><span class="sxs-lookup"><span data-stu-id="ef220-119">PARAMETERS</span></span>

### <span data-ttu-id="ef220-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ef220-120">-DefaultProfile</span></span>
<span data-ttu-id="ef220-121">Azure ile iletişim için kullanılan kimlik bilgileri, hesap, kiracı ve abonelik.</span><span class="sxs-lookup"><span data-stu-id="ef220-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="ef220-122">-Konum</span><span class="sxs-lookup"><span data-stu-id="ef220-122">-Location</span></span>
<span data-ttu-id="ef220-123">Konumuyla.</span><span class="sxs-lookup"><span data-stu-id="ef220-123">Location.</span></span>
...
### <span data-ttu-id="ef220-124">-Ad</span><span class="sxs-lookup"><span data-stu-id="ef220-124">-Name</span></span>
<span data-ttu-id="ef220-125">Kaynak adı.</span><span class="sxs-lookup"><span data-stu-id="ef220-125">Resource name.</span></span>
...
### <span data-ttu-id="ef220-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="ef220-126">-ResourceGroupName</span></span>
<span data-ttu-id="ef220-127">Kaynak grubu adı.</span><span class="sxs-lookup"><span data-stu-id="ef220-127">Resource group name.</span></span>
...
### <span data-ttu-id="ef220-128">-RESOURCEID</span><span class="sxs-lookup"><span data-stu-id="ef220-128">-ResourceId</span></span>
<span data-ttu-id="ef220-129">Kaynak KIMLIĞI.</span><span class="sxs-lookup"><span data-stu-id="ef220-129">Resource ID.</span></span>
...
### <span data-ttu-id="ef220-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="ef220-130">CommonParameters</span></span>
<span data-ttu-id="ef220-131">Bu cmdlet ortak parametreleri destekler:-Debug,-ErrorAction,-ErrorVariable,-ınformationaction,-ınformationvariable,-OutVariable,-OutBuffer,-Pipelinedeğişken,-verbose,-WarningAction ve-Warningdeğişken.</span><span class="sxs-lookup"><span data-stu-id="ef220-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="ef220-132">Daha fazla bilgi için [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)bakın.</span><span class="sxs-lookup"><span data-stu-id="ef220-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="ef220-133">GÖLGELENDIRICI</span><span class="sxs-lookup"><span data-stu-id="ef220-133">INPUTS</span></span>

### <span data-ttu-id="ef220-134">System. String</span><span class="sxs-lookup"><span data-stu-id="ef220-134">System.String</span></span>

## <span data-ttu-id="ef220-135">ÇıKıŞLAR</span><span class="sxs-lookup"><span data-stu-id="ef220-135">OUTPUTS</span></span>

### <span data-ttu-id="ef220-136">Microsoft. Azure. Commands. Security. modeller. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="ef220-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="ef220-137">NOTLARıNDA</span><span class="sxs-lookup"><span data-stu-id="ef220-137">NOTES</span></span>

## <span data-ttu-id="ef220-138">ILGILI BAĞLANTıLAR</span><span class="sxs-lookup"><span data-stu-id="ef220-138">RELATED LINKS</span></span>
