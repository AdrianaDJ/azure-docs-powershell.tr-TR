...
## Tanım
Remove-AzIotSecuritySolution cmdlet 'i belirli bir IoT güvenlik çözümünü siler. IoT güvenlik çözümü, tehditlere karşı korunmaya ve saptamasını engellemeye yardımcı olmak için IoT aygıtlarından ve IoT Hub 'dan güvenlik verilerini ve olayları toplar.
...
"MyResourceGroup" kaynak grubuyla "Myörnek" IoT güvenlik çözümünü silme
