...
## Tanım
Azure Güvenlik Merkezi, olası güvenlik sorunlarını saptamak için kaynaklarınızı tarar.
Bu cmdlet, Azure Güvenlik Merkezi 'nin yapmanızı önerdiği güvenlik görevlerini keşfetmenize olanak tanır.
...
Aboneliğin içindeki kaynaklarda keşfedilen tüm güvenlik görevlerini alır.
...
Kaynak grubu içindeki kaynaklarda keşfedilen tüm güvenlik görevlerini alır.
...
Belirli bir güvenlik görevini alır.
...
### Microsoft. Azure. Commands. Security. modeller. Tasks. PSSecurityTask
