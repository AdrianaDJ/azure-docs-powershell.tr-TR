...
### -DosyaYolu
SQL Information Protection Ilke tanımını içeren bir. json dosyasının yolunu belirtir.
...
### -İlke
SQL Information Protection ilke tanımını belirtir. Bir. json dosyasının veya ilkeyi tanımlayan JSON biçim dizesinin yolunu belirtebilirsiniz.
...
### Microsoft. Azure. Commands. Securitcenter. model. SqlInformationProtectionPolicy. PSSqlInformationProtectionPolicy
