...
## Tanım
New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject cmdlet, IoT güvenlik çözümünde cihaz güvenlik grubu için izin verilen özel uyarı kurallarının yeni bir listesini oluşturur.
...
"LocalUserNotAllowed" türünden "LocalUserNotAllowed" türünden devre dışı

## PARAMETRELERINE

### -AllowlistValue
Liste değerlerine izin ver.
