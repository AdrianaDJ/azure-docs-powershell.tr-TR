...
## Tanım
Aboneliğin çalışma alanı ayarlarını güncelleştirir.
Yapılandırılmış çalışma alanı, bu aboneliğin VM 'Lere yüklenen Azure Log Analytics Aracısı Aracısı tarafından toplanan güvenlik verilerini tutar.
...
"MyWorkspace" çalışma alanını, Azure Log Analytics Aracısı tarafından toplanan tüm güvenlik verilerini tutmak için ayarlar.
