...
## Tanım
**New-Azıntegrationaccountcertificate** cmdlet 'i bir tümleştirme hesabı sertifikası oluşturur.
Bu cmdlet, tümleştirme hesabı sertifikasını temsil eden bir nesne döndürür.
Tümleştirme hesap adını, kaynak grubu adını, sertifika adını, anahtar adını, anahtar sürümü ve Anahtar Kasası KIMLIĞINI belirtin.
...
### Örnek 1: Tümleştirme hesabı sertifikası oluşturma
```
...
Bu komut, belirtilen kaynak grubunda tümleştirme hesabı sertifikasını oluşturur.

## PARAMETRELERINE

### -CertificateName
Tümleştirme hesabı sertifikası için bir ad belirtir.
...
### -AnahtarAdı
Anahtar kasasındaki sertifika anahtarının adını belirtir.
...
### -Anahtarlı
Bir anahtar kasa KIMLIĞI belirtir.
...
### -KeyVersion
Anahtar kasasındaki sertifika anahtarının sürümünü belirtir.
...
### -Metadata
Sertifikanın meta veri nesnesini belirtir.
...
Ortak sertifika (. cer) dosyasının yolunu belirtir.
...
### Microsoft. Azure. Management. Logic. modeller. ıntegrationaccountcertificate
