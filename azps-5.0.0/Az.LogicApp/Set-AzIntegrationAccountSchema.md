...
## Tanım
**Set-Azıntegrationaccountschema** cmdlet 'i bir tümleştirme hesabı şemasını değiştirir.
Bu cmdlet, tümleştirme hesabı şemasını temsil eden bir nesne döndürür.
Tümleştirme hesap adını, kaynak grubu adını ve şema adını belirtin.
...
### Örnek 1: Tümleştirme hesabı şemasını değiştirme
```
...
Bu komut, IntegrationAccountSchema43 adlı tümleştirme hesabı şemasını değiştirir.
