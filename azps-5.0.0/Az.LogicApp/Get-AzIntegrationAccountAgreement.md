...
## Tanım
**Get-Azıntegrationaccountagreement** cmdlet 'i, bir Azure kaynak grubundan tümleştirme hesabı anlaşmasını alır.
...
### Örnek 1: Tümleştirme hesabı anlaşması alma
```
...
Bu komut, IntegrationAccountAgreement06 adlı bir tümleştirme hesabı anlaşmasını alır.

### Örnek 2: kaynak grubu adına göre tümleştirme hesap sözleşmelerini alma
```
...
Bu komut, tümleştirme hesap sözleşmelerini kaynak grubu adına göre alır.
