...
## Tanım
**Get-Azıntegrationaccountcertificate** cmdlet 'i bir kaynak grubundan tümleştirme hesabı sertifikalarını alır.
Tümleştirme hesap adını, kaynak grubu adını ve sertifika adını belirtin.
...
### Örnek 1: Tümleştirme hesabı sertifikası alma
```
...
Bu komut, IntegrationAccountCertificate01 adlı tümleştirme hesabı sertifikasını alır.

### Örnek 2: Tümleştirme hesabı sertifikalarını tümleştirme hesap adıyla alma
```
...
Bu komut, IntegrationAccount31 adlı tümleştirme hesabı için tümleştirme hesabı sertifikalarını alır.
