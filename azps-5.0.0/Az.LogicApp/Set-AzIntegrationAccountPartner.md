...
## Tanım
**Set-Azıntegrationaccountpartner** cmdlet 'i bir tümleştirme hesabı ortağını değiştirir.
...
### Örnek 1: Tümleştirme hesabı ortağını değiştirme
```powershell
...
Bu komut, belirtilen kaynak grubundaki IntegrationAccountPartner22 adlı tümleştirme hesabı ortağını değiştirir.

### Örnek 2

Bir tümleştirme hesabı ortağını değiştirir. oluşturulmuş
