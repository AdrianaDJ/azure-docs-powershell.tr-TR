...
### -NetworkBlock
Adres bloğunun aboneliğinizdeki VNet genelinde yanı sıra şirket içi olarak benzersiz olması gerekir.
CıDR biçiminin, A, B, C, D, 0 ile 255 arasındaki, B, C, D, 0 ile 22 arasındaki bir
...
### -Nsxtparola
İsteğe bağlı olarak, özel bulut oluşturulduğunda NSX-T Yöneticisi parolasını ayarlama
...
### -Vcenterparola
İsteğe bağlı olarak, özel bulut oluşturulduğunda vCenter Yöneticisi parolasını ayarlama
