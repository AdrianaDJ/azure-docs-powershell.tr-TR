...
## Tanım
**New-AzPowerBIWorkspaceCollection** cmdlet 'i, belirtilen kaynak grubunda ve konumunda Azure aboneliğiniz Için BIR Power BI çalışma alanı koleksiyonu oluşturur.

## ÖRNEKLERDEN

### Örnek 1: çalışma alanı koleksiyonu oluşturma
```
...
Bu komut belirtilen konumda belirtilen kaynak grubunda WCN11 adlı bir çalışma alanı koleksiyonu oluşturur.
...
### -Konum
Bu cmdlet 'in bir çalışma alanı koleksiyonu oluşturduğu Azure konumunu belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in çalışma alanı koleksiyonu oluşturduğu kaynak grubunun adını belirtir.
...
Power BI çalışma alanı koleksiyonu için bir ad belirtir.
