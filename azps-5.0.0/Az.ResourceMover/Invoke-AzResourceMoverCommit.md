...
### Örnek 1: kaynakların işlemeden önce bağımlıları doğrulama
```powershell
...
Kaynaklar tamamlanmadan önce bağımlıları doğrulayın.

### Örnek 2: giriş olarak "MoveResource" kullanarak taşıma koleksiyonundaki kaynaklar kümesini Işleyin
```powershell
...
Giriş olarak "MoveResource adı" kullanarak taşıma koleksiyonundaki kaynaklar kümesini işleyin

### Örnek 3: taşıma koleksiyonundaki kaynaklar kümesini giriş olarak "SourceARMID" kullanarak Işleyin
```powershell
...
Taşıma koleksiyonundaki kaynaklar kümesini giriş olarak "SourceARMID" kullanarak kaydetme
