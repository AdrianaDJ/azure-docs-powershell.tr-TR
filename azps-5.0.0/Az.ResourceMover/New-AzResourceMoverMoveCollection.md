...
### Örnek 1: yeni bir taşıma koleksiyonu oluşturun.
```powershell
...
Abonelik içinde yeni bir taşıma koleksiyonu oluşturun.
...
### -IdentityPrincipalId
Anapara kimliği alır veya ayarlar.
...
### -IdentityType
Bölge taşıma hizmeti için kullanılan kimliğin türü.
