...
## Tanım
**Unregister-AzProviderFeature** cmdlet 'i hesabınızdaki bir Azure sağlayıcı özelliğinin kaydını siler.

## ÖRNEKLERDEN

### Örnek 1: özelliğin kaydını silme
```
PS C:\>Unregister-AzProviderFeature -FeatureName AllowApplicationSecurityGroups -ProviderNamespace Microsoft.Network
```

Bu işlem, Microsoft. Network için AllowApplicationSecurityGroups özelliğinin hesabınızdan kaydını siler.
