...
## Tanım
**Get-AzResourceLock** cmdlet 'i Azure kaynak kilitlerini alır.
...
### Örnek 2: Kaynak Grup düzeyindeki veya üzeri kilitleri alma
```
PS C:\> Get-AzResourceLock -ResourceGroupName "ResourceGroup11" -AtScope
```

Bu komut, kaynak grubundaki veya abonelikteki kaynak kilitlerini alır.
