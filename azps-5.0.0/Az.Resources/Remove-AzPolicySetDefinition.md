...
## Tanım
**Remove-AzPolicySetDefinition** cmdlet 'i bir ilke tanımını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: kaynak KIMLIĞIYLE ilke kümesi tanımını kaldırma
```
...
Komut, $PolicySetDefinition değişkeninde depolar.
İkinci komut $PolicySetDefinition 'un **RESOURCEID** özelliğinin tanımladığı ilke kümesi tanımını kaldırır.
...
### -InputObject
Başka bir cmdlet 'ten çıktı olan kaldırılacak ilke kümesi tanım nesnesi.
...
### -ManagementGroupName
Silinecek ilke kümesi tanımının yönetim grubunun adı.
...
### -SubscriptionID
Silinecek ilke kümesi tanımının abonelik KIMLIĞI.
