...
## Tanım
**Remove-AzTenantDeployment** cmdlet 'i geçerli kiracı kapsamındaki bir Azure dağıtımını ve ilişkili işlemleri kaldırır.
...
Bu komut, geçerli kiracı kapsamındaki "RolesDeployment" dağıtımını kaldırır.
...
Bu komut, geçerli kiracı kapsamındaki "RolesDeployment" dağıtımını alır ve kaldırır.
