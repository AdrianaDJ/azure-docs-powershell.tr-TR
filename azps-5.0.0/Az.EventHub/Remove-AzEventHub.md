...
### Eventhubresourceıdparameterset
```
...
## Tanım
Remove-AzEventHub cmdlet, verilen ad alanından belirtilen olay hub 'ını kaldırır ve siler.
...
### Örnek 3: boru kullanarak InputObject:
```powershell
...
### Örnek 5: RESOURCEID-dize kullanarak:
```powershell
