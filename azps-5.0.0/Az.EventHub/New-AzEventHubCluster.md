...
## SYNOPSIS
Yeni adanmış bir eventhub kümesi oluşturur
...
## Tanım
New-AzEventHubCluster cmdlet 'i, verilen kaynak grubunda adanmış eventhub kümesi oluşturur
...
' RSG-Cluster27651 ' için resourcegroup ', ' Eventhub-Cluster-5557 ' ile

## PARAMETRELERINE

### -Kapasite
Küme kapasitesi (CU), curerntrly, izin verilen değer = 1
...
### Etiketli
Kümeler için kaynak etiketlerini temsil eden hashtables
...
### Microsoft. Azure. Commands. EventHub. modeller. Pyetthubclusterattributes
