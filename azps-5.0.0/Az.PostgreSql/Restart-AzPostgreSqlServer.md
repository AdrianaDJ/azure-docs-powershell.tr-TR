...
### Örnek 1: posta kaynağı grubuna göre PostgreSql sunucusunu yeniden başlatın
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Bu cmdlet, kaynak grubu ve sunucu adına göre PostgreSql sunucusunu yeniden başlatır.

### Örnek 2: kimliği kullanarak PostgreSql Server 'ı yeniden başlatın
```powershell
...
Bu cmdlet 'ler kimliği kullanarak PostgreSql sunucusunu yeniden başlatır.
