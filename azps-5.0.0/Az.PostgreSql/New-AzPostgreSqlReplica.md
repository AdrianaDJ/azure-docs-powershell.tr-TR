...
### Örnek 1: yeni bir PostgreSql Server çoğaltması oluşturma
```powershell
...
Bu cmdlet yeni bir PostgreSql sunucu yinelemesi oluşturur.

### Örnek 2: yeni bir PostgreSql Server çoğaltması oluşturma
```powershell
