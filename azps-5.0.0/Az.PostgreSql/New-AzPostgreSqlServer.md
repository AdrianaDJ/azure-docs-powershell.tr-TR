...
### Örnek 1: yeni bir PostgreSql sunucusu oluşturma
```powershell
...
Bu cmdlet 'ler yeni bir PostgreSql sunucusu oluşturur.
...
### -GeoRedundantBackup
Coğrafi olarak yedekli veya sunucu yedeklemesi için değil özelliğini etkinleştirin.
