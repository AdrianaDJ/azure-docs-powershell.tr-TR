...
### Örnek 1: PostgreSql yapılandırmasını adıyla güncelleştirme
```powershell
...
Bu cmdlet, PostgreSql yapılandırmasını adıyla güncelleştirir.

### Örnek 2: kimliği kullanarak PostgreSql yapılandırmasını güncelleyin.
```powershell
...
Bu cmdlet 'ler kimliği kullanarak PostgreSql yapılandırmasını güncelleştirir.
...
### Microsoft. Azure. PowerShell. cmdlet. PostgreSql. modeller. Api20171201. Iconation
