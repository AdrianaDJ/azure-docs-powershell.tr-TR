...
### Örnek 1: kaynak grubuna ve sunucu adına göre PostgreSql sunucu çoğaltmasını al
```powershell
...
Bu cmdlet, kaynak grubu ve sunucu adına göre PostgreSql sunucu çoğaltmasını alır.
