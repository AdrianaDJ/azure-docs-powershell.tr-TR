...
## SYNOPSIS
Güncelleştirmeler destek bileti.

## INDEKI

### UpdateByNameWithContactDetailParameterSet (varsayılan)
```
...
### Updatebynamewith, Tobjectparameterset
```
...
### Updatebyinputobjectwith, Tobjectparameterset
```
...
## Tanım
Destek biletinin önem düzeyini, durumunu veya müşteri iletişim ayrıntılarını güncelleştirmek için bu cmdlet 'i kullanın. Bilet destek mühendisine atandığında destek biletinin önem düzeyini veya durumunun güncelleştirildiğine dikkat edin. Bilet atamasından sonra önem düzeyini veya durumu güncelleştirmek isterseniz, Bilet üzerinden bir iletişim göndererek destek mühendisine başvurun.

## ÖRNEKLERDEN

### Örnek 1: destek biletinin güncelleştirme önem derecesi.
```powershell
...
### Örnek 2: destek anahtarının güncelleştirme durumu.
```powershell
...
### Örnek 3: kişi nesnesini belirterek destek biletinin iletişim ayrıntılarını güncelleyin.
```powershell
...
### Örnek 4: destek biletinin destek bileti
```powershell
...
### Örnek 5: tek tek kişi parametrelerini belirterek destek biletinin iletişim ayrıntılarını güncelleyin.
```powershell
...
### Örnek 6: destek anahtarının durumunu boru desteği bilet nesnesiyle karşılaştırarak güncelleştirin.
```powershell
...
### -Müştercontactdetail
Destek bileti ile Ilgili kişi ayrıntılarını güncelleştirin.
...
Müşteri tarafından tercih edilen destek dili.
Burada listelenen desteklenen dillerden birinin geçerli bir dil-Contry kodu olması gerekir https://azure.microsoft.com/support/faq/ .
...
### -InputObject
Bu cmdlet 'in güncelleştirdiği SupportTicket kaynak nesnesi.
...
### -Ad
Bu cmdlet 'in güncelleştirdiği SupportTicket kaynağının adı.
...
### -Önem derecesi
Destek anahtarının önem derecesi.
...
### -Durum
Destek anahtarının güncelleştirme durumu.
