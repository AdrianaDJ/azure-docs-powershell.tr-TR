...
## SYNOPSIS
Destek kişi profili nesnesi oluşturur.
...
## Tanım
Bu, destek bileti oluştururken veya güncelleştirirken bir destek kişi profili nesnesi oluşturmak için kullanabileceğiniz bir yardımcı cmdlet. Destek bileti oluşturmak için zorunlu olan aşağıdaki parametreleri belirtmeniz gerekir: 
...
### Örnek 1: kişi nesnesi oluşturma
```powershell
...
### Microsoft. Azure. Commands. support. model. PSContactProfile
