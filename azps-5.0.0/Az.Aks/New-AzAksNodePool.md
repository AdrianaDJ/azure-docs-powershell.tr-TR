...
### Varsayılan parametrelerle düğüm havuzu oluşturma
```powershell
...
### -Force
Zaten var olsa bile düğüm Havuzu Oluştur
...
### -OsType
OS türünü belirtmek için kullanılacak OsType.
Linux ve Windows 'tan seçim yapın.
Linux.
...
Düşük öncelikli sanal makine ölçek kümesi için çıkarma ilkesini belirtmek amacıyla kullanılan ScaleSetEvictionPolicy.
Varsayılan olarak silinir.
...
### -ScaleSetPriority
Sanal makine ölçek kümesi önceliğini belirtmek için kullanılacak ScaleSetPriority.
Normal olarak.
...
### -VmSetType
Düğüm havuzunun türlerini temsil eder.
Olası değerler: ' VirtualMachineScaleSets ', ' kullanılabilirlik ayarı '
...
### Microsoft. Azure. Commands. aks. modeller. PSNodePool
