...
### Kubectl 'nin en son sürümünü indirin ve yükleyin
```powershell
...
Varsayılan olarak ~/.Azure-kubectl/uygulamasına yüklenecek
...
### -DownloadFromMirror
Yansıtma sitesinden indirin: https://mirror.azure.cn/kubernetes/kubectl/
...
### -Force
Sormadan mevcut kubectl 'nin üzerine yaz
...
### -Version
' V 1.17.2 ' gibi bir yüklenecek kubectl sürümü.
