...
Aşağıdaki örnek, Web App ContosoWebApp için myConnectionString adlı bir bağlantı dizesi oluşturur. Bu, Web App ContosoWebApp için varolan tüm bağlantı dizelerini değiştirir.
