...
### -AppServicePlan
App Service planlama adı veya App Service planlama kimliği. WebApp ve App hizmet planı farklı kaynak gruplarınızda, ad yerine KIMLIĞI kullanın. App Service planlama kimliği,: $asp = Get-AzAppServicePlan-ResourceGroup myRG-Name MyWebapp $asp. id kullanılarak alınabilir.
...
### -GitRepositoryPath
Dağıtılacak Web uygulamasını içeren GitHub deposunun yolu.
