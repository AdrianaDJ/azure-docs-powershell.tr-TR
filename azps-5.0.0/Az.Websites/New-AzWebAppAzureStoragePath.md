...
## Tanım
Web uygulamasının içine takılacak bir Azure depolama yolunu temsil eden bir nesne oluşturur.
...
### -AccessKey
Azure depolama hesabına erişim anahtarı
...
Örneğin: myfilestorageaccount.file.core.windows.net
...
### -Bağlamayolu
Formülde belirtilen paylaşımın sunulacağı kapsayıcıdaki yol
...
### -Ad
Azure depolama özelliğinin tanıtıcısı.
Web uygulaması veya yuvasında benzersiz olmalıdır
...
### -PaylaşımAdı
Kapsayıcıya takılacak paylaşımın adı
...
### -Tür
Azure depolama hesabı türü.
Windows kapsayıcıları yalnızca Azure dosyalarını destekler
...
### Microsoft. Azure. Commands. WebApps. modeller. WebAppAzureStoragePath
