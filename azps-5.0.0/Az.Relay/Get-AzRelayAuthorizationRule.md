...
## Tanım
**Get-AzRelayAuthorizationRule** cmdlet 'i, verilen geçiş varlıklarındaki (Namespace/WcfRelay/HybridConnection) belirtilen yetkilendirme kuralının açıklamasını alır.
