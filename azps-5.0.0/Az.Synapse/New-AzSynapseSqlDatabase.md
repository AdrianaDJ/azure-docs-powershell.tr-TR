...
## SYNOPSIS
SYNAPSE Analytics SQL veritabanı oluşturur.
...
## Tanım
**Get-AzSynapseSqlDatabase** cmdlet 'ı bir Azure SYNAPSE Analytics SQL veritabanı hakkında bilgi alır.
...
Bu komut, bir Azure SYNAPSE Analytics SQL veritabanı oluşturur.
