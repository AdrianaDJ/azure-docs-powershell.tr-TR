...
## Tanım
**Get-AzSynapseNotebook** cmdlet 'i çalışma alanındaki Not defterleri hakkında bilgi alır. Not defterinin adını belirtirseniz, cmdlet bu not defteri hakkında bilgi alır. Bir ad belirtmezseniz cmdlet, çalışma alanındaki tüm not defterleri hakkında bilgi alır.
...
Çalışma alanı olan tüm Not defterlerinin listesini alır.
...
Çalışma alanında ContosoNotebook adındaki tek bir not defterini alır.
...
Çalışma alanında ContosoNotebook adındaki tek bir not defterini ardışık düzen aracılığıyla alır.
