...
## Tanım
**Set-AzSynapseDataFlow** cmdlet 'i veri akışı oluşturur veya çalışma alanında var olan bir veri akışını güncelleştirir.
...
Bu komut, ContosoWorkspace adlı çalışma alanında ContosoDataFlow adlı bir veri akışı oluşturur.
Komut, veri akışını DataFlow.jsdosyadaki bilgilerde temel alır.
