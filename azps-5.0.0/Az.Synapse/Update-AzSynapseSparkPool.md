...
## Tanım
**Update-AzSynapseSparkPool** cmdlet 'ı bir Azure SYNAPSE Analytics Spark havuzunu güncelleştirir.
...
Bu komut, bir Azure SYNAPSE Analytics Spark havuzunu güncelleştirir.
...
Bu komut, bir Azure SYNAPSE Analytics Spark havuzunu ardışık düzen aracılığıyla güncelleştirir.
...
Bu komut, kaynak KIMLIĞIYLE bir Azure SYNAPSE Analytics Spark havuzunu güncelleştirir.
...
Bu komut, Azure SYNAPSE Analytics Spark havuzu için otomatik ölçeği olanaklı kılar.
...
Bu komut, Azure SYNAPSE Analytics Spark havuzu için otomatik ölçeği devre dışı bırakır.
...
Bu komut bir Azure SYNAPSE Analytics Spark havuzu için otomatik duraklatma 'yi etkinleştirmiştir.
...
Bu komut, Azure SYNAPSE Analytics Spark havuzu için otomatik duraklatma özelliğini devre dışı bırakır.
...
### -Autopausedelayınminute
Dakika sayısı. Otomatik duraklatma etkinleştirildiğinde bu parametrenin belirtilmesi gerekir.
...
Belirtilen Spark havuzunda ayrılacak en fazla düğüm sayısı.
Otomatik ölçek etkinleştirildiğinde bu parametrenin belirtilmesi gerekir.
...
Belirtilen Spark havuzunda ayrılacak en az düğüm sayısı.
Otomatik ölçek etkinleştirildiğinde bu parametrenin belirtilmesi gerekir.
...
### -EnableAutoPause
Otomatik duraklatma özelliğinin etkinleştirilip etkinleştirilmeyeceğini gösterir.
...
### -Enableotomatik ölçeklendirme
Otomatik ölçeğin etkinleştirilip etkinleştirilmeyeceğini gösterir
...
### -Librarygereksinimlerdosyayolu
Ortam yapılandırma dosyası ("zar dondurma" çıktısı).
...
### -NodeCount
Belirtilen Spark havuzunda tahsis edilecek düğümlerin sayısı.
...
### -NodeSize
Belirtilen Spark havuzunda tahsis edilen düğümlerde kullanılacak çekirdek ve bellek sayısı.
Otomatik ölçek devre dışı bırakıldığında bu parametre belirtilmelidir
