...
### NewByNameParameterSet (varsayılan)
```
...
## Tanım
**New-AzSynapseIntegrationRuntimeKey** cmdlet 'ı ' KeyName ' parametresiyle belirtilen anahtar adıyla tümleştirme çalışma zamanı anahtarını yeniden oluşturur. Önceki anahtar geçersiz olur.
...
### Microsoft. Azure. Commands. SYNAPSE. modeller. Psıntegrationruntimekeys
