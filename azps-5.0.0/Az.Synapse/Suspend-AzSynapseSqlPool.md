...
## SYNOPSIS
SYNAPSE Analytics SQL havuzunu askıya alır.

## INDEKI

### SuspendByNameParameterSet (varsayılan)
```
...
## Tanım
**Suspend-AzSynapseSqlPool** cmdlet 'ı bir Azure SYNAPSE Analytics SQL havuzunu askıya alır.
...
Bu komut, etkin bir Azure SYNAPSE Analytics SQL havuzunu askıya alır.
