...
## SYNOPSIS
SYNAPSE Analytics SQL havuzunun geri yüklenebildiği ayrı geri yükleme noktalarını getirir.
...
## Tanım
**Get-AzSynapseSqlPoolRestorePoint** cmdlet 'ı, Azure SYNAPSE Analytics SQL havuzunun geri yüklenemeyebilecek ayrı geri yükleme noktalarını alır.
...
Bu komut, ContosoSqlPool adlı Azure SYNAPSE Analytics SQL havuzu için kullanılabilir tüm geri yükleme noktalarını döndürür.
...
### Microsoft. Azure. Management. SYNAPSE. modeller. RestorePoint
