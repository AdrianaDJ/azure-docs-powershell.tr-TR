...
### Runmini Ifade değeri (varsayılan)
```
...
### Runmini ifade Durumüpdınputobjectparameterset
```
...
### Runmini Ifade Statebycodepathandınputobjectparameterset
```
Invoke-AzSynapseSparkStatement -Language <String> -SessionObject <PSSynapseSparkSession> [-SessionId <Int32>]
...
## Tanım
**Invoke-AzSynapseSparkStatement** cmdlet 'ı bir Synapse Analytics Spark deyimini çağırır.
...
Bu komutlar, bir Spark oturumu başlatır ve ardından satır içi Spark deyimini ardışık düzen aracılığıyla başlatır.
...
Bu komutlar, bir Spark oturumu başlatır ve ardından satır içi Spark deyimini başlatır.
...
Bu komutlar, bir Spark oturumu başlatır ve bir dosyada Spark deyimlerini çağırır.
...
### -DosyaYolu
Yürütme kodunu içeren yerel bir dosya yolunu belirtir.
...
### -Response
Tam yanıtın döndürülmesini belirtir.
...
### Microsoft. Azure. Commands. SYNAPSE. modeller. PSSynapseExtendedSparkStatement
