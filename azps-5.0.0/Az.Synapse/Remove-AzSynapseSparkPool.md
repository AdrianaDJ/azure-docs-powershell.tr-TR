...
## Tanım
**Remove-AzSynapseSparkPool** cmdlet 'ı bir Azure SYNAPSE Analytics Spark havuzunu kalıcı olarak siler.
...
Bu komut bir Azure SYNAPSE Analytics Spark havuzunu siler.
...
Bu komut bir Azure SYNAPSE Analytics Spark havuzunu ardışık düzen aracılığıyla siler.
...
Bu komut, kaynak KIMLIĞIYLE bir Azure SYNAPSE Analytics Spark havuzunu siler.
