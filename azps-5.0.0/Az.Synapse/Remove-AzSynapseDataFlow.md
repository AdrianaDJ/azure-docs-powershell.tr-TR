...
## Tanım
**Remove-AzSynapseDataFlow** cmdlet 'i çalışma alanından veri akışını kaldırır.
...
Bu komut, ContosoDataFlow adlı veri akışını ContosoWorkspace adlı çalışma alanından kaldırır.
