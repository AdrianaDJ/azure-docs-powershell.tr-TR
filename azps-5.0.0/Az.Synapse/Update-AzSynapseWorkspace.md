...
## Tanım
**Update-AzSynapseWorkspace** cmdlet 'ı bir Azure SYNAPSE Analytics çalışma alanını güncelleştirir.
...
Bu komutlar, belirli bir Azure SYNAPSE Analytics çalışma alanı için etiketleri güncelleştirir.
...
Bu komutlar, ardışık düzen aracılığıyla belirli bir Azure SYNAPSE Analytics çalışma alanı için etiketleri güncelleştirir.
...
Bu komutlar, kaynak KIMLIĞI ile ardışık düzen aracılığıyla belirtilmeyen Azure SYNAPSE analitik çalışma alanı etiketlerini güncelleştirir.
...
Çalışma alanı için yeni SQL Yöneticisi parolası.
