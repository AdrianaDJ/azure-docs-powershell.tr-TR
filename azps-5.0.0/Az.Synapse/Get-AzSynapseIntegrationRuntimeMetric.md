...
## Tanım
**Get-AzSynapseIntegrationRuntimeMetric** cmdlet 'i, çalışma alanındaki tümleştirme çalışma zamanı hakkında ölçüm verilerini alır.
...
Bu komut, ContosoWorkspace adlı çalışma alanındaki ' test-Selfhost-IR ' adlı tümleştirme çalışma zamanı hakkında ölçüm verilerini görüntüler.
...
### Microsoft. Azure. Commands. SYNAPSE. modeller. Psıntegrationruntimeölçüler
