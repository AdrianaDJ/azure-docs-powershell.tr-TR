...
## Tanım
**Stop-AzSynapseSparkSession** cmdlet 'ı SYNAPSE Analytics Spark oturumunu durdurur.
...
Bu komut, SYNAPSE Analytics Spark oturumunu durdurur.
...
Bu komut SYNAPSE Analytics Spark oturumunu ardışık düzen aracılığıyla durdurur.
