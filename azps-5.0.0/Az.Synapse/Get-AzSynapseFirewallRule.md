...
## Tanım
**Get-AzSynapseFirewallRule** cmdlet 'ı bir Azure SYNAPSE Analytics güvenlik duvarı kuralını alır.
Bir kural adı belirtmezseniz, bu cmdlet tüm kuralları alır.
...
Bu komut, çalışma alanı altındaki tüm güvenlik duvarı kurallarını alır.
...
Bu komut, ardışık düzen aracılığıyla tüm güvenlik duvarı kurallarını alır.
