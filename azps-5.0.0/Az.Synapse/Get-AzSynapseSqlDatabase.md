...
## SYNOPSIS
SYNAPSE Analytics SQL veritabanını alır.
...
## Tanım
[Bu özellik, başlangıçta yalnızca belirli aboneliklerde erişilebilen sınırlı bir önizlemede.] **Get-AzSynapseSqlDatabase** cmdlet 'ı bir Azure SYNAPSE Analytics SQL veritabanı hakkında bilgi alır.
...
Bu komut, çalışma alanı altındaki tüm SQL veritabanlarını alır.
...
Bu komut, çalışma alanı adı ContosoSqlDatabase ile SQL veritabanını alır.
...
Bu komut, ardışık düzen aracılığıyla tüm SQL veritabanlarını alır.
...
Bu komut, SQL veritabanını belirtilen kaynak KIMLIĞIYLE alır.
...
### -RESOURCEID
SYNAPSE SQL veritabanının kaynak tanımlayıcısı.
...
### Microsoft. Azure. Commands. SYNAPSE. modeller. PSSynapseSqlDatabase
