...
## Tanım
**Stop-AzSynapseSparkStatement** cmdlet 'ı bir Synapse Analytics Spark deyimini iptal eder.
...
Bu komut, belirtilen Livy KIMLIĞIYLE Spark deyimini iptal eder.
...
Bu komut, ardışık düzen aracılığıyla belirtilen Livy KIMLIĞI ile Spark deyimini iptal eder.
