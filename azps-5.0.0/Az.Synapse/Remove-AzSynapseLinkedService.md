...
## Tanım
**Remove-AzSynapseLinkedService** cmdlet 'i çalışma alanından bağlantılı hizmeti kaldırır.
...
Bu komut, ContosoLinkedService adındaki bağlantılı hizmeti ContosoWorkspace adlı çalışma alanından kaldırır.
...
Bu komut, ContosoLinkedService adındaki bağlantılı hizmeti Contosoçalışma alanı adlı çalışma alanından ardışık düzen aracılığıyla kaldırır.
