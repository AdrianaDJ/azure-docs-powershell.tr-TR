...
### Örnek 1: ada göre bir Windows sanal masaüstü çalışma
```powershell
...
Bu komut, kaynak grubunda Windows sanal masaüstü çalışma alanı oluşturur.

### Örnek 2: ada göre bir Windows sanal masaüstü çalışma
```powershell
PS C:\> New-AzWvdWorkspace -ResourceGroupName ResourceGroupName `
                        -Name WorkspaceName `
                        -Location 'eastus' `
