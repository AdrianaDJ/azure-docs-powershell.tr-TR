...
### Örnek 1: Windows sanal masaüstü
```powershell
...
Bu komut, kaynak grubundaki Windows sanal masaüstü çalışma alanını alır.

### Örnek 2: Windows sanal masaüstü çalışma alanlarını listeleyin
```powershell
...
Bu komut, kaynak grubundaki Windows sanal masaüstü çalışma alanlarını listeler.
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. ıworkspace
