...
### Örnek 1: Windows sanal masaüstü UserSession adını adıyla silme
```powershell
...
Bu komut, bir oturum ana bilgisayarında Windows sanal masaüstü Kullanıcı oturumunu siler.
...
### -Force
Kullanıcı oturumunu kapatma bayrağı.
