...
### Örnek 1: Windows sanal masaüstü uygulaması grubunu kaydettirme
```powershell
...
Bu komut bir Windows sanal masaüstü uygulama grubunu çalışma alanına kaydeder.

## PARAMETRELERINE

### -ApplicationGroupPath
ApplicationGroupPath yolu
