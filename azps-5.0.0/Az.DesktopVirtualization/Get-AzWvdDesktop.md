...
### Örnek 1: ada göre bir Windows Sanal Masaüstü Masaüstü edinme
```powershell
...
Bu komut, bir grup grubundaki Windows sanal masaüstü masaüstünü alır.

### Örnek 2: Windows sanal masaüstü masaüstlerini Listele
```powershell
...
Bu komut listsWindows sanal masaüstü masaüstü bilgisayarları.
...
### -Ad
Belirtilen masaüstü grubundaki masaüstünün adı
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. ıdesktop

### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. ıdesktoplist
