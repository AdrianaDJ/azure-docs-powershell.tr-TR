...
### Örnek 1: Windows sanal masaüstü kayıt belirteci oluşturma
```powershell
...
Bu komut, bir konak havuzunda Windows sanal masaüstü kayıt belirteci oluşturur.
...
### Microsoft. Azure. PowerShell. cmdlet. DesktopVirtualization. modeller. Api20191210Preview. ıregistrationınfo
