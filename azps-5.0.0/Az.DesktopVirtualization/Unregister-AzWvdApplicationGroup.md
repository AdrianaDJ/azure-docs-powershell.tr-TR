...
### Örnek 1: Windows sanal masaüstü uygulama grubunun kaydını silme
```powershell
...
Bu komut Windows sanal masaüstü uygulaması grubunu çalışma alanına siler.

## PARAMETRELERINE

### -ApplicationGroupPath
ResourceGroupName yolu
