...
## Tanım
Remove-AzDataFactoryV2DataFlow cmdlet 'i Azure Veri Fabrikası 'ndan veri akışını kaldırır.
...
Bu komut, WikiADF adındaki dataflow5 adındaki veri akışını kaldırır.
