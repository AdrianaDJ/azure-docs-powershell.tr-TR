...
## Tanım
Get-AzDataFactoryV2Pipeline cmdlet 'i Azure Veri Fabrikası 'ndaki ardışık düzenler hakkında bilgi alır.
...
### Örnek 4: ilk etkinliğin girişleri hakkında bilgi edinme
```powershell
