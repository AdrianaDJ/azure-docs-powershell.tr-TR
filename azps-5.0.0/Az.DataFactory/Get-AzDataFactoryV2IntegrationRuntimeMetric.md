...
## Tanım
Get-AzDataFactoryV2IntegrationRuntimeMetric cmdlet 'i, veri fabrikasında Integration Runtime hakkında ölçüm verilerini alır.

## ÖRNEKLERDEN

### Örnek 1: Tümleştirme çalışma zamanı ölçüsünü alma
```
...
Bu komut, ' RG-test-dfv2 ' ve ' test-df-EU2 ' adlı veri fabrikası için abonelikteki ' test-Selfhost-IR ' adlı tümleştirme çalışma zamanı hakkında ölçüm verilerini görüntüler.
...
### Microsoft. Azure. Commands. DataFactoryV2. modeller. Psıntegrationruntimeölçüler
