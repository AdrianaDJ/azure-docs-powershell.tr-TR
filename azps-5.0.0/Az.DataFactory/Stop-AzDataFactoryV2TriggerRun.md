...
## SYNOPSIS
Bir veri fabrikası içinde bir tetikleyiciyi çalıştırmayı durdurur.
...
## Tanım
**Stop-AzDataFactoryV2TriggerRun** cmdlet 'i tetik Name ve tetık Run ID ile belirtilen bir veri fabrikasında çalıştırılan bir tetikleyiciyi durdurur.
Şu anda WaitingOnDependency durumundaki TumblingWindowTriggers için desteklenmektedir.
...
Bu komut, fabrikanın fabrikada ' 08586002468005888497807248799CU16 ' ile çalıştırılmasını durdurur.
