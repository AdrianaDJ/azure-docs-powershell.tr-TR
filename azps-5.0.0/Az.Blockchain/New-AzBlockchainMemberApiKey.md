...
### Regenerategenişletilen (varsayılan)
```
...
### Regenerateviaıdentitygenişletilen
```
...
### Örnek 1: ad kullanan blockzincirine üyesinin API anahtarlarını yeniden üret
```powershell
...
Bu komut, ad, kaynak grubu kullanarak blockzincirine üye için API anahtarlarını yeniden oluşturur.

### Örnek 2: tanımlayıcıların kullanıldığı blockzincirine üye için API anahtarlarını yeniden üret
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Bu komut, kimlik kullanan blockzincirine üye için API anahtarlarını yeniden oluşturur.
...
### -AnahtarAdı
API anahtarı adını alır veya ayarlar.
...
### -Değer
API anahtar değerini alır veya ayarlar.
...
### Microsoft. Azure. PowerShell. cmdlet. Blockzincirine. modeller. Api20180601Preview. ıapıkey
