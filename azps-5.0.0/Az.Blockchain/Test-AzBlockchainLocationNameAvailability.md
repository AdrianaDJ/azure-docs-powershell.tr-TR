...
### Örnek 1: kaynak adının kullanılabilir olup olmadığını denetleme
```powershell
...
Komut, kaynak adının kullanılabilir olup olmadığını denetler.

### Örnek 2: kaynak adının kullanılabilir olup olmadığını denetleme
```powershell
...
### -Ad
Denetlenecek adı alır veya ayarlar.
...
### -Tür
Denetlenecek kaynağın türünü alır veya ayarlar.
...
### Microsoft. Azure. PowerShell. cmdlet. Blockzincirine. modeller. Api20180601Preview. INameAvailability
