...
### Örnek 1: yeni blockzincirine üye oluşturma
```powershell
...
Bu komut yeni bir blockzincirüyesi oluşturur.
...
### -Consortium
Blockzincirine üye için konsorsiyum alır veya ayarlar.
...
Konsorsiyumun görünen adını alır.
...
### -ConsortiumRole
Konsorsiyumun üyesinin rolünü alır.
...
### -FirewallRule
Yapılandırmak Için güvenlik duvarı kurallarını alır veya ayarlar, FIREWALLRULE özellikleri için Notlar bölümüne bakın ve karma tablo oluşturun.
...
### -Konum
Blockzincir hizmetinin COĞRAFI konumu.
...
### -Parola
Blockzincirine üyesinin temel auth parolasını ayarlar.
...
### -İletişim kuralı
Blockzincirleri protokolünü alır veya ayarlar.
...
### -SkuTier
SKU katmanını alır veya ayarlar
...
### -Validatornosuucapacity
Düğümlerin kapasitesini alır veya ayarlar.
