...
## Tanım
Remove-AzCdnOrigin, belirtilen uç noktadaki CDN kaynağını silecek. Kaynak, belirtilen uç noktadaki tek kaynak ise, en az 1 başlangıç gerektiğinden silme işlemi başarısız olur. 
...
```
Bu cmdlet belirtilen kaynağı belirtilen uç noktasından kaldırır. 
