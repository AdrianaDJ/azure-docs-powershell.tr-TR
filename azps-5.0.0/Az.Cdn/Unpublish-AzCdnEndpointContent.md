...
## Tanım
**Yayımdan kaldırma-AzCdnEndpointContent** cmdlet 'ı Azure Içerik teslim ağı (CDN) uç noktasındaki içeriği temizler.
...
### -CdnEndpoint
Bu cmdlet 'in temizler bitiş noktasını belirtir.
...
### -EndpointName
Bu cmdlet 'in temizler uç noktasının adını belirtir.
...
### -PurgeContent
Bu cmdlet 'in temizler olduğu kaynak sunucuda içeriğin göreli yollarının dizisini belirtir.
