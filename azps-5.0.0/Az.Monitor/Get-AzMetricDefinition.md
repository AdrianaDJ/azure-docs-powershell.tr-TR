...
## Tanım
**Get-AzMetricDefinition** cmdlet 'i, metrik tanımları alır.

## ÖRNEKLERDEN

### Örnek 1: kaynağın metrik tanımlarını alma
```
...
Bu komut, belirtilen kaynağın ölçüm tanımlarını alır.

### Örnek 2: ayrıntılı çıktıyla metrik tanımları alma
```
...
Bu komut, website2 için ölçüm tanımlarını alır.
Çıktı

### Örnek 3: ad ile metrik tanımları alma
```
...
Bu komut, BytesSent ve CpuTime ölçümlerinin tanımlarını alır.
Çıktı
...
### -MetricNamespace
Ölçüm tanımlarının sorgu olarak kullanılacağını belirtir.
