...
## Tanım
Bu komut yalnızca "etkin" özelliğini güncelleştiren bir günlük uyarısı kuralını güncelleştirir.
Diğer özellikleri güncelleştirmek için [set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) komutunu inceleyin.

## ÖRNEKLERDEN

### Örnek 1: kural adına göre güncelleştirme
```powershell
...
### Örnek 2: giriş nesnesine göre güncelleştir
```powershell
...
### Örnek 3: kaynak kimliğiyle güncelleştirme
```powershell
...
### Özellikli
Azure uyarı durumu-geçerli değerler-$true, $false
