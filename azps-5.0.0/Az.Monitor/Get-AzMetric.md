...
### GetWithDefaultParameters (varsayılan)
```
...
## Tanım
**Get-Azmetrik** cmdlet 'i, belirli bir kaynağın metrik değerlerini alır.
...
Bu komut, sayfa görünümleri ölçümünün belirtilen boyut filtresi ve toplama türü ile özetlenmiş çıktısını alır.

## PARAMETRELERINE

### -AggregationType
Sorgunun toplama türü
...
### -MetricFilter
Ölçümleri sorgulamak için ölçüm boyutu filtresini belirtir.
...
### -MetricNamespace
Ölçümleri sorgulamak için ölçü ad boşluğunu belirtir.
...
### -OrderBy
Sonuçları sıralarken kullanılacak toplamı ve sıralamanın yönünü belirtir (örnek: Sum ASC).
...
### -ResultType
Döndürülecek sonuç türünü belirtir (meta veriler veya veriler).
...
### -Üst
$Filter ile belirtiye alınacak en fazla kayıt sayısını (varsayılan: 10) belirtir.
...
### System. Nullable ' 1 [[Microsoft. Azure. Management. Monitor. modeller. AggregationType, Microsoft. Azure. Management. Monitor, Version = 0.21.0.0, Culture = neutral, PublicKeyToken = 31bf3856ad364e35]]
...
### System. Nullable ' 1 [[Microsoft. Azure. Management. Monitor. modeller. ResultType, Microsoft. Azure. Management. Monitor, Version = 0.21.0.0, Culture = neutral, PublicKeyToken = 31bf3856ad364e35]]
...
Desteklenen ölçümler hakkında daha fazla bilgiyi şu adreste bulabilirsiniz: https://docs.microsoft.com/en-us/azure/azure-monitor/platform/metrics-supported
