...
Bu komut tüm sürümleri contoso adlı anahtar kasasına ITPfx adlı anahtarla alır.
...
### Örnek 5: silinen, ancak bu Anahtar Kasası için temizlenmiş tüm anahtarları edinin
```powershell
...
### Örnek 7: filtreleme kullanarak anahtar kasasındaki tüm anahtarları alma
```powershell
...
Bu komut, "test" ile başlayan contoso adlı tuş kasasındaki tüm anahtarları alır.
...
Bu, HSM korumalı anahtarları Azure Anahtar Kasası 'na almanın bir adımıdır. Öğrenmek https://docs.microsoft.com/en-us/azure/key-vault/keys/hsm-protected-keys
...
### -Çıkışdosyası
Bu cmdlet 'in anahtarı kaydettiği çıkış dosyasını belirtir. Genel anahtar varsayılan olarak PEM biçiminde kaydedilir.
