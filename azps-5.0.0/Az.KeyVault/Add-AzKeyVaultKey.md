...
### Örnek 7: "kendi anahtarınızı yapma" (BYOK) özelliğini sağlayan bir anahtar değişimi anahtarı (KEK) oluşturma

```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName $vaultName -Name $keyName -Destination HSM -Size 2048 -KeyOps "import"
```

Bir anahtar (anahtar değişimi anahtarı (KEK) olarak adlandırılır) oluşturur. KEK yalnızca içeri aktarma anahtarı olan bir RSA-HSM anahtarı olmalıdır. Yalnızca Key kasa Premium SKU 'SU RSA-HSM anahtarlarını destekler.
Daha fazla bilgi için lütfen https://docs.microsoft.com/en-us/azure/key-vault/keys/hsm-protected-keys
...
- ISS
- ayarlandığını
- İçeri Aktar (yalnızca KEK için, bkz: örnek 7)
