...
Anahtar Kasası oluşturma ve $myNetworkResId tarafından belirtilen sanal ağdan belirtilen IP adresine erişim izni vermek için ağ kurallarını belirtir. `New-AzKeyVaultNetworkRuleSetObject`Daha fazla bilgi için bkz.
...
Belirtilmişse, veri eylemlerine rol tabanlı erişim denetimi (RBAC) tarafından yetki verme izni verir ve ardından kasa özelliklerinde belirtilen erişim ilkeleri yok sayılır. Yönetim eylemlerine her zaman RBAC ile yetki verildiğini unutmayın.
...
### -Konum
Anahtar Kasası oluşturacağınız Azure bölgesini belirtir. Seçimlerinizi görmek için [Get-AzLocation](https://docs.microsoft.com/powershell/module/Azure/Get-AzLocation) komutunu kullanın.
...
### -NetworkRuleSet
Kasanın ağ kuralı kümesini belirtir. Belirli ağ konumlarından Anahtar Kasası erişilebilirliğini yönetir. Oluşturan `New-AzKeyVaultNetworkRuleSetObject` .
