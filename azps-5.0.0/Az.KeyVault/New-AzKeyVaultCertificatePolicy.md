...
Bir bellek içi sertifika ilkesi nesnesi oluşturur. oluşturulmuş
...
### Örnek 3: konu diğer adı (veya SAN) sertifikası oluşturma
...
Bu örnek, 3 DNS adı olan bir SAN sertifikası oluşturur.

## PARAMETRELERINE

### -CertificateTransparency
Sertifika saydamlığının bu sertifika/veren için etkinleştirilip etkinleştirilmediğini gösterir; belirtilmezse, varsayılan değer ' doğru ' olur
...
### -Eğri
Sertifikanın anahtarının eliptik eğri adını belirtir.
...
### -DnsName
Sertifikadaki DNS adlarını belirtir. Konu diğer adları (San) DNS adları olarak belirtilebilir.
...
> [!NOTE]
> Parametrede bir özellik içinde virgül (,) veya nokta (.) kullanmanız gerekiyorsa `SubjectName` , özellik alanını tırnak işaretleri içine almalısınız. Örneğin, O = "contoso, Ltd." kullanabilirsiniz. Kuruluş adı alanında.
