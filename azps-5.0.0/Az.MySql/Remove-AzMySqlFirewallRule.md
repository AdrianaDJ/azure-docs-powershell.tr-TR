...
### Örnek 1: MySql güvenlik duvarı kuralını adla kaldırma
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Bu cmdlet MySql güvenlik duvarı kuralını adıyla kaldırır.

### Örnek 2: MySql güvenlik duvarı kuralını kimlikle kaldırma
```powershell
...
Bu cmdlet 'ler, MySql güvenlik duvarı kuralını kimlik ile kaldırır.
