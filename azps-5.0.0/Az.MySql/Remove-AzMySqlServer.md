...
### Örnek 1: resourceGroup ve sunucu adına göre MySql sunucusunu kaldırma
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Bu cmdlet, resourceGroup ve sunucu adına göre MySql sunucusunu kaldırır.

### Örnek 2: MySql sunucusunu kimliğe göre kaldırma
```powershell
...
Bu cmdlet 'ler, MySql sunucusunu kimliğe göre kaldırır.
