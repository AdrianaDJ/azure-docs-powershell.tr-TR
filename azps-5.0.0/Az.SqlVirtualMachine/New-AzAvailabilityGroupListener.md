...
## Tanım
New-AzAvailabilityGroupListener cmdlet 'i yeni bir kullanılabilirlik grubu dinleyicisi oluşturur.
...
SQL sanal makine grubunda AvailabilityGroup01 kullanılabilirlik grubu için yeni bir kullanılabilirlik grubu dinleyicisi AgListener01 oluşturur.
...
### -Kullanılabilirlik Grupadi
Kullanılabilirlik grubu adı.
...
### -Loadbalancerresourceıd
Yük dengeleyici kimliği
...
### -Bağlantı noktası
AĞ dinleyicisi bağlantı noktası numarası. Varsayılan değer 1433 ' dır.
...
### -Publicıpadresresourceıd
Ortak IP adresi kaynak kimliği
...
### -Sqlvirtualmachineıd
SQL VM kaynak kimliklerinin listesi
