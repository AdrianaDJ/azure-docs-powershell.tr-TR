...
### Örnek 1: bağlantılı makine olarak kullandığınız makine
```powershell
...
Bağlı bir makine olarak kullandığınız makine.

### Örnek 2: bağlı bir cihaz olarak uzak bir makine
```powershell
...
Uzak bir makineyi PowerShell uzaktan iletişimi kullanan bağlı bir cihaz olarak kullanın.
Not: Şu anda yalnızca hedefin penceresi destekleniyor.
...
### -Konum
Oluşturulan ConnectedMachine için konum.
...
### -Ad
Bu makine için kullanılacak ad.
Varsayılan olarak ana bilgisayar adı kullanılır.
...
### -Proxy
Kullanılacak ara sunucunun URI 'SI
...
### -PSSession
Belirtildiğinde, Azure 'a makinalar kullanan komut her Psoturumunda çalışacaktır.
Not: Bu, yalnızca Windows 'da çalışır.
...
### -ResourceGroupName
Makineyi eklemek istediğiniz kaynak grubunun adı.
...
### -SubscriptionID
Makineyi eklemek istediğiniz aboneliğin KIMLIĞI.
