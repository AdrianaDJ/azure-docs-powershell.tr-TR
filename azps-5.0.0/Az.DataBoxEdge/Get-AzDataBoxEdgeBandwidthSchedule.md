...
## Tanım
**Get-AzDataBoxEdgeBandwidthSchedule** cmdlet 'ı bant genişliği zamanlamalarıyla ilgili bilgileri alır. Belirli bir bant genişliği zamanlama hakkında bilgi almak için kaynak grubu adı ve cihaz adıyla birlikte bir zamanlamanın adını belirtebilirsiniz
