...
## Tanım
**Remove-AzDataBoxEdgeStorageAccount** cmdlet 'i, bir veri kutusu uç aygıtının Ilişkili kenar depolama hesabını kaldırır. Cmdlet 'teki bir parametre olarak kaldırılacak Edge depolama hesabının adını belirtebilirsiniz.
