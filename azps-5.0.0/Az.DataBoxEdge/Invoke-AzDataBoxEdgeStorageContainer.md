...
## Tanım
**Invoke-AzDataBoxEdgeStorageContainer** cmdlet 'i, bir veri kutusu uç aygıtındaki bir depolama kapsayıcısındaki verileri yenilemeye yönelik eylemleri başlatır. 
...
### -RefreshData
Buluttan verilerle kapsayıcı meta verilerini yenileme
