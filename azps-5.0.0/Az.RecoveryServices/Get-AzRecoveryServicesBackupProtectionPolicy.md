...
Korunan kaynakların sınıfı. Şu anda bu cmdlet için desteklenen değerler AzureVM, AzureStorage, AzureWorkload
...
### -WorkloadType
Kaynağın iş yükü türü. Desteklenen geçerli değerler AzureVM, AzureFiles, MSSQL
