...
## Tanım
**Enable-AzRecoveryServicesBackupProtection** cmdlet 'i, bir koruma ilkesini öğeyle ilişkilendirerek yedekleme özelliğini etkinleştirir.
...
İkinci cmdlet, yedeklenecek disk LUN 'Ları belirtir ve $inclusionDiskLUNS değişkeninde depolar.
Üçüncü cmdlet $Pol ilkeyi kullanarak V2VM adındaki ARM sanal makinesi için yedekleme koruma ilkesini ayarlar.

### Örnek 2

Belirtilen yedekleme koruma ilkesine sahip bir öğe için yedeklemeyi etkinleştirmiştir. oluşturulmuş
...
### -ExcludeAllDataDisks
Yalnızca işletim sistemi disklerini yedeklemeyi belirtme seçeneği
...
### -ExclusionDisksList
Yedeklemede dışlanacak disk LUN 'Ları listesi, Rest otomatik olarak eklenir.
...
### -Her Ikisi de
Yedeklemeye dahil edilecek disk LUN 'Ları listesi ve REST, işletim sistemi diski dışında otomatik olarak dışlanır.
...
**Azurermrecoveryservicesbackupprotectionpolicy** nesnesi almak için Get-AzRecoveryServicesBackupProtectionPolicy cmdlet 'ini kullanın.
...
### -Korunabilir öğe
Verilen ilke ile korunacak öğeyi belirtir.
...
### -Resetexclusııısettings
Öğeyle ilişkilendirilmiş disk dışlama ayarını sıfırlama
...
### -StorageAccountName
Azure dosya paylaşımı depolama hesabı adı
