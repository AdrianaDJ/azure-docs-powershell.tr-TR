...
## Tanım
**Yeni-Azrecoveryservicesasrreplicationkorutdıtem** cmdlet 'i, yeni bir çoğaltma korumalı öğesi oluşturur.
...
Seçmeli diskler dahil olmak üzere belirtilen ASR korunabilir öğesi için çoğaltma korumalı öğe oluşturma işlemini başlatır ve seçili disklerle işlemi izlemek için kullanılan ASR işini (vmWare-Azure senaryosu) döndürür.
...
Belirtilen VMID için çoğaltma korumalı öğe oluşturma işlemini başlatır ve işlemi izlemek için kullanılan ASR işini (Azure 'dan Azure 'a) döndürür. Şifreleme cmdlet 'inde geçirilen yük devretme VM ayrıntıları için kullanılır.
...
Yakınlık yerleştirme grubundaki bir sanal makine için çoğaltma korumalı öğe oluşturma işlemini başlatır ve işlemi izlemek için kullanılan ASR işini (Azure 'dan Azure 'a) döndürür.
...
### -AzureToAzure
Switch parametresi Azure 'dan Azure 'da yinelenen öğenin oluşturulmasını belirtir.
...
Azure için VM 'den Azure olağanüstü durum kurtarma senaryosuna kullanılacak disk yapılandırmasını belirtir.
...
### -AzureVmId
Kurtarma bölgesindeki olağanüstü durum kurtarma koruması için Azure VM kimliğini belirtir.
...
### -DiskEncryptionSetId
Yönetilen disklerin şifrelenmesi için kullanılacak disk şifrelemesi kümesinin kaynak kimliğini belirtir.
...
Yük devretmenin ardından kurtarma VM olarak kullanılacak disk şifrelemesi gizli kasası KIMLIĞINI (Azure disk şifrelemesi) belirtir.
...
### -DiskType
Kurtarma VM yönetimli disk türünü belirtir.
...
Belirtilen korunabilir öğeden korunacak vMWare disk kimliği için disk yapılandırması girişini belirtir.
...
### -KeyEncryptionKeyUrl
Sürüm yerine çalışma sonrasında kurtarma VM olarak kullanılacak sürüm (Azure disk şifrelemesi) içeren disk şifrelemesi anahtar URL 'sini belirtir.
...
Yük devretmenin ardından kurtarma VM olarak kullanılacak disk şifrelemesi anahtarı Anahtar Kasası KIMLIĞI 'ni (Azure disk şifrelemesi) belirtir.
...
Yük devretmenin ardından kurtarma VM kullanılabilirlik bölgesini belirtir.
...
Hedef kurtarma bölgesinde yük devretme VM tarafından kullanılan yakınlık Yerleşim grubu kimliğini belirtin.
