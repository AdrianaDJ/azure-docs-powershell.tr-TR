...
## Tanım
Get-AzRecoveryServicesBackupRPMountScript cmdlet 'i, çalıştırıldığı makinede kurtarma noktası birimlerini takar.

## ÖRNEKLERDEN

### Örnek 1: kurtarma noktası bağlama
```powershell
...
Komut dosyası çalıştırıldığında, kurtarma noktasının \[ dosyalarını $RP\]

### Örnek 2

Kurtarma noktasının tüm dosyalarını bağlamak için bir betik indirir. oluşturulmuş
...
### -Yol
Dosya kurtarma durumunda dosyanın indirileceği konum. -Path sağlanmazsa, komut dosyası geçerli dizine indirilir.
...
### Microsoft. Azure. Commands. RecoveryServices. Backup. cmdlet. model. RPMountScriptDetails
