...
## Tanım
**Disable-AzRecoveryServicesBackupProtection** cmdlet 'ı Azure yedekleme korumalı bir öğenin korumasını devre dışı bırakır.
Bu cmdlet, bir öğenin olağan zamanlanmış yedeklemesini durdurur.
Bu cmdlet, RemoveRecoveryPoints parametresiyle yürütülürse yedekleme öğesi için var olan kurtarma noktalarını silebilir.
...
Yedekleme korumalı öğenin korumasını devre dışı bırakır. oluşturulmuş
