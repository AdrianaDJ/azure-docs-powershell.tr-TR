...
## Tanım
Bir vMWare sanal makine diskini, diski çoğaltmak için kullanılacak önbellek depolama hesabına ve hedef yönetilen disk türüne (kurtarma bölgesi) eşleyen bir disk eşleme nesnesi oluşturur.
...
Çoğaltılacak vMWare sanal makine disklerinin disk eşleme nesnesi oluşturma. VMWare makinesi için korumayı etkinleştirme sırasında kullanılır.
...
### -DiskId
Bu eşlemenin karşılık geldiği diskin DiskID 'yi belirtin.
...
### -DiskType
Kurtarma diski türünü belirtir.
