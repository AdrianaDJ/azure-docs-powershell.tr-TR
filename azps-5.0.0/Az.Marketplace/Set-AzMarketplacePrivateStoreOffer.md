...
## Tanım
Kiracı kapsamı altında oluşturulmuş özel mağaza için bu teklifi güncelleştirir veya oluşturur.
...
Kiracı kapsamı altında oluşturulmuş özel mağaza için özel + genel planlar içeren teklif oluşturur. 
...
Yalnızca abonelik kapsamı altında oluşturulan özel mağaza için özel planlar içeren teklif oluşturur. 
...
Güncelleştirmeler, kiracı kapsamı altında oluşturulmuş özel mağaza için özel + genel planlarıyla birlikte sunulur. ETag gereklidir.
...
Güncelleştirmeler yalnızca abonelik kapsamı altında oluşturulan özel planlarla özel mağaza için geçerlidir. ETag gereklidir.
...
### -ETag
Azure Market privateStore 'ın güncelleştirme için eTag 'i
...
### -Privatestoreıd
Gerekli Azure Market privateStore teklifleri
...
Gerekli Azure Market privateStore teklifinin belirli plan kimlikleri sınırlaması
...
### Microsoft. Azure. Commands. Market. model. PrivateStore. Psprivatestoreteklifini
