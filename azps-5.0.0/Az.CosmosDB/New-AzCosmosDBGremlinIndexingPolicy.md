...
## SYNOPSIS
Yeni bir CosmosDB ındexingpolicy nesnesi oluşturur.
...
## Tanım
**New-Azcosmosdbgremlinındexingpolicy** cmdlet 'ı Psındexingpolicy türünde yeni bir nesne oluşturur.
...
### -Otomatik
Boole, Dizin ilkesinin otomatik olup olmadığını belirtecek şekilde
...
### -CompositePath
Microsoft. Azure. Commands. CosmosDB. PSCompositePath türünde nesneler dizisi dizisi
...
### -Excludedyolu
ExcludedPath içeren dizeler dizisi (Azure Cosmos DB hizmetinde dışlanacak bir JSON belgesi içindeki bir yol belirtir.)  öðelerinin.
...
### -Includedyol
Includedpath içeren dizeler dizisi (Azure Cosmos DB hizmeti.) öğelerine eklenecek bir JSON belgesi içindeki bir yol belirtir.
...
Olası değerler: ' tutarlı ', ' Lazy ', ' none '
...
### -SpatialSpec
Microsoft. Azure. Commands. CosmosDB. Psshaalspec türünde nesneler dizisi
