...
## SYNOPSIS
Psındexes türünde yeni bir nesne oluşturur. Set-Azcosmosdbgremlinıncludedpath için parametre değeri olarak iletilebilir.
...
## Tanım
API 'nin ıncludedpath's Indexes 'a karşılık gelen nesne.
