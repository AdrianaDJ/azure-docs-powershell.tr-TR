...
### -Şema
PSCassandraSchema nesnesi.
Bu nesneyi oluşturmak için New-AzCosmosDBCassandraSchema kullanın.
...
### -Üretim
Cassandra keyspace 'in üretimi (RU/s).
...
### Microsoft. Azure. Commands. CosmosDB. modeller. PSCassandraSchema
