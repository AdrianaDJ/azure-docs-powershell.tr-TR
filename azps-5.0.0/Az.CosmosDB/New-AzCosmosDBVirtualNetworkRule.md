...
### -ID
Alt ağın kaynak KIMLIĞI; örneğin:/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
...
Sanal ağın VNET hizmeti uç noktası etkinleştirilmeden önce güvenlik duvarı oluşturup oluşturmamı belirten Boole değeri.
...
### Microsoft. Azure. Commands. CosmosDB. modeller. PSVirtualNetworkRule
