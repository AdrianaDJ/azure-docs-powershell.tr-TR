...
## SYNOPSIS
CosmosDB Gremlın grafiğini siler.
...
## Tanım
**Remove-AzCosmosDBGremlinGraph** cmdlet 'ı Cosmosdb Gremlın grafiğini siler.
...
Cmdlet bool (ne zaman geçiş geçirilir) türünde, silme işlemi başarılıysa doğru olan bir nesneyi döndürür.
...
### -Geçiş
Kullanıcı çıktı almak isterse true olarak ayarlanır.
İşlem başarılı olduysa ve değilse hata atılır.
