...
## SYNOPSIS
CosmosDB Cassandra anahtar uzayını siler.
...
## Tanım
**Remove-AzCosmosDBCassandraKeyspace** cmdlet 'i var olan cosmosdb
...
Cmdlet, silme işlemi başarılı olmuşsa, bool (ne zaman geçiş geçirildiğinde) türünde bir nesne döndürür.
