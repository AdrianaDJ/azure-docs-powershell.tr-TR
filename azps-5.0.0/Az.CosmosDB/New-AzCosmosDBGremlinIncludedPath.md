...
## SYNOPSIS
Psıncludedpath türünde yeni bir nesne oluşturur. Set-AzCosmosDBGremlinGraph için parametre değeri olarak iletilebilir.
...
## Tanım
API 'nin ıncludedpath 'e karşılık gelen nesne.
