...
FailoverPolicies region1, FailoverPriority 1 olarak Region2, FailoverPriority 2 olarak ve FailoverPriority 3 olarak region3.
...
### -FailoverPolicy
Bölge adlarına sahip, yük devretme önceliğine göre sıralanan dizeler dizisi.
Örneğin eastus, westus
