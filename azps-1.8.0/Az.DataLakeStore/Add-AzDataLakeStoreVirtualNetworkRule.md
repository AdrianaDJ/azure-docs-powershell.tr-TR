...
## Tanım
**Add-AzDataLakeStoreVirtualNetworkRule** cmdlet 'ı belirtilen Data Lake Store hesabına bir sanal ağ kuralı ekler.
...
Bu, alt ağ kimliği "DLS" hesabında "myVNET" adlı yeni bir sanal ağ kuralı oluşturur

## PARAMETRELERINE

### -Hesap
Sanal ağ kuralı ekleme
...
### -SubnetId
Sanal ağ kuralının alt NetID değeri
