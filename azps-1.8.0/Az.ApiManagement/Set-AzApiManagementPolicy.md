...
## Tanım
**Set-Azapsananagementpolicy** cmdlet 'ı, API yönetimi için belirtilen kapsam ilkesini ayarlar.
...
### Biçimli
İlkenin biçimini belirtir. Kullanıldığında `application/vnd.ms-az-apim.policy+xml` , ilkenin içerdiği Ifadeler XML kaçışlı olmalıdır. Bunu kullanırken `application/vnd.ms-az-apim.policy.raw+xml` , ILKENIN **not** XML kaçılması gerekmez.
Varsayılan değer `application/vnd.ms-az-apim.policy+xml` .
