...
## SYNOPSIS
Yeni bir örnek oluştur DataMigration Azure ActiveDirectory uygulaması ayrıntıları.
...
```
ApplicationId: "AppID/hizmet asıl kimliği burada" AppKey: System. Security. SecureString Tenantıd: "Kiracı kimliği"

## PARAMETRELERINE

### -AppKey
Azure Active Directory anahtarı
...
### Microsoft. Azure. Commands. DataMigration. modeller. PSAzureActiveDirectoryApp
