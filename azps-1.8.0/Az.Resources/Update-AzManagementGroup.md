...
## Tanım
**Update-AzManagementGroup** cmdlet 'ı bir yönetim grubu için **parentID** veya **DisplayName** 'i güncelleştirir.

## ÖRNEKLERDEN

### Örnek 1: yönetim grubunun görünen adını güncelleştirme
```
...
### Örnek 2: yönetim grubunun üst öğesini güncelleştirme
```
...
### Örnek 3: bir yönetim grubunu, PSManagementGroup nesnesini kullanarak güncelleştirme
```
...
### Örnek 4: ParentObject kullanarak yönetim grubunun üst öğesini güncelleştirme
```
