...
## Tanım
**Set-AzResourceLock** cmdlet 'i kaynak kilidini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: kilidin notlarını güncelleştirme
```
PS C:\>Set-AzResourceLock -LockLevel CanNotDelete -LockNotes "Updated note" -LockName "ContosoSiteLock" -ResourceName "ContosoSite" -ResourceType "microsoft.web/sites" -ResourceGroupName "ResourceGroup11"
```

Bu komut, ContosoSiteLock adındaki kilit için notu güncelleştirir.
...
### -LockId
Bu cmdlet 'in değiştirdiği kilidin KIMLIĞINI belirtir.
...
Şu anda tek geçerli değer CanNotDelete.
...
### -LockName
Bu cmdlet 'in değiştirdiği kilidin adını belirtir.
...
### -ResourceType
Kilidin uygulandığı kaynak türünü belirtir.
