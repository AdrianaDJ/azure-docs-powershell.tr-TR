...
### Örnek 2: var olan bir fabrika nesnesini kullanarak repoconfiguration ayrıntılarını içeren bir veri fabrikası oluşturun.
```
...
### -Ana bilgisayar adı
Refpo yapılandırması için ana bilgisayar adı.
...
### -ProjectName
Refpo yapılandırması için proje adı.
...
### -Tenantıd
Repo yapılandırması için Kiracı kimliği.
