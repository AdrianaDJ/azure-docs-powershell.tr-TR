...
## Tanım
**Remove-AzDataFactoryV2Trigger** cmdlet 'i Veri Fabrikası 'ndan bir tetikleyiciyi kaldırır. _Force_ parametresi belirtilirse, cmdlet tetikleyiciyi kaldırmadan önce istemez.
