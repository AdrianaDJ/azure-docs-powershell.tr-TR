...
## Tanım
**Set-AzStorageContainerAcl** cmdlet 'i, genel erişim iznini Azure 'da belirtilen depolama kapsayıcısına ayarlar.
...
Bu parametre için kabul edilebilir değerler şunlardır:-Container.
