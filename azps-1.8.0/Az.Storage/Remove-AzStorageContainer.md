...
## Tanım
**Remove-AzStorageContainer** cmdlet 'i Azure 'da belirtilen depolama kapsayıcısını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: kapsayıcıyı kaldırma
```
PS C:\>Remove-AzStorageContainer -Name "MyTestContainer"
```

Bu örnek MyTestContainer adlı kapsayıcıyı kaldırır.
...
### -Context
Kaldırmak istediğiniz kapsayıcının bağlamını belirtir.
New-AzStorageContext cmdlet 'ini oluşturmak için kullanabilirsiniz.
...
### -Ad
Kaldırılacak kapsayıcının adını belirtir.
