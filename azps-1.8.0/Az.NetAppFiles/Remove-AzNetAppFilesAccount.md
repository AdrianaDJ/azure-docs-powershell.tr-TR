...
## Tanım
**Remove-AzNetAppFilesAccount** cmdlet 'ı BIR ANF hesabını siler.
...
Bu komut "MyAnfAccount" ANF hesabını siler.
...
### -Geçiş
Belirtilen hesabın başarıyla kaldırıldığını döndürme
