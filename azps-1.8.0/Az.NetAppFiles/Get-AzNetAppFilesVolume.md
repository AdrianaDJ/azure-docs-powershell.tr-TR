...
## Tanım
**Get-AzNetAppFilesVolume** cmdlet 'inin ayrıntılarını alır.

## ÖRNEKLERDEN

### Örnek 1: ANF sesi edinme
```
...
Bu komut, "MyAnfPool" havuzundan MyAnfVolume adındaki birimi alır. 
...
### -PoolObject
Döndürülecek birimi içeren havuz nesnesi
