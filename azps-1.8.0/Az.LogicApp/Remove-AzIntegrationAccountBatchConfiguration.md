...
## Tanım
**Remove-Azıntegrationaccountbatchconfiguration** cmdlet 'i, tümleştirme hesabından toplu iş yapılandırmasını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: parametrelere göre bir toplu iş yapılandırmasını kaldırma
```powershell
...
"Sampleıntegrationaccount" tümleştirme hesabında bulunan "sampleBatchConfig" adlı toplu iş yapılandırmasını kaldırır.
...
### -Geçiş
Komutun başarılı olup olmadığını döndürün.
