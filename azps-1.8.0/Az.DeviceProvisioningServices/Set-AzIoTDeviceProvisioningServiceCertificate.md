...
## Tanım
Generate-doğrulama kodu çağrılarak elde edilen doğrulama kodunu içeren bir doğrulama sertifikası yükleyerek sertifikayı doğrulama. Bu, elinde bulunan en son adımdır.
...
"Mycertificate" özel anahtarının sahipliğini doğrulama.
...
Ardışık düzeni kullanarak "parolam" özel anahtarının sahipliğini doğrulayın.
...
### -Yol
x509 Certificate. cer dosyasının veya. pem dosyası yolunun temel 64 temsili
