...
Korumalı bir tablo öğesi için, belirtilen yedekleme koruma ilkesiyle Otomatik yedeklemeyi etkinleştirmiştir.
...
Bir kapsayıcıdan korunabilir öğeleri alın.
...
Yedeklenmiş öğenin zaman aralıklarını alma.
...
Yedekleme öğesi için kurtarma planı alın.
...
İş yüküne yeni DBMS 'ler için bir iş yapın.
...
Korunabilir kapsayıcıyı kaydeder.
