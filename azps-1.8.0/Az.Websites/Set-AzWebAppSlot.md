...
Bu komut Slot001 ile ilişkili appservice planını, varsayılan-Web-WestUS kaynak grubuyla ilişkili WebApp ContosoWebApp 'de değiştirir. Bu bağlantıyı kullanarak appservice planı ve onunla ilişkilendirilmiş kısıtlamaları değiştirme hakkında daha fazla bilgi.
