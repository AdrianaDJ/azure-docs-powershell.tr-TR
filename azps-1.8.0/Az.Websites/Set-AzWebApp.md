...
Bu komut, Default-Web-WestUS kaynak grubuyla ilişkili Web App ContosoWebApp ile ilişkili appservice planını değiştirir. Bu bağlantıyı kullanarak appservice planı ve onunla ilişkilendirilmiş kısıtlamaları değiştirme hakkında daha fazla bilgi.
