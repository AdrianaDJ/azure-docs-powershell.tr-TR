...
## Tanım
**Get-AzConsumptionPriceSheet** cmdlet 'inin, aboneliğin fiyat sayfalarını alır.

## ÖRNEKLERDEN

### Örnek 1: fiyat sayfalarını alma
```powershell
...
### Örnek 2: MeterDetails 'i genişletme ile fiyat sayfaları alma
```powershell
...
### Örnek 3: BillingPeriodName 'in fiyat sayfalarını alma
```powershell
...
### Örnek 4: fiyat sayfalarının ilk 5 kaydını alma
```powershell
...
### -BillingPeriodName
İlişkili fiyat sayfalarının alınacağı belirli bir fatura döneminin adı.
...
### -ExpandMeterDetail
MeterDetails tabanlı fiyat sayfalarını genişletin.
...
### Microsoft. Azure. Commands. tüketim. modeller. PSPriceSheet
