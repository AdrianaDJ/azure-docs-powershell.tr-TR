...
## Tanım
**Disable-AzCdnCustomDomainHttps** CMDLET 'i CDN özel etki ALANıNıN güvenli https teslimini devre dışı bırakır.
...
Özel etki alanının güvenli dağıtımını devre dışı bırakın.

## PARAMETRELERINE

### -Custometkialanıadı
Azure CDN özel etki alanı görünen adı.
