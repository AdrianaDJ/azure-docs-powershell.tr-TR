...
Örnek 1 ile aynıdır, ancak şimdi Get-Azvpnbağlantısından Piped nesneyi kullanarak bağlantıyı kaldırır.
...
### -InputObject
Güncelleştirilecek VpnConenction nesnesi.
...
### -RESOURCEID
Silinecek VpnConenction nesnesinin kaynak kimliği.
