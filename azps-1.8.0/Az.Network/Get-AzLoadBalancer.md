...
## Tanım
**Get-AzLoadBalancer** cmdlet 'i, kaynak grubunda yer alan bir veya birden çok Azure yük dengeleyici alır.
...
### Örnek 2: filtreleme kullanarak yük dengeleyicileri listeleyin
```
...
Bu komut, tüm yük dengeleyicileri "MyLoadBalancer" ile başlayan bir adla alır
