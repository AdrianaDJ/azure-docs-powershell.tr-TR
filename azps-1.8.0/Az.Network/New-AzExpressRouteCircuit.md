...
## Tanım
**Yeni-Azexpressroutedevdevi** bir Azure Express Route devresi oluşturur.
...
### Örnek 2: ExpressRoutePort 'ta yeni bir ExpressRoute devresi oluşturma
```
$parameters = @{
    Name='ExpressRouteCircuit'
    ResourceGroupName='ExpressRouteResourceGroup'
...
### -BandwidthInGbps
Bir ExpressRoutePort kaynağında bir devre sağlandığında devrenin bant genişliği.
...
### -ExpressRoutePort
Bir ExpressRoutePort kaynağında sağlanan devre hazırlandığında ExpressRoutePort kaynağının başvurusu.
...
### -ServiceProviderName
Devre hizmeti sağlayıcısının adı. Bu, Get-AzExpressRouteServiceProvider cmdlet tarafından listelenen bir adla eşleşmelidir.
...
### -SkuTier
Devre için hizmet katmanı. Bu parametre için olası değerler: `Standard` `Premium` veya `Basic` .
...
### Microsoft. Azure. Commands. Network. model. Psexpressrouteter
