...
## Tanım
**Get-Azvirtualnetworkeşlemecmdlet** 'i sanal ağ eşliğini alır.

## ÖRNEKLERDEN

### Örnek 1: iki sanal ağ arasındaki eşlemeyi alma
```
...
### Örnek 2: sanal ağdaki tüm eş lamaları alma
```
...
### -Ad
Sanal ağ eşleme adını belirtir.
...
### -ResourceGroupName
Sanal ağ eşliğini ait olduğu kaynak grubu adını belirtir.
...
### -VirtualNetworkName
Bu cmdlet 'in aldığı sanal ağ adını belirtir.
