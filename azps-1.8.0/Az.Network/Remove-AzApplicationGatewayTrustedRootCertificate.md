...
## Tanım
**Remove-AzApplicationGatewayTrustedRootCertificate** cmdlet 'i, varolan bir uygulama ağ geçidinden güvenilen kök sertifikayı kaldırır.
...
İkinci komut, $gw depolanan uygulama ağ geçidinden myRootCA adlı güvenilen kök sertifikayı kaldırır.
