...
Yukarıdaki, birden çok yoldan oluşan ve yeni bir sanal hub 'a bağlanan bir yol tablosu oluşturur.

Bu, yeni veya var olan bir VirtualHub 'a yönlendirme tablosu eklemek için kullanılabilecek bir bellek içi nesnedir.
