...
## Tanım
Get-AzNetworkUsage cmdlet 'i ağ kaynaklarının sınırlarını ve geçerli kullanımını alır.
...
Westcentralus bölgesindeki kaynak kullanım verilerini alır
...
### -Konum
Kaynak kullanımının sorguladığı konum.
...
### Microsoft. Azure. Commands. Network. modeller. PSUsage
