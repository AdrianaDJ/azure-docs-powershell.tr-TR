...
## Tanım
**Get-AzVirtualNetwork** cmdlet 'i bir veya daha fazla sanal ağı bir kaynak grubuna alır.
...
Bu komut TestResourceGroup kaynak grubunda MyVirtualNetwork adındaki sanal ağı alır

### 2: filtre kullanarak sanal ağları listeleme
```
