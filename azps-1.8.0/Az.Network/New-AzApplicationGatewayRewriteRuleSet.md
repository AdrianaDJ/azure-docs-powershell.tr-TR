...
## Tanım
**Yeni-AzApplicationGatewayRewriteRuleSet** cmdlet 'i, bir Azure Application Gateway için yeniden yazma kuralı oluşturur.
...
Bu komut ruleset1 adlı bir yeniden yazma kuralı kümesi oluşturur ve sonucu $ruleset adlı değişkende depolar.
