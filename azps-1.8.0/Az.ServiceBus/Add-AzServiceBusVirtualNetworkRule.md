...
### VirtualNetworkRulePropertiesParameterSet (varsayılan)
```
...
Verilen alt ağ ve ıgnoremissingvnetserviceendpoint (VirtualNetworkRule) verili ad alanı için NetworkRuleSet 'e ekler
...
Verilen ad alanı için $virtualruleset 1 öğesini NetworkRuleSet 'e ekler
...
VirtualNetworkRule yapılandırma nesnesi
...
### Microsoft. Azure. Commands. ServiceBus. modeller. PSNWRuleSetVirtualNetworkRulesAttributes
