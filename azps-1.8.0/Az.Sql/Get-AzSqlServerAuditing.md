...
## Tanım
**Get-AzSqlServerAuditing** cmdlet 'i, BIR Azure SQL Server 'ın denetim ayarlarını alır.
Sunucuyu tanımlayan *Resourcegroupname* ve *ServerName* parametrelerini belirtin.
...
### Örnek 1: Azure SQL Server 'ın BLOB depolama denetimi ayarlarını alma
```
...
### Örnek 2: Azure SQL Server 'ın BLOB depolama denetimi ayarlarını alma
```
...
### Örnek 3: Azure SQL Server 'ın BLOB depolama denetimi ayarları
```
...
### Örnek 4: Azure SQL Server 'ın Olay Hub denetimini alma
```
...
### Örnek 5: bir Azure SQL Server 'ın Olay Hub denetimini gözden geçirme
```
...
### Örnek 6: Azure SQL Server 'ın Log Analytics denetim ayarlarını alma
```
