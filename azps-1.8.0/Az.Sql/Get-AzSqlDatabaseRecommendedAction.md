...
## Tanım
**Get-AzSqlDatabaseRecommendedAction** cmdlet 'ı BIR Azure SQL veritabanı Danışmanı için önerilen bir veya birden çok eylemi alır.
...
Bu komut, Wi-Runner-Avustralya-Doğu adlı veritabanında, CreateIndex adındaki tüm önerilen eylemlerin listesini alır.
...
Bu komut \[ \] \[ \] , CreateIndex adındaki danışman için IR_ test_schema _ test_table_0 .0361551 _6C7AE8CC9C87E7FD5893 adlı önerilen eylemi alır.
...
### -DatabaseName
Bu cmdlet 'in önerilen eylemleri istediği veritabanının adını belirtir.
