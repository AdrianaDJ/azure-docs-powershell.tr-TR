...
### DeletedDatabaseList (varsayılan)
```
...
## Tanım
**Get-Azsqldeletedınstancedatabasebackup** cmdlet 'i, geri yüklediğiniz veya geri yüklediğiniz tüm silinmiş yedekleme veritabanı yedeklemesini alır.
Bu cmdlet, Azure 'da SQL örneği genişletme veritabanı hizmeti tarafından da desteklenir.
...
### Microsoft. Azure. Commands. Sql. ManagedDatabaseBackup. model. Azuressqldeletedmanageddatabasebackupmodel
