...
### Örnek 8: filtreleme kullanarak anahtar kasasındaki tüm gizliliklerin tüm güncel sürümlerini alma
```powershell
...
Bu komut, contoso adlı anahtar kasasına "gizli" ile başlayan tüm gizliliklerin geçerli sürümlerini alır.
