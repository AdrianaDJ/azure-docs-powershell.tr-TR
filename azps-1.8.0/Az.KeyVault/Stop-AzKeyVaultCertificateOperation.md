...
## Tanım
**Dur-Azanahtarvaultcertificateoperation** cmdlet 'ı Azure Anahtar Kasası hizmetinde sertifika işlemini iptal eder.

## ÖRNEKLERDEN

### Örnek 1: sertifika işlemini Iptal etme
```powershell
...
Bu komut TestCert02 sertifika işlemini iptal eder.
