...
## Tanım
IoT Hub 'ındaki bir IoT otomatik cihaz yönetimi yapılandırması veya listesi
...
IoT otomatik cihaz yönetimi yapılandırmasının ayrıntılarını edinin.
...
IoT Hub 'ındaki IoT otomatik cihaz yönetimi yapılandırmalarını listeleyin.
...
### Microsoft. Azure. Commands. Management. IotHub. modeller. PSConfigurations []
