...
## Tanım
IotHub için yeni bir dışarı aktarma cihazları işi oluşturur.
Bu işlem tüm cihazları belirtilen kapsayıcıya aktarır. SAS URI 'sini oluşturma konusunda aşağıdaki makaleye bakın.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## ÖRNEKLERDEN

### Örnek 1 gönderme cihazı isteği.
```
...
IotHub "myiothub" için yeni bir dışarı aktarma aygıtı isteği oluşturur.
...
### -ExcludeKeys
Anahtarları olmayan cihazları dışarı aktarmaya olanak tanır.
