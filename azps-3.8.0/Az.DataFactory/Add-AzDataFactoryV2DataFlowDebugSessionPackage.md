...
## Tanım
Bu komut veri akışı kaynağını ve bağımlılıklarını belirli bir hata ayıklama oturumuna iliştirir veri akışı hata ayıklama iş akışı için PowerShell komut dizisi şöyle olmalıdır:
...
"W50effe4-93a3-485C-8525-eaf25259efbd"/"WikiADF" Veri Fabrikası
Pakcage dosyası veri akışı hata ayıklama kaynağı, veri kümesi hata ayıklama kaynağının listesi, bağlantılı hizmet hata ayıklama kaynağı listesi, hata ayıklama ayarı ve oturum KIMLIĞI içerir. Örneğin:
...
SessionID parametresi, paket dosyasındaki var olan SessionID özelliğini değiştirmek için kullanılır.
...
### -Geçiş
Belirtilirse, çalışması işlemi başarılı olduğunda doğru yazılır. Bu parametre isteğe bağlıdır.
