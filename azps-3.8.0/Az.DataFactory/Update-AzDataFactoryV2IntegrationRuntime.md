...
## Tanım
**Update-AzDataFactoryV2IntegrationRuntime** cmdlet 'i Integration Runtime özelliklerini günceller. Şu anda cmdlet, self-hosted Integration Runtime için yalnızca ' otomatik güncelleştirme ' ve ' AutoUpdateDelayOffset ' güncelleştirmesini destekliyor.
