...
## Az. DataFactory cmdlet 'Leri
### [Add-AzDataFactoryV2DataFlowDebugSessionPackage](Add-AzDataFactoryV2DataFlowDebugSessionPackage.md)
Veri akışı kaynağı ve bağımlılıklarını belirli veri akışı hata ayıklama oturumuna ekleyin.
...
### [Get-Azdatafactorygatewaygatewaykey](Get-AzDataFactoryGatewayAuthKey.md)
...
Veri Fabrikası içindeki veri akışları hakkında bilgi alır.

### [Get-AzDataFactoryV2DataFlowDebugSession](Get-AzDataFactoryV2DataFlowDebugSession.md)
Azure Veri Fabrikası tarafından tüm etkin veri akışı hata ayıklama oturumlarını edinin.
...
### [New-Azdatafactorygatewaygatewaykey](New-AzDataFactoryGatewayAuthKey.md)
...
Veri Fabrikası 'ndan veri akışını kaldırır.
...
Azure Veri Fabrikası 'nde veri akışı hata ayıklama oturumu başlatır.
...
Veri Fabrikası içinde bir ardışık düzeni durdurur.
...
Azure Veri Fabrikası 'nda veri akışı hata ayıklama oturumunu durdurur.
...
### [Güncelleştirme-AzDataFactoryV2](Update-AzDataFactoryV2.md)
Veri Fabrikası özelliklerini güncelleştirir.

### [Güncelleştirme-AzDataFactoryV2IntegrationRuntime](Update-AzDataFactoryV2IntegrationRuntime.md)
Tümleştirme çalışma zamanını güncelleştirir.

### [Güncelleştirme-AzDataFactoryV2IntegrationRuntimeNode](Update-AzDataFactoryV2IntegrationRuntimeNode.md)
