...
## Tanım
Invoke-AzDataMigrationCommand cmdlet, var olan geçiş görevinde çalıştırılacak yeni bir komut görevi oluşturur.
...
Yukarıdaki örneklerde, var olan hizmet, proje ve görev için komut oluşturmak için Invoke-AzDataMigrationCommand cmdlet 'i kullanılır
...
```
### -ObjectName
Komutun çalışacağı veritabanı nesnesinin adı.
