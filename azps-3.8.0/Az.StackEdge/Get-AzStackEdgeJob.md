...
## Tanım
**Get-AzStackEdgeJob** cmdlet 'ı yığın uç aygıtındaki etkin işleri alır. Belirli bir işin ayrıntılarını almak için Name parametresinden bahsedebilirsiniz.
...
### Microsoft. Azure. PowerShell. cmdlet. StackEdge. modeller. PSStackEdgeJob
