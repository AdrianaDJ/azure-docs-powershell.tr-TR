...
## Tanım
**Remove-AzStackEdgeUser** cmdlet 'ı yığın uç cihazında bir kullanıcıyı kaldırır. Yalnızca türü kullanıcıların oluşturulması `Share` desteklenir.
...
### Microsoft. Azure. PowerShell. cmdlet. StackEdge. model. PSStackEdgeUser
