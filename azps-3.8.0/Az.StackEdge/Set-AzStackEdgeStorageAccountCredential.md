...
## Tanım
**Set-AzStackEdgeStorageAccountCredential** cmdlet 'ı, yığın uç aygıtındaki bir depolama hesabına karşılık gelen depolama hesabı kimlik bilgisini güncelleştirir.
...
Bir depolama hesabı için Access tuşlarının döndürülmesini sağlar
...
depolama hesabı erişim anahtarı sağlayın
...
### Microsoft. Azure. PowerShell. cmdlet. StackEdge. modeller. PSStackEdgeStorageAccountCredential
