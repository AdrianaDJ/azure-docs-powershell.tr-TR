...
## Tanım
**Get-AzStackEdgeStorageAccount** cmdlet 'ı, yığın uç cihazında kullanılabilen Edge depolama hesaplarını alır. Belirli bir Edge depolama hesabının bilgilerini almak için adı cmdlet 'te parametre olarak belirtebilirsiniz.
