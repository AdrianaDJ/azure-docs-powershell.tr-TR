...
## Tanım
**Remove-AzStackEdgeStorageAccount** cmdlet 'i, bir yığın uç aygıtının Ilişkili Edge depolama hesabını kaldırır. Cmdlet 'teki bir parametre olarak kaldırılacak Edge depolama hesabının adını belirtebilirsiniz.
