...
### UnlimitedBandwidthParameterSet (varsayılan)
```
...
## Tanım
**New-AzStackEdgeBandwidthSchedule** cmdlet 'ı, bant genişliği kullanımını yönetmeye yardımcı olacak bir yığın uç aygıtı için yeni bir bant genişliği çizelgesi oluşturur.
...
Bant genişliğini sınırsız olarak ayarlar
