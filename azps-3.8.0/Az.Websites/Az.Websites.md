...
Belirli bir sitede veya yuvada ve belirli bir kaynak grubunda belirtilen Windows kapsayıcısında bir uzak PowerShell oturumu açar
...
Get-AzWebAppContainerContinuousDeploymentUrl kapsayıcı sürekli dağıtım URL 'si geri döndürülecek
...
Web uygulamasında takılacak bir Azure depolama yolunu temsil eden bir nesne oluşturur. Set-AzWebApp ve Set-AzWebAppSlot için parametre (-AzureStoragePath) olarak kullanılmalıdır.

### [Yeni-AzWebAppBackup](New-AzWebAppBackup.md)


### [Yeni-AzWebAppContainerPSSession](New-AzWebAppContainerPSSession.md)
