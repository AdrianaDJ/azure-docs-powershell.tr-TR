...
Kayıt tanımının tam kaynak kimliği için yeni bir kayıt ataması oluşturur.
...
Bir kapsam ve kayıt tanımı adı verilen bir kayıt atamasını oluşturur.
...
```
Kayıt tanımlama nesnesi verilen bir kayıt atamasını oluşturur.
## PARAMETRELERINE
...
### -Registrationdefinitionresourceıd
Kayıt tanımının tam kaynak kimliği (örneğin,/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationDefinitions/b0c052e5-c437-4771-a476-8b1201158a57).
...
Kayıt tanımı adı (örneğin, b0c052e5-c437-4771-A476-8b1201158a57.
...
### -Kapsam
Kayıt atamasının oluşturulması gereken kapsam.
