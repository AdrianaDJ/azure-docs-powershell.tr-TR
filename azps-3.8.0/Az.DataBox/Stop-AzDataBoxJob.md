...
## SYNOPSIS
İş cancelstate durumundaysa devam eden bir databox işini iptal eder.
...
## Tanım
Bir databox işini iptal etmek için **stop-AzDataBoxJob** cmdlet 'i kullanılır.
...
Belirtilen databox işini iptal eder
...
Belirtilen veri kutusu işini onaysız iptal eder
...
### -InputObject
PSDataBoxJob türünde InputObject
