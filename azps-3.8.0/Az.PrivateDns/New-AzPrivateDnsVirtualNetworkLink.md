...
Bu komut, myzone.com ve sanal ağ "myvirtualnetwork" (kaynak grubunda zaten oluşturulmuş) adlı özel DNS bölgesiyle ilişkili olarak belirtilen kaynak grubundaki yeni bir sanal ağ bağlantısı oluşturur ve $Link değişkeninde depolar.
...
### -EnableRegistration
Bağlantının kayıt özelliğinin etkin olup olmadığını gösteren Switch parametresi.
...
### -Ad
Oluşturulacak sanal ağ bağlantısının adını belirtir.
...
### -Remotevirtualnetworkıd
Başka bir Kiracıdaki sanal ağın kaynak kimliği.
...
### -ResourceGroupName
Bağlantının oluşturulacağı kaynak grubunu belirtir.
...
### -VirtualNetwork
Bağlantıyla ilişkili sanal ağ nesnesi.
...
### -Virtualnetworkıd
Bağlantıyla ilişkili sanal ağın kaynak kimliği.
...
### -BölgeAdı
Sanal ağ bağlantısına bağlanacak bölgenin adını belirtir.
