...
### ByAvailableAttestation (varsayılan)
```
...
## Tanım
Remove-AzAttestation cmdlet 'i belirtilen kanıtlamayı siler.
...
*PSH-test-RG* adlı kaynak grubundaki *Pshtest3* adındaki kanıtlama sağlayıcısını geçerli abonelikten silin.
...
### -Ad
Kaldırılacak kanıtlama adını belirtir.
...
### -ResourceGroupName
Kaldırılacak Azure kanıtlama kaynak grubunun adını belirtir.
