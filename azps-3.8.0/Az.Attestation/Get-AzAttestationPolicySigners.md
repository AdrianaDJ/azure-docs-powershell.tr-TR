...
ms.locfileid: "94098215"
---
# <span data-ttu-id="fa8f2-101">Get-AzAttestationPolicySigners</span><span class="sxs-lookup"><span data-stu-id="fa8f2-101">Get-AzAttestationPolicySigners</span></span>

## <span data-ttu-id="fa8f2-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="fa8f2-102">SYNOPSIS</span></span>
<span data-ttu-id="fa8f2-103">Azure kanıtlama 'ndaki güvenilen ilke İmzalayanları bir kiracıdan alır.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-103">Gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="fa8f2-104">INDEKI</span><span class="sxs-lookup"><span data-stu-id="fa8f2-104">SYNTAX</span></span>

### <span data-ttu-id="fa8f2-105">NameParameterSet</span><span class="sxs-lookup"><span data-stu-id="fa8f2-105">NameParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-Name] <String> [-ResourceGroupName] <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="fa8f2-106">Resourceıdparameterset</span><span class="sxs-lookup"><span data-stu-id="fa8f2-106">ResourceIdParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-ResourceId] <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

## <span data-ttu-id="fa8f2-107">Tanım</span><span class="sxs-lookup"><span data-stu-id="fa8f2-107">DESCRIPTION</span></span>
<span data-ttu-id="fa8f2-108">Get-AzAttestationPolicySigners cmdlet 'i Azure kanıtlama 'ndaki güvenilen ilke İmzalayanları alır.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-108">The Get-AzAttestationPolicySigners cmdlet gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="fa8f2-109">ÖRNEKLERDEN</span><span class="sxs-lookup"><span data-stu-id="fa8f2-109">EXAMPLES</span></span>

### <span data-ttu-id="fa8f2-110">Örnek 1</span><span class="sxs-lookup"><span data-stu-id="fa8f2-110">Example 1</span></span>
```powershell
...
<span data-ttu-id="fa8f2-111">Kaynak grubunda *PSH-test-RG* *kanıtlama sağlayıcısı için* güvenilen ilke İmzalayanları alır.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-111">Gets the trusted policy signers for the Attestation Provider *pshtest* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="fa8f2-112">Bu kanıtlama sağlayıcısı için güvenilen imzalayanlar olmadığını unutmayın.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-112">Note that there are no trusted signers for this Attestation Provider.</span></span>

### <span data-ttu-id="fa8f2-113">Örnek 2</span><span class="sxs-lookup"><span data-stu-id="fa8f2-113">Example 2</span></span>
```powershell
...
<span data-ttu-id="fa8f2-114">Grup *PSH-test-RG* kaynak grubundaki kanıtlama sağlayıcısı *pshtest2* için güvenilen ilke İmzalayanları alır.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-114">Gets the trusted policy signers for the Attestation Provider *pshtest2* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="fa8f2-115">Bu kanıt sağlayıcısı için güvenilen bir imzalayan olduğunu unutmayın.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-115">Note that there is one trusted signer for this Attestation Provider.</span></span>

## <span data-ttu-id="fa8f2-116">PARAMETRELERINE</span><span class="sxs-lookup"><span data-stu-id="fa8f2-116">PARAMETERS</span></span>

### <span data-ttu-id="fa8f2-117">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="fa8f2-117">-DefaultProfile</span></span>
<span data-ttu-id="fa8f2-118">Azure ile iletişim için kullanılan kimlik bilgileri, hesap, kiracı ve abonelik.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-118">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="fa8f2-119">-Ad</span><span class="sxs-lookup"><span data-stu-id="fa8f2-119">-Name</span></span>
<span data-ttu-id="fa8f2-120">Kanıt sağlayıcısının adını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-120">Specifies the name of an attestation provider.</span></span>
...
### <span data-ttu-id="fa8f2-121">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="fa8f2-121">-ResourceGroupName</span></span>
<span data-ttu-id="fa8f2-122">Bir kanıt sağlayıcısının kaynak grubu adını belirtir.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-122">Specifies the resource group name of an attestation provider.</span></span>
...
### <span data-ttu-id="fa8f2-123">-RESOURCEID</span><span class="sxs-lookup"><span data-stu-id="fa8f2-123">-ResourceId</span></span>
<span data-ttu-id="fa8f2-124">Bir kanıt sağlayıcısının RESOURCEID 'nı belirtir.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-124">Specifies the ResourceID of an attestation provider.</span></span>
...
### <span data-ttu-id="fa8f2-125">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="fa8f2-125">CommonParameters</span></span>
<span data-ttu-id="fa8f2-126">Bu cmdlet ortak parametreleri destekler:-Debug,-ErrorAction,-ErrorVariable,-ınformationaction,-ınformationvariable,-OutVariable,-OutBuffer,-Pipelinedeğişken,-verbose,-WarningAction ve-Warningdeğişken.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-126">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="fa8f2-127">Daha fazla bilgi için [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)bakın.</span><span class="sxs-lookup"><span data-stu-id="fa8f2-127">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="fa8f2-128">GÖLGELENDIRICI</span><span class="sxs-lookup"><span data-stu-id="fa8f2-128">INPUTS</span></span>

### <span data-ttu-id="fa8f2-129">System. String</span><span class="sxs-lookup"><span data-stu-id="fa8f2-129">System.String</span></span>

## <span data-ttu-id="fa8f2-130">ÇıKıŞLAR</span><span class="sxs-lookup"><span data-stu-id="fa8f2-130">OUTPUTS</span></span>

### <span data-ttu-id="fa8f2-131">Microsoft. Azure. Commands. kanıt. model. PSPolicySigners</span><span class="sxs-lookup"><span data-stu-id="fa8f2-131">Microsoft.Azure.Commands.Attestation.Models.PSPolicySigners</span></span>

## <span data-ttu-id="fa8f2-132">NOTLARıNDA</span><span class="sxs-lookup"><span data-stu-id="fa8f2-132">NOTES</span></span>

## <span data-ttu-id="fa8f2-133">ILGILI BAĞLANTıLAR</span><span class="sxs-lookup"><span data-stu-id="fa8f2-133">RELATED LINKS</span></span>
