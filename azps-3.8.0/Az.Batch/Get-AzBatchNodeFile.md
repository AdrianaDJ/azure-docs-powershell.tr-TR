...
## Tanım
**Get-AzBatchNodeFile** cmdlet 'i, görevin veya compute düğümünün Azure toplu iş düğümü dosyalarının özelliklerini alır.
...
Görev nesnesi almak için Get-AzBatchTask cmdlet 'ini kullanın.
