...
## SYNOPSIS
Havuzdan toplu işlem düğümlerini alır.
...
## Tanım
**Get-AzBatchComputeNode** cmdlet 'i bir havuzdan Azure toplu işlem düğümlerini alır.
*PoolID* veya *Havuz* parametresini belirtin.
Tek bir COMPUTE düğümü almak için *ID* parametresini belirtin.
Açık bir veri Protokolü (OData) filtresiyle eşleşen hesaplama düğümlerini almak için *Filter* parametresini belirtin.

## ÖRNEKLERDEN

### Örnek 1: KIMLIĞE göre işlem düğümü alma
```
...
Bu komut, kimlik numarası Pool06 olan havuzdan TVM-2316545714_1-20150725t213220z olan COMPUTE düğümünü alır.
$Context değişkenine bağlam atamak için Get-AzBatchAccountKey cmdlet 'ini kullanın.

### Örnek 2: havuzdan tüm boşta işlemi düğümlerini alma
```
...
Bu komut, Pool06 KIMLIĞINE sahip havuzda bulunan tüm boşta COMPUTE düğümlerini alır.
Bu komut, *filtre* parametresini kullanarak Boşta durumunu belirtir.

### Örnek 3: belirtilen havuzda tüm işlem düğümlerini alma
```
...
Bu komut, Get-AzBatchPool cmdlet 'ini kullanarak KIMLIK Pool07 havuzunu alır.
Bu komut, ardışık düzen işlecini kullanarak bu havuzu geçerli cmdlet 'e geçirir.
Bu cmdlet bu havuzdan tüm işlem düğümlerini alır.
...
Bu cmdlet, bu parametrenin belirttiği filtreyle eşleşen işlem düğümlerini döndürür.
Filtre belirtmezseniz, bu cmdlet havuzun tüm işlem düğümlerini döndürür.
...
### -ID
Bu cmdlet 'in havuzdan aldığı COMPUTE düğümünün KIMLIĞINI belirtir.
...
### -MaxCount
Döndürülecek en fazla işlem düğümü sayısını belirtir.
...
### -Havuz
Havuzu, COMPUTE düğümlerini içeren bir **Pscses havuzu** nesnesi olarak belirtir.
**Pscses havuzu** nesnesi edinmek için Get-AzBatchPool cmdlet 'ini kullanın.
...
### -PoolId
Hesaplama düğümlerini içeren havuzun KIMLIĞINI belirtir.
