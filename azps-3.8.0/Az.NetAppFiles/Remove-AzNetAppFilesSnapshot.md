...
## Tanım
**Remove-AzNetAppFilesSnapshot** cmdlet 'i ANF anlık görüntüsünü siler.
...
Bu komut, ANF anlık görüntüsünü "MyAnfSnapshot" siler.
...
### -InputObject
Kaldırılacak anlık görüntü nesnesi
...
### -ResourceGroupName
ANF anlık görüntüsünün kaynak grubu
...
### -RESOURCEID
ANF anlık görüntüsünün kaynak kimliği
...
### -VolumeObject
Kaldırılacak anlık görüntüyü içeren birim nesnesi
