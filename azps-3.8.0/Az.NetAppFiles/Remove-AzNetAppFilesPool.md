...
## Tanım
**Remove-AzNetAppFilesPool** cmdlet 'i ANF havuzunu siler.
...
Bu komut, "MyAnfPool" ANF havuzunu siler.
...
### -AccountObject
Kaldırılacak havuzu içeren hesap nesnesi
...
### -Geçiş
Belirtilen havuzun başarıyla kaldırıldığını geri döndürme
