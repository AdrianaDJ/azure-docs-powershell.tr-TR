...
## Tanım
**Enable-AzHDInsightMonitoring** cmdlet 'ı bir Azure HDInsight kümesinde izlemeyi etkinleştirir.
...
İzleme, HDInsight kümesinde etkinleştirilecek ve ilgili Günlükler, kimlik 1d364e89-bb71-4503-aa3d-a23535aea7bd
...
### -Ad
İzlemeyi etkinleştirmek için kümenin adı.
...
### -PrimaryKey
İzleme çalışma alanının birincil anahtarı.
...
### -
İzleme çalışma alanının kimliği.
