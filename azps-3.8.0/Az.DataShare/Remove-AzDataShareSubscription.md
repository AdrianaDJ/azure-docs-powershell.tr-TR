...
## Tanım
**Remove-AzDataShareSubscription** cmdlet 'i bir paylaşım aboneliğini kaldırır
...
Bu komut, hesap WikiAds 'den bir sharesubscripın adlı bir paylaşım listesini kaldırır. 
