...
## Tanım
**Remove-AzStorageAccountManagementPolicy** cmdlet 'ı, Azure depolama hesabının yönetim ilkesini kaldırır.

## ÖRNEKLERDEN

### Örnek 1: depolama hesabının yönetim ilkesini kaldırma.
```
PS C:\>Remove-AzStorageAccountManagementPolicy -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount"
```

Bu komut, depolama hesabının yönetim ilkesini kaldırır.
