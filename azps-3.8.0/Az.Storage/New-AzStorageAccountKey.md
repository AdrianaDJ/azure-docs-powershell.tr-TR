...
## Tanım
**New-AzStorageAccountKey** cmdlet 'ı Azure depolama hesabı için depolama anahtarını yeniden oluşturur.
...
### Microsoft. Azure. Management. Storage. modeller. StorageAccountListKeysResult
