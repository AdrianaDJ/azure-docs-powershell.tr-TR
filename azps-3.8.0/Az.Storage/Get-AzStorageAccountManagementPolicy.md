...
## Tanım
**Get-AzStorageAccountManagementPolicy** cmdlet 'i, bir Azure depolama hesabının yönetim ilkesini alır.

## ÖRNEKLERDEN

### Örnek 1: depolama hesabının yönetim ilkesini edinin.
```
...
Bu komut, depolama hesabının yönetim ilkesini alır.
