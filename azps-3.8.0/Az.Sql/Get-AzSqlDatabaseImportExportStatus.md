...
## Tanım
**Get-Azsqldatabaseımportexportstatus** cmdlet 'i, depolama hesabındaki bir bacpac dosyasının ayrıntılarını, bir depolama hesabındaki BIR Azure SQL veritabanına aktarma
...
### -OperationStatusLink
New-AzSqlDatabaseExport veya New-AzSqlDatabaseImport cmdlet 'lerinin döndürdüğü durum bağlantısını belirtir.
...
### Microsoft. Azure. Commands. Sql. ımportexport. model. Azurestabdatabaseımportexportstatusmodel
