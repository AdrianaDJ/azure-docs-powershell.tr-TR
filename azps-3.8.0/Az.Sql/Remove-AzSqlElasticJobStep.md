...
## Tanım
Remove-AzSqlElasticJobStep cmdlet 'i işten bir iş adımını kaldırıyor

## ÖRNEKLERDEN

### Örnek 1-işten bir iş adımını kaldırır
```
