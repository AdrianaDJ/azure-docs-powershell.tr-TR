...
## Tanım
**Set-Azsqlınstance** cmdlet 'ı, Azure SQL veritabanı yönetilen örneğinin özelliklerini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: yeni,-\Administrators parolasının (-LicenseType,-StorageSizeInGB,-VCore ve-Edition)
```powershell
...
### Örnek 2: yeni değer için yeni değer kullanarak var olan örnek donanım üretimini ComputeGeneration
```powershell
...
### Örnek 3: örnek havuzundaki bir örnek için yeni-\Administrators parolası,-LicenseType,-StorageSizeInGB ve-VCore değerlerini kullanarak varolan örneği ayarlayın
```powershell
PS C:\>$InstancePassword = "Newpassword1234"
PS C:\> $SecureString = ConvertTo-SecureString $InstancePassword -AsPlainText -Force
...
Bu komut, örnek havuzundaki bir örnek için yeni-\Administrators parolası,-LicenseType,-StorageSizeInGB ve-VCore değerlerini kullanarak var olan örneği ayarlar
