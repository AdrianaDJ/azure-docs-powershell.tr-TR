...
## Tanım
**Get-AzSqlServerActiveDirectoryAdministrator** cmdlet 'i, geçerli abonelikteki bir AzureSQL Server Için Azure Active Directory (Azure AD) Yöneticisi hakkında bilgi alır.
