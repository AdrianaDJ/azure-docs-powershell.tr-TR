...
### AddAzureRmSqlServerTransparentDataEncryptionCertificateDefaultParameterSet (varsayılan)
```
...
## Tanım
Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate, verilen SQL Server örneğine bir saydam veri şifreleme sertifikası ekler
...
Kaynak grubu adını ve SQL Server adını kullanarak bir SQL sunucusuna ton sertifikası ekleme
...
Sunucu ResourceId kullanarak sunuculara TDE sertifikası ekleme
...
Kaynak grubundaki tüm SQL sunucularına TDE sertifikası ekleme
