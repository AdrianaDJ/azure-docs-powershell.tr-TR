...
## Tanım
**Stop-AzResourceGroupDeployment** cmdlet 'i, başlatılmış ancak tamamlanmamış bir Azure Kaynak grubu dağıtımını iptal eder.
...
Kaynak grubu dağıtmak için New-AzResourceGroupDeployment cmdlet 'ini kullanın.
New-AzResource cmdlet 'i yeni bir kaynak oluşturur, ancak bu cmdlet 'in durdurmadığı bir kaynak grubu dağıtım işlemini tetiklemez.
Bu cmdlet yalnızca bir çalışan dağıtımı durdurur.
Belirli bir dağıtımı durdurmak için *Name* parametresini kullanın.
*Name* parametresini atlarsanız, **stop-AzResourceGroupDeployment** çalışan bir dağıtımı arar ve bunu durdurur.
...
Dağıtım adını almak için Get-AzResourceGroupDeployment cmdlet 'ini kullanın.
