...
## Tanım
**Yeni-AzManagedApplicationDefinition** cmdlet 'i yönetilen uygulama tanımı oluşturur.
...
Bu komut yönetilen uygulama tanımı oluşturur
...
PrincipalId biçimindeki virgülle ayrılmış yetkilendirme çiftleri \< \> : \< roledefinitionıd\>
...
### -Createuıdefinition
Yönetilen uygulama tanımı UI tanımı oluştur
...
### -LockLevel
Yönetilen uygulama tanımı için kilit düzeyi.
...
### -MainTemplate
Yönetilen uygulama tanımı ana şablonu
...
### Microsoft. Azure. Commands. ResourceManager. cmdlet. varlık. uygulama. ApplicationLockLevel
