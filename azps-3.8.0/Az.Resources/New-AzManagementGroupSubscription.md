...
## Tanım
**New-AzManagementGroupSubscription** cmdlet 'ı bir yönetim grubuna abonelik ekler.

## ÖRNEKLERDEN

### Örnek 1: yönetim grubuna abonelik ekleme
```
...
### -SubscriptionID
Yönetim ile ilişkili aboneliğin abonelik kimliği
