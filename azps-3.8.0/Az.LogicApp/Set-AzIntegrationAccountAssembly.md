...
### Byıntegrationaccountandfilepath (varsayılan)
```
...
### Byıntegrationaccountandcontentlink
```
Set-AzIntegrationAccountAssembly -ResourceGroupName <String> -ParentName <String> -Name <String>
...
### Byıntegrationaccountandfilebytes
```
Set-AzIntegrationAccountAssembly -ResourceGroupName <String> -ParentName <String> -Name <String>
...
## Tanım
**Set-AzIntegrationAccountAssembly** cmdlet 'i bir tümleştirme hesabı derlemesini değiştirir.

## ÖRNEKLERDEN

### Örnek 1: yerel dosya kullanarak derlemeyi değiştirme
```powershell
...
"SampleAssembly" adlı derlemeyi, "$localAssemblyFilePath" içindeki dosya yolundaki yerel dosyayı kullanarak değiştirir.

### Örnek 2: bayt verileri kullanarak derlemeyi değiştirme
```powershell
...
"SampleAssembly" adlı derlemeyi, "$assemblyContent" içindeki bayt dizisini kullanarak değiştirir.

### Örnek 3: içerik bağlantısını kullanarak derlemeyi değiştirme
```powershell
...
"$AssemblyUrl" URL 'sinde bulunan bayt verilerini kullanarak "sampleAssembly" adlı derlemeyi değiştirir. Büyük boyutlu derlemeler oluşturmak için önerilen yöntem budur.

## PARAMETRELERINE

### -AssemblyData
Tümleştirme hesabı derleme baytlık veriler.
...
### -AssemblyFilePath
Tümleştirme hesabı derleme dosyası yolu.
...
### -ContentLink
Tümleştirme hesabı derleme verilerine genel olarak erişilebilir bir bağlantı.
...
### -Metadata
Tümleştirme hesabı derleme meta verileri.
...
### -RESOURCEID
Tümleştirme hesabı derleme kaynak kimliği.
...
### Microsoft. Azure. Commands. Logicuyg. modeller. PSIntegrationAccountAssembly
