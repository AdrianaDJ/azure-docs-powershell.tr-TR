...
## Tanım
**Get-Azıntegrationaccountcallbackurl** cmdlet 'i, bir kaynak grubundan tümleştirme hesabı geri araması URL 'sini alır.
Bu cmdlet, tümleştirme hesabı geri çağırma URL 'sini temsil eden bir **Callbackurl** nesnesi döndürür.
...
### Örnek 1: Tümleştirme hesabı geri çağırma URL 'SI alma
```
...
Bu komut, tümleştirme hesabı geri çağırma URL 'sini alır.
...
### -NotAfter
Geri arama URL 'sinin bitiş tarihini belirtir.
...
### Microsoft. Azure. Management. Logic. modeller. CallbackUrl
