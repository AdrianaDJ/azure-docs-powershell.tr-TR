...
### Byıntegrationaccountandparameters (varsayılan)
```
...
### Byıntegrationaccountandfilepath
```
Set-AzIntegrationAccountBatchConfiguration -ResourceGroupName <String> -ParentName <String> -Name <String>
...
## Tanım
**Set-Azıntegrationaccountbatchconfiguration** cmdlet 'i bir tümleştirme hesabı toplu iş yapılandırmasını değiştirir.

## ÖRNEKLERDEN

### Örnek 1: yerel dosya kullanarak toplu iş yapılandırmasını değiştirme
```powershell
...
"$BatchConfigurationFilePath" içinde yer alan dosya yolundaki yerel dosyayı kullanarak "sampleBatchConfig" adlı bir toplu iş yapılandırmasını değiştirin.

### Örnek 2: JSON dizesi kullanarak toplu iş yapılandırmasını değiştirme
```powershell
...
"SampleBatchConfig" adlı bir toplu iş yapılandırmasını değiştirerek "$batchConfigurationContent" içinde bulunan bir JSON dizesini kullanın.

### Örnek 3: parametreler kullanarak toplu iş yapılandırmasını değiştirme
```powershell
...
Gerekli parametrelerin tümünü el ile sağlayarak "sampleBatchConfig" adlı bir toplu iş yapılandırmasını değiştirin.

## PARAMETRELERINE

### -BatchConfigurationDefinition
Tümleştirme hesabı toplu işlem yapılandırma tanımı.
...
Tümleştirme hesabı toplu yapılandırma dosyası yolu.
...
### -BatchGroupName
Tümleştirme hesabı toplu iş Yapılandırması Grup adı.
...
### -BatchSize
Tümleştirme hesabı toplu yapılandırması toplu iş boyutu.
...
### -InputObject
Tümleştirme hesabı toplu iş yapılandırması.
...
### -MessageCount
Tümleştirme hesabı toplu yapılandırması ileti sayısı.
...
### -Metadata
Tümleştirme hesabı toplu yapılandırma meta verileri.
...
### -Ad
Tümleştirme hesabı toplu işlem yapılandırma adı.
...
### -RESOURCEID
Tümleştirme hesabı toplu yapılandırması kaynak kimliği.
...
### -ScheduleFrequency
Tümleştirme hesabı toplu yapılandırması zamanlama sıklığı.
...
### -Scheduleınterval
Tümleştirme hesabı toplu iş yapılandırması zamanlama aralığı.
...
### -ScheduleStartTime
Tümleştirme hesabı toplu yapılandırması başlangıç saati.
...
### -ScheduleTimeZone
Tümleştirme hesabı toplu iş yapılandırması zamanlama saat dilimi.
...
### Microsoft. Azure. Commands. Logicuyg. modeller. Psıntegrationaccountbatchconfiguration
