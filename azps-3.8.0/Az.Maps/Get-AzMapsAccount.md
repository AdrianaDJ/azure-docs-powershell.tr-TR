...
## Tanım
Get-AzMapsAccount cmdlet 'i, kaynak grubu ile ad veya kaynak kimliği tarafından sağlanan Azure haritaları hesabını alır. Ayrıca, geçerli aboneliğin ResourceGroup veya tüm Azure haritalar hesaplarında tüm hesapların bir listesini döndürebilir.
