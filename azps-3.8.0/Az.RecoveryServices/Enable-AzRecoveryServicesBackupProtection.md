...
## Tanım
**Enable-AzRecoveryServicesBackupProtection** cmdlet 'i bir öğede Azure yedekleme koruma ilkesini ayarlar.
...
### -ExclusionDisksList
Yedeklemede dışlanacak disk LUN 'Ları listesi
...
### -Her Ikisi de
Yedeklemeye eklenecek disk LUN 'Ları listesi
