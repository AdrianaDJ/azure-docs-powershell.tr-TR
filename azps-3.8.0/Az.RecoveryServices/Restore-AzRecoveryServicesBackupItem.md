...
Yönetilen diskleri, geri yükleme işlemi bittikten sonra müşteri depolama hesabına bir hedef kaynak grubuna ve yapılandırma bilgilerine geri yükler, sanal makineyi oluşturmalı ve başlamanız gerekir.
...
Yedinci komutu, kurtarma noktasından hangi disklerin geri yükleneceği ve $restoreDiskLUNs değişkeninde sakladığı diskleri belirtir.
