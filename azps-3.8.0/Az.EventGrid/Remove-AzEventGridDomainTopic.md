...
\` \` \` \` Myresourcegroupname kaynak grubundaki konu1 etki alanı domain1 altındaki olay \` Kılavuzu etki alanı konu başlığını kaldırır \` .
...
### -RESOURCEID
Olay Kılavuzu etki alanı konusunu temsil eden kaynak tanıtıcısı.
