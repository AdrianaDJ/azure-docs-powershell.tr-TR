...
İkinci komut, uygulama ağ geçidinden otomatik ölçeklendirme yapılandırmasını güncelleştirir.
...
### -MaxCapacity
Uygulama ağ geçidi için maksimum kapasite.
...
### -MinCapacity
Uygulama ağ geçidi için minimum kapasite.
