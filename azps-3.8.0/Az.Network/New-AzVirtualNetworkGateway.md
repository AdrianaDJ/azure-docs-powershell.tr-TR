...
### 3: P2S ayarları ile sanal ağ geçidi oluşturma
```
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
$subnet = New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### 4: sanal ağ geçidi 'nin VpnClient için AAD kimlik doğrulama yapılandırması ile sanal ağ geçidi oluşturun.
```
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### 5: VpnGatewayGeneration ile sanal ağ geçidi oluşturma
```
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
$subnet = New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### 6: ıpconfigurationbgppeeringaddresses ile sanal ağ geçidi oluşturma
```
...
### -GatewayType
Bu sanal ağ geçidinin türü: VPN, ExoressRoute
