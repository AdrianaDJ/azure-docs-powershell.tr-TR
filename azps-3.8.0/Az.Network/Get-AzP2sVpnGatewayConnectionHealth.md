...
## Tanım
**Get-AzP2sVpnGatewayConnectionHealth** cmdlet 'i P2SVpnGateway 'dan site bağlantılarına işaret eden geçerli toplu durumu almanızı olanaklı kılar. Toplu sağlık P2SVpnGateway 'e bağlı olan site istemcilerinin, P2SVpnGateway ve ayrılan IP adresleri aracılığıyla site istemcilerine bağlı noktaya giden toplam bayt ve çıkış baytlarını gösterir.
...
**Get-AzP2sVpnGatewayConnectionHealth** cmdlet 'i P2SVpnGateway 'dan site bağlantılarına işaret eden geçerli toplu durumu almanızı olanaklı kılar. Yukarıdaki komut çıkış durumunun, P2SVpnGateway 'e bağlı olan site istemcilerinin 2 olduğunu gösterir. P2SVpnGateway aracılığıyla aktarılan toplam gelen ve çıkış baytları, sırasıyla 100 ve 200. Site istemcilerine bağlı bağlantı noktası için ayrılan IP adresleri "192.168.2.1", "192.168.2.2" dir.
