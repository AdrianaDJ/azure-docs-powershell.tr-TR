...
## Tanım
Sanal ağ geçidinde paket yakalama Işlemini durdurur ve depolama kapsayıcısının verilen SasUrl 'sindeki sonucu karşıya yükler.
...
### -Ad
Paketin yakalanması için sanal ağ geçidi adı.
...
### -SasUrl
Sanal ağ geçidinde SAS URL paketi yakalama.
