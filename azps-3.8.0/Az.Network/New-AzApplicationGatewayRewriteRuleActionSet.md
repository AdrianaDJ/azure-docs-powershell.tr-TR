...
## Tanım
**Yeni-AzApplicationGatewayRewriteRuleActionSet** cmdlet 'ı bir Azure uygulama ağ geçidi için yeniden yazma kuralı eylem kümesi oluşturur.
...
Bu komut yeniden yazma kuralı eylem kümesi oluşturur ve sonucu $action adlı değişkende depolar.
...
İstek üst bilgi yapılandırmalarının listesi
...
Yanıt üst bilgi yapılandırmalarının listesi
...
### -Urlyapılandırma
Eylem kümesi için URL yapılandırması
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayRewriteRuleActionSet
