...
Konumdaki kullanılabilir özel uç nokta türlerini döndürme
...
Bağlantı izleyicisini güncelleştirme.

### [Set-AzNetworkWatcherFlowLog](Set-AzNetworkWatcherFlowLog.md)
Akış günlüğü kaynağını güncelleyin.
...
Sanal ağ geçidi VPN bağlantısını kesin.

### [AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
VPN ağ geçidi VPN bağlantısının bağlantısını P2S.
