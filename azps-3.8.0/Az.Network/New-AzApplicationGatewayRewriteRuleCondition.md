...
## Tanım
**AzApplicationGatewayRewriteRuleCondition** cmdlet 'ı bir Azure uygulama ağ geçidi için yeniden yazma kuralı koşulunu oluşturur.
...
```
Bu komut yeniden yazma kuralında bir koşul oluşturur ve sonucu $condition adlı değişkende depolar.
...
### -IgnoreCase
Desende büyük/küçük harf işareti
...
### -Negate
Koşul doğrulamayı Negate olarak ayarlayın
...
### -Desen
Değişken üst bilgisinde arama deseni
...
### Değişkenli
Koşul ayarlanacak üst bilginin adı
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayRewriteRuleCondition
