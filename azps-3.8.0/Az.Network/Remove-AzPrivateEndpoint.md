...
## Tanım
**Remove-AzPrivateEndpoint** cmdlet 'i özel uç noktayı kaldırır. 
...
Bu örnekte MyPrivateEndpoint1 adlı özel bir uç nokta kaldırılır.
...
### -ResourceGroupName
Özel uç noktasının kaynak grubu adı.
