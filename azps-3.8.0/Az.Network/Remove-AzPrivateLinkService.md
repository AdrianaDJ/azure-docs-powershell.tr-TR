...
## Tanım
**Remove-AzPrivateLinkService** cmdlet 'i özel bir bağlantı hizmetini kaldırıyor
...
Bu örnek TestPrivateLinkService adındaki özel bağlantı hizmetini kaldırır.
...
### -ResourceGroupName
Özel bağlantı hizmetinin kaynak grubu adı.
