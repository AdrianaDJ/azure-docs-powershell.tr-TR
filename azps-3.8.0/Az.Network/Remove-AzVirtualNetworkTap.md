...
## Tanım
**Remove-AzVirtualNetworkTap** cmdlet 'ı bir Azure sanal ağ öğesine dokunun.

## ÖRNEKLERDEN

### Örnek 1: sanal ağ 'ı kaldırma
```
PS C:\>Remove-AzNetworkInterface -Name "VirtualNetworkTap1" -ResourceGroup "ResourceGroup1"
```

Bu komut ResourceGroup1 kaynak grubundaki VirtualNetworkTap1 kaldırır.
...
### -InputObject
VirtualNetworkTap kaynağına başvuru
