...
VM 'deki durum değişikliği nedeniyle otomatik onarımların askıya alındığı süre. Kullanım süresi, durum değişikliği tamamlandıktan sonra başlar. Bu, erken veya kazayla onarılmasını önlemeye yardımcı olur. Süre ISO 8601 biçiminde belirtilmelidir. Varsayılan değer 5 dakikadır (PT5M).
...
Aynı anda onarılacak sanal makinelerin yüzdesi (ölçek kümesi kapasitesi). Varsayılan değer %20 ' dir.
