...
### Kubectl yapılandırmasını içeri ve birleştirme
```
...
### -Yönetici
Varsayılan ' clusterUser ' yerine ' clusterAdmin' kubectl config 'i alın.
...
### -ConfigPath
Oluşturulacak veya güncelleştirilecek bir kubectl yapılandırma dosyası.
Bunun yerine stdout ile
Varsayılan:% giriş%/.Kube/config.
...
### -Force
Varsayılan olsa bile Kubernetes yapılandırmasını içeri aktarma
...
### -Geçiş
İçeri aktarma işlemi başarılıysa doğru verir
