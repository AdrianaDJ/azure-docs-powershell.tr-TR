...
## Tanım
API yönetim hizmetlerinin ağ durumunu alır
...
Hangi farklı kaynağın bağlantı durumunu alır ve bu servisin bağlı olduğu farklı kaynaklar.

## PARAMETRELERINE

### -Apsananagementobject
...
### -ResourceGroupName
API yönetiminin altındaki kaynak grubunun adı.
