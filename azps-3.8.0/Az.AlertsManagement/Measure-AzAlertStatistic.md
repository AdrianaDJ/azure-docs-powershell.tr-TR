...
## Tanım
**Measure-Azalertistatistiğini** cmdlet, uyarı Özeti ayrıntılarını alır.
...
Durumları, etkin duruma göre filtrelenmiş önem derecesine ve duruma göre gruplandırılmış olarak gruplandırılmış uyarılar.
...
### -CustomTimeRange
Desteklenen biçim- \< \> / \< \> zamanın ISO-8601 biçiminde olduğu başlangıç saati bitiş saati
...
### Microsoft. Azure. Commands. AlertsManagement. Outputmodel. Psalcertssummary
