...
### Örnek 15: Müştercontactdetail nesnesi yerine bireysel müşteri irtibat parametrelerini belirterek bir destek bileti oluşturun. 
```powershell
...
### Örnek 16: Azure 'dan 24 x 7 yanıtını içeren bir destek bileti oluşturun. 
```powershell
