...
Bir Azure IoT Hub cihaz sağlama hizmetinde "mycertificate" hakkındaki ayrıntıları gösterin.
...
Ardışık düzen kullanarak "myıotdps" içindeki tüm sertifikaları listeleyin.
