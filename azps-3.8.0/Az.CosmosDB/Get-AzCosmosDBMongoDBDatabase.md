...
## SYNOPSIS
CosmosDB MongoDB veritabanını alır
...
## Tanım
**Get-AzCosmosDBMongoDBDatabase** cmdlet 'ı Cosmosdb MongoDB veritabanını alır.
...
Kaynak nesnesi _rid, _ts _etag özelliklerini içerir.
...
### -Ayrıntılı
Sağlanmışsa, cmdlet, ilgili üretilen iş değerini içeren veritabanını döndürür.
