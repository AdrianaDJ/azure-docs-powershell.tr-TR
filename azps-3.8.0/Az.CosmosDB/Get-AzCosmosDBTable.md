...
## Tanım
**Get-AzCosmosDBTable** cmdlet 'i var olan bir tabloyu alır.
...
Resource nesnesi tablonun _rid, _ts, _ ETag özelliklerini içerir.
...
### -Ayrıntılı
Sağlanmışsa, cmdlet, ilgili üretilen iş değerini içeren tabloyu döndürür.
