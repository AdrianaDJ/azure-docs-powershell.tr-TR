...
## SYNOPSIS
Psıncludedpath türünde yeni bir nesne oluşturur. Set-AzCosmosDBSqlContainer için parametre değeri olarak iletilebilir.
...
## Tanım
SQL API 'sinin ıncludedpath 'e karşılık gelen nesne.
...
### Microsoft. Azure. Commands. CosmosDB. modeller. Psıncludedpath
