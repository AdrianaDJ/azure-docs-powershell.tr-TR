...
## SYNOPSIS
CosmosDB Cassandra tuş uzayını ayarlar.
...
## Tanım
**Set-AzCosmosDBCassandraKeyspace** cmdlet 'ı Cosmosdb Cassandra anahtar uzayını ayarlar.
...
Resource nesnesi _rid, _ts _etag özelliklerinin değerlerini içerir.
