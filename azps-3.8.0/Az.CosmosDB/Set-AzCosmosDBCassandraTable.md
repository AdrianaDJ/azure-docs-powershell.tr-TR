...
## SYNOPSIS
CosmosDB Cassandra tablosunu ayarlar.
...
## Tanım
**Set-AzCosmosDBCassandraTable** cmdlet 'ı Cosmosdb Cassandra tuş uzayını ayarlar.
...
Kaynak nesnesi _rid, _ts, _etag, DefaultTtl ve şema özelliklerinin değerlerini içerir.
