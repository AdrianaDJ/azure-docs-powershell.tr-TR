...
### Örnek 1 Application Insights kaynağı için yeni bir sürekli dışarı aktarma yapılandırması oluşturma
```
...
Yeni Application Insights sürekli dışarı aktarma yapılandırması "Istek" ve "Izleme" belge türlerini depolama alanına "testgroup" kaynak grubundaki "teststorageaccount" depolama hesabında "testcontainer" içerir. SAS belirtecinin geçerli olması ve kapsayıcıya yazma izni olması gerekir, aksi takdirde sürekli dışarı aktarma özelliği çalışmaz. SAS belirtecinin süresi dolduysa, sürekli dışarı aktarma özelliği çalışmayı durdurur.
