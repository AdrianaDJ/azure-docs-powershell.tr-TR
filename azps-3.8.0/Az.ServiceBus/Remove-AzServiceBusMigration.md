...
## Tanım
**Remove-AzServiceBusMigration** cmdlet 'i standart için Premium ad alanlarına geçiş yapılandırmasını siler
...
' TestingNamespaceStandardMigration ' geçiş yapılandırmasını siler
