...
## Tanım
Remove-AzAvailabilityGroupListener cmdlet 'i bir kullanılabilirlik grubu dinleyicisini siler.
...
AgListener01 kullanılabilirlik grubundaki kullanılabilirlik grubu dinleyicisi 'ni siler.
...
### -InputObject
Kullanılabilirlik grubu dinleyici nesnesi.
...
### -Geçiş
, Cmdlet 'in yürütülmesinin sonunda silinen kaynağın çıktısının mi edilmeyeceğini belirtir.
