...
## Tanım
**New-Azoperationalınsightswindowseventdatasource** cmdlet 'ı, Azure Operasyonel Öngörüler 'de Windows işletim sistemini çalıştıran bağlı bilgisayarlardan Windows olay günlüklerini toplayan bir veri kaynağı ekler.

## ÖRNEKLERDEN

### Örnek 1: sistem Windows olayı veri kaynağı oluşturma
```
$EventLogNames       = @()
...
### -Collectınformation
Işlemsel Öngörüler 'in bilgi iletilerini topladığı anlamına gelir.
...
### -Ad
Veri kaynağı için bir ad belirtir. Ad, Azure portalında gösterilmez ve tüm dizeler benzersiz olduğu sürece kullanılabilir.
...
### -ResourceGroupName
Bilgisayarları içeren bir kaynak grubunun adını belirtir.
