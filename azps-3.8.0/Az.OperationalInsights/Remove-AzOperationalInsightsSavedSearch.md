...
## Tanım
**Remove-Azoperationalınsightssavedsearch** cmdlet 'i, kaydedilmiş bir aramayı çalışma alanından kaldırır.

## ÖRNEKLERDEN

### Örnek 1: kaydedilen aramayı kaldırma
```
...
Bu komut, kaydedilmiş bir aramayı çalışma alanından kaldırır.
