...
## Tanım
**New-Azoperationalınsightsccustomlogdatasource** cmdlet 'i özel günlük koleksiyonu ilkesi tanımlar.
...
### -CustomLogRawJson
Özel koleksiyon ilkesini ham JavaScript nesne gösterimi (JSON) dizesi olarak belirtir.
