...
## SYNOPSIS
Azure 'da çalışan bir Web sitesini yapılandırır.
...
**Set-AzureWebsite** cmdlet 'ı, Azure 'da çalışan bir Web sitesini yapılandırır.
...
Bu örnekte HTTP günlüğe kaydetme etkinleştirilir.

### Örnek 2: Web sitesi için depolama bilgilerini ayarlama
```
...
Bu örnekte, AZURE_STORAGE_ACCOUNT ve AZURE_STORAGE_ACCESS_KEY için ortam değişkenleriyle birlikte myWebsite adlı Web sitesindeki depolama bilgileri ayarlanır.
...
### -DefaultDocuments
Web sitesine gözatarken otomatik olarak görüntülenen belgeleri belirtir.
...
### -HandlerMappings
Web sitesi tarafından kullanılan İşleyici eşlemelerini belirtir.
...
### -Ana makine adları
Web sitesine erişmek için kullanılabilecek tam nitelikli ana bilgisayar adlarını belirtir.
...
### -ManagedPipelineMode
Yönetilen ardışık düzen modunu belirtir.
...
### -Metadata
Web sitesi için meta verileri belirtir.
...
### -NetFrameworkVersion
Web sitesi için gereken .NET Framework sürümünü belirtir.
...
### -Geçiş
Bu cmdlet 'in **Boole** değeri döndürdüğü anlamına gelir.
...
### -PhpVersion
Web sitesi için gereken PHP sürümünü belirtir.
...
Web sitesi için istek izlemenin etkinleştirilip etkinleştirilmediğini belirler.
...
32 bit modunun etkinleştirilip etkinleştirilmeyeceğini belirtir.
...
### -WebSocketsEnabled
WebSockets etkinleştirilip etkinleştirilmeyeceğini belirtir.
