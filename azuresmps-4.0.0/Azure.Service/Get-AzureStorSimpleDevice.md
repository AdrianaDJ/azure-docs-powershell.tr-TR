...
## Tanım
**Get-AzureStorSimpleDevice** cmdlet 'i kaynağa bağlı StorSimple aygıtların bir listesini alır.
Cihaz KIMLIĞI, adı, model KIMLIĞI ve türünü belirtebilirsiniz.
Diğer StorSimple cmdlet 'lerinin cihazlarını belirtmek için bu cmdlet kullanılarak alınan **DeviceID** özelliğini kullanın.

## ÖRNEKLERDEN

### Örnek 1: kaynakta kullanılabilir cihazları alma
```
...
Bu komut, bir kaynaktaki kullanılabilir tüm cihazları alır.
Bu örnekte yalnızca bir cihaz kullanılabilir.

### Örnek 2: bir kaynakta belirli kullanılabilir cihazları alma
```
...
Bu komut, bir kaynaktaki belirtilen ad, tür ve model KIMLIĞI içeren kullanılabilir tüm cihazları alır.

### Örnek 3: aygıtın ayrıntılarını alma
```
...
Bu komut, bir kaynaktaki belirtilen adı ve türü içeren kullanılabilir tüm cihazları alır.
Bu komut, *ayrıntılı* parametreyi belirtir.
Komut döndürdüğü aygıtlarla ilgili ek bilgiler sağlar.

## PARAMETRELERINE

### -Ayrıntılı
Bu cmdlet 'in aldığı cihazların cihaz ayrıntılarını döndürmediğini belirtir.
...
### -DeviceID
Alınacak aygıtın örnek KIMLIĞINI belirtir.
...
### -Aygıtadı
Alınacak StorSimple aygıtının adını belirtir.
...
### -ModelId
Alınacak StorSimple aygıtlarının modelinin KIMLIĞINI belirtir.
...
### -Tür
StorSimple aygıtının türünü belirtir.
Geçerli değerler: Gereç ve VirtualAppliance.
...
### Liste \<DeviceDetails\> , IEnumerable\<DeviceInfo\>
Bu cmdlet, *ayrıntılı* parametreyi belirttiğinizde bir **liste \<DeviceDetails\>** nesnesi döndürür.
Parametreyi belirtmezseniz, **IEnumerable \<DeviceInfo\>** nesnesi döndürür.
