...
## SYNOPSIS
Azure sanal ağ ağ geçidi oluşturur.
...
## Tanım
**New-AzureVirtualNetworkGateway** cmdlet 'ı bir Azure sanal ağ geçidi oluşturur.
...
### -Force
Azure sanal ağ geçidi oluşturmayı onaylama
