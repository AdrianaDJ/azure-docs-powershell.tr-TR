...
## SYNOPSIS
Site kurtarma sunucularını bir site kurtarma Kasası 'na getirir.
...
## Tanım
**Get-AzureSiteRecoveryServer** cmdlet 'i, geçerli site kurtarma kasasına kaydedilen Azure Site Recovery sunucuları hakkında bilgi alır.

## ÖRNEKLERDEN

### Örnek 1: site kurtarma sunucusu hakkında bilgi alma
```
...
Bu komut, bir Azure Site Recovery sunucusu hakkında bilgi alır.

## PARAMETRELERINE

### -ID
Sunucunun KIMLIĞINI belirtir.
