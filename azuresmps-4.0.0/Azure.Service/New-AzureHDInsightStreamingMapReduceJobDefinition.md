...
## SYNOPSIS
Yeni bir akış MapReduce işi tanımlar.
...
**New-AzureHDInsightStreamingMapReduceJobDefinition** cmdlet 'ı bir Hadoop akış işinin parametrelerini temsil eden yeni bir iş tanımı nesnesi tanımlar.
...
Bu komut belirtilen akış MapReduce iş tanımını oluşturur ve $StreamingWordCount değişkeninde depolar.
...
### -CmdEnv
Bir iş veri düğümlerinde çalıştığında ayarlanacak komut satırı ortam değişkenleri dizisini belirtir.
...
### -Combiner
Bir Combiner dosya adı belirtir.
...
### -Dosyalar
Bir iş için gereken dosyalar dizisini belirtir.
...
### -Inputpath
Giriş dosyalarının en fazla yolunu belirtir.
...
### -JobName
Yeni Maduce iş tanımının adını belirtir.
...
### -OutputPath
İş çıkışının en son yolunu belirtir.
...
### -StatusFolder
İş için, çıkış kodu ve görev günlükleri dahil standart çıktıları ve hata çıktılarını içeren klasörü belirtir.
