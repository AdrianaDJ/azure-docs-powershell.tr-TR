...
### Örnek 1: Web işi için eksiksiz geçmişi alma
```
PS C:\> Get-AzureWebsiteJobHistory -Name MyWebsite -JobName MyWebJob
```

MyWebJob 'un tam geçmişini alır.

### Örnek 2: Web işi için en son çalıştırmayı alma
```
PS C:\> Get-AzureWebsiteJobHistory -Name MyWebsite -JobName MyWebJob -Latest
```

MyWebJob için en son çalışma bilgilerini alır.

### Örnek 3: Web işi için belirli bir çalışma alma
```
PS C:\> Get-AzureWebsiteJobHistory -Name MyWebsite -JobName MyWebJob -RunId 10
```

MyWebJob için ID 10 ile çalışma hakkında tüm bilgileri alır.
...
### -En son
Belirtilmişse, en son çalışma geçmişini döndürün.
...
### -RunId
Görmek istediğiniz çalışma geçmişinin KIMLIĞINI belirtir.
