...
## SYNOPSIS
Azure sanal ağ geçidi ağ bağlantısı oluşturur.
...
## Tanım
**New-AzureVirtualNetworkGatewayConnection** cmdlet 'ı bir Azure sanal ağ geçidi ağ bağlantısı oluşturur.
...
### -EnableBgp
Sınır Ağ Geçidi Protokolü 'Nü (BGP) verir.
...
Ağ Geçidi bağlantısı için bir ad belirtir.
...
Ağ Geçidi bağlantı türünü belirtir.
...
### -SharedKey
Paylaşılan bir anahtar belirtir.
...
### -Virtualnetworkgatewayıd
Sanal ağ geçidinin KIMLIĞINI belirtir.
