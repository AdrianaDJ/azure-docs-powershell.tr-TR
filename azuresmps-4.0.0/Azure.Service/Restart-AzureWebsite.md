...
## SYNOPSIS
Belirtilen Web sitesini durdurur ve yeniden başlatır.
...
**Restart-AzureWebsite** cmdlet 'i durur ve belirtilen Web sitesini yeniden başlatır.

## ÖRNEKLERDEN

### Örnek 1: Web sitesini yeniden başlatma
```
PS C:\> Restart-AzureWebsite -Name MyWebsite
```

Bu örnek MyWebsite adlı bir Web sitesini yeniden başlatır.

## PARAMETRELERINE

### -Ad
Yeniden başlatılacak Azure Web sitesinin adını belirtir.
