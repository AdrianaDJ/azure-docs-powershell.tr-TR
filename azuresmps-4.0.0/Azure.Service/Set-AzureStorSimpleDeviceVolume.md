...
## SYNOPSIS
Var olan bir birimin özelliklerini güncelleştirir.
...
## Tanım
**Set-AzureStorSimpleDeviceVolume** cmdlet 'i mevcut bir birimin özelliklerini günceller.
Bu cmdlet, bir birimi bir veya daha fazla erişim denetimi kaydı ile ilişkilendirir.
**Accesscontrolrecord** nesnelerini almak için **Get-AzureStorSimpleAccessControlRecord** cmdlet 'ini kullanın.
Birimin boyutunu veya türünü güncelleyin.
Ayrıca, birimi çevrimiçi oluşturmayı de güncelleyin.

## ÖRNEKLERDEN

### Örnek 1: bir birimin çevrimiçi değerini güncelleştirme
```
...
Bu komut, Volume18 adlı birimi $False çevrimiçi değeri olacak şekilde güncelleştirir.
Bu komut görevi başlatır ve bir **Taskresponse** nesnesi döndürür.
Görevin durumunu görmek için **Get-AzureStorSimpleTask** cmdlet 'ini kullanın.

### Örnek 2: çevrimiçi değeri değiştirme ve türü
```
...
Bu komut, Volume18 adlı birimi güncelleştirir.
Türü değiştirir ve *çevrimiçi* parametrenin değerini $true olarak değiştirir.
...
### -Aygıtadı
Birimin güncelleştirilmesi gereken StorSimple aygıtının adını belirtir.
...
### -NewName
StorSimple cihazı için yeni bir ad belirtir.
...
### -Çevrimiçi
Birimin çevrimiçi olup olmadığını belirtir.
...
### -Hacim
Güncelleştirilecek birimin adını belirtir.
...
### -VolumeAppType
Birimi birincil veya arşiv birimi olacak şekilde güncelleştirip güncelleştirmeyeceğinizi belirtir.
...
### -VolumeSizeInBytes
Birimin güncelleştirilmiş boyutunu bayt cinsinden belirtir.
...
### Listeniz\<AccessControlRecord\>
Bu cmdlet, birimle ilişkilendirilecek **Accesscontrolrecord** nesnelerinin listesini kabul eder.
