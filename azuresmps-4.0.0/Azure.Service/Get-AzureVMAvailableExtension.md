...
## SYNOPSIS
Sanal makinelerde kullanılabilen en son uzantılara yönelik bilgileri alır.

## INDEKI

### ListLatestExtensions (varsayılan)
```
...
## Tanım
**Get-AzureVMAvailableExtension** cmdlet 'i sanal makinelerde kullanılabilir en son uzantılara yönelik bilgileri alır.

## ÖRNEKLERDEN

### Örnek 1: kullanılabilir en son uzantılar için bilgi alma
```
...
Bu komut, tüm sanal makinelerde kullanılabilen en son uzantılara yönelik bilgileri alır.

### Örnek 2: belirtilen bir uzantı adından bilgi alma
```
...
Bu komut, VMAccessAgent adındaki ve Microsoft.

### Örnek 3: belirli bir sanal makine uzantısından sürüm numarasıyla bilgi alma
```
...
Bu komut, VMAccessAgent adlı uzantıya ve Microsoft.

## PARAMETRELERINE

### -AllVersions
Bu cmdlet 'in bir uzantının tüm sürümlerini listediğini belirtir.
...
### -ExtensionName
Kullanılabilir uzantının adını belirtir.
