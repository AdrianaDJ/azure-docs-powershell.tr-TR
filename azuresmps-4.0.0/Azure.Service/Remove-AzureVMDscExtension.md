...
## SYNOPSIS
Bir sanal makineden Azure DSC uzantısını kaldırır.
...
## Tanım
**Remove-AzureVMDscExtension** cmdlet 'i, BIR Azure DSC uzantısını sanal makineden kaldırır.
Bu cmdlet 'in çıkışının **Update-AzureVM** cmdlet 'ine yöneltilmesi gerekmektedir.

## ÖRNEKLERDEN

### Örnek 1: bir sanal makineden DSC uzantısını kaldırma
```
PS C:\> Remove-AzureVMDscExtension -VM $VM | Update-AzureVM
```

Bu komut, bir sanal makineden Azure DSC uzantısını kaldırır.
