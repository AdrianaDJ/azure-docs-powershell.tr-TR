...
**Get-AzureAutomationVariable** cmdlet 'i bir veya daha fazla Microsoft Azure Otomasyonu değişkenini alır.
Varsayılan olarak, tüm değişkenler döndürülür.
...
Bu komutlar MyVariable adlı bir Automation değişkeni alır ve değerini $value adlı bir değişkene atar.
