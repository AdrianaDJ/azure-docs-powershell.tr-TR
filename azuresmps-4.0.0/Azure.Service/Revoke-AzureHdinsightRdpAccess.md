...
## SYNOPSIS
HDInsight kümesine RDP erişimini devre dışı bırakır.
...
**Revoke-AzureHDInsightRdpAccess** cmdlet 'ı bir Azure HDInsight kümesine Uzak Masaüstü Protokolü (RDP) erişimini devre dışı bırakır.
...
### -Abonelik
Aboneliği belirtir.
Bu cmdlet, bu parametrenin belirttiği aboneliğe Uzak Masaüstü Protokolü (RDP) erişimini iptal eder.
