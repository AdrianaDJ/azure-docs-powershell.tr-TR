...
## SYNOPSIS
Bulut hizmeti için bir AD etki alanı uzantısını etkinleştirmiştir.
...
## Tanım
**Set-AzureServiceADDomainExtension** cmdlet 'i bulut hizmeti IÇIN bir ad (Active Directory) etki alanı uzantısı verir.
...
### -Credential
AD etki alanına katılma kimlik bilgilerini belirtir.
