...
## SYNOPSIS
Bir bulut hizmetinde dağıtılan tüm sanal makinelerin veya hizmette belirli bir sanal makinenin DSC Uzantısı durumunu alır.

## INDEKI

### GetStatusByServiceAndVMName (varsayılan)
```
...
## Tanım
**Get-AzureVMDscExtensionStatus** cmdlet 'i, bir bulut hizmetinde dağıtılan tüm sanal makinelerin veya hizmette belirli bir sanal makinenin Istenen durum YAPıLANDıRMASı (DSC) uzantı durumunu alır.
...
### Microsoft. Windowsazde. Commands. ServiceManagement. IaaS. Extensions. VirtualMachineDscExtensionStatusContext
