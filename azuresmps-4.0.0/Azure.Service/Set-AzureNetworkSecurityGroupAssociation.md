...
## SYNOPSIS
Ağ güvenlik grubunu sanal makineyle, PaaS rolüyle veya ağ bağdaştırıcısıyla ilişkilendirir.
...
## Tanım
**Set-AzureNetworkSecurityGroupAssociation** cmdlet 'i, bir ağ güvenlik grubunu bir sanal makineyle, hizmet (PaaS) rolüyle veya ağ bağdaştırıcısıyla ilişkilendirir.

## ÖRNEKLERDEN

### Örnek 1: ağ güvenlik grubuna sanal makine atama
```
...
Geçerli cmdlet, ContosoNetworkSecurityGroup adlı ağ güvenlik grubunu bu sanal makineye atar.
...
### -Ad
Bu cmdlet 'in ayarladığı ağ güvenlik grubunun adını belirtir.
...
Bu cmdlet 'in ağ güvenlik grubunu uyguladığı ağ bağdaştırıcısının adını belirtir.
...
### -RoleName
Bu cmdlet 'in ağ güvenlik grubunu uyguladığı PaaS rolünün adını belirtir.
...
Bu cmdlet 'in ağ güvenlik grubunda ayarladığı PaaS rolü, bu parametrenin belirttiği yuvaya sahiptir.
Geçerli değerler: 
...
### -SubnetName
Bu cmdlet 'in ağ güvenlik grubunu ilişkilendiğinde alt ağın adını belirtir.
...
### -VirtualNetworkName
Bu cmdlet 'in ağ güvenlik grubunu ilişkilendiğinde alt ağını içeren sanal ağın adını belirtir.
