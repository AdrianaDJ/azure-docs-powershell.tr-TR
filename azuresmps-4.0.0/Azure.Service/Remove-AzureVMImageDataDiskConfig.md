...
## SYNOPSIS
DiskConfigSet nesnesinden veri diski yapılandırmasını kaldırır.

## INDEKI

### RemoveByDiskName (varsayılan)
```
...
## Tanım
**Remove-AzureVMImageDataDiskConfig** cmdlet 'ı **diskconfigset** nesnesinden veri diski yapılandırmasını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: DiskConfigSet nesnesinden veri diski yapılandırmasını kaldırma
```
...
Bu örnek **Diskconfigset** oluşturur, yapılandırır ve veri diskini kaldırır.

## PARAMETRELERINE

### -DataDiskName
Bu cmdlet 'in kaldırdığı veri diskinin adını belirtir.
