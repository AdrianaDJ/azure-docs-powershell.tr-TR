...
## SYNOPSIS
Bir dağıtım için bulut hizmeti uzantısı oluşturur.
...
## Tanım
**New-AzureServiceExtensionConfig** cmdlet 'i bir dağıtım için bulut hizmeti uzantısı oluşturur.

## ÖRNEKLERDEN

### Örnek 1: uzantı yapılandırması oluşturma
```
...
Bu komut, bir uzantı yapılandırmasını belirtir.

### Örnek 2: rol için genişletme yapılandırması oluşturma
```
...
Bu komut, rol WebRole1 için bir genişletme yapılandırması belirtir.
...
### -ProviderNamespace
Uzantının sağlayıcı ad boşluğunu belirtir.
