...
## SYNOPSIS
Bir koleksiyon için yayımlanmış bir veya birden çok Azure RemoteApp programının özelliklerini getirir.

## INDEKI

### FilterByName (varsayılan)
```
...
## Tanım
**Get-AzureRemoteAppProgram** cmdlet 'i, bir koleksiyon için yayımlanmış bir veya birden çok Azure RemoteApp programının özelliklerini alır.

## ÖRNEKLERDEN

### Örnek 1: bir programın özelliklerini alma
```
...
Bu komut, bir Azure RemoteApp programının özelliklerini görüntüler.
Finans uygulaması adlı program, ContosoApps adlı Azure RemoteApp koleksiyonudur.

## PARAMETRELERINE

### -Diğer ad
Özelliklerin alınacağı programın diğer adını belirtir.
...
### -RemoteAppProgram
Özelliklerini alacak olan programın adını belirtir.
