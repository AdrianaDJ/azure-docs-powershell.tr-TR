...
## SYNOPSIS
Bir aboneliğindeki HDInsight kümesini siler.
...
**Remove-AzureHDInsightCluster** cmdlet 'i, belirtilen HDInsight hizmet kümesini abonelikten siler.
...
### Örnek 1: kümeyi kaldırma
```
PS C:\>Remove-AzureHDInsightCluster -Name "HDICluster"
```

Bu komut, HDICluster adlı HDInsight kümesini siler.
...
### -Ad
Kaldırılacak HDInsight kümesinin adını belirtir.
...
### -Abonelik
Kaldırılacak HDInsight kümesini içeren abonelik hesabını belirtir.
