...
## Tanım
**Restart-AzureVM** cmdlet 'ı bir Azure sanal makinesinin yeniden başlatılmasını ister.
...
Bu komut, Service01 adındaki Azure hizmetinde çalışan VirtualMachine27 sanal makinesini yeniden başlatır.

### Örnek 2: sanal makine nesnesini kullanarak sanal makineyi yeniden başlatın
```
PS C:\> Get-AzureVM -ServiceName "MyService01" -Name "VirtualMachine27" | Restart-AzureVM
```

Bu komut MyVM adındaki sanal makine için sanal makine nesnesini alır ve ardından yeniden başlatır.
...
### -Ad
Yeniden başlatılacak sanal makinenin adını belirtir.
...
### -Yeniden dağıtma
Cmdlet 'in sanal makineyi yeniden dağıttığını gösterir.
...
### -HizmetAdı
Yeniden başlatılacak sanal makineyi içeren Azure hizmetinin adını belirtir.
...
### -VM
Sanal makineyi yeniden başlatılacak şekilde tanımlayan sanal makine nesnesini belirtir.
