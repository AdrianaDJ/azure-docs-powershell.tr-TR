...
## Tanım
**Get-AzureSiteRecoveryVM** cmdlet 'ı Azure Site Recovery 'de yönetilen sanal makineler hakkında bilgi alır.

## ÖRNEKLERDEN

### Örnek 1: sanal makine hakkında bilgi alma
```
...
İkinci komut $ProtectionContainer sanal makinelerle ilgili bilgileri alır.

## PARAMETRELERINE

### -ID
Bilgi alınacak sanal makinenin KIMLIĞINI belirtir.
...
Bilgi alınacak korumalı kapsayıcının KIMLIĞINI belirtir.
