...
## SYNOPSIS
Dağıtıma uygulanan bulut hizmeti uzantılarını kaldırır.
...
## Tanım
**Remove-AzureServiceExtension** cmdlet 'i, dağıtıma uygulanan bulut hizmeti uzantılarını kaldırır.

## ÖRNEKLERDEN

### Örnek 1: hizmet uzantısını kaldırma
```
...
Bu komut, hizmet uzantısını kaldırır.

### Örnek 2: hizmet uzantısını kaldırma ve tüm yapılandırmaları kaldırma
```
...
Bu komut, hizmet uzantısını kaldırır ve tüm yapılandırmaları kaldırır.
...
### -Role
Uzantısını belirtmek için isteğe bağlı bir rol dizisi belirtir.
Belirtilmezse, uzantı tüm roller için varsayılan yapılandırma olarak uygulanır.
...
Bu cmdlet 'in bulut hizmetindeki tüm yapılandırmaları kaldırmadığını gösterir.
