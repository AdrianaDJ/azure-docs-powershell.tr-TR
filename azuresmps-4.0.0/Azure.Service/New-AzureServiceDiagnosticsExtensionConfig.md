...
## SYNOPSIS
Belirtilen rollerin veya tüm rollerin tanılama uzantısı için yapılandırma oluşturur.
...
## Tanım
**Yeni-Azurezervicediagnoçıkartsextensionconfig** cmdlet 'i, belirtilen roller veya tüm roller için bir tanılama uzantısı için yapılandırma oluşturur.

## ÖRNEKLERDEN

### Örnek 1: bulut hizmetindeki tüm roller için Azure tanılama uzantısı oluşturma
```
...
Bu komut, bulut hizmetindeki tüm roller için Azure tanılama uzantısı oluşturur.

### Örnek 2: bir rol için Azure tanılama uzantısı oluşturma
```
...
Bu komut, bulut hizmetinde WebRole01 rol için Azure tanılama uzantısı oluşturur.
...
### -Role
Tanılama yapılandırmasını belirtmek için isteğe bağlı bir rol dizisi belirtir.
Belirtilmezse, tanılama yapılandırması tüm roller için varsayılan yapılandırma olarak uygulanır.
