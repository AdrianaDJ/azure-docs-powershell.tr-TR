...
## Tanım
**Get-AzureStorSimpleDeviceBackupPolicy** cmdlet 'i yedekleme ilkelerini alır.
Bu cmdlet **, bir cihaza** ait **olan yedekleme İlkesi nesnelerinin listesini** veya bir listeyi döndürür.
Yedekleme ilkesi nesneleri aşağıdaki özellikleri içerir: 
...
### Örnek 1: bir ilkenin ayrıntılarını alma
```
...
Bu komut, Contoso63-AppVm adlı cihazda GeneralBackupPolicy07 adlı bir **Backuppolicydetails** nesnesi alır.

### Örnek 2: yedekleme ilkelerinin listesini alma
```
...
Bu komut, Contoso63-AppVm adlı cihazdaki **Backuppolicy** nesnelerini listeler.

## PARAMETRELERINE

### -BackupPolicyName
Alınacak yedekleme ilkesinin adını belirtir.
Bu parametreyi belirtmezseniz, bu cmdlet tüm ilkeleri alır.
...
*Backuppolicyname* parametresini belirtirseniz, bu cmdlet bir **backuppolicydetails** nesnesi döndürür.
Parametreyi belirtmezseniz, bir **IList \<BackupPolicy\>** nesnesi döndürür.
