...
## SYNOPSIS
Varsa, bir sanal makine nesnesinden statik VNet IP adresi bilgilerini alır.
...
## Tanım
**Get-AzureStaticVNetIP** cmdlet 'i bir sanal makine nesnesinden statik sanal ağ (VNet) IP adresi bilgilerini alır.
