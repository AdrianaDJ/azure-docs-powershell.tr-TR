...
## SYNOPSIS
Sanal makinenin BgInfo uzantısını ayarlar.

## INDEKI

### SetBGInfoExtension (varsayılan)
```
...
## Tanım
**Set-AzureVMBGInfoExtension** cmdlet 'i sanal makinenin BgInfo uzantısını ayarlar.

## ÖRNEKLERDEN

### Örnek 1: sanal makine için BgInfo uzantısını ayarlama
```
PS C:\> Set-AzureVMBGInfoExtension -VM $VM
```

Bu komut, belirtilen sanal makinenin $VM değişkende depolanan BgInfo uzantısını ayarlar.
...
### -ReferenceName
BgInfo uzantısının başvuru adını belirtir.
...
Uzantıyı güncelleştirirken daha önce kullanılmış olan başvuru adını belirtebilirsiniz.
...
### -Uninstall
Bu cmdlet 'in BgInfo uzantısını kaldırmadığını gösterir.
...
### -Version
BgInfo uzantısının sürümünü belirtir.
