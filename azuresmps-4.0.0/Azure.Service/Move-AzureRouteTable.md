...
## SYNOPSIS
Yol tablosunu Azure Resource Manager yığınına geçirir.
...
## Tanım
**Taşıma-AzureRouteTable** cmdlet 'i, yol tablosunu Azure Kaynak Yöneticisi yığınındaki bir kaynak grubuna geçirir.
...
### -Abort
Bu cmdlet 'in yol tablosu geçişini iptal ettiğini gösterir.
...
### -Commit
Bu cmdlet 'in yol tablosu geçişini başlattığını gösterir.
...
### -Prepare
Bu cmdlet 'in yol tablosunu geçiş için hazırtığını gösterir.
...
### -RouteTableName
Bu cmdlet 'in geçirolduğu yol tablosunun adını belirtir.
...
### -Doğrulama
Bu cmdlet 'in geçiş için yol tablosunu doğrulayacağını belirtir.
