...
## SYNOPSIS
Alt ağ için yol tablosunu alır.
...
## Tanım
**Get-azuyeniden gönderme Netroutetable** cmdlet 'i bir alt ağla ilişkilendirilmiş yol tablosunu alır.

## ÖRNEKLERDEN

### Örnek 1: alt ağın yollarını görüntüleme
```
...
Bu komut, ContosoSubnet adlı alt ağla ilişkili yol tablosu adındaki yolları görüntüler.

## PARAMETRELERINE

### -Ayrıntılı
Bu cmdlet 'in alt ağla ilişkili yol tablosundaki yolları görüntüleyeceğini gösterir.
...
### -SubnetName
Bu cmdlet 'in yol tablosunu aldığı alt ağı belirtir.
...
### -VirtualNetworkName
Bu cmdlet 'in yol tablosunu aldığı alt ağı içeren sanal ağın adını belirtir.
