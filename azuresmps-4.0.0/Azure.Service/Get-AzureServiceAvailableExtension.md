...
## SYNOPSIS
Barındırılan hizmetler için kullanılabilir uzantılar hakkında bilgi alır.
...
## Tanım
**Get-Azurezerviceavailableextension** cmdlet 'i barındırılan hizmetler için kullanılabilir en son uzantılara yönelik bilgileri alır.

## ÖRNEKLERDEN

### Örnek 1: kullanılabilir uzantıları alma
```
...
Bu komut kullanılabilir tüm uzantıları alır.

### Örnek 2: belirtilen ad alanında uzantıları alma
```
...
Bu komut belirtilen ad alanında belirtilen ada sahip uzantıları alır.

### Örnek 3: uzantının belirli bir sürümünü alma
```
...
Bu komut, uzantının belirli bir sürümü hakkında bilgi alır.

## PARAMETRELERINE

### -AllVersions
Bu cmdlet 'in bir uzantının tüm sürümlerini aldığını gösterir.
