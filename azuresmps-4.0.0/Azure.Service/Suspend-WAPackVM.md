...
**Askıya al-WAPackVM** cmdlet 'i sanal makineyi askıya alır.

## ÖRNEKLERDEN

### Örnek 1: sanal makineyi askıya alma
```
...
İkinci komut $VirtualMachine depolanan sanal makineyi askıya alır.
