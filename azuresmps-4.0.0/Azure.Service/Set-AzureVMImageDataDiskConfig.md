...
## SYNOPSIS
Sanal makine yansımasındaki veri diski özelliklerini ayarlar.
...
## Tanım
**Set-AzureVMImageDataDiskConfig** cmdlet 'i sanal makine yansımasındaki veri diski özelliklerini ayarlar.

## ÖRNEKLERDEN

### Örnek 1: sanal makine yansımasında veri diski özelliklerini ayarlama
```
...
Bu komut sanal makinedeki veri diski özelliklerini ayarlar ve ardından sanal makine yansımasını güncelleştirir.

## PARAMETRELERINE

### -DataDiskName
Bu cmdlet 'in yapılandırdığı veri diskinin adını belirtir.
...
### -LUN
Sanal makinede veri sürücüsünün bağlı olduğu yuvayı belirtir.
