...
**Set-AzureAutomationCertificate** cmdlet 'ı, Microsoft Azure Otomasyonu 'nda bir sertifikanın yapılandırmasını değiştirir.

## ÖRNEKLERDEN

### Örnek 1: sertifikayı güncelleştirme
```
...
Bu komutlar, Otomasyon 'daki MyCertificate adlı sertifikayı güncelleştirir.
İlk komut, sertifikayı güncelleştiren ikinci komutta kullanılan sertifika dosyasının parolasını oluşturur.
