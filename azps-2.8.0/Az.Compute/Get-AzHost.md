...
## Tanım
Bu cmdlet, konak grubundaki bir ana bilgisayarı alır.
Bu cmdlet, bir ana bilgisayar adı verilmemişse tüm ana bilgisayarları da listeler.
...
Bu komut bir ana bilgisayar döndürür.
...
Bu komut, bir ana bilgisayarın örnek görünümünü döndürür.
...
Bu komut, verilen konak grubundaki tüm Konakları döndürür.
...
### -InstanceView
Bu cmdlet 'in yalnızca ana bilgisayarın örnek görünümünü aldığını gösterir.
