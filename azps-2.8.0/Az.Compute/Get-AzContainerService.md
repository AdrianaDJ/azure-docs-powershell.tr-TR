...
## Tanım
**Get-AzContainerService** cmdlet 'i bir kapsayıcı hizmeti alır.
...
### Örnek 2: tüm kapsayıcı hizmetlerini alma
```
...
Bu komut, abonelikteki tüm kapsayıcı hizmetlerini alır.

### Örnek 3: kaynak grubundaki tüm kapsayıcı hizmetlerini alma
```
...
Bu komut, ResourceGroup17 'deki tüm kapsayıcı hizmetlerini alır.

### Örnek 4: filtre kullanarak tüm kapsayıcı hizmetlerini alma
```
...
Bu komut, "CSResourceGroup1" ile başlayan tüm kapsayıcı hizmetlerini alır.
