...
### -Öncelik
Sanal makine ölçek kümesi için öncelik.  Yalnızca desteklenen değerler ' Regular ' ve ' Low ' değerleridir.
...
Bu ölçek kümesiyle kullanılacak yakınlık Yerleşim grubunun adı veya kaynak kimliği.
