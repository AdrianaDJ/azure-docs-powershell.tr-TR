...
Veritabanıyla ilgili güvenli bağlantı ilkesini alır. Güvenli bağlantı kullanım dışıdır ve bu komut sonraki sürümde kaldırılacaktır. Bağlantı dizelerini görüntülemek için lütfen Azure portalında SQL veritabanı Blade 'i kullanın
...
### [Güncelleştirme-AzSqlServerAdvancedThreatProtectionSettings](Update-AzSqlServerAdvancedThreatProtectionSettings.md)
