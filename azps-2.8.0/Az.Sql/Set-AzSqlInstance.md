...
### Örnek 2: örnek havuzundaki bir örnek için yeni-\Administrators parolası,-LicenseType,-StorageSizeInGB ve-VCore değerlerini kullanarak varolan örneği ayarlayın
```powershell
PS C:\>$InstancePassword = "Newpassword1234"
PS C:\> $SecureString = ConvertTo-SecureString $InstancePassword -AsPlainText -Force
