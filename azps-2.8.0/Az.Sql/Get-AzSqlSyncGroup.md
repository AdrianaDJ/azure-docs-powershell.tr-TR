...
## Tanım
**Get-AzSqlSyncGroup** cmdlet 'i, bir veya daha fazla Azure SQL veritabanı eşitleme grubuyla ilgili bilgileri döndürür.
Yalnızca bu eşitleme grubuyla ilgili bilgileri görmek için eşitleme grubunun adını belirtin.

## ÖRNEKLERDEN

### Örnek 1: Azure SQL veritabanına atanan tüm Azure SQL eşitleme grubu örneklerini alma
```
...
Bu komut, Azure SQL veritabanına atanmış tüm Azure SQL veritabanı eşitleme grupları hakkında bilgi alır.

### Örnek 2: Azure SQL veritabanı eşitleme grubu hakkında bilgi alma
```
...
Bu komut, "SyncGroup01" adlı Azure SQL veritabanı eşitleme grubu hakkında bilgi alıyor

### Örnek 3: filtreleme kullanarak Azure SQL veritabanına atanan tüm Azure SQL eşitleme grubu örneklerini alma
```
...
Bu komut, "SyncGroup" ile başlayan bir Azure SQL veritabanına atanmış tüm Azure SQL veritabanı eşitleme grupları hakkında bilgi alır.
