...
## Tanım
**Get-Azsqlserverserviceamacın** cmdlet 'i, BIR Azure SQL veritabanı sunucusu için kullanılabilir hizmet hedeflerini alır.

## ÖRNEKLERDEN

### Örnek 1: hizmet amaçlarını alma
```
...
Bu komut, server01 adlı sunucunun hizmet amaçlarını alır.

### Örnek 2: filtreleme kullanarak hizmet amaçlarını alma
```
...
Bu komut, "System" ile başlayan server01 adındaki sunucunun hizmet amaçlarını alır.

### Örnek 3: bir konum için hizmet amaçlarını alma
```
...
Bu komut belirtilen bir Azure bölgesinin hizmet amaçlarını alır.
...
### -Konum
Hizmet hedeflerine alınacak konumun adı.
...
Bu cmdlet, bu kaynağa atanmış bir SQL veritabanı sunucusu için hizmet amaçlarını alır.
...
### -ServerName
SQL veritabanı SQL veritabanı sunucusunun adını belirtir.
...
Azure SQL veritabanı sunucusu için hizmet amacın adını belirtir.
Bu parametre için kabul edilebilir değerler: Basic, S0, S1, S2, P1, P2 ve P3.
...
### Microsoft. Azure. Commands. Sql. Serviceamacın. model. azures, Serverserviceobjectivemodel
