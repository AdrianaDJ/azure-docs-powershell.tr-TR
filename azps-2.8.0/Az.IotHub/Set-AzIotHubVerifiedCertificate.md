...
## Tanım
Get-Aziothubcertificatedoðrulamasý Icationcode cmdlet 'i tarafından alınan doğrulama kodunu içeren bir doğrulama sertifikası yükleyerek sertifikayı doğrular. Bu, elinde bulunan en son adımdır.
...
MyCertificate özel anahtarının sahipliğini doğrular. 
