...
## Tanım
Get-AzNetworkWatcher cmdlet bir veya birden çok Azure ağ Izleyicisi kaynağını alır.

## ÖRNEKLERDEN

### Örnek 1: ağ Izleyicisi alma
```
...
### Örnek 2: filtreleme kullanarak ağ Watchers
```
...
"Ağizleyicisi" ile başlayan ağ Watchers
