...
**Remove-AzVirtualNetworkGatewayConnection** cmdlet 'ı, ad ve kaynak grubu adına dayalı olarak bağlantınızın nesnesini siler.

## ÖRNEKLERDEN

### 1: sanal ağ geçidi bağlantısını silme
```
Remove-AzVirtualNetworkGatewayConnection -Name myTunnel -ResourceGroupName myRG
```

"MyRG" kaynak grubunda "myTunnel" adlı sanal ağ geçidi bağlantısı nesnesini siler
...
### -Ad
Bu cmdlet 'in kaldırıldığı sanal ağ geçidi bağlantısının adını belirtir.
...
### -ResourceGroupName
Sanal ağ geçidi bağlantısını içeren kaynak grubunun adını belirtir.
