...
Yukarıdaki "Batı ABD" bölgesinde "testRG" kaynak grubu ve Azure 'daki bu kaynak grubunda bir Azure sanal WAN oluşturur. VirtualWan yeni özelliklerle güncelleştirilir.

## PARAMETRELERINE

### -AllowBranchToBranchTraffic
VirtualWan için dal trafiğine izin verin.
...
VirtualWan için VNET 'den VNET trafiğine izin verin.
...
### -InputObject
Değiştirilecek sanal WAN nesnesi
