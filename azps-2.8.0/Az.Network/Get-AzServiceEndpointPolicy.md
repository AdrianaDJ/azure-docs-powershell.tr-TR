...
## Tanım
**Get-AzServiceEndpointPolicy** cmdlet 'i bir hizmet uç noktası ilkesini alır.
...
Bu komut, "ServiceEndpointPolicy" ile başlayan tüm hizmet uç noktası ilkelerinin listesini alır.
...
### -RESOURCEID
Hizmet uç noktası ilkesinin KIMLIĞI.
