...
## Tanım
**Yeni-AzApplicationGatewayRewriteRule** cmdlet 'ı bir Azure Application Gateway için yeniden yazma kuralı oluşturur.

## ÖRNEKLERDEN

### Örnek 1: uygulama ağ geçidi için yeniden yazma kuralı oluşturma
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Bu komut rule1 adlı bir yeniden yazma kuralı oluşturur ve sonucu $rule adlı değişkende depolar.

## PARAMETRELERINE

### -ActionSet
Yeniden yazma kuralının ActionSet
...
### -Koşul
Yeniden yazma kuralının yürütüleceği koşul
...
### -RuleSequence
Yeniden yazma kuralı kümesindeki bu yeniden yazma kuralının kural sıralaması
...
### Microsoft. Azure. Commands. Network. modeller. PSApplicationGatewayRewriteRule
