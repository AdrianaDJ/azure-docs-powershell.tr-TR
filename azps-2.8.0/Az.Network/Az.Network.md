...
VPN istemci bağlantısı başına sanal ağ VPN istemcisi bağlantı durumunu alır.
...
IPSec trafiği seçici Ilkesi oluşturur.
...
Özel bir bağlantı hizmetinin geçerli kullanımda olup olmadığını denetler.
