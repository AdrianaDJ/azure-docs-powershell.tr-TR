...
### Getbyresourcenparameteroexpandparameterset (varsayılan)
```
...
## Tanım
**Get-AzNetworkProfile** cmdlet 'i var olan bir ağ profili üst düzey kaynağını alır
...
Bu, "NP" ile başlayan ağ profillerini alır
