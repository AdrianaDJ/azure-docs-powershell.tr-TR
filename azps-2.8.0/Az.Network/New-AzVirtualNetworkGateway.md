...
Bu VirtualNetwork VPN ağ geçidi için oluşturma işlemi. GatewayType VPN değilse None olmalıdır. Bu özellik, ağ geçidinin kullanım süresi boyunca değiştirilemez.
