...
### Örnek 3: filtreleme kullanarak ağ arabirimleri alma
```
...
Bu komut, geçerli aboneliğin "test" ile başlayan tüm ağ arabirimlerini alır.
...
### -RESOURCEID
Ağ arabiriminin Azure Resource Manager kimliği.
