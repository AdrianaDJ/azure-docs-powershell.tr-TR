...
Azure IoT Hub cihaz sağlama hizmetinde bağlı IoT Hub "myiothub" öğesini silin.
...
Ardışık düzen kullanarak bir Azure IoT Hub cihaz sağlama hizmetine bağlı IoT Hub "myiothub" öğesini silin.
