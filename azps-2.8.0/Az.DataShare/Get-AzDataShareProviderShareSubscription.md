...
### Byprovidersharesubscriptionıdparameterset
```
...
## Tanım
**Get-AzDataShareProviderSubscription** cmdlet 'i sağlayıcı tarafında tüketici paylaşma abonelikleri hakkında bilgi alır. Paylaşım alt öğesi kimliği belirtirseniz, bu cmdlet paylaşım aboneliği hakkında bilgi alır. Paylaşım aboneliği kimliğini belirtmezseniz, bu cmdlet, paylaşım ile ilişkili olan tüm tüketici paylaşımı abonelikleri hakkında bilgi alır.
...
Bu komut, veri paylaşımı hesap WikiAds 'de paylaşım AdsShare ile ilişkilendirilmiş tüketici paylaşımı aboneliği hakkında bilgi sağlar.

## PARAMETRELERINE

### -AccountName
Azure DataShare hesap adı.
...
### -ResourceGroupName
Azure DataShare hesabının kaynak grubu.
...
### -Sharesubscriptionıd
Tüketici paylaşımı aboneliği kimliği
