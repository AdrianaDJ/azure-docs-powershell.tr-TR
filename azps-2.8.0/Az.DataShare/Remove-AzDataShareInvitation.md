...
## Tanım
**Remove-Azdatasharedavetiyesi** cmdlet 'i bir datashare davetini kaldırır.
...
Bu komut, Share AdsShare ile ADSInvite adındaki daveti kaldırır. 
...
### -InputObject
Azure veri paylaşımı davet nesnesi
