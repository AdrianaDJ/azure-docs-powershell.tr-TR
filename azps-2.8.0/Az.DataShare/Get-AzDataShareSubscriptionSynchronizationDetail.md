...
## Tanım
**Get-AzDataShareSubscriptionSynchronizationDetail** cmdlet 'i, bir paylaşım aboneliği için başlatılan eşitlemenin ayrıntılarını sağlar.
...
Bu komut, veri paylaşımı hesap WikiAds altında paylaşım aboneliği Adssharesubscripın altında başlatılan eşitleme hakkında bilgi sağlar.
...
### -Synchronizationıd
Abonelik paylaşımının eşitleme kimliği
