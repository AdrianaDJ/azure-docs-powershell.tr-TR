...
Sağlayıcı ve eşleme konumu içeren bir eşleme hizmeti nesnesi oluşturur. İle birlikte kullanın `Get-AzPeeringServiceProvider` ve `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Azure bölgesinden farklı fiziksel konum. Get-AzPeeringServiceLocation [-Country <country> ] kullanın
...
Eşleme hizmeti sağlayıcısının adı.
Liste için Get-AzPeeringServiceProvider cmdlet 'ini kullanma
...
### Etiketli
Microsoft InputObject hizmetiyle ilişkilendirilecek Etiketler.
