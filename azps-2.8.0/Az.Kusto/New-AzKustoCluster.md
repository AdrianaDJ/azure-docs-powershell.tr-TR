...
### Örnek 1-yeni kusto kümesi oluşturma
...
Yukarıdaki komut, "testrg" kaynak grubunda "mykustocluster" adlı yeni bir kusto kümesi oluşturur.
...
### -Konum
Kümenin oluşturulması gereken Azure bölgesi.
...
### -ResourceGroupName
Kümeyi oluşturmak istediğiniz kaynak grubunun adı.
...
### Etiketli
Bu kümeyle ilişkilendirilmiş etiketlerin dize sözlüğü
