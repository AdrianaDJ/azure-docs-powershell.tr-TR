...
### Örnek 6: Azure dosyaları için AAD DS kimlik doğrulaması içeren bir depolama hesabı oluşturun.
```
...
Bu komut, Azure dosyaları AAD DS kimlik doğrulaması içeren bir depolama hesabı oluşturur.
