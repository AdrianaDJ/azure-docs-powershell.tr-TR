...
## Tanım
**Set-AzStorageQueueStoredAccessPolicy** cmdlet 'i Azure depolama sırası için depolanan bir erişim ilkesini ayarlar.

## ÖRNEKLERDEN

### Örnek 1: kuyrukta depolanan bir erişim ilkesini tam izinlerle ayarlama
```
