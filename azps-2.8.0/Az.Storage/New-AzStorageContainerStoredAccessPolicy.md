...
## Tanım
**New-AzStorageContainerStoredAccessPolicy** cmdlet 'ı bir Azure depolama kapsayıcısı için depolanan bir erişim ilkesi oluşturur.

## ÖRNEKLERDEN

### Örnek 1: depolama kapsayıcısında depolanan bir Access ilkesi oluşturma
```
PS C:\>New-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Bu komut MyContainer adındaki depolama kapsayıcısında Policy01 adlı bir erişim ilkesi oluşturur.
...
### -İzin
Depolanan erişim ilkesindeki kapsayıcıya erişim izinlerini belirtir.
