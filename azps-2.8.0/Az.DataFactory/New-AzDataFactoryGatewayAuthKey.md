...
## Tanım
**Yeni-Azverifactorygatewaygatewaykey** cmdlet 'i, belirli bir Azure Data Factory ağ geçidi için ağ geçidi doğrulama anahtarı oluşturur.
Bu anahtarı kullanarak ağ geçidini bir bulut hizmetiyle kaydedersiniz.

## ÖRNEKLERDEN

### Örnek 1: anahtar için bir ağ geçidi kimlik doğrulama anahtarı oluşturur
```
...
Bu komut MyGateway adlı Data Factory ağ geçidi için anahtar için bir Gateway auth anahtarı oluşturur.
...
### -AnahtarAdı
' Anahtar ' veya ' anahtar2 ' yeniden üretilecek Ağ Geçidi kimlik doğrulama anahtarının adı.
