...
## Tanım
**Add-Azdatalakeanaliz Ticsdatasource** cmdlet 'ı bir Azure Data Lake Analytics hesabına veri kaynağı ekler.

## ÖRNEKLERDEN

### Örnek 1: hesaba veri kaynağı ekleme
```
PS C:\>Add-AzDataLakeAnalyticsDataSource -Account "ContosoAdlA" -DataLakeStore "ContosoAdlS"
```

Bu komut, Data Lake Analytics hesabına bir Data Lake Store veri kaynağı ekler.

## PARAMETRELERINE

### -AccessKey
Eklenecek Azure Blob depolama hesabının erişim anahtarını belirtir.
...
### -Blob
Eklenecek Azure Blob depolama hesabının adını belirtir.
...
### -DataLakeStore
Eklenecek Azure Data Lake Store hesabının adını belirtir.
