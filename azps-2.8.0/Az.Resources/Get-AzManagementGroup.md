...
## Tanım
Get-AzManagementGroup cmdlet 'i veya belirli bir yönetim grubunu alır.

## ÖRNEKLERDEN

### Örnek 1: tüm yönetim gruplarını alma
```
...
### Örnek 2: belirli bir yönetim grubu edinin
```
...
### Örnek 3: belirli bir yönetim grubu ve hiyerarşinin birinci düzeyini alma
```
...
Bayrak ile `Expand` bir tane, dizi boyunca gezinilerek `Children` her çocuğun ayrıntılarını alabilirler. Örneğin, `Children[0]` görünen adı olan grubun ayrıntılarını sağlayacaktır `TestGroup1DisplayName` .

### Örnek 4: belirli bir yönetim grubu ve tüm hiyerarşi düzeylerini alma
```
...
### -Genişletme
Yönetim grubunun alt öğelerini listelemek için çıktıyı genişletme
...
### -Recurse
Yinelemeli olarak yönetim grubunun alt öğelerini listeler
...
### Microsoft. Azure. Commands. resources. model. ManagementGroups. Psmanagementgroupınfo
