...
### -Metadata
Güncelleştirilmiş ilke kümesi tanımının meta verileri. Bu, meta veri içeren bir dosya adı veya meta veri içeren bir yol olabilir.
...
### -Parametre
Güncelleştirilmiş ilke kümesi tanımının parametreler bildirimi. Bu, parametre bildirimini içeren bir dosya adı veya URI veya dize olarak parametre bildirimi olabilir.
...
### -PolicyDefinition
İlke tanımları. Bu, ilke tanımlarını içeren bir dosya adına veya dizi olarak ilke tanımlarına yol açabilir.
