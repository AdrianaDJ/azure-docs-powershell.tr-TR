...
Varsayılan kapsam altındaki kayıt atamasını siler.
...
Tam nitelikli kaynak kimliği için kayıt atamasını siler.
...
### -ID
Kayıt atama GUID 'SI (örneğin, b0c052e5-c437-4771-A476-8b1201158a57)
```yaml
Type: System.String
...
### -RESOURCEID
Kayıt atamasının tam kaynak kimliği (örneğin,/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationAssignments/b0c052e5-c437-4771-a476-8b1201158a57).
