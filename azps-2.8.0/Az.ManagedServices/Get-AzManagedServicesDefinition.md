...
Tüm kayıt tanımlamalarını alır.
...
Kimliği verilen kayıt tanımını alır.
...
Tam nitelikli kaynak kimliği için kayıt tanımını alır.
...
### -ID
Kayıt tanım tanımlayıcısı (örneğin, b0c052e5-c437-4771-A476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
