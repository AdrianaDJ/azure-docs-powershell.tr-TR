...
## Tanım
Azure Danışmanı önerileri listesini alır. Kategoriye, kaynak koduna, ada göre filtrelenebilir.
...
Type                 : Microsoft.Advisor/recommendations
```
Kategori performansına göre filtrelenmiş tüm önerilerin listesini alır.
