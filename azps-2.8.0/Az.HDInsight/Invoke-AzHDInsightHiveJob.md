...
## Tanım
**Invoke-AzHDInsightHiveJob** cmdlet 'ı bir Azure HDInsight kümesine kovan sorgusu gönderir ve sorgu sonuçlarını tek bir işlemde alır.
Sorgu için kullanılacak kümeyi belirtmek üzere **Invoke-AzHDInsightHiveJob** ' i çağırmadan önce Use-AzHDInsightCluster cmdlet 'ini kullanın.
...
Bu parametreyi belirtmezseniz, bu cmdlet varsayılan değeri kullanır: "kovan: \< ilk 100 karakter \> ".
