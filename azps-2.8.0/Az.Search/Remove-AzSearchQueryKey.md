...
## Tanım
**Remove-AzSearchQueryKey** cmdlet 'ı, Azure Search hizmetinden sorgu anahtarını kaldırır.
...
Örnekte, sorgu anahtarı Azure Search hizmetinden kaldırılır.
...
### -KeyValue
Arama Hizmeti sorgu anahtar değeri.
