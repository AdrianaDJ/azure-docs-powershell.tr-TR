...
## Tanım
**New-Azaramaquerykey** cmdlet 'ı Azure Search hizmeti için yeni bir sorgu anahtarı oluşturur.
...
Örnek, Azure Search hizmeti için yeni bir sorgu anahtarı oluşturur.
...
### -Ad
Arama Hizmeti sorgu anahtarı adı.
