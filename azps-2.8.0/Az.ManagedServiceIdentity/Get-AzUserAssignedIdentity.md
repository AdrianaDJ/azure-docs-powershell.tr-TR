...
### SuscriptionParameterSet (varsayılan)
```
...
## Tanım
**Get-Azuseratanandentity** varolan kullanıcı tarafından atanmış kimlikleri alır.

## ÖRNEKLERDEN

### Örnek 1
Bu örnek cmdlet, Kullanıcı tarafından atanan kimliği **ID1** **PSRG**
...
### Örnek 2
Bu örnek cmdlet, Kullanıcı tarafından atanan tüm kimlikleri **Psrg** kaynak grubu altında alır
...
### Örnek 3
Bu örnek cmdlet, aboneliğin altındaki tüm Kullanıcı kimliklerini alır.
