...
### ResourceGroupAndNameParameterSet (varsayılan)
```
...
## Tanım
**Remove-Azuseratanandentity** belirtilen kullanıcının atadığı kimliği siler.
