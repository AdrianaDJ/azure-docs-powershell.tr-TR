...
## Tanım
**Remove-azbir ınitialveservicesaccountnetworkrule** cmdlet 'i, bir öğretici hizmet hesabının networkrule özelliğinden ıprules veya virtualnetworkrules öğesini kaldırıyor
...
### -Ipadressorrange
Öğrenme Hizmetleri hesap NetworkRule ıprules, String 'teki.
...
Öğrenme Hizmetleri hesap NetworkRule Virtualnetworkrule Virtualnetworkresourceıd ın String.
...
### Microsoft. Azure. Commands. Management. öğretici ınitialveservices. modeller. Psıprule
