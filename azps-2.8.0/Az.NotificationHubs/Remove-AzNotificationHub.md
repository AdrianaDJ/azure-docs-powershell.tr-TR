...
## Tanım
**Remove-AzNotificationHub** cmdlet 'i var olan bir Bildirim Hub 'ını kaldırır.
...
**Remove-AzNotificationHub** cmdlet 'ini kullanarak var olan bir Bildirim Hub 'ını kaldırabilirsiniz.
