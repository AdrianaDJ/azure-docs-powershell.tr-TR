...
ms.openlocfilehash: c800ca3a449aeb18d82df62a1bf909155e599ce5
ms.sourcegitcommit: 4d2c178cd6df9151877b08d54c1f4a228dbec9d1
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 01/29/2020
ms.locfileid: "93933269"
---
# <span data-ttu-id="88d43-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="88d43-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="88d43-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="88d43-102">SYNOPSIS</span></span>
<span data-ttu-id="88d43-103">Azure Güvenlik Merkezi tarafından algılanan güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="88d43-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="88d43-104">INDEKI</span><span class="sxs-lookup"><span data-stu-id="88d43-104">SYNTAX</span></span>

### <span data-ttu-id="88d43-105">SubscriptionScope (varsayılan)</span><span class="sxs-lookup"><span data-stu-id="88d43-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="88d43-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="88d43-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="88d43-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="88d43-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="88d43-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="88d43-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="88d43-109">Içermiyor</span><span class="sxs-lookup"><span data-stu-id="88d43-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="88d43-110">Tanım</span><span class="sxs-lookup"><span data-stu-id="88d43-110">DESCRIPTION</span></span>
<span data-ttu-id="88d43-111">Azure Güvenlik Merkezi tarafından algılanan güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="88d43-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="88d43-112">ÖRNEKLERDEN</span><span class="sxs-lookup"><span data-stu-id="88d43-112">EXAMPLES</span></span>

### <span data-ttu-id="88d43-113">Örnek 1</span><span class="sxs-lookup"><span data-stu-id="88d43-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="88d43-114">Aboneliğin içindeki kaynaklarda algılanan tüm güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="88d43-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="88d43-115">Örnek 2</span><span class="sxs-lookup"><span data-stu-id="88d43-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="88d43-116">"MyService1" kaynak grubu içindeki kaynaklarda algılanan tüm güvenlik uyarılarını alır</span><span class="sxs-lookup"><span data-stu-id="88d43-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="88d43-117">Örnek 3</span><span class="sxs-lookup"><span data-stu-id="88d43-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="88d43-118">"MyService1" kaynak grubu içindeki kaynaklarda algılanan belirli bir güvenlik uyarısını alır</span><span class="sxs-lookup"><span data-stu-id="88d43-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="88d43-119">PARAMETRELERINE</span><span class="sxs-lookup"><span data-stu-id="88d43-119">PARAMETERS</span></span>

### <span data-ttu-id="88d43-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="88d43-120">-DefaultProfile</span></span>
<span data-ttu-id="88d43-121">Azure ile iletişim için kullanılan kimlik bilgileri, hesap, kiracı ve abonelik.</span><span class="sxs-lookup"><span data-stu-id="88d43-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="88d43-122">-Konum</span><span class="sxs-lookup"><span data-stu-id="88d43-122">-Location</span></span>
<span data-ttu-id="88d43-123">Konumuyla.</span><span class="sxs-lookup"><span data-stu-id="88d43-123">Location.</span></span>
...
### <span data-ttu-id="88d43-124">-Ad</span><span class="sxs-lookup"><span data-stu-id="88d43-124">-Name</span></span>
<span data-ttu-id="88d43-125">Kaynak adı.</span><span class="sxs-lookup"><span data-stu-id="88d43-125">Resource name.</span></span>
...
### <span data-ttu-id="88d43-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="88d43-126">-ResourceGroupName</span></span>
<span data-ttu-id="88d43-127">Kaynak grubu adı.</span><span class="sxs-lookup"><span data-stu-id="88d43-127">Resource group name.</span></span>
...
### <span data-ttu-id="88d43-128">-RESOURCEID</span><span class="sxs-lookup"><span data-stu-id="88d43-128">-ResourceId</span></span>
<span data-ttu-id="88d43-129">Kaynak KIMLIĞI.</span><span class="sxs-lookup"><span data-stu-id="88d43-129">Resource ID.</span></span>
...
### <span data-ttu-id="88d43-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="88d43-130">CommonParameters</span></span>
<span data-ttu-id="88d43-131">Bu cmdlet ortak parametreleri destekler:-Debug,-ErrorAction,-ErrorVariable,-ınformationaction,-ınformationvariable,-OutVariable,-OutBuffer,-Pipelinedeğişken,-verbose,-WarningAction ve-Warningdeğişken.</span><span class="sxs-lookup"><span data-stu-id="88d43-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="88d43-132">Daha fazla bilgi için bkz about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="88d43-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="88d43-133">GÖLGELENDIRICI</span><span class="sxs-lookup"><span data-stu-id="88d43-133">INPUTS</span></span>

### <span data-ttu-id="88d43-134">System. String</span><span class="sxs-lookup"><span data-stu-id="88d43-134">System.String</span></span>

## <span data-ttu-id="88d43-135">ÇıKıŞLAR</span><span class="sxs-lookup"><span data-stu-id="88d43-135">OUTPUTS</span></span>

### <span data-ttu-id="88d43-136">Microsoft. Azure. Commands. Security. modeller. Alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="88d43-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="88d43-137">NOTLARıNDA</span><span class="sxs-lookup"><span data-stu-id="88d43-137">NOTES</span></span>

## <span data-ttu-id="88d43-138">ILGILI BAĞLANTıLAR</span><span class="sxs-lookup"><span data-stu-id="88d43-138">RELATED LINKS</span></span>
