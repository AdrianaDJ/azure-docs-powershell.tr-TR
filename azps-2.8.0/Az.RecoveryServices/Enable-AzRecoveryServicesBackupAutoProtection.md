...
## Tanım
**Enable-AzRecoveryServicesBackupAutoProtection** cmdlet 'i korunabilir bir tabloda Azure otomatik yedekleme koruma ilkesini ayarlar.
...
İkinci cmdlet $Pol ilkeyi kullanarak AzureWorkload için yedekleme koruması ilkesini ayarlar.

## PARAMETRELERINE

### -BackupManagementType
Kaynağın yedekleme yönetimi türü (örneğin: MAB, DPM, AzureWorkload).
...
### -Inputıtem
Giriş olarak geçirilebilecek korunabilir öğe nesnesini belirtir.
