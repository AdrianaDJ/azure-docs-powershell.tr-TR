...
## Tanım
Cmdlet, belirli workloadType ile AzureWorkloads için bir Azure VM kaydeder.
...
Cmdlet, iş yükü MSSQL için bir Azure VM kaydeder.

## PARAMETRELERINE

### -BackupManagementType
Azure yedekleme kapsayıcısının yedekleme yönetimi türü
