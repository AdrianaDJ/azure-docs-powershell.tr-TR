...
### -Addilatencya
Sondada en düşük gecikme demetini olan sonbaharın mili saniye cinsinden ek gecikme süresi. Varsayılan değer 0 ' dır
...
### -SampleSize
Yük Dengelemesi kararlarını göz önünde bulundurmanız gereken örnek sayısı.
Varsayılan değer 4 ' dir
...
### -Başarılı
Örnek dönem içindeki, varsayılan değeri 2 olan örnek sayısı
...
### Microsoft. Azure. Commands. Frontkapısı. modeller. PSLoadBalancingSetting
