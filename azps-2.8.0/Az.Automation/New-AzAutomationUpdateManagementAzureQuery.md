...
## SYNOPSIS
Azure Otomasyonu yazılım güncelleştirme yapılandırması Azure sorgu nesnesi oluşturur.
...
## Tanım
Dinamik olarak çözümlenen Azure sanal makinelerin listesini güncelleştirmek için bir zamanlamada çalışacak bir yazılım güncelleştirme yapılandırması oluşturmak için kullanılacak bir yazılım güncelleştirme yapılandırması Azure sorguları nesnesi oluşturur.
...
### -Konum
Azure sanal makinelerinin konumlarının listesi.
...
### Etiketli
Azure sanal makinelerinin etiketi.
...
### Microsoft. Azure. Commands. Automation. model. UpdateManagement. Azuyeniden sorgulama
