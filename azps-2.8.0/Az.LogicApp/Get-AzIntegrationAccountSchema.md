...
## Tanım
**Get-Azıntegrationaccountschema** cmdlet 'i tümleştirme hesabı şemalarını alır.
Tümleştirme hesap adını, kaynak grubu adını ve şema adını belirtme.
...
### Örnek 1: Tümleştirme hesabı şeması alma
```
...
Bu komut, IntegrationAccountSchema43 adlı tümleştirme hesabı şemasını alır.

### Örnek 2: kaynak grubu için tümleştirme hesabı şemalarını alma
```
...
Bu komut, ResourceGroup11 adlı kaynak grubunun tümleştirme hesabı şemalarını alır.
