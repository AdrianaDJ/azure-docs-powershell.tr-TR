...
## Tanım
**Get-AzIntegrationAccountAssembly** cmdlet 'i bir tümleştirme hesabından derleme alır.

## ÖRNEKLERDEN

### Örnek 1: parametrelerle derleme alma
```powershell
...
"Sampleleresourcegroup" kaynak grubunda bulunan "Sampleıntegrationaccount" tümleştirme hesabında bulunan "sampleAssembly" adlı bir derleme alın.

### Örnek 2: parametrelere göre tümleştirme hesabındaki tüm derlemeleri listeleme
```powershell
...
"SampleResourceGroup" kaynak grubunda bulunan "Sampleıntegrationaccount" tümleştirme hesabındaki tüm birleştirmeleri edinin.
