...
## Tanım
**Get-AzLogicAppTriggerCallbackUrl** cmdlet 'i, kaynak grubundan bir mantık App tetik geri arama URL 'si alır.
Bu cmdlet geri çağırma URL 'sini temsil eden bir **Workflowtriggercallbackurl** nesnesi döndürür.
Kaynak Grup adını, mantık uygulama adını ve tetik adını belirtin.
...
### Örnek 1: mantık uygulama tetikleyicisi geri çağırma URL 'SI alma
```
...
Bu komut, bir mantık uygulama tetikleyicisi geri çağırma URL 'sini alır.
...
### Microsoft. Azure. Management. Logic. modeller. WorkflowTriggerCallbackUrl
