...
## Tanım
**Set-AzBatchPool** cmdlet 'ı, Azure toplu iş hizmetindeki bir havuzun özelliklerini güncelleştirir.
Bir **Pscses havuzu** nesnesi almak için Get-AzBatchPool cmdlet 'ini kullanın.
...
İlk komut **Get-AzBatchPool** kullanarak bir havuz alır ve $Pool değişkeninde depolar.
