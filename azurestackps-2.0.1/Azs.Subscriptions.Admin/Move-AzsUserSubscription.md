...
Kullanıcı aboneliklerini temsilci seçilmiş bir sağlayıcı teklifine taşıyın.
...
Kullanıcı aboneliklerini temsilci seçilen sağlayıcıdan varsayılan sağlayıcıya taşıyın.
