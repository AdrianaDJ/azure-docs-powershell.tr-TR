...
Belirtilen aboneliğin uygunluk adını ve adını döndürür
...
### -Namekullanılabilirlik tanım
Ad kullanılabilirliğini denetleme eylem tanımı.
Oluşturmak için, ad KULLANıLABILIRLIĞI için Notlar bölümüne bakın ve karma tablo oluşturun.
...
### Microsoft. Azure. PowerShell. cmdlet. SubscriptionsAdmin. modeller. Api20151101. ICheckNameAvailabilityDefinition

### Microsoft. Azure. PowerShell. cmdlet. SubscriptionsAdmin. modeller. ısubscriptionsadminıdentity

## ÇıKıŞLAR

### Microsoft. Azure. PowerShell. cmdlet. SubscriptionsAdmin. modeller. Api20151101. ICheckNameAvailabilityResponse
...
<ICheckNameAvailabilityDefinition>Ad kullanılabilirliği: ad kullanılabilirliğini denetleme eylem tanımı.
  - `[Name <String>]`: Doğrulanacak kaynak adı.
  - `[ResourceType <String>]`: Doğrulanacak kaynak türü.
