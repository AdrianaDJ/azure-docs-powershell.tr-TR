...
### Örnek 1: platform görüntüsünü kaldırma
```powershell
PS C:\>Remove-AzsPlatformImage -Location northwest -Offer UbuntuServer -Publisher Microsoft -Sku 16.04-LTS -Version 1.0.0
```

Bir platform görüntüsünü kaldırma işleminin başarılı olması hiçbir çıkış döndürmez

### Örnek 2: bir platform görüntüsünü kaldırma yok
```powershell
