...
* `Get-AzResource` sonucu şuna aktarılırken oluşan sorun düzeltildi: `Set-AzResource`
    - Burada daha fazla bilgi bulunabilir: https://github.com/Azure/azure-powershell/issues/8240
* Şu çalıştırılırken JSON veri türü değişikliğine neden olan sorun düzeltildi: `Set-AzResource`
...
### <a name="azresources"></a>Az.Resources
* Şu cmdlet'lerdeki kaynak kimliğiyle ilgili parametrelerin yardım belgeleri güncelleştirildi: `New-AzureRmPolicyAssignment` ve `Set-AzureRmPolicyAssignment`
