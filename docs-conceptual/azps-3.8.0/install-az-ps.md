...
Azure PowerShell tüm platformlarda PowerShell 6.2.4 ve üzeri sürümlerle birlikte kullanılabilir. Ayrıca Windows üzerinde PowerShell 5.1 ile de desteklenir. İşletim sisteminiz için sunulan [en son PowerShell sürümünü](/powershell/scripting/install/installing-powershell) yüklemeniz önerilir. PowerShell 6.2.4 ve üzerinde çalıştırıldığında Azure PowerShell için ek gereksinim yoktur.
...
1. [Windows PowerShell 5.1](/powershell/scripting/install/installing-windows-powershell#upgrading-existing-windows-powershell)’e güncelleştirin.
...
3. En son PowerShellGet sürümünü kullandığınızdan emin olun. **Yönetici olarak çalıştır** seçeneğini kullanıp `Install-Module -Name PowerShellGet -AllowClobber -Force` komutunu çalıştırarak bir PowerShell 5.1 oturumu başlatın.
...
PowerShell galerisi varsayılan olarak PowerShellGet için güvenilir depo olarak yapılandırılmamıştır ve aşağıdaki komut istemini görürsünüz:
