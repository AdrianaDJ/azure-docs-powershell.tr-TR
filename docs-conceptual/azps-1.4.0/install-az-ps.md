...
Windows’da PowerShell 5 kullanıyorsanız .NET Framework 4.7.2’nin de yüklü olması gerekir. .NET Framework’ü güncelleştirme veya yeni bir sürümü yükleme hakkındaki yönergeler için [.NET Framework yükleme kılavuzuna](/dotnet/framework/install) bakın.
