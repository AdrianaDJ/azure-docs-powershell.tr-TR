...
PowerShell'i tanımıyorsanız, PowerShell'e giriş bilgileri size yardımcı olabilir.

* [PowerShell’i yükleme](/powershell/scripting/install/installing-windows-powershell)
