...
| ----------------------------------------------------------------------- | ------------------------------------------------------------ | ------------------ |
| <bpt id="p1">[</bpt>Resource group<ept id="p1">](/azure/azure-resource-manager/resource-group-overview)</ept> | [Az.Resources](/powershell/module/az.resources#resources)    | `AzResourceGroup`  |
