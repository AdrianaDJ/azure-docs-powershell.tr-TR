...
#### <a name="azurermiothub"></a><span data-ttu-id="da889-114">AzureRM.IotHub</span><span class="sxs-lookup"><span data-stu-id="da889-114">AzureRM.IotHub</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="da889-132">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="da889-132">AzureRM.Websites</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="da889-147">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="da889-147">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="da889-161">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="da889-161">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="da889-175">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="da889-175">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventgrid"></a><span data-ttu-id="da889-190">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="da889-190">AzureRM.EventGrid</span></span>
...
#### <a name="azurermmachinelearningcompute"></a><span data-ttu-id="da889-206">AzureRM.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="da889-206">AzureRM.MachineLearningCompute</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="da889-221">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="da889-221">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="da889-258">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="da889-258">AzureRM.Scheduler</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="da889-272">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="da889-272">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="da889-287">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="da889-287">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="da889-305">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="da889-305">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="da889-321">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="da889-321">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="da889-336">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="da889-336">AzureRM.Storage</span></span>
...
#### <a name="azurermautomation"></a><span data-ttu-id="da889-353">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="da889-353">AzureRM.Automation</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="da889-367">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="da889-367">AzureRM.Network</span></span>
...
* <span data-ttu-id="da889-384">Standard'dan Premium NameSpace'e geçiş cmdlet’leri eklendi :</span><span class="sxs-lookup"><span data-stu-id="da889-384">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    ...
    - <span data-ttu-id="da889-388">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="da889-388">Stop-AzureRmServiceBusMigration</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="da889-404">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="da889-404">AzureRM.Profile</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="da889-424">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="da889-424">AzureRM.EventHub</span></span>
...
#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="da889-442">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="da889-442">AzureRM.RecoveryServices.Backup</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="da889-460">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="da889-460">AzureRM.ServiceBus</span></span>
...
* <span data-ttu-id="da889-477">Aşağıdaki cmdlet'ler 'operation ID' ve 'operation status' bilgilerini doğru gösterecek şekilde düzeltildi:</span><span class="sxs-lookup"><span data-stu-id="da889-477">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="da889-478">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="da889-478">Start-AzureRmVM</span></span>
    - <span data-ttu-id="da889-479">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="da889-479">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="da889-480">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="da889-480">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="da889-481">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="da889-481">Set-AzureRmVM</span></span>
    - <span data-ttu-id="da889-482">Remove-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="da889-482">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="da889-483">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="da889-483">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="da889-484">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="da889-484">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="da889-485">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="da889-485">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="da889-486">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="da889-486">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="da889-487">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="da889-487">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="da889-488">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="da889-488">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="da889-489">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="da889-489">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="da889-490">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="da889-490">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="da889-491">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="da889-491">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="da889-492">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="da889-492">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="da889-493">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="da889-493">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="da889-494">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="da889-494">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="da889-495">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="da889-495">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="da889-496">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="da889-496">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="da889-497">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="da889-497">AzureRM.EventGrid</span></span>
* <span data-ttu-id="da889-498">Gerekli olması halinde parametrelerin boş dizeyle değiştirilmesine izin vermek için Update-AzureRmEventGridSubscription cmdlet'i içindeki SubjectBeginsWith/SubjectEndsWith için ValidateNotNullOrEmpty doğrulama koşulları kaldırıldı.</span><span class="sxs-lookup"><span data-stu-id="da889-498">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="da889-499">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="da889-499">AzureRM.KeyVault</span></span>
* <span data-ttu-id="da889-500">Get-AzureRmKeyVault -Tag çalıştırıldığında etiket döndürülmeme sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="da889-500">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="da889-501">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="da889-501">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="da889-502">Policy Insights cmdlet'leri genel kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="da889-502">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="da889-503">API 2018-04-04 sürümünü kullanın</span><span class="sxs-lookup"><span data-stu-id="da889-503">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="da889-504">PolicyDefinitionReferenceId, Get-AzureRmPolicyStateSummary sonuçlarına eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-504">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="da889-505">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="da889-505">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="da889-506">RecoveryServices.Backup cmdlet'lerine -Vault parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="da889-506">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="da889-507">Bu parametre iletildiğinde Set-AzureRmRecoveryServicesContext cmdlet'ini geçersiz kılar.</span><span class="sxs-lookup"><span data-stu-id="da889-507">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="da889-508">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="da889-508">AzureRM.Sql</span></span>
* <span data-ttu-id="da889-509">Yardım dosyasındaki Get-AzureRmSqlDatabaseExpanded örneği güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-509">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="da889-510">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="da889-510">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="da889-511">Yardım dosyasındaki Add-AzureRmTrafficManagerEndpointConfig bölümü güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-511">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="da889-512">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="da889-512">AzureRM.Websites</span></span>
* <span data-ttu-id="da889-513">'Set-AzureRmWebApp', -AssignIdentity kullanıldığında AppSettings verilerini geçersiz kılmayacak şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-513">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="da889-514">'New-AzureRmWebAppSlot', isteğe bağlı parametre olarak AppServicePlan girişini kabul edecek şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-514">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="da889-515">6.2.1 - Haziran 2018</span><span class="sxs-lookup"><span data-stu-id="da889-515">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="da889-516">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="da889-516">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="da889-517">PSWorkspace modeli Network için tür parametresini kullanacak şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-517">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="da889-518">6.2.0 - Haziran 2018</span><span class="sxs-lookup"><span data-stu-id="da889-518">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="da889-519">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="da889-519">AzureRM.Profile</span></span>
* <span data-ttu-id="da889-520">Modülün içeri aktarılması sırasında Newtonsoft.Json 10.0.3 sürümünün yüklenmemesine ilişkin sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="da889-520">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="da889-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="da889-521">AzureRM.Compute</span></span>
* <span data-ttu-id="da889-522">VMSS VM Güncelleştirme özelliği</span><span class="sxs-lookup"><span data-stu-id="da889-522">VMSS VM Update feature</span></span>
    - <span data-ttu-id="da889-523">'Update-AzureRmVmssVM' ve 'New-AzureRmVMDataDisk' cmdlet’leri eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-523">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="da889-524">VMSS VM’sine veri diski eklemeyi desteklemek için 'Add-AzureRmVMDataDisk' cmdlet’ine VirtualMachineScaleSetVM parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="da889-524">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="da889-525">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="da889-525">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="da889-526">ADF .Net SDK sürümü, aşağıdaki değişiklikleri içeren 0.8.0-preview sürümüne güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="da889-526">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="da889-527">Fabrika deposunu yapılandırma işlemi eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-527">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="da889-528">QuickBooks LinkedService, consumerKey ve consumerSecret özelliklerini kullanıma sunmak üzere güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-528">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="da889-529">SecretBase’ten Object’e birkaç model türü güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-529">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="da889-530">Blob Etkinliklerini tetikleme eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-530">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="da889-531">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="da889-531">AzureRM.KeyVault</span></span>
* <span data-ttu-id="da889-532">Belgeler örnek çıktı ile güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-532">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="da889-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="da889-533">AzureRM.Network</span></span>
* <span data-ttu-id="da889-534">Ağ İzleyicisi cmdlet’leri üzerindeki Trafik Analizi parametreleri etkinleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-534">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="da889-535">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="da889-535">AzureRM.Resources</span></span>
* <span data-ttu-id="da889-536">'Get-AzureRmResource' cmdlet’inden döndürülen 'PSResource' nesnesinin 'Properties' özelliğiyle ilgili bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="da889-536">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="da889-537">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="da889-537">AzureRM.Scheduler</span></span>
* <span data-ttu-id="da889-538">Güncelleştirilen ServiceBusQueueJob’ın yeni Kimlik Doğrulaması değerlerini ayarlamamasıyla ilgili bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="da889-538">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="da889-539">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="da889-539">AzureRM.Sql</span></span>
* <span data-ttu-id="da889-540">Şu cmdlet’ler isteğe bağlı LicenseType parametresiyle güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="da889-540">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="da889-541">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="da889-541">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="da889-542">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="da889-542">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="da889-543">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="da889-543">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="da889-544">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="da889-544">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="da889-545">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="da889-545">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="da889-546">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="da889-546">AzureRM.Websites</span></span>
* <span data-ttu-id="da889-547">'New-AzureRMWebApp' Strategy kütüphanesindeki ortak algoritmaları kullanmak üzere güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="da889-547">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="da889-548">6.1.0 - Mayıs 2018</span><span class="sxs-lookup"><span data-stu-id="da889-548">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="da889-549">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="da889-549">AzureRM.Profile</span></span>
* <span data-ttu-id="da889-550">'Clear-AzureRmContext' komutunun çalıştırılmasının boş bir bağlamı önceki varsayılan bağlamın adıyla tutmasına ve böylece kullanıcının eski ad ile yeni bir bağlam oluşturamadığı bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="da889-550">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="da889-551">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="da889-551">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="da889-552">AS’de Ağ geçidi ilişkilendirme/ilişkilendirme kaldırma işlemlerini etkinleştirin.</span><span class="sxs-lookup"><span data-stu-id="da889-552">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="da889-553">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="da889-553">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="da889-554">ApiVersions, ApiReleases ve ApiRevisions desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-554">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="da889-555">ServiceFabric Arka Ucu desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-555">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="da889-556">Application Insights Günlükçüsü desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-556">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="da889-557">‘Temel’ sku’yu Api Yönetim hizmetinin geçerli sku’su olarak algılama desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-557">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="da889-558">Özel CA tarafından Kök veya CA olarak yayınlanan Sertifikaları yükleme desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-558">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="da889-559">Özel SSL sertifikalarını KeyVault ve Çoklu ara sunucu ana bilgisayar adlarıyla kabul etme desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-559">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="da889-560">MSI kimliği desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-560">Added support for MSI identity</span></span>
* <span data-ttu-id="da889-561">İlkeleri Url ile kabul etme desteği eklendi NOT: Aşağıdaki cmdlet’ler gelecekteki sürümlerde kullanım dışı kalacaktır</span><span class="sxs-lookup"><span data-stu-id="da889-561">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="da889-562">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="da889-562">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="da889-563">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="da889-563">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="da889-564">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="da889-564">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="da889-565">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="da889-565">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="da889-566">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="da889-566">AzureRM.Batch</span></span>
* <span data-ttu-id="da889-567">Yeni Get-AzureBatchPoolNodeCounts cmdlet’ini yayınlama</span><span class="sxs-lookup"><span data-stu-id="da889-567">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="da889-568">Yeni AzureBatchComputeNodeServiceLogUpload cmdlet’ini yayınlama</span><span class="sxs-lookup"><span data-stu-id="da889-568">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="da889-569">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="da889-569">AzureRM.Consumption</span></span>
* <span data-ttu-id="da889-570">Get-AzureRmConsumptionUsageDetail cmdlet’inde yeni Expand, ResourceGroup, InstanceName, InstanceId, Tags ve Top parametrelerini ekleme</span><span class="sxs-lookup"><span data-stu-id="da889-570">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="da889-571">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="da889-571">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="da889-572">Export-AzureRmDataLakeStoreChildItemProperties için düzeltme örneği</span><span class="sxs-lookup"><span data-stu-id="da889-572">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="da889-573">Set-AzureRmDataLakeStoreItemAclEntry komutunda Özyineleme durumu için null parametresi özel durumunu düzeltme</span><span class="sxs-lookup"><span data-stu-id="da889-573">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="da889-574">Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry’ye yönelik yardım dosyalarını düzeltme</span><span class="sxs-lookup"><span data-stu-id="da889-574">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="da889-575">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="da889-575">AzureRM.Network</span></span>
* <span data-ttu-id="da889-576">Ağ SDK sürümünü 18.0.0-önizleme’den 19.0.0-önizlemeye yükseltme</span><span class="sxs-lookup"><span data-stu-id="da889-576">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="da889-577">Protokol yapılandırması oluşturma cmdlet’i eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-577">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="da889-578">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="da889-578">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="da889-579">Varolan express route bağlantı hattına yeni bir bağlantı hattı ekleme cmdlet’i eklendi.</span><span class="sxs-lookup"><span data-stu-id="da889-579">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="da889-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="da889-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="da889-581">Varolan express route bağlantı hattındaki bir bağlantı hattı bağlantısını kaldırma cmdlet’i eklendi.</span><span class="sxs-lookup"><span data-stu-id="da889-581">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="da889-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="da889-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="da889-583">Bağlantı hattı bağlantısı alma cmdlet’i eklendi</span><span class="sxs-lookup"><span data-stu-id="da889-583">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="da889-584">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="da889-584">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="da889-585">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="da889-585">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="da889-586">Oluşturulan sertifikalarla sunucu kimlik doğrulaması kullanımı düzeltildi (Sorun No. 5998)</span><span class="sxs-lookup"><span data-stu-id="da889-586">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="da889-587">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="da889-587">AzureRM.Sql</span></span>
* <span data-ttu-id="da889-588">AuditActions veya AuditActionGroups’un kaldırılmasını sağlamak üzere Denetim cmdlet’leri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="da889-588">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="da889-589">Yeni bir esnek saklama ilkesi ayarlarken komutun ‘Azure kurtarma hizmeti kasası ve ilkesiyle uzun süreli saklama ilkesini yapılandırma artık desteklenmiyor. Lütfen yeni esnek saklama ilkesi ile istek gönderin’ hatasını verdiği Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="da889-589">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="da889-590">komutuna ilişkin sorun düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="da889-590">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="da889-591">Ölçek ve katman ilişkili özelliklere yönelik Sku özelliğini destekleyen yeni Veritabanı API’sini kullanmak için tüm Azure Sql Database/ElasticPool Creation/Update cmdlet’lerini güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="da889-591">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="da889-592">Güncelleştirilen cmlet’ler arasında şunlar yer almaktadır:</span><span class="sxs-lookup"><span data-stu-id="da889-592">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="da889-593">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="da889-593">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="da889-594">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="da889-594">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="da889-595">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="da889-595">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="da889-596">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="da889-596">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="da889-597">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="da889-597">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="da889-598">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="da889-598">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="da889-599">-Name parametresini kullanırken -ResourceGroupName parametresinin gerekli olması için 'Get-AzureRmTrafficManagerProfile'a yönelik parametreleri güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="da889-599">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
