...
`Get-AzApiManagementProperty` cmdlet’i `Get-AzApiManagementNamedValue` ile değiştirildi.

### `New-AzApiManagementProperty`

`New-AzApiManagementProperty` cmdlet’i `New-AzApiManagementNamedValue` ile değiştirildi.

### `Remove-AzApiManagementProperty`

`Remove-AzApiManagementProperty` cmdlet’i `Remove-AzApiManagementNamedValue` ile değiştirildi.

### `Set-AzApiManagementProperty`

`Set-AzApiManagementProperty` cmdlet’i `Set-AzApiManagementNamedValue` ile değiştirildi.
