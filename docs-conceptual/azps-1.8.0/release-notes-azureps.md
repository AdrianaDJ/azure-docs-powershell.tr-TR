...
#### <a name="azaccounts"></a><span data-ttu-id="27dcf-113">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="27dcf-113">Az.Accounts</span></span>
...
#### <a name="azeventgrid"></a><span data-ttu-id="27dcf-129">Az.EventGrid</span><span class="sxs-lookup"><span data-stu-id="27dcf-129">Az.EventGrid</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="27dcf-144">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="27dcf-144">Az.Monitor</span></span>
...
#### <a name="azrecoveryservices"></a><span data-ttu-id="27dcf-161">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-161">Az.RecoveryServices</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="27dcf-178">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="27dcf-178">Az.Websites</span></span>
...
#### <a name="azanalysisservices"></a><span data-ttu-id="27dcf-194">Az.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-194">Az.AnalysisServices</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="27dcf-209">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-209">Az.Resources</span></span>
...
## <a name="160---march-2019"></a><span data-ttu-id="27dcf-231">1.6.0 - Mart 2019</span><span class="sxs-lookup"><span data-stu-id="27dcf-231">1.6.0 - March 2019</span></span>
...
#### <a name="azkeyvault"></a><span data-ttu-id="27dcf-248">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="27dcf-248">Az.KeyVault</span></span>
...
* <span data-ttu-id="27dcf-262">Depolama hesabında Yönetim İlkesini Alma/Ayarlama/Kaldırma desteği</span><span class="sxs-lookup"><span data-stu-id="27dcf-262">Support Get/Set/Remove Management Policy on a Storage account</span></span>
    ...
    - <span data-ttu-id="27dcf-267">New-AzStorageAccountManagementPolicyFilter</span><span class="sxs-lookup"><span data-stu-id="27dcf-267">New-AzStorageAccountManagementPolicyFilter</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="27dcf-283">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="27dcf-283">Az.DataFactory</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="27dcf-301">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-301">Az.Sql</span></span>
...
#### <a name="azcompute"></a><span data-ttu-id="27dcf-315">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-315">Az.Compute</span></span>
...
* <span data-ttu-id="27dcf-334">Tümleştirme Hesabı Toplu Yapılandırması için yeni cmdlet’ler</span><span class="sxs-lookup"><span data-stu-id="27dcf-334">New cmdlets for Integration Account Batch Configuration</span></span>
    ...
    - <span data-ttu-id="27dcf-336">New-AzIntegrationAccountBatchConfiguration</span><span class="sxs-lookup"><span data-stu-id="27dcf-336">New-AzIntegrationAccountBatchConfiguration</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="27dcf-353">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-353">Az.Sql</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="27dcf-369">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-369">Az.Resources</span></span>
...
## <a name="120---january-2019"></a><span data-ttu-id="27dcf-385">1.2.0 - Ocak 2019</span><span class="sxs-lookup"><span data-stu-id="27dcf-385">1.2.0 - January 2019</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="27dcf-403">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="27dcf-403">Az.DataFactory</span></span>
...
* <span data-ttu-id="27dcf-421">'PSResourceGroupDeployment' nesnesinin biçimlendirme sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-421">Fix formatting issue with 'PSResourceGroupDeployment' object</span></span>
    - <span data-ttu-id="27dcf-422">Burada daha fazla bilgi bulunabilir: https://github.com/Azure/azure-powershell/issues/2123</span><span class="sxs-lookup"><span data-stu-id="27dcf-422">More information here: https://github.com/Azure/azure-powershell/issues/2123</span></span>
...
#### <a name="aztrafficmanager"></a><span data-ttu-id="27dcf-440">Az.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="27dcf-440">Az.TrafficManager</span></span>
...
#### <a name="azeventgrid"></a><span data-ttu-id="27dcf-456">Az.EventGrid</span><span class="sxs-lookup"><span data-stu-id="27dcf-456">Az.EventGrid</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="27dcf-473">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-473">Az.Resources</span></span>
...
* <span data-ttu-id="27dcf-481">Az.Accounts modülündeki geriye dönük uyumluluk sorunu çözüldü</span><span class="sxs-lookup"><span data-stu-id="27dcf-481">Fix backward compatibility issue with Az.Accounts module</span></span>

#### <a name="azsql"></a><span data-ttu-id="27dcf-482">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-482">Az.Sql</span></span>
* <span data-ttu-id="27dcf-483">Depolama yönetimi istemci bağımlılığı ortak SDK uygulamasına dönüştürüldü.</span><span class="sxs-lookup"><span data-stu-id="27dcf-483">Converted the Storage management client dependency to the common SDK implementation.</span></span>

#### <a name="azstorage"></a><span data-ttu-id="27dcf-484">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="27dcf-484">Az.Storage</span></span>
* <span data-ttu-id="27dcf-485">Sas Token, OAuth veya Anonymous ile oluşturulduğunda Storage bağlamının StorageAccountName değeri gerçek Depolama Hesabı Adına ayarlanıyor</span><span class="sxs-lookup"><span data-stu-id="27dcf-485">Set the StorageAccountName of Storage context as the real Storage Account Name, when it's created with Sas Token, OAuth or Anonymous</span></span>
    - <span data-ttu-id="27dcf-486">New-AzStorageContext</span><span class="sxs-lookup"><span data-stu-id="27dcf-486">New-AzStorageContext</span></span>
* <span data-ttu-id="27dcf-487">Blob Anlık Görüntü Nesnesinin Sas Belirteci '-FullUri' parametresiyle oluşturulduğunda, döndürülen Uri anlık görüntü Uri'si olacak şekilde düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-487">Create Sas Token of Blob Snapshot Object with '-FullUri' parameter, fix the returned Uri to be the sanpshot Uri</span></span>
    - <span data-ttu-id="27dcf-488">New-AzStorageBlobSASToken</span><span class="sxs-lookup"><span data-stu-id="27dcf-488">New-AzStorageBlobSASToken</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="27dcf-489">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="27dcf-489">Az.Websites</span></span>
* <span data-ttu-id="27dcf-490">'Get-AzDeletedWebApp' cmdlet'indeki tarih ayrıştırma hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-490">Fixed a date parsing bug in 'Get-AzDeletedWebApp'</span></span>
* <span data-ttu-id="27dcf-491">Az.Accounts modülündeki geriye dönük uyumluluk sorunu çözüldü</span><span class="sxs-lookup"><span data-stu-id="27dcf-491">Fix backward compatibility issue with Az.Accounts module</span></span>

## <a name="100---december-2018"></a><span data-ttu-id="27dcf-492">1.0.0 - Aralık 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-492">1.0.0 - December 2018</span></span>
### <a name="general"></a><span data-ttu-id="27dcf-493">Genel</span><span class="sxs-lookup"><span data-stu-id="27dcf-493">General</span></span>

- <span data-ttu-id="27dcf-494">Az Modülü Genel Kullanıma Sunuldu</span><span class="sxs-lookup"><span data-stu-id="27dcf-494">General Availability of Az Module</span></span>
- <span data-ttu-id="27dcf-495">Her modül için çevrimiçi yardım</span><span class="sxs-lookup"><span data-stu-id="27dcf-495">Online help for each module</span></span>
- <span data-ttu-id="27dcf-496">Diğer ayrıntılar ve yol haritası için bkz. [Az Duyuru Sayfası](https://aka.ms/azps-announce)</span><span class="sxs-lookup"><span data-stu-id="27dcf-496">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="27dcf-497">AzureRM’den geçiş hakkında bilgi edinmek için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-497">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="27dcf-498">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="27dcf-498">Az.Accounts</span></span>
- <span data-ttu-id="27dcf-499">Önceki adı: Az.Profile</span><span class="sxs-lookup"><span data-stu-id="27dcf-499">Changed from Az.Profile</span></span>
- <span data-ttu-id="27dcf-500">Profil ve bağlam türleri için tablo biçimleri düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-500">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="27dcf-501">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="27dcf-501">Az.ApiManagement</span></span>
- <span data-ttu-id="27dcf-502">#7002 düzeltmeleri</span><span class="sxs-lookup"><span data-stu-id="27dcf-502">Fixes for #7002</span></span>
- <span data-ttu-id="27dcf-503">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-503">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="27dcf-504">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="27dcf-504">Az.Batch</span></span>
- <span data-ttu-id="27dcf-505">`PSComputeNode` üzerinde yeni `NodeAgentInformation` aracılığıyla bir havuzdaki her bir VM’de Azure Batch Düğüm Aracısı’nın hangi sürümünün çalıştığını görme olanağı eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-505">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="27dcf-506">`PSDataDisk` için `Caching` varsayılan ayarı artık `None` yerine `ReadWrite`.</span><span class="sxs-lookup"><span data-stu-id="27dcf-506">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="27dcf-507">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-507">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="27dcf-508">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="27dcf-508">Az.Billing</span></span>
- <span data-ttu-id="27dcf-509">Billing, Consumption ve UsageAggregates cmdlet’lerini birleştirir, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-509">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="27dcf-510">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-510">Az.CognitivServices</span></span>
- <span data-ttu-id="27dcf-511">New-AzureRmCognitiveServicesAccount işleminde kullanılabilen SkuName ve Typem için tamamlayıcılar eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-511">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="27dcf-512">Get-AzCognitiveServicesAccountSkus cmdlet’inden GetSkusWithAccountParamSetName parametresi kaldırıldı</span><span class="sxs-lookup"><span data-stu-id="27dcf-512">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="27dcf-513">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-513">Az.ContainerInstance</span></span>
- <span data-ttu-id="27dcf-514">ManagedIdentity desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-514">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="27dcf-515">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="27dcf-515">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="27dcf-516">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-516">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="27dcf-517">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="27dcf-517">Az.DataLakeStore</span></span>
- <span data-ttu-id="27dcf-518">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-518">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="27dcf-519">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="27dcf-519">Az.Monitor</span></span>
- <span data-ttu-id="27dcf-520">Az.Insights cmdlet’inin adı Az.Monitor olarak değiştirildi ve başka yeni değişiklikler yapıldı, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-520">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="27dcf-521">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="27dcf-521">Az.KeyVault</span></span>
- <span data-ttu-id="27dcf-522">Çıkış türlerinden kullanım dışı 'PurgeDisabled' özelliği kaldırıldı</span><span class="sxs-lookup"><span data-stu-id="27dcf-522">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="27dcf-523">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="27dcf-523">Az.MachineLearning</span></span>
- <span data-ttu-id="27dcf-524">Az.MachineLearningCompute modülünden cmdlet’ler eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-524">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="27dcf-525">Az.Media</span><span class="sxs-lookup"><span data-stu-id="27dcf-525">Az.Media</span></span>
- <span data-ttu-id="27dcf-526">New-AzMediaService cmdlet’inden kullanım dışı -Tags diğer adı kaldırıldı</span><span class="sxs-lookup"><span data-stu-id="27dcf-526">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="27dcf-527">Az.Network</span><span class="sxs-lookup"><span data-stu-id="27dcf-527">Az.Network</span></span>
<span data-ttu-id="27dcf-528">Application Gateway’de RewriteRuleSets parametresini yapılandırma desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-528">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="27dcf-529">Yeni cmdlet'ler eklendi:</span><span class="sxs-lookup"><span data-stu-id="27dcf-529">New cmdlets added:</span></span>
        - <span data-ttu-id="27dcf-530">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-530">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-531">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-531">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-532">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-532">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-533">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-533">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-534">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-534">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-535">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="27dcf-535">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="27dcf-536">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="27dcf-536">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="27dcf-537">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="27dcf-537">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="27dcf-538">Cmdlet’ler isteğe bağlı -RewriteRuleSet parametresiyle güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-538">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="27dcf-539">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="27dcf-539">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="27dcf-540">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="27dcf-540">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="27dcf-541">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="27dcf-541">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="27dcf-542">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="27dcf-542">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="27dcf-543">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="27dcf-543">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="27dcf-544">New-AzureRmApplicationGatewayUrlPathMapConfig, Kimlik kullanarak Application Gateway’e KeyVault Desteği ekledi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-544">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="27dcf-545">Cmdlet’ler isteğe bağlı -KeyVaultSecretId, -KeyVaultSecret parametresiyle güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-545">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="27dcf-546">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="27dcf-546">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="27dcf-547">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="27dcf-547">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="27dcf-548">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="27dcf-548">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="27dcf-549">New-AzApplicationGateway cmdlet’i isteğe bağlı -UserAssignedIdentity parametresiyle güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-549">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="27dcf-550">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-550">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="27dcf-551">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="27dcf-551">Az.OperationalInsights</span></span>
- <span data-ttu-id="27dcf-552">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-552">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="27dcf-553">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="27dcf-553">Az.Profile</span></span>
- <span data-ttu-id="27dcf-554">Modül adı Az.Accounts olarak değiştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-554">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="27dcf-555">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-555">Az.RecoveryServices</span></span>
- <span data-ttu-id="27dcf-556">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-556">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="27dcf-557">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-557">Az.Resources</span></span>
- <span data-ttu-id="27dcf-558">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-558">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="27dcf-559">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="27dcf-559">Az.ServiceFabric</span></span>
- <span data-ttu-id="27dcf-560">Sertifikayı ortak ad ve parmak iziyle belirtme desteği</span><span class="sxs-lookup"><span data-stu-id="27dcf-560">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="27dcf-561">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-561">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="27dcf-562">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="27dcf-562">Az.SIgnalR</span></span>
- <span data-ttu-id="27dcf-563">SIgnalR için PowerShell cmdlet'leri Genel Kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="27dcf-563">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="27dcf-564">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-564">Az.Sql</span></span>
- <span data-ttu-id="27dcf-565">Tehdit Algılama cmdlet’lerine yeni Data_Exfiltration ve Unsafe_Action algılama türleri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-565">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="27dcf-566">Sql Denetimi cmdlet'leri için belge örnekleri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-566">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="27dcf-567">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-567">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="27dcf-568">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="27dcf-568">Az.Storage</span></span>
- <span data-ttu-id="27dcf-569">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-569">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="27dcf-570">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="27dcf-570">Az.Websites</span></span>
- <span data-ttu-id="27dcf-571">Küçük yeni değişiklikler, ayrıntılar için bkz. [Geçiş Kılavuzu](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="27dcf-571">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="27dcf-572">0.7.0 - Aralık 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-572">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="27dcf-573">Genel</span><span class="sxs-lookup"><span data-stu-id="27dcf-573">General</span></span>

* <span data-ttu-id="27dcf-574">Yakında gerçekleşecek AzureRM’den Az’ye geçiş süreci için küçük değişiklikler</span><span class="sxs-lookup"><span data-stu-id="27dcf-574">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="27dcf-575">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-575">Az.Compute</span></span>

* <span data-ttu-id="27dcf-576">`New-AzVm(ss)` cmdlet’leri için basit parametre kümelerinde UltraSSD ve Galeri Görüntüleri desteği eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-576">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="27dcf-577">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="27dcf-577">Az.DataLakeStore</span></span>

* <span data-ttu-id="27dcf-578">Adls hesabı etki alanının sonundaki eğik çizgi düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-578">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="27dcf-579">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="27dcf-579">Az.FrontDoor</span></span>

* <span data-ttu-id="27dcf-580">Bazı bozuk bağlantılar düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-580">Fixed some broken links</span></span>
    - <span data-ttu-id="27dcf-581">New-AzureRmFrontDoor ve Set-AzureRmFrontDoor makalelerinde, New-AzureRmFrontDoorHealthProbeSettingObject cmdlet’i makalesinin bağlantısı düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-581">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="27dcf-582">New-AzureRmFrontDoorManagedRuleObject makalesinde, New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet’i makalesinin bağlantısı düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-582">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="27dcf-583">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-583">Az.RecoveryServices</span></span>

* <span data-ttu-id="27dcf-584">Azure Dosya Paylaşımı geri yükleme işlemleri için istemci tarafı doğrulamalar eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-584">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="27dcf-585">Afs geri yükleme işlemi için storageAccountName ve storageAccountResourceGroupName isteğe bağlı hale getirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-585">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="27dcf-586">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-586">Az.Resources</span></span>

* <span data-ttu-id="27dcf-587"> https://github.com/Azure/azure-powershell/issues/7679 düzeltmesi</span><span class="sxs-lookup"><span data-stu-id="27dcf-587">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="27dcf-588">Get-AzureRmRoleAssignment, klasik yöneticiler istenirken sağlanmışsa abonelik kapsamını kullanacak şekilde güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-588">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="27dcf-589">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-589">Az.Sql</span></span>

* <span data-ttu-id="27dcf-590">Yakında gerçekleşecek AzureRM’den Az’ye geçiş süreci için küçük değişiklikler</span><span class="sxs-lookup"><span data-stu-id="27dcf-590">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="27dcf-591">Get-AzureRmSqlDatabaseVulnerabilityAssessment cmdlet’inin DotNet core ile kullanılması konusundaki bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-591">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="27dcf-592">SQL Denetimi cmdlet’leriyle ilgili yardım iletilerinin belgeleri değiştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-592">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="27dcf-593">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="27dcf-593">Az.Storage</span></span>

* <span data-ttu-id="27dcf-594">New-AzureRmStorageAccount cmdlet’ine -EnableHierarchicalNamespace eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-594">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="27dcf-595">-DestContext girilmediğinde Dosya Kopyalama cmdlet’inin hedefte kaynak bağlamını yeniden kullanamamasına yol açan sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-595">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="27dcf-596">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="27dcf-596">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="27dcf-597">Statik Web Sitesi yapılandırması için destek eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-597">Support Static Website configuration</span></span>
    - <span data-ttu-id="27dcf-598">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="27dcf-598">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="27dcf-599">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="27dcf-599">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="27dcf-600">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="27dcf-600">Az.Websites</span></span>

* <span data-ttu-id="27dcf-601">Set-AzureRmWebApp ve Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="27dcf-601">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span>
    - <span data-ttu-id="27dcf-602">Windows ve Linux kapsayıcı uygulamalarında bağlanacak Azure Depolama yollarının belirtilmesi için yeni parametre (-AzureStoragePath) eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-602">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="27dcf-603">Azure Depolama yollarını ayarlamak için yeni New-AzureRmWebAppAzureStoragePath cmdlet’inin çıktısını bir parametre olarak kullanın.</span><span class="sxs-lookup"><span data-stu-id="27dcf-603">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="27dcf-604">0.6.1 - Kasım 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-604">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="27dcf-605">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="27dcf-605">Az.ApiManagement</span></span>
* <span data-ttu-id="27dcf-606">Tür eşlemesinde güncelleştirme bağımlılıkları sorunu</span><span class="sxs-lookup"><span data-stu-id="27dcf-606">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="27dcf-607">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="27dcf-607">Az.Automation</span></span>
* <span data-ttu-id="27dcf-608">Swagger tabanlı Azure Otomasyon cmdlet'leri</span><span class="sxs-lookup"><span data-stu-id="27dcf-608">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="27dcf-609">Güncelleştirme Yönetimi cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-609">Added Update Management cmdlets</span></span>
* <span data-ttu-id="27dcf-610">Kaynak Denetimi cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-610">Added Source Control cmdlets</span></span>
* <span data-ttu-id="27dcf-611">Remove-AzureRmAutomationHybridWorkerGroup cmdlet'i eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-611">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="27dcf-612">DSC Kayıt Düğümü komutu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-612">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="27dcf-613">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-613">Az.Compute</span></span>
* <span data-ttu-id="27dcf-614">SystemAssigned kimliği için kimlik sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-614">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="27dcf-615">Tür eşlemesinde güncelleştirme bağımlılıkları sorunu</span><span class="sxs-lookup"><span data-stu-id="27dcf-615">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="27dcf-616">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-616">Az.ContainerInstance</span></span>
* <span data-ttu-id="27dcf-617">Tür eşlemesinde güncelleştirme bağımlılıkları sorunu</span><span class="sxs-lookup"><span data-stu-id="27dcf-617">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="27dcf-618">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="27dcf-618">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="27dcf-619">Market cmdlet'leri için örnekler açıklaması güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-619">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="27dcf-620">Az.Network</span><span class="sxs-lookup"><span data-stu-id="27dcf-620">Az.Network</span></span>
* <span data-ttu-id="27dcf-621">New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-621">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="27dcf-622">Desteklenen AzureFirewall Ağ Protokollerine yeniden ICMP eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-622">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="27dcf-623">Test-AzureRmNetworkWatcherConnectivity cmdlet'i güncelleştirildi; hedef kimlik, adres ve bağlantı noktasında doğrulama eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-623">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span>
* <span data-ttu-id="27dcf-624">VirtualNetwork eşlemesinde bellek kullanımıyla ilgili sorunlar düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-624">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="27dcf-625">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="27dcf-625">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="27dcf-626">Korumalı dosya paylaşımı için ilke değiştirme sorunu düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-626">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="27dcf-627">İlke saat dilimi büyük harfe dönüştürüldü.</span><span class="sxs-lookup"><span data-stu-id="27dcf-627">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="27dcf-628">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="27dcf-628">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="27dcf-629">New-AzureRmRecoveryServicesAsrProtectableItem cmdlet'indeki örnek düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-629">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="27dcf-630">Tür eşlemesinde güncelleştirme bağımlılıkları sorunu</span><span class="sxs-lookup"><span data-stu-id="27dcf-630">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="27dcf-631">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="27dcf-631">Az.Relay</span></span>
* <span data-ttu-id="27dcf-632">Kullanıcının New-AzureRmRelayKey cmdlet'ine KeyValue sağlamasına olanak tanıyan isteğe bağlı -KeyValue parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-632">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="27dcf-633">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-633">Az.Resources</span></span>
* <span data-ttu-id="27dcf-634">`New-AzureRmPolicyAssignment` ve `Set-AzureRmPolicyAssignment` cmdlet'lerindeki kaynak kimliğiyle ilgili parametrelerin yardım belgeleri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-634">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="27dcf-635">New-AzureRmPolicyDefinition cmdlet'ine -Metadata kullanan bir örnek eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-635">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="27dcf-636">NetStandard'da Tag anahtarında büyük/küçük harf kullanımının korunmasına yönelik düzeltme yapıldı: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="27dcf-636">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="27dcf-637">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="27dcf-637">Az.ServiceFabric</span></span>
* <span data-ttu-id="27dcf-638">Hataya neden olan değişiklikler yayınlanacağından kullanımdan kaldırılacak özellikleri belirten iletiler eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-638">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="27dcf-639">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-639">Az.Sql</span></span>
* <span data-ttu-id="27dcf-640">Azure Sql Veritabanı Yönetilen Örneği ve Azure Sql Yönetilen Veritabanı'nındaki CRUD işlemleri için yeni cmdlet'ler eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-640">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="27dcf-641">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-641">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="27dcf-642">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-642">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="27dcf-643">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-643">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="27dcf-644">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="27dcf-644">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="27dcf-645">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="27dcf-645">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="27dcf-646">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="27dcf-646">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="27dcf-647">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="27dcf-647">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="27dcf-648">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="27dcf-648">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="27dcf-649">Sunucuda veya veritabanında Genişletilmiş Denetim İlkesi yönetimi etkinleştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-649">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="27dcf-650">Denetim günlüklerinde filtrelemeyi etkinleştirmek için yeni parametre (PredicateExpression) eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-650">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="27dcf-651">Cmdlet'ler, SQL istemcileri yerine Eski istemcileri kullanacak şekilde değiştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-651">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="27dcf-652">Set-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="27dcf-652">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="27dcf-653">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="27dcf-653">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="27dcf-654">Set-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="27dcf-654">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="27dcf-655">Get-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="27dcf-655">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="27dcf-656">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings cmdlet'inin depolama hesabı ad parametre kümesiyle kullanılmasıyla ilgili sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-656">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="27dcf-657">0.5.0 - Kasım 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-657">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="27dcf-658">Genel</span><span class="sxs-lookup"><span data-stu-id="27dcf-658">General</span></span>
* <span data-ttu-id="27dcf-659">Birçok temel cmdlet’e Kaynak Tamamlayıcıları eklendi - bunlar cmdlet’leri etkileşimli olarak çağırırken mevcut kaynak adları arasında gezinmenize olanak tanır</span><span class="sxs-lookup"><span data-stu-id="27dcf-659">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="27dcf-660">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="27dcf-660">Az.Profile</span></span>
* <span data-ttu-id="27dcf-661">ClientRuntime’ın en son sürümünü kullanacak şekilde ortak kod güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-661">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="27dcf-662">Connect-AzAccount cmdlet'indeki TenantId parametresi Tenant olarak yeniden adlandırıldı ve TenantId için diğer ad eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-662">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="27dcf-663">Connect-AzAccount için TenantId açıklaması güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-663">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="27dcf-664">Kiracı etki alanı sağlanırken başarısız oturum açma durumunda gösterilen hata iletisi düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-664">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="27dcf-665">Kiracıda abonelikleri olmayan hesaplar için bağlam adı çakışmasıyla ilgili sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-665">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="27dcf-666">MSI kullanırken DataLake uç noktalarıyla ilgili sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-666">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="27dcf-667">Bağlantı olmadığında 'Disconnect-AzAccount' oluşturulmasına neden olan sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-667">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="27dcf-668">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-668">Az.CognitiveServices</span></span>
* <span data-ttu-id="27dcf-669">Get-AzCognitiveServicesAccountSkus işlemi eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-669">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="27dcf-670">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-670">Az.Compute</span></span>
* <span data-ttu-id="27dcf-671">Add-AzVmssVMDataDisk ve Remove-AzVmssVMDataDisk cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-671">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="27dcf-672">Get-AzVMImage, AutomaticOSUpgradeProperties gösteriyor</span><span class="sxs-lookup"><span data-stu-id="27dcf-672">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="27dcf-673">SetAzVMChefExtension -BootstrapOptions ve -JsonAttribute seçeneği değerlerinin Json biçiminde ayarlanmamasıyla ilgili hata düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-673">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="27dcf-674">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="27dcf-674">Az.DataLakeStore</span></span>
* <span data-ttu-id="27dcf-675">DataLake paketi 1.1.10'a güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-675">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="27dcf-676">Çok iş parçacıklı işlemlere varsayılan Concurrency değeri eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-676">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="27dcf-677">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="27dcf-677">Az.Insights</span></span>
* <span data-ttu-id="27dcf-678">7267 numaralı (Otomatik ölçeklendirme alanı) sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-678">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="27dcf-679">Yeni otomatik ölçeklendirme kuralı oluşturma sırasında numaralandırılmış parametrelerin düzgün ayarlanmamasıyla ilgili sorunlar (bunlar her zaman varsayılan değere ayarlanıyordu).</span><span class="sxs-lookup"><span data-stu-id="27dcf-679">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="27dcf-680">Set-AzDiagnosticSetting'in ayar oluşturma sırasında kategorilerin açıkça belirtilmesini gerektirmesiyle ilgili 7513 numaralı [Insights] sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-680">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="27dcf-681">Artık cmdlet oluşturma sırasında açık kategori gösteriminin etkinleştirilmesini gerektirmiyor; başka bir deyişle belgelerinde belirtildiği gibi çalışıyor</span><span class="sxs-lookup"><span data-stu-id="27dcf-681">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="27dcf-682">Az.Network</span><span class="sxs-lookup"><span data-stu-id="27dcf-682">Az.Network</span></span>
* <span data-ttu-id="27dcf-683">Aşağıdaki parametrelerde PeeringType parametresi zorunlu parametre olarak değiştirildi:-</span><span class="sxs-lookup"><span data-stu-id="27dcf-683">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="27dcf-684">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="27dcf-684">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="27dcf-685">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="27dcf-685">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="27dcf-686">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="27dcf-686">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="27dcf-687">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="27dcf-687">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="27dcf-688">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="27dcf-688">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="27dcf-689">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="27dcf-689">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="27dcf-690">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="27dcf-690">Az.PolicyInsights</span></span>
* <span data-ttu-id="27dcf-691">İlke düzeltme cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-691">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="27dcf-692">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-692">Az.Resources</span></span>
* <span data-ttu-id="27dcf-693"> https://github.com/Azure/azure-powershell/issues/7402 düzeltmesi</span><span class="sxs-lookup"><span data-stu-id="27dcf-693">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="27dcf-694">'Get-AzResource' için '-ResourceId' parametresi kullanılarak kaynakların listelenmesine olanak tanındı</span><span class="sxs-lookup"><span data-stu-id="27dcf-694">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="27dcf-695">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="27dcf-695">Az.ServiceBus</span></span>
* <span data-ttu-id="27dcf-696">PSServiceBusMigrationConfigurationAttributes'e Geçiş durumunun bilinmesine yardımcı olacak salt okunur MigrationState özelliği eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-696">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="27dcf-697">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="27dcf-697">Az.ServiceFabric</span></span>
* <span data-ttu-id="27dcf-698">Linux Vmss'ye sertifika ekleme sorunu düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-698">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="27dcf-699">'Add-AzServiceFabricClusterCertificate' düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-699">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="27dcf-700">Yeni sertifikadan doğru parmak izi kullanıyor (Azure/service-fabric-issues#932).</span><span class="sxs-lookup"><span data-stu-id="27dcf-700">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="27dcf-701">Özel durum doğru görüntüleniyor (Azure/service-fabric-issues#1054).</span><span class="sxs-lookup"><span data-stu-id="27dcf-701">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="27dcf-702">'Update-AzServiceFabricDurability', Vmss CreateOrUpdate işlemini başlatmadan önce küme yapılandırmasını güncelleştirecek şekilde düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-702">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="27dcf-703">0.4.0 - Ekim 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-703">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="27dcf-704">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="27dcf-704">Az.Profile</span></span>
* <span data-ttu-id="27dcf-705">CloudShell’de Get-AzSubscription sorunu çözüldü</span><span class="sxs-lookup"><span data-stu-id="27dcf-705">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="27dcf-706">ClientRuntime’ın en son sürümünü kullanacak şekilde ortak kod güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-706">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="27dcf-707">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-707">Az.Compute</span></span>
* <span data-ttu-id="27dcf-708">'New-AzVm' için basit parametre kümesi kullanıldığında hızlandırılmış ağların açılacağı VM boyutları beyaz listesine yeni boyutlar eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-708">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="27dcf-709">Tüm cmdlet'lere ResourceName bağımsız değişken tamamlayıcısı eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-709">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="27dcf-710">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="27dcf-710">Az.DataLakeStore</span></span>
* <span data-ttu-id="27dcf-711">Sanal Ağ Kuralları desteği ekleme</span><span class="sxs-lookup"><span data-stu-id="27dcf-711">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="27dcf-712">Get-AzDataLakeStoreVirtualNetworkRule: Azure Data Lake Store sanal ağ kuralını alır veya listeler.</span><span class="sxs-lookup"><span data-stu-id="27dcf-712">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="27dcf-713">Add-AzDataLakeStoreVirtualNetworkRule: Belirtilen Data Lake Store hesabına sanal ağ kuralı ekler.</span><span class="sxs-lookup"><span data-stu-id="27dcf-713">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="27dcf-714">Set-AzDataLakeStoreVirtualNetworkRule: Belirtilen Data Lake Store hesabındaki belirtilen sanal ağ kuralını değiştirir.</span><span class="sxs-lookup"><span data-stu-id="27dcf-714">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="27dcf-715">Remove-AzDataLakeStoreVirtualNetworkRule: Bir Azure Data Lake Store sanal ağ kuralını siler.</span><span class="sxs-lookup"><span data-stu-id="27dcf-715">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="27dcf-716">Az.Network</span><span class="sxs-lookup"><span data-stu-id="27dcf-716">Az.Network</span></span>
* <span data-ttu-id="27dcf-717">Test-AzNetworkWatcherConnectivity cmdlet'i güncelleştirildi, arka uca protokol değerini geçiriyor.</span><span class="sxs-lookup"><span data-stu-id="27dcf-717">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="27dcf-718">Tüm cmdlet'lere ResourceName bağımsız değişken tamamlayıcısı eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-718">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="27dcf-719">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-719">Az.Resources</span></span>
* <span data-ttu-id="27dcf-720">Get-AzRoleDefinition cmdlet'inin anlaşılmaz bir özel durum oluşturmasına neden olan hata (varsayılan profilin içinde abonelik olmadığında ve hiçbir kapsam belirtilmediğinde), senaryoya anlamlı bir özel durum eklenerek düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-720">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="27dcf-721">Ayrıca varsayılan parametre kümesi 'RoleDefinitionNameParameterSet' olarak ayarlandı.</span><span class="sxs-lookup"><span data-stu-id="27dcf-721">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="27dcf-722">0.3.0 - Ekim 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-722">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="27dcf-723">Azure Depolama</span><span class="sxs-lookup"><span data-stu-id="27dcf-723">Azure.Storage</span></span>
* <span data-ttu-id="27dcf-724">Hedefte meta veri sorunu olduğunda Fix Copy Blob/File meta verileri kopyalamayacak</span><span class="sxs-lookup"><span data-stu-id="27dcf-724">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="27dcf-725">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="27dcf-725">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="27dcf-726">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="27dcf-726">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="27dcf-727">Belirli bir konumunun Depolama kaynağı kullanımını alma desteği ve genel Depolama kayrağı kullanımını almak için uyarı iletisi ekleme kullanımdan kalktı.</span><span class="sxs-lookup"><span data-stu-id="27dcf-727">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="27dcf-728">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="27dcf-728">Get-AzStorageUsage</span></span>

#### <a name="azcognitiveservices"></a><span data-ttu-id="27dcf-729">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="27dcf-729">Az.CognitiveServices</span></span>
* <span data-ttu-id="27dcf-730">Mevcut hesap olmadan Get-AzCognitiveServicesAccountSkus desteği.</span><span class="sxs-lookup"><span data-stu-id="27dcf-730">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="27dcf-731">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="27dcf-731">Az.Compute</span></span>
* <span data-ttu-id="27dcf-732">Get-AzVM -ResourceGroupName <rg> gerektiğinde 50'den fazla sonuç döndürecek şekilde düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-732">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="27dcf-733">New-AzVmss cmdlet'inin yardımına 'SimpleParameterSet' örneği eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-733">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="27dcf-734">Azure Disk Şifrelemesi ilerleme durumu iletisindeki yazım hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-734">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="27dcf-735">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="27dcf-735">Az.DataFactoryV2</span></span>
* <span data-ttu-id="27dcf-736">ADF .Net SDK sürümü 2.3.0'a güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-736">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="27dcf-737">Az.Network</span><span class="sxs-lookup"><span data-stu-id="27dcf-737">Az.Network</span></span>
* <span data-ttu-id="27dcf-738">NetworkProfile işlevselliği eklendi.</span><span class="sxs-lookup"><span data-stu-id="27dcf-738">Added NetworkProfile functionality.</span></span> <span data-ttu-id="27dcf-739">yeni cmdlet'ler eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-739">new cmdlets added</span></span>
    - <span data-ttu-id="27dcf-740">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="27dcf-740">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="27dcf-741">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="27dcf-741">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="27dcf-742">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="27dcf-742">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="27dcf-743">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="27dcf-743">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="27dcf-744">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="27dcf-744">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="27dcf-745">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="27dcf-745">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="27dcf-746">Alt Ağ Modeline hizmet ilişki bağlantısı eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-746">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="27dcf-747">New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-747">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="27dcf-748">Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig cmdlet'leri eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-748">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="27dcf-749">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="27dcf-749">Az.RedisCache</span></span>
* <span data-ttu-id="27dcf-750">Bundan sonra Size parametresi olarak her dizeye izin veriliyor.</span><span class="sxs-lookup"><span data-stu-id="27dcf-750">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="27dcf-751">PSArgumentCompleter açılan listesine P5 eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-751">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="27dcf-752">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="27dcf-752">Az.Resources</span></span>
* <span data-ttu-id="27dcf-753">Set-AzPolicyDefinition'a eksik -Mode parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="27dcf-753">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="27dcf-754">Origin öğesi User içeren işlemler için Get-AzProviderOperation commandlet hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-754">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="27dcf-755">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="27dcf-755">Az.Sql</span></span>
* <span data-ttu-id="27dcf-756">Bazı yedekleme cmdlet'lerinin geçerli Azure aboneliğini tanıyamamasına neden olan sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="27dcf-756">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="27dcf-757">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="27dcf-757">Az.Websites</span></span>
* <span data-ttu-id="27dcf-758">Yeni Get-AzWebAppContainerContinuousDeploymentUrl Cmdlet'i - Kapsayıcı Sürekli Dağıtım Web Kancası URL'sini alıyor</span><span class="sxs-lookup"><span data-stu-id="27dcf-758">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="27dcf-759">Yeni New-AzWebAppContainerPSSession ve Enter-WebAppContainerPSSession Cmdlet'leri - Windows kapsayıcı uygulamasında PowerShell uzak oturumunu başlatıyor</span><span class="sxs-lookup"><span data-stu-id="27dcf-759">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="27dcf-760">0.2.0 - Eylül 2018</span><span class="sxs-lookup"><span data-stu-id="27dcf-760">0.2.0 - September 2018</span></span>
 <span data-ttu-id="27dcf-761">İlk Yayın</span><span class="sxs-lookup"><span data-stu-id="27dcf-761">Initial Release</span></span>
