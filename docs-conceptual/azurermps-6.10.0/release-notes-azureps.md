...
#### <a name="azurermcompute"></a><span data-ttu-id="b62da-112">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-112">AzureRM.Compute</span></span>
...
#### <a name="azurermrediscache"></a><span data-ttu-id="b62da-130">AzureRM.RedisCache</span><span class="sxs-lookup"><span data-stu-id="b62da-130">AzureRM.RedisCache</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="b62da-147">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-147">AzureRM.Profile</span></span>
...
#### <a name="azurerminsights"></a><span data-ttu-id="b62da-164">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="b62da-164">AzureRM.Insights</span></span>
...
* <span data-ttu-id="b62da-183">ARM aracılığıyla Azure Güvenlik Duvarı özelliği için yeni cmdlet'ler eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-183">Added new cmdlets for feature: Azure Firewall via ARM</span></span>
  ...
  - <span data-ttu-id="b62da-186">New-AzureRmFirewall eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-186">Added New-AzureRmFirewall</span></span>
...
* <span data-ttu-id="b62da-194">Application Gateway'de Güvenilen Kök sertifika ve Otomatik ölçeklendirme yapılandırması desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-194">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  ...
  - <span data-ttu-id="b62da-210">Cmdlet'ler isteğe bağlı -AutoscaleConfiguration parametresiyle güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-210">Cmdlets updated with optonal parameter -AutoscaleConfiguration</span></span>
...
* <span data-ttu-id="b62da-235">Alt ağ temsilcisi seçme cmdlet'leri eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-235">Adding cmdlets for subnet delegation.</span></span>
  ...
  - <span data-ttu-id="b62da-238">Add-AzureRmDelegation: Bir alt ağı alır ve belirtilen hizmet adını o alt ağa temsilci olarak ekler</span><span class="sxs-lookup"><span data-stu-id="b62da-238">Add-AzureRmDelegation: Takes in a subnet and adds the provided service name as a delegation to that subnet</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="b62da-256">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="b62da-256">AzureRM.Storage</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="b62da-277">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b62da-277">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="b62da-294">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-294">AzureRM.Network</span></span>
...
## <a name="680---august-2018"></a><span data-ttu-id="b62da-310">6.8.0 - Ağustos 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-310">6.8.0 - August 2018</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="b62da-325">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b62da-325">AzureRM.Resources</span></span>
...
* <span data-ttu-id="b62da-344">'Connect-AzureRmAccount' için kiracı etki alanının '-TenantId' parametresine geçirilmesi etkinleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-344">Enable tenant domain to be passed to '-TenantId' parameter for 'Connect-AzureRmAccount'</span></span>
...
#### <a name="azurermbackup"></a><span data-ttu-id="b62da-358">AzureRM.Backup</span><span class="sxs-lookup"><span data-stu-id="b62da-358">AzureRM.Backup</span></span>
...
#### <a name="azurermconsumption"></a><span data-ttu-id="b62da-374">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="b62da-374">AzureRM.Consumption</span></span>
...
* <span data-ttu-id="b62da-390">Set-AzureRmDataLakeStoreItemAclEntry örneği güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-390">Update example for Set-AzureRmDataLakeStoreItemAclEntry</span></span>
...
#### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-405">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-405">AzureRM.KeyVault</span></span>
...
* <span data-ttu-id="b62da-422">Set-AzureRmVirtualNetworkGatewayConnectionSharedKey örneği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-422">Added example for Set-AzureRmVirtualNetworkGatewayConnectionSharedKey</span></span>
...
#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b62da-436">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="b62da-436">AzureRM.RecoveryServices.Backup</span></span>
...
* <span data-ttu-id="b62da-451">Abonelik kapsamındaki şablon dağıtımı destekleniyor.</span><span class="sxs-lookup"><span data-stu-id="b62da-451">Support template deployment at subscription scope.</span></span> <span data-ttu-id="b62da-452">Yeni Cmdlet’ler eklendi:</span><span class="sxs-lookup"><span data-stu-id="b62da-452">Add new Cmdlets:</span></span>
    ...
    - <span data-ttu-id="b62da-457">Stop-AzureRmDeployment</span><span class="sxs-lookup"><span data-stu-id="b62da-457">Stop-AzureRmDeployment</span></span>
...
#### <a name="azurermstreamanalytics"></a><span data-ttu-id="b62da-473">AzureRM.StreamAnalytics</span><span class="sxs-lookup"><span data-stu-id="b62da-473">AzureRM.StreamAnalytics</span></span>
...
* <span data-ttu-id="b62da-487">Kaynağın geçerli yapılandırmasının hedef kaynakla uyumlu olduğunu doğrulayabilmek için Common.Strategy kitaplığı güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-487">Updated Common.Strategy library to be able to validate that the current config for a resource is compatible with the target resource.</span></span>
* <span data-ttu-id="b62da-488">Common.Storage'a ps1xml türleri eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-488">Added ps1xml types to Common.Storage</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b62da-489">Azure Depolama</span><span class="sxs-lookup"><span data-stu-id="b62da-489">Azure.Storage</span></span>
* <span data-ttu-id="b62da-490">DefaultProfile’dan Depolama Bağlamı almak için destek eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-490">Added support for getting Storage Context from DefaultProfile</span></span>
* <span data-ttu-id="b62da-491">Cmdlet'lerin çıkış türü özelliklerine Ps1XmlAttribute eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-491">Added Ps1XmlAttribute to cmdlets output types properties.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="b62da-492">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b62da-492">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="b62da-493">https://github.com/Azure/azure-powershell/issues/6370 sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-493">Fixed issue https://github.com/Azure/azure-powershell/issues/6370</span></span>
    - <span data-ttu-id="b62da-494">PsApiManagementApi'yi ApiContract'e çevirmek için Automapper hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-494">Fixed bug in Automapper to translate PsApiManagementApi to ApiContract</span></span>
* <span data-ttu-id="b62da-495">https://github.com/Azure/azure-powershell/issues/6515 sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-495">Fixed issue https://github.com/Azure/azure-powershell/issues/6515</span></span>
    - <span data-ttu-id="b62da-496">Kodlama Türü ile aşırı yüklemeyi önlemek için File.Save hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-496">Fixed bug in File.Save to not overload with Encoding Type</span></span>
* <span data-ttu-id="b62da-497">https://github.com/Azure/azure-powershell/issues/6560 sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-497">Fixed issue https://github.com/Azure/azure-powershell/issues/6560</span></span>
    - <span data-ttu-id="b62da-498">apiId üzerindeki desen özel durumunu düzelten 4.0.3 Nuget sürümüne yükseltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-498">Upgraded to 4.0.3 Nuget version which fixes the pattern exception on apiId</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b62da-499">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-499">AzureRM.Compute</span></span>
* <span data-ttu-id="b62da-500">PremiumLRS depolama hesap türü yeniden adlandırması nedeniyle New-AzureRmVm'de DiskFileParameterSet kullanılarak sanal makine oluşturmanın başarısız olmasıyla ilgili hata düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-500">Fix issue with creating a vm using DiskFileParameterSet in New-AzureRmVm failing because of PremiumLRS storage account type renaming.</span></span>
* <span data-ttu-id="b62da-501">Invoke-AzureRmVMRunCommand cmdlet'i düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-501">Fix Invoke-AzureRmVMRunCommand cmdlet</span></span>
* <span data-ttu-id="b62da-502">Abonelikteki tüm kullanılabilir kümelerin listelenebilmesi için Get-AzureRmAvailabilitySet güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-502">Update Get-AzureRmAvailabilitySet to enable list all availability sets in a subscription.</span></span>  <span data-ttu-id="b62da-503">(ResouceGroupName parametresi artık isteğe bağlı.)</span><span class="sxs-lookup"><span data-stu-id="b62da-503">(ResouceGroupName parameter is now optional.)</span></span>
* <span data-ttu-id="b62da-504">Uygun sanal makinelerde Hızlandırılmış Ağı etkinleştirmek için 'New-AzureRmVm' cmdlet'inin SimpleParameterSet öğesi güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-504">Update SimpleParameterSet of 'New-AzureRmVm' to enable Accelerated Network on qualifying vms.</span></span>
* <span data-ttu-id="b62da-505">Kullanıcının belirttiği LB zaten mevcut olduğunda vmss oluşturmanın başarısız olması için New-AzureRmVmss basit parametre kümesi güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-505">Update New-AzureRmVmss simple parameter set to fail creating the vmss when a user specified LB already exists.</span></span>
* <span data-ttu-id="b62da-506">New-AzureRmDisk örneği güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-506">Update example for New-AzureRmDisk</span></span>
* <span data-ttu-id="b62da-507">'New-AzureRmVM' için örnek eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-507">Add example for 'New-AzureRmVM'</span></span>
* <span data-ttu-id="b62da-508">Set-AzureRmVMOSDisk açıklaması güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-508">Update description for Set-AzureRmVMOSDisk</span></span>
* <span data-ttu-id="b62da-509">Yazımı ve ön eki düzeltmek amacıyla Set-AzureRmVMBginfoExtension için Örnek 1 güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-509">Update Example 1 for Set-AzureRmVMBginfoExtension to correct spelling and prefix.</span></span> 

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b62da-510">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b62da-510">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="b62da-511">ADF .Net SDK sürümü 1.1.0'a güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-511">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="b62da-512">Veri fabrikaları arasında paylaşılan şirket içinde barındırılan tümleştirme çalışma zamanı desteği.</span><span class="sxs-lookup"><span data-stu-id="b62da-512">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="b62da-513">Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet'ine yeni -SharedIntegrationRuntimeResourceId parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-513">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="b62da-514">Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet'ine isteğe bağlı yeni -LinkedDataFactoryName parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-514">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b62da-515">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b62da-515">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b62da-516">DataPlane SDK'sı (Microsoft.Azure.DataLake.Store) sürümü 1.1.9'a güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-516">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b62da-517">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b62da-517">AzureRM.EventHub</span></span>
* <span data-ttu-id="b62da-518">Kaldırma cmdlet'lerine InputObject ve ResourceId yöneltmesi güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-518">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="b62da-519">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="b62da-519">AzureRM.Insights</span></span>
* <span data-ttu-id="b62da-520">Yardım dosyalarındaki OutputType biçimlendirmesi düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-520">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="b62da-521">Microsoft.Azure.Management.Monitor SDK 0.19.1-preview kullanımı</span><span class="sxs-lookup"><span data-stu-id="b62da-521">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-522">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-522">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b62da-523">Set-AzureRmKeyVaultAccessPolicy'de yönlendirme sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-523">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b62da-524">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-524">AzureRM.Network</span></span>
* <span data-ttu-id="b62da-525">LoadBalancerInboundNatPoolConfig cmdlet'leri için örnekler eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-525">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b62da-526">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b62da-526">AzureRM.Resources</span></span>
* <span data-ttu-id="b62da-527">'Get-AzureRmResource' için hem etiket adı hem de değer sağlama sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-527">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="b62da-528">'Set-AzureRmResource' için yönlendirme senaryosu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-528">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="b62da-529">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b62da-529">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b62da-530">Kaldırma cmdlet'lerine InputObject ve ResourceId yöneltmesi güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-530">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="b62da-531">birkaç sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-531">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="b62da-532">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-532">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-533">Aşağıdaki cmdlet'lere Sunucu Gelişmiş Tehdit Koruması desteği ekleniyor:</span><span class="sxs-lookup"><span data-stu-id="b62da-533">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="b62da-534">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="b62da-534">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="b62da-535">Aşağıdaki cmdlet'lere Güvenlik Açığı Değerlendirme desteği ekleniyor:</span><span class="sxs-lookup"><span data-stu-id="b62da-535">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="b62da-536">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="b62da-536">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="b62da-537">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="b62da-537">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="b62da-538">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="b62da-538">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="b62da-539">Remove-AzureRmSqlServerFirewallRulecmdlet'indeki örnek düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-539">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="b62da-540">Get-AzureSqlSyncGroupLog içinde ABD temelli olmayan kültürde yanlış tarih saat işlemesi düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-540">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="b62da-541">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="b62da-541">AzureRM.Storage</span></span>
* <span data-ttu-id="b62da-542">Cmdlet'lerin çıkış türü özelliklerine Ps1XmlAttribute eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-542">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="b62da-543">Tablo görünümünde StorageAccount cmdlet'i çıkışı gösteriliyor</span><span class="sxs-lookup"><span data-stu-id="b62da-543">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="b62da-544">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b62da-544">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="b62da-545">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b62da-545">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="b62da-546">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b62da-546">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="b62da-547">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="b62da-547">AzureRM.Tags</span></span>
* <span data-ttu-id="b62da-548">Tag cmdlet'inin yardımında hatayı deyim kaldırıldı</span><span class="sxs-lookup"><span data-stu-id="b62da-548">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="b62da-549">6.5.0 - Temmuz 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-549">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b62da-550">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-550">AzureRM.Profile</span></span>
* <span data-ttu-id="b62da-551">'Get-AzureRmContextAutosaveSetting' için yardım güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-551">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b62da-552">Azure Depolama</span><span class="sxs-lookup"><span data-stu-id="b62da-552">Azure.Storage</span></span>
* <span data-ttu-id="b62da-553">Salt yazılır Sas belirteciyle Karşıya Yükleme Blobu veya Dosyası desteği</span><span class="sxs-lookup"><span data-stu-id="b62da-553">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="b62da-554">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="b62da-554">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="b62da-555">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="b62da-555">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="b62da-556">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="b62da-556">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="b62da-557">AS'ye gerekli ResourceGroupName özelliği eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-557">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="b62da-558">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="b62da-558">AzureRM.Automation</span></span>
* <span data-ttu-id="b62da-559">'New-AzureRMAutomationSchedule' için yardım güncelleştirildi ve örnek eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-559">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b62da-560">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-560">AzureRM.Compute</span></span>
* <span data-ttu-id="b62da-561">Update/New-AzureRmAvailabilitySet komutlarına -Tag parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-561">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="b62da-562">'Add-AzureRmVmssExtension' için örnek eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-562">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="b62da-563">'Remove-AzureRmVmssExtension' için örnek eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-563">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="b62da-564">'Set-AzureRmVMAccessExtension' için yardım güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-564">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="b62da-565">New-AzureRmVmss için SimpleParameterSet güncelleştirilerek SinglePlacementGroup varsayılan olarak false değerine ayarlandı ve kullanıcının tek yerleşim grubunda VMSS oluşturmasına olanak tanıyan 'SinglePlacementGroup' geçiş parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-565">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b62da-566">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b62da-566">AzureRM.EventHub</span></span>
* <span data-ttu-id="b62da-567">PSEventHubDRConfigurationAttributes sınıfına, çoğaltma işlemi devam ederken bekleyen çoğaltma işlemlerinin sayısını veren salt okunur 'PendingReplicationOperationsCount' özelliği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-567">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-568">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-568">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b62da-569">Set-AzureRmKeyVaultAccessPolicy için hata iletisi güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-569">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="b62da-570">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="b62da-570">AzureRM.LogicApp</span></span>
* <span data-ttu-id="b62da-571">New-AzureRmLogicApp’te "parametre kümesi çözümlenemedi" hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-571">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b62da-572">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-572">AzureRM.Network</span></span>
* <span data-ttu-id="b62da-573">Set/Add-AzureRmVirtualNetworkPeering için birden çok Kiracıdaki Sanal Makineler arasında eşleme etkinleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-573">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="b62da-574">Aşağıdaki cmdlet’ler Application Gateway için güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-574">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="b62da-575">New-AzureRmApplicationGateway : EnableFIPS bayrağı ve Zones desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-575">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="b62da-576">New-AzureRmApplicationGatewaySku : Yeni Standard_v2 ve WAF_v2 sku'ları eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-576">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="b62da-577">Set-AzureRmApplicationGatewaySku : Yeni Standard_v2 ve WAF_v2 sku'ları eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-577">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="b62da-578">RouteTable cmdlet’leri en son oluşturucu sürümüyle yeniden oluşturuldu</span><span class="sxs-lookup"><span data-stu-id="b62da-578">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="b62da-579">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="b62da-579">AzureRM.Relay</span></span>
* <span data-ttu-id="b62da-580">Markdown dosyaları güncelleştirildi, örnekteki parametre adı sorunu çözüldü</span><span class="sxs-lookup"><span data-stu-id="b62da-580">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b62da-581">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b62da-581">AzureRM.Resources</span></span>
* <span data-ttu-id="b62da-582">Roleassignment ve roledefinition cmdlet’leri güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="b62da-582">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="b62da-583">Disk belleğinin parçası olarak yapılan ek roledefinition çağrıları kaldırıldı.</span><span class="sxs-lookup"><span data-stu-id="b62da-583">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="b62da-584">Get-AzureRmRoleAssignment cmdlet’i düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-584">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="b62da-585">-ExpandPrincipalGroups komut parametresi işlevselliği düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-585">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="b62da-586">'-ResourceType' parametresinin büyük/küçük harfe duyarlı olduğu 'Get-AzureRmResource' sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-586">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="b62da-587">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b62da-587">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b62da-588">Liste cmdlet’lerine top ve skip parametreleri eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-588">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="b62da-589">Standard'dan Premium NameSpace'e geçiş cmdlet’leri eklendi :</span><span class="sxs-lookup"><span data-stu-id="b62da-589">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="b62da-590">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b62da-590">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b62da-591">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b62da-591">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b62da-592">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b62da-592">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b62da-593">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b62da-593">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b62da-594">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b62da-594">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="b62da-595">PSServiceBusDRConfigurationAttributes sınıfına, çoğaltma işlemi sürerken beklemede olan çoğaltma işlemi sayısını veren salt okunur 'PendingReplicationOperationsCount' özelliği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-595">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="b62da-596">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b62da-596">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="b62da-597">'New-AzureRmServiceFabricCluster' için örnek güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-597">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b62da-598">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-598">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-599">Müşterilerin Sql Server örneğine veya Yönetilen Örneğe TDE Sertifikası ekleyebilmeleri için yeni Management.Sql Cmdlet’leri eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-599">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="b62da-600">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="b62da-600">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="b62da-601">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="b62da-601">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b62da-602">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b62da-602">AzureRM.Websites</span></span>
* <span data-ttu-id="b62da-603">Artık `Set-AzureRmWebApp -AssignIdentity` ve `Set-AzureRmWebAppSlot -AssignIdentity` false olarak ayarlandığında site object.Removing önizleme etiketinden Identity özelliğini kaldırıyor.</span><span class="sxs-lookup"><span data-stu-id="b62da-603">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="b62da-604">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` örneği güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-604">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="b62da-605">`Set-AzureRmWebApp -PhpVersion` geçerli bir php sürümü off değerini destekliyor</span><span class="sxs-lookup"><span data-stu-id="b62da-605">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="b62da-606">6.4.0 - Temmuz 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-606">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="b62da-607">Genel</span><span class="sxs-lookup"><span data-stu-id="b62da-607">General</span></span>
* <span data-ttu-id="b62da-608">Modüllerin çoğu için yardım dosyalarındaki OutputType biçimlendirmesi düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-608">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="b62da-609">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-609">AzureRM.Profile</span></span>
* <span data-ttu-id="b62da-610">Temel çıkış türlerine Ps1Xml özniteliği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-610">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b62da-611">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-611">AzureRM.Compute</span></span>
* <span data-ttu-id="b62da-612">VMSS için IP Etiketi özelliği</span><span class="sxs-lookup"><span data-stu-id="b62da-612">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="b62da-613">'New-AzureRmVmssIpTagConfig' cmdlet'i eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-613">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="b62da-614">New-AzureRmVmssIpConfig cmdlet'ine IpTag parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-614">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="b62da-615">VMSS için Otomatik İşletim Sistemi Geri Alma özelliği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-615">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="b62da-616">New-AzureRmVmssConfig ve Update-AzureRmVmss cmdlet'lerine DisableAutoRollback parametreleri eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-616">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="b62da-617">VMSS için İşletim Sistemi Yükseltme Geçmişi özelliği</span><span class="sxs-lookup"><span data-stu-id="b62da-617">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="b62da-618">Get-AzureRmVmss cmdlet'ine OSUpgradeHistory anahtarı parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-618">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="b62da-619">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="b62da-619">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="b62da-620">Aşağıdaki komutlarla Katalog ACL'si için destek eklendi:</span><span class="sxs-lookup"><span data-stu-id="b62da-620">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="b62da-621">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b62da-621">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="b62da-622">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b62da-622">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="b62da-623">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b62da-623">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b62da-624">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b62da-624">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b62da-625">Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry ve Set-AzureRmDataLakeStoreItemAcl için iptal desteği ve ilerleme izleme özelliği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-625">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="b62da-626">Export-AzureRmDataLakeStoreChildItemProperties için iptal desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-626">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="b62da-627">Özyinelemeli işlemler gerçekleştiren cmdlet'ler için hata ayıklama iletilerinin boşaltılması hatası düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-627">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="b62da-628">DataLake cmdlet'lerinin test konumu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-628">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b62da-629">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b62da-629">AzureRM.EventHub</span></span>
* <span data-ttu-id="b62da-630">Get-AzureRmEventHub ve Get-AzureRmEventHubConsumerGroup Listeleme İşlemleri cmdlet'lerine İsteğe Bağlı MaxCount parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-630">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="b62da-631">New-AzureRmEventHub cmdlet'inde yeni Olay Hub'ı oluşturma sırasında en az bir parametreye ihtiyaç duyma sorunu düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-631">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="b62da-632">Varsayılan Parametre kümesi sağlandı.</span><span class="sxs-lookup"><span data-stu-id="b62da-632">Provided Default Parameter set.</span></span>
* <span data-ttu-id="b62da-633">Kullanıcının New-AzureRmEventHubKey cmdlet'ine KeyValue eklemesini sağlayan isteğe bağlı -KeyValue parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-633">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-634">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-634">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b62da-635">Get-AzureRmKeyVault -Tag ile tüm kaynakların döndürülmesine neden olan sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-635">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b62da-636">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-636">AzureRM.Network</span></span>
* <span data-ttu-id="b62da-637">Zone-Redundant VirtualNetworkGateways için yeni SKU'lar kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="b62da-637">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="b62da-638">ARM aracılığıyla ExpressRoute Partner API'leri özelliği için yeni komutlar eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-638">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="b62da-639">Get-AzureRmExpressRouteCrossConnection eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-639">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="b62da-640">Set-AzureRmExpressRouteCrossConnection eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-640">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="b62da-641">Add-AzureRmExpressRouteCrossConnectionPeering eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-641">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b62da-642">Get-AzureRmExpressRouteCrossConnectionPeering eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-642">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b62da-643">Remove-AzureRmExpressRouteCrossConnectionPeering eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-643">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b62da-644">Get-AzureRMExpressRouteCrossConnectionArpTable eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-644">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="b62da-645">Get-AzureRMExpressRouteCrossConnectionRouteTable eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-645">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="b62da-646">Get-AzureRMExpressRouteCrossConnectionRouteTableSummary eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-646">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b62da-647">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="b62da-647">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b62da-648">Get-AzureRmRecoveryServicesBackupStatus cmdlet'i eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-648">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="b62da-649">Bu cmdlet bir sanal makinenin kimliğini alır ve sanal makinenin abonelik içindeki kasaların koruması altında olup olmadığını denetler.</span><span class="sxs-lookup"><span data-stu-id="b62da-649">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="b62da-650">Böyle bir kasa varsa cmdlet, bu kasanın ayrıntılarını belirtir.</span><span class="sxs-lookup"><span data-stu-id="b62da-650">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b62da-651">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b62da-651">AzureRM.Resources</span></span>
* <span data-ttu-id="b62da-652">Get-AzureRmPolicyAssignment cmdlet'leri güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="b62da-652">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="b62da-653">Yönetim grubu düzeyinde -Scope değerlerini listeleme desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-653">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="b62da-654">Yönetim grubu düzeyinde -Scope değerlerine sahip olan tek atamaları alma desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-654">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="b62da-655">control parametresine -Effective ve -All anahtarları eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-655">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="b62da-656">Get/New/Remove/Set-AzureRmPolicyDefinition cmdlet'leri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-656">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="b62da-657">Belirli bir yönetim grubuna işlem uygulamayı sağlayan için -ManagementGroupName parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-657">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="b62da-658">Belirli bir aboneliğe işlem uygulamayı sağlayan Add -SubscriptionId parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-658">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="b62da-659">Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlet'leri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-659">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="b62da-660">Belirli bir yönetim grubuna işlem uygulamayı sağlayan -ManagementGroupName parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-660">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="b62da-661">Belirli bir aboneliğe işlem uygulamayı sağlayan Add -SubscriptionId parametresi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-661">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="b62da-662">'New-AzureRmResourceGroupDeployment' içinde 'TemplateParameterObject' kullanırken parametrelerde KeyVault gizli dizi başvurusu desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-662">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="b62da-663">'New-AzureRmADAppCredential' için '-EndDate' parametresinin yoksayılmasına neden olan sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-663">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="b62da-664">'Add-AzureRmADGroupMember' cmdlet'inin istekte bulunmak için yanlış URL'yi kullandığı sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-664">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="b62da-665">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b62da-665">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b62da-666">Kullanıcının New-AzureRmServiceBusKey cmdlet'ine KeyValue eklemesini sağlayan isteğe bağlı -KeyValue parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-666">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b62da-667">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-667">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-668">New-AzureRmSqlDatabaseRestorePoint yardımında Kullanıcı Tanımlı Geri Yükleme Noktaları netleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-668">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="b62da-669">Birden fazla cmdlet'te -ComputeGeneration parametresinin belgeleri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-669">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="b62da-670">6.3.0 - Haziran 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-670">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b62da-671">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-671">AzureRM.Profile</span></span>
* <span data-ttu-id="b62da-672">Enable-AzureRmContextAutoSave için hata iletileri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-672">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="b62da-673">'Connect-AzureRmAccount' cmdlet'i eski bir bağlam olmadan çalıştırıldığında her abonelik için bir bağlam oluşturur</span><span class="sxs-lookup"><span data-stu-id="b62da-673">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b62da-674">Azure Depolama</span><span class="sxs-lookup"><span data-stu-id="b62da-674">Azure.Storage</span></span>
* <span data-ttu-id="b62da-675">Yardım dosyalarına -Permissions parametresi hakkında daha fazla bilgi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-675">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b62da-676">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-676">AzureRM.Compute</span></span>
* <span data-ttu-id="b62da-677">'Get-AzureRmVmDiskEncryptionStatus' için veri diski bulunmayan VM'lerde karşılaşılan bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-677">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="b62da-678">Aşağıdaki cmdlet'leri düzeltmek için bilgisayar istemci kitaplığı sürümü güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-678">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="b62da-679">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="b62da-679">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="b62da-680">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="b62da-680">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="b62da-681">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="b62da-681">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="b62da-682">Aşağıdaki cmdlet'ler 'operation ID' ve 'operation status' bilgilerini doğru gösterecek şekilde düzeltildi:</span><span class="sxs-lookup"><span data-stu-id="b62da-682">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="b62da-683">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b62da-683">Start-AzureRmVM</span></span>
    - <span data-ttu-id="b62da-684">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b62da-684">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="b62da-685">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b62da-685">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="b62da-686">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b62da-686">Set-AzureRmVM</span></span>
    - <span data-ttu-id="b62da-687">Remove-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b62da-687">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="b62da-688">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b62da-688">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="b62da-689">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="b62da-689">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="b62da-690">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="b62da-690">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="b62da-691">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b62da-691">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="b62da-692">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b62da-692">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="b62da-693">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b62da-693">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="b62da-694">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b62da-694">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="b62da-695">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="b62da-695">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="b62da-696">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="b62da-696">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="b62da-697">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="b62da-697">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="b62da-698">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="b62da-698">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="b62da-699">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="b62da-699">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="b62da-700">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="b62da-700">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="b62da-701">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="b62da-701">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="b62da-702">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="b62da-702">AzureRM.EventGrid</span></span>
* <span data-ttu-id="b62da-703">Gerekli olması halinde parametrelerin boş dizeyle değiştirilmesine izin vermek için Update-AzureRmEventGridSubscription cmdlet'i içindeki SubjectBeginsWith/SubjectEndsWith için ValidateNotNullOrEmpty doğrulama koşulları kaldırıldı.</span><span class="sxs-lookup"><span data-stu-id="b62da-703">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-704">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-704">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b62da-705">Get-AzureRmKeyVault -Tag çalıştırıldığında etiket döndürülmeme sorunu düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-705">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="b62da-706">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="b62da-706">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="b62da-707">Policy Insights cmdlet'leri genel kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="b62da-707">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="b62da-708">API 2018-04-04 sürümünü kullanın</span><span class="sxs-lookup"><span data-stu-id="b62da-708">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="b62da-709">PolicyDefinitionReferenceId, Get-AzureRmPolicyStateSummary sonuçlarına eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-709">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b62da-710">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="b62da-710">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b62da-711">RecoveryServices.Backup cmdlet'lerine -Vault parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-711">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="b62da-712">Bu parametre iletildiğinde Set-AzureRmRecoveryServicesContext cmdlet'ini geçersiz kılar.</span><span class="sxs-lookup"><span data-stu-id="b62da-712">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b62da-713">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-713">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-714">Yardım dosyasındaki Get-AzureRmSqlDatabaseExpanded örneği güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-714">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b62da-715">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b62da-715">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b62da-716">Yardım dosyasındaki Add-AzureRmTrafficManagerEndpointConfig bölümü güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-716">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b62da-717">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b62da-717">AzureRM.Websites</span></span>
* <span data-ttu-id="b62da-718">'Set-AzureRmWebApp', -AssignIdentity kullanıldığında AppSettings verilerini geçersiz kılmayacak şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-718">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="b62da-719">'New-AzureRmWebAppSlot', isteğe bağlı parametre olarak AppServicePlan girişini kabul edecek şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-719">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="b62da-720">6.2.1 - Haziran 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-720">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="b62da-721">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="b62da-721">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="b62da-722">PSWorkspace modeli Network için tür parametresini kullanacak şekilde güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-722">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="b62da-723">6.2.0 - Haziran 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-723">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b62da-724">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-724">AzureRM.Profile</span></span>
* <span data-ttu-id="b62da-725">Modülün içeri aktarılması sırasında Newtonsoft.Json 10.0.3 sürümünün yüklenmemesine ilişkin sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-725">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b62da-726">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b62da-726">AzureRM.Compute</span></span>
* <span data-ttu-id="b62da-727">VMSS VM Güncelleştirme özelliği</span><span class="sxs-lookup"><span data-stu-id="b62da-727">VMSS VM Update feature</span></span>
    - <span data-ttu-id="b62da-728">'Update-AzureRmVmssVM' ve 'New-AzureRmVMDataDisk' cmdlet’leri eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-728">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="b62da-729">VMSS VM’sine veri diski eklemeyi desteklemek için 'Add-AzureRmVMDataDisk' cmdlet’ine VirtualMachineScaleSetVM parametresi eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-729">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b62da-730">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b62da-730">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="b62da-731">ADF .Net SDK sürümü, aşağıdaki değişiklikleri içeren 0.8.0-preview sürümüne güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="b62da-731">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="b62da-732">Fabrika deposunu yapılandırma işlemi eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-732">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="b62da-733">QuickBooks LinkedService, consumerKey ve consumerSecret özelliklerini kullanıma sunmak üzere güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-733">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="b62da-734">SecretBase’ten Object’e birkaç model türü güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-734">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="b62da-735">Blob Etkinliklerini tetikleme eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-735">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="b62da-736">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b62da-736">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b62da-737">Belgeler örnek çıktı ile güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-737">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="b62da-738">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-738">AzureRM.Network</span></span>
* <span data-ttu-id="b62da-739">Ağ İzleyicisi cmdlet’leri üzerindeki Trafik Analizi parametreleri etkinleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-739">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b62da-740">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b62da-740">AzureRM.Resources</span></span>
* <span data-ttu-id="b62da-741">'Get-AzureRmResource' cmdlet’inden döndürülen 'PSResource' nesnesinin 'Properties' özelliğiyle ilgili bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-741">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="b62da-742">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="b62da-742">AzureRM.Scheduler</span></span>
* <span data-ttu-id="b62da-743">Güncelleştirilen ServiceBusQueueJob’ın yeni Kimlik Doğrulaması değerlerini ayarlamamasıyla ilgili bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-743">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="b62da-744">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-744">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-745">Şu cmdlet’ler isteğe bağlı LicenseType parametresiyle güncelleştirildi:</span><span class="sxs-lookup"><span data-stu-id="b62da-745">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="b62da-746">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b62da-746">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b62da-747">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b62da-747">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b62da-748">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b62da-748">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b62da-749">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b62da-749">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b62da-750">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b62da-750">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b62da-751">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b62da-751">AzureRM.Websites</span></span>
* <span data-ttu-id="b62da-752">'New-AzureRMWebApp' Strategy kütüphanesindeki ortak algoritmaları kullanmak üzere güncelleştirildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-752">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="b62da-753">6.1.0 - Mayıs 2018</span><span class="sxs-lookup"><span data-stu-id="b62da-753">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b62da-754">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b62da-754">AzureRM.Profile</span></span>
* <span data-ttu-id="b62da-755">'Clear-AzureRmContext' komutunun çalıştırılmasının boş bir bağlamı önceki varsayılan bağlamın adıyla tutmasına ve böylece kullanıcının eski ad ile yeni bir bağlam oluşturamadığı bir sorun düzeltildi</span><span class="sxs-lookup"><span data-stu-id="b62da-755">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="b62da-756">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="b62da-756">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="b62da-757">AS’de Ağ geçidi ilişkilendirme/ilişkilendirme kaldırma işlemlerini etkinleştirin.</span><span class="sxs-lookup"><span data-stu-id="b62da-757">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="b62da-758">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b62da-758">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="b62da-759">ApiVersions, ApiReleases ve ApiRevisions desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-759">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="b62da-760">ServiceFabric Arka Ucu desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-760">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="b62da-761">Application Insights Günlükçüsü desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-761">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="b62da-762">‘Temel’ sku’yu Api Yönetim hizmetinin geçerli sku’su olarak algılama desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-762">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="b62da-763">Özel CA tarafından Kök veya CA olarak yayınlanan Sertifikaları yükleme desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-763">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="b62da-764">Özel SSL sertifikalarını KeyVault ve Çoklu ara sunucu ana bilgisayar adlarıyla kabul etme desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-764">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="b62da-765">MSI kimliği desteği eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-765">Added support for MSI identity</span></span>
* <span data-ttu-id="b62da-766">İlkeleri Url ile kabul etme desteği eklendi NOT: Aşağıdaki cmdlet’ler gelecekteki sürümlerde kullanım dışı kalacaktır</span><span class="sxs-lookup"><span data-stu-id="b62da-766">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="b62da-767">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="b62da-767">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="b62da-768">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="b62da-768">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="b62da-769">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="b62da-769">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="b62da-770">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="b62da-770">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="b62da-771">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="b62da-771">AzureRM.Batch</span></span>
* <span data-ttu-id="b62da-772">Yeni Get-AzureBatchPoolNodeCounts cmdlet’ini yayınlama</span><span class="sxs-lookup"><span data-stu-id="b62da-772">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="b62da-773">Yeni AzureBatchComputeNodeServiceLogUpload cmdlet’ini yayınlama</span><span class="sxs-lookup"><span data-stu-id="b62da-773">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="b62da-774">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="b62da-774">AzureRM.Consumption</span></span>
* <span data-ttu-id="b62da-775">Get-AzureRmConsumptionUsageDetail cmdlet’inde yeni Expand, ResourceGroup, InstanceName, InstanceId, Tags ve Top parametrelerini ekleme</span><span class="sxs-lookup"><span data-stu-id="b62da-775">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b62da-776">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b62da-776">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b62da-777">Export-AzureRmDataLakeStoreChildItemProperties için düzeltme örneği</span><span class="sxs-lookup"><span data-stu-id="b62da-777">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="b62da-778">Set-AzureRmDataLakeStoreItemAclEntry komutunda Özyineleme durumu için null parametresi özel durumunu düzeltme</span><span class="sxs-lookup"><span data-stu-id="b62da-778">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="b62da-779">Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry’ye yönelik yardım dosyalarını düzeltme</span><span class="sxs-lookup"><span data-stu-id="b62da-779">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="b62da-780">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b62da-780">AzureRM.Network</span></span>
* <span data-ttu-id="b62da-781">Ağ SDK sürümünü 18.0.0-önizleme’den 19.0.0-önizlemeye yükseltme</span><span class="sxs-lookup"><span data-stu-id="b62da-781">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="b62da-782">Protokol yapılandırması oluşturma cmdlet’i eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-782">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="b62da-783">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="b62da-783">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="b62da-784">Varolan express route bağlantı hattına yeni bir bağlantı hattı ekleme cmdlet’i eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-784">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="b62da-785">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b62da-785">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b62da-786">Varolan express route bağlantı hattındaki bir bağlantı hattı bağlantısını kaldırma cmdlet’i eklendi.</span><span class="sxs-lookup"><span data-stu-id="b62da-786">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="b62da-787">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b62da-787">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b62da-788">Bağlantı hattı bağlantısı alma cmdlet’i eklendi</span><span class="sxs-lookup"><span data-stu-id="b62da-788">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="b62da-789">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b62da-789">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="b62da-790">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b62da-790">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="b62da-791">Oluşturulan sertifikalarla sunucu kimlik doğrulaması kullanımı düzeltildi (Sorun No. 5998)</span><span class="sxs-lookup"><span data-stu-id="b62da-791">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b62da-792">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b62da-792">AzureRM.Sql</span></span>
* <span data-ttu-id="b62da-793">AuditActions veya AuditActionGroups’un kaldırılmasını sağlamak üzere Denetim cmdlet’leri güncelleştirildi</span><span class="sxs-lookup"><span data-stu-id="b62da-793">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="b62da-794">Yeni bir esnek saklama ilkesi ayarlarken komutun ‘Azure kurtarma hizmeti kasası ve ilkesiyle uzun süreli saklama ilkesini yapılandırma artık desteklenmiyor. Lütfen yeni esnek saklama ilkesi ile istek gönderin’ hatasını verdiği Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="b62da-794">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="b62da-795">komutuna ilişkin sorun düzeltildi.</span><span class="sxs-lookup"><span data-stu-id="b62da-795">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="b62da-796">Ölçek ve katman ilişkili özelliklere yönelik Sku özelliğini destekleyen yeni Veritabanı API’sini kullanmak için tüm Azure Sql Database/ElasticPool Creation/Update cmdlet’lerini güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="b62da-796">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="b62da-797">Güncelleştirilen cmlet’ler arasında şunlar yer almaktadır:</span><span class="sxs-lookup"><span data-stu-id="b62da-797">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="b62da-798">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b62da-798">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b62da-799">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b62da-799">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b62da-800">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b62da-800">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b62da-801">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b62da-801">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b62da-802">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b62da-802">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b62da-803">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b62da-803">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b62da-804">-Name parametresini kullanırken -ResourceGroupName parametresinin gerekli olması için 'Get-AzureRmTrafficManagerProfile'a yönelik parametreleri güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="b62da-804">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
