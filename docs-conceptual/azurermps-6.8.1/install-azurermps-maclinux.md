...
.NET Core için Azure PowerShell modülleri geliştirme aşamasındadır. Bu modüller, modüllerin Windows sürümünde kullanılabilecek tüm cmdlet'leri sağlamaz. AzureRM.Netcore modüllerine aşağıdaki işlevler uygulanmıştır:
...
* Azure hizmetleri için Resource Manager ve klasik dağıtım modeli arabirimlerini kullanan yönetim düzlemi cmdlet'leri.
  * Sanal Makine
