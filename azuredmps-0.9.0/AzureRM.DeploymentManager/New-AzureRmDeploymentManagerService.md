...
## Tanım
**Yeni-AzureRmDeploymentManagerService** cmdlet 'i hizmet topolojisi altında bir hizmet oluşturur ve bu hizmeti temsil eden bir nesne döndürür.
Hizmeti adına, hizmet topolojisine ve kaynak grubu adına göre belirtin. 

Cmdlet bir hizmet nesnesi döndürür. Bu nesneyi yerel olarak değiştirebilir ve Set-AzureRmDeploymentManagerService cmdlet 'ini kullanarak değişiklikleri hizmete uygulayabilirsiniz.
