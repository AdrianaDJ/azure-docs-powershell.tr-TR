...
## SYNOPSIS
Ad alanı/eventhub için Azure eventhub yetkilendirme kuralı için SAS belirteci oluşturur. 
...
## Tanım
New-AzEventHubAuthorizationRuleSASToken cmdlet 'i Azure Eventhub ad sapce veya Azure Eventhub için paylaşılan bir erişim Imzası (SAS) belirteci oluşturur
...
### Microsoft. Azure. Commands. EventHub. modeller. Pssharedaccesstifreattributes
