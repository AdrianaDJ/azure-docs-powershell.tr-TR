...
## Tanım
Get-AzNetworkWatcherConnectionMonitorReport cmdlet 'i, raporu en son bağlantı durumlarına getirir.

## ÖRNEKLERDEN

### ---------------Örnek 1: bağlantı izlemenin en son bağlantı anlık görüntüsünü belirtilen konumda ada göre alın---------------
```
...
Bu örnekte, belirtilen bağlantı izleyicisini en son bağlantı durumlarını sorgulıyoruz.
...
### Microsoft. Azure. Commands. Network. model. PSConnectionMonitorQueryResult
