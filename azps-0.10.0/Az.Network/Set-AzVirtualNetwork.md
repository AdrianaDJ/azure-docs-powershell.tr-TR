...
## Tanım
**Set-AzVirtualNetwork** cmdlet 'ı bir Azure sanal ağının hedef durumunu ayarlar.
...
Bu örnek, iki alt ağ içeren bir sanal ağ oluşturur. Ardından sanal ağın bellekteki gösteriminden bir alt ağ kaldırır. Ardından, hizmet tarafında değiştirilmiş sanal ağ durumunu yazmak için Set-AzVirtualNetwork cmdlet 'i kullanılır.
...
### -VirtualNetwork
Hedef durumu temsil eden bir **VirtualNetwork** nesnesi belirtir.
