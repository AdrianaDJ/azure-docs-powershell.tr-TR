...
## Tanım
**Set-Azanahtarvaultcertificateattribute** cmdlet 'i, bir sertifikanın düzenlenebilir özniteliklerini değiştirir.
...
Final komutu, işlemi doğrulamak için Get-AzKeyVaultCertificate cmdlet 'ini kullanarak TestCert01 sertifikasını görüntüler.
