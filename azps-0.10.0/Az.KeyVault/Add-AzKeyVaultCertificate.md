...
## Tanım
**Add-Azanahtarvaultcertificate** cmdlet 'ı, Azure Anahtar Kasası 'ndaki bir anahtar kasasına sertifika için kaydolma işlemini başlatır.

## ÖRNEKLERDEN

### Örnek 1: sertifika ekleme
```
...
İlk komut, sertifika ilkesi oluşturmak için New-AzKeyVaultCertificatePolicy cmdlet 'ini kullanır ve sonra $Policy değişkeninde depolar.

İkinci komut, bir sertifika oluşturma işlemini başlatmak için **Add-Azanahtarvaultcertificate** kullanır.

Üçüncü komut, işlemin tamamlandığını doğrulamak için Get-AzKeyVaultCertificateOperation cmdlet 'ini kullanır.

Final komutu, sertifikayı almak için Get-AzKeyVaultCertificate cmdlet 'ini kullanır.

## PARAMETRELERINE

### -CertificatePolicy
Bir **Keyvaultcertificatepolicy** nesnesi belirtir.
...
### -Ad
Eklenecek sertifikanın adını belirtir.
...
### Microsoft. Azure. Commands. Keykasa. modeller. KeyVaultCertificateOperation
