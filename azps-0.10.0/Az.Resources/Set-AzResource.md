...
## Tanım
**Set-Azkaynak** cmdlet 'i mevcut bir Azure kaynağını değiştirir.
...
İlk komut, Get-AzResource cmdlet 'ini kullanarak ContosoSite adlı kaynağı alır ve $Resource değişkeninde depolar.
İkinci komut $Resource özelliğini değiştirir.
Son komutu $Resource eşleşecek şekilde güncelleştirir.

### Örnek 2: belirli bir kaynak grubundaki tüm kaynakları değiştirme
```
...
İlk komut, testrg kaynak grubundaki kaynakları alır ve $Resource değişkeninde depolar.

İkinci komut, kaynak grubundaki bu kaynakların her birinin üzerinde dolaşır ve bunlara yeni bir etiket ekler.

Son komutu bu kaynakların her birini güncelleştirir.
...
Örneğin, uzantı kaynağı bir veritabanıdır, aşağıdakileri belirtin: `Microsoft.Sql/Servers/Databases`
...
### -InputObject
Güncelleştirilecek kaynağın nesne gösterimi.
...
### Microsoft. Azure. Commands. ResourceManager. model. PSResource
