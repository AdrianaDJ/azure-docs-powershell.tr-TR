...
## Tanım
**Remove-AzDnsRecordConfig** cmdlet 'i, bir kayıt kümesinden etki alanı adı SISTEMI (DNS) kaydını kaldırır.
...
Kayıt kümesini tümüyle kaldırmak için Remove-AzDnsRecordSet ' e bakın.
...
Bu, kayıt kümesinin çevrimdışı temsilidir ve ayarla-AzDnsRecordSet 'i çalıştırana kadar DNS yanıtlarını değiştirmiyor.
