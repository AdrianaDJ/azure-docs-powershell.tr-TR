...
### Geistdedinfobyresourceıdparameterset
```
Get-AzDataBoxEdgeDevice -ResourceId <String> [-ExtendedInfo] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### Getnetworksettingbyresourceıdparameterset
```
Get-AzDataBoxEdgeDevice -ResourceId <String> [-NetworkSetting] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### Getsummaryupdatebyresourceıdparameterset
```
Get-AzDataBoxEdgeDevice -ResourceId <String> [-UpdateSummary] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### Getalertbyresourceıdparameterset
```
...
## Tanım
**Get-AzDataBoxEdgeDevice** cmdlet 'ı kullanılabilir veri kutusu uç aygıtları hakkında bilgi alır. Belirli bir cihazda bilgileri almak için kaynak grubu adıyla birlikte aygıtın adını belirtebilirsiniz. 
...
### -Uyarı
Veri kutusu kenarı/ağ geçidi cihazında uyarıları getirme
...
### -Extendeınfo
Belirtilen veri kutusu kenarı/veri kutusu ağ geçidi cihazı için ek bilgi alır
...
### -NetworkSetting
Belirtilen veri kutusunun uç/veri kutusu ağ geçidi aygıtının ağ ayarlarını alır
...
### -UpdateSummary
Cihazın son taramasını temel alarak güncelleştirmelerin kullanılabilirliği hakkında bilgi alır. Ayrıca, cihazda devam eden indirme ve yükleme işleri hakkında bilgi alır.
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDAtaboxedgedeviceextendeınfo
