...
## Tanım
**Get-AzDataBoxEdgeUser** cmdlet 'ı bir veri kutusu uç aygıtı için yapılandırılmış kullanıcıları listeler. Belirli bir kullanıcının ayrıntılarını almak için parametrelerde adın bahsetmeye başlayabilirsiniz.
