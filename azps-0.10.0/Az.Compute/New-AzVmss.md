...
Bu cmdlet giriş olarak bir **VirtualMachineScaleSet** nesnesi alır.

## ÖRNEKLERDEN

### Örnek 1: VMSS oluşturma
```
# Common
$LOC = "WestUs";
$RGName = "rgkyvms";
...
Aşağıdaki karmaşık örnek bir VMSS oluşturur.
...
### -DomainNameLabel
Bu ölçek kümesi için genel Fully-Qualified etki alanı adı (FQDN) için etki alanı adı etiketi. Bu, etki alanı adının ölçek kümesinin otomatik olarak assiged ilk bileşenidir. Otomatik olarak atanan etki alanı adları formu ( <DomainNameLabel> . <Location> . cloudapp.azure.com). Değer sağlanmadıysa, varsayılan etki alanı adı etiketi <ScaleSetName> ve <ResourceGroupName> .
...
### -Frontenvseçpoolname
Ölçek kümesi locad dengeleyicisinde kullanılan ön uç adres havuzunun adı.  Değer sağlanmadıysa, ölçek kümesiyle aynı ada sahip yeni bir ön uç adres havuzu oluşturulur.
