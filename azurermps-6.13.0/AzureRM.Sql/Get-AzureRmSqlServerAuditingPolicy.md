...
## Tanım
**Get-AzureRmSqlServerAuditingPolicy** cmdlet 'i, BIR Azure SQL Server 'ın denetim ilkesini alır.
Veritabanını tanımlamak için *Resourcegroupname* , *ServerName* ve *DatabaseName* parametrelerini belirtin.
Bu cmdlet, belirtilen Azure SQL Server 'da tanımlı olan Azure SQL veritabanları tarafından kullanılan bir ilkeyi döndürür ve denetim ilkesini kullanır.

## ÖRNEKLERDEN

### Örnek 1: bir Azure SQL Server 'ın üzerinde tablo denetimi tanımlanmış denetim ilkesini alma
```
...
### Örnek 2: blob denetimi tanımlanmış bir Azure SQL Server denetim ilkesini alma
```
PS C:\>Get-AzureRmSqlServerAuditingPolicy -ResourceGroupName "resourcegroup01" -ServerName "server01"
...
### -ServerName
Bu cmdlet 'in denetim ilkesini aldığı Azure SQL Server 'ın adını belirtir.
