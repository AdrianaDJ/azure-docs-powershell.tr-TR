...
## Tanım
**Get-AzureRmSqlDatabaseBackupLongTermRetentionPolicy** cmdlet 'i, bu veritabanına kaydedilen uzun süreli bekletme ilkesini alır.
...
### Örnek 2: uzun süreli bekletme ilkesinin eski sürümünü edinin
```powershell
...
Bu komut, database01 için uzun süreli bekletme ilkesinin eski sürümünü alır.

## PARAMETRELERINE

### -Geçerli
Sağlanmazsa, komut eski uzun süreli bekletme ilkesi bilgilerini döndürür.
Aksi takdirde komut, uzun süreli bekletme ilkesinin geçerli sürümünü döndürür.
