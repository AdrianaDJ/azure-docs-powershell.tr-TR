...
## Tanım
**Remove-AzureRmSqlSyncMember** cmdlet 'ı BIR Azure SQL veritabanı eşitleme üyesini kaldırır.

## ÖRNEKLERDEN

### Örnek 1: eşitleme üyesini kaldırma
```
...
Bu komut, syncMember01 adındaki Azure SQL veritabanı eşitleme üyesini kaldırır.
...
### -Geçiş
Kaldırılan eşitleme üyesini verip vermediğini tanımlar
