...
## Tanım
**Get-AzureRmSqlServerBackupLongTermRetentionVault** cmdlet 'i, bu sunucuya kaydedilen uzun süreli bekletme kasasından alır.
...
### -ServerName
Bu cmdlet 'in kasa aldığı sunucuyu belirtir.
