...
## Tanım
**Get-AzureRmSqlDatabaseAuditingPolicy** cmdlet 'i, BIR Azure SQL veritabanının denetim ilkesini alır.
Cmdlet 'i kullanmak için, *Resourcegroupname* , *ServerName* ve *DatabaseName* parametrelerini kullanarak veritabanını belirleyin.

## ÖRNEKLERDEN

### Örnek 1: bir Azure SQL veritabanının denetim ilkesini, üzerinde tablo denetimi tanımlanmış olarak alma
```
...
### Örnek 2: blob denetimi tanımlanmış bir Azure SQL veritabanının denetim ilkesini alma
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
