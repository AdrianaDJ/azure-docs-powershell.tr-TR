...
## Tanım
Test-AzureRmAnalysisServicesServer cmdlet 'i Analysis Services sunucusu örneğinin varlığını sınar
...
Resourcegroup testgroup 'ta TestServer adlı bir sunucu varsa bu komut test edecektir
