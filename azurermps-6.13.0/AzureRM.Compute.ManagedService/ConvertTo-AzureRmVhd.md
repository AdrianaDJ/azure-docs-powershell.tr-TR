...
' Test ' adlı Hyper-V VM 'yi geçerli klasöre Azure desteklenen sanal sabit disk dosyalarına dönüştürün.
...
### -ExportPath
Disk dosyalarını içerecek olan dışarı aktarma klasörü yolu.
...
### -Force
Var olan klasör bulunsa bile dışarı aktarmayı zorlayın.
...
### -HyperVServer
Varsayılan değer olarak ' localhost ' içeren Hyper-V sunucusu DNS adı.
