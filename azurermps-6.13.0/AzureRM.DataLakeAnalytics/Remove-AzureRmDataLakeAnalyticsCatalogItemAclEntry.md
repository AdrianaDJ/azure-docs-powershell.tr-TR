...
## Tanım
**Remove-Azurermdatalakeanalyzer Tic, Alogitemacbir** cmdlet 'ı, Data Lake Analytics 'teki bir kataloğun veya katalog öğesinin erişim denetim LISTESINDEN (ACL) kaldırır.
