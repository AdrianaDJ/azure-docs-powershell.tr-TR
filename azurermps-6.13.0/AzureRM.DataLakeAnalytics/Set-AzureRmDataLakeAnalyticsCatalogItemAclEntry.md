...
## Tanım
**Set-Azurermdatalakeanalizticdağıda** , Data Lake Analytics 'teki bir kataloğun veya katalog öğesinin erişim denetim lıstesıne (ACL) GIRIŞ (ACE) ekler veya değiştirir.
