...
## Tanım
Remove-AzureRmDataLakeAnalyticsCatalogCredential cmdlet 'i bir Azure Data Lake Analytics kataloğu kimlik bilgisini siler.
...
Bu komut, belirtilen Data Lake Analytics Katalog kimlik bilgisini kaldırır.
...
### -DatabaseName
Kimlik bilgilerini tutan veritabanının adını belirtir.
...
### -Geçiş
Bu cmdlet 'in işlemin tamamlanmasını beklemediğini belirtir.
...
### -Parola
Kimlik bilgisinin parolası.
Arayan hesabın sahibi değilse bu gereklidir.
...
### -Recurse
Bu silme işleminin, bu kimlik bilgilerine bağımlı olan tüm kaynakları silip, sonra da silmesi gerektiğini belirtir.
