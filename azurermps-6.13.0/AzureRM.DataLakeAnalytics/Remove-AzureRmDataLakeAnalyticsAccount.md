...
## Tanım
**Remove-Azurermdatalakeanalizizsaccount** cmdlet 'i, bir Azure Data Lake Analytics hesabını kalıcı olarak siler.
...
Bu komut, belirtilen Data Lake Analytics hesabını kaldırır.
