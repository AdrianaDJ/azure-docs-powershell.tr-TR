...
Yeni Application Insights sürekli dışarı aktarma yapılandırması "Istek" ve "Izleme" belge türlerini depolama alanına "testgroup" kaynak grubundaki "teststorageaccount" depolama hesabında "testcontainer" içerir. SAS belirtecinin geçerli olması ve kapsayıcıya yazma izni olması gerekir, aksi takdirde dışarı aktarma özelliği çalışmaz. SAS belirtecinin süresi dolduysa, sürekli dışarı aktarma özelliği çalışmayı durdurur.
