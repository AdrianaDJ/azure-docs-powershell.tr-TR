...
### Örnek 1 Application Insights kaynağında birlikte gelen bir dışarı aktarma yapılandırmasını kaldırma
```
...
"Testgroup" kaynak grubundaki "test" adlı kaynak için "uGOoki0jQsyEs3IdQ83Q4QsNr4
