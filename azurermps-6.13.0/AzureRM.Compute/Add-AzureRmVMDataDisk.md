...
## SYNOPSIS
Bir sanal makineye veya bir VMSS VM 'ye veri diski ekler.
...
## Tanım
**Add-Azurermvmdatadısk** cmdlet 'i, bir sanal makineye veya bir VMSS VM 'ye veri diski ekler.
...
### Örnek 5: bir VMSS VM 'ye yönetilen veri diski ekleyin.
```
...
Sanal makine ölçeği kümesi VM nesnesini edinmek için **Get-AzureRmVmssVM** cmdlet 'ini kullanabilirsiniz.
