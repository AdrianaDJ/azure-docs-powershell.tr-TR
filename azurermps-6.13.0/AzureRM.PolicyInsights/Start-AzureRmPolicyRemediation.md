...
## Tanım
**Start-AzureRmPolicyRemediation** cmdlet 'i belirli bir ilke ataması için bir ilke düzeltmesi oluşturur. Düzeltmenin kapsamının veya altındaki uyumlu olmayan tüm kaynaklar düzeltildi. Düzeltme yalnızca ' deployIfNotExists ' efektine sahip ilkelerde desteklenir.
