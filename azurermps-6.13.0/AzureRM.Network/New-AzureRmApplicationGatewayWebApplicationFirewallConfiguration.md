...
## Tanım
**New-AzureRmApplicationGatewayWebApplicationFirewallConfiguration** cmdlet 'ı bir Azure Application Gateway için Web uygulaması güvenlik duvarı (WAF) oluşturur.
