...
İlk komut, Gateway01 adlı bir sanal ağ ağ geçidini kaynak grubuna ait ResourceGroup001 alır ve bu değişkeni $Gateway ikinci komut değişken $Gateway
Komut ayrıca ASN 'yi 1337 'e ayarlar.

### Örnek 2: hedef durumunu ayarlama sanal ağ geçidi
```
PS C:\>$Gateway = Get-AzureRmVirtualNetworkGateway -ResourceGroupName "ResourceGroup001" -Name "Gateway001"
...
Üçüncü komut, değişken $Gateway depolanan sanal ağ geçidi için hedef durumunu ayarlar.
