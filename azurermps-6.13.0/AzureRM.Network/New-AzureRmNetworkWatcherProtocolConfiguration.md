...
## Tanım
New-AzureRmNetworkWatcherProtocolConfiguration cmdlet 'i yeni bir iletişim kuralı yapılandırma nesnesi oluşturur. Bu nesne, belirtilen ölçütleri kullanarak connecitivity denetleme oturumu sırasında protokol yapılandırması 'nı kısıtlamak için kullanılır. 
