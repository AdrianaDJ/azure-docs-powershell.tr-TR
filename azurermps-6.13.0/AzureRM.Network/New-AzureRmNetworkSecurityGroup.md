...
## Tanım
**New-AzureRmNetworkSecurityGroup** cmdlet 'ı bir Azure ağ güvenlik grubu oluşturur.

## ÖRNEKLERDEN

### 1: yeni ağ güvenlik grubu oluşturma
```
...
### 2: ayrıntılı ağ güvenlik grubu oluşturma
```
...
### System. Koleksiyonlar. Generic. LIST ' 1 [[Microsoft. Azure. Commands. Network. modeller. PSSecurityRule, Microsoft. Azure. Commands. Network, Version = 6.4.1.0, Culture = neutral, PublicKeyToken = null]]
