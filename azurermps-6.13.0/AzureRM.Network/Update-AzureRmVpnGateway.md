...
## SYNOPSIS
Update-AzureRmVpnGateway uygun hedef durumuna ölçeklenebilir bir VPN ağ geçidi güncelleştirir.
...
## Tanım
Update-AzureRmVpnGateway uygun hedef durumuna ölçeklenebilir bir VPN ağ geçidi güncelleştirir. AzureRmVpnGateway, VirtualHub içindeki site bağlantılarına site için tanımlanmış bir yazılımdır. Bu ağ geçidi, Kullanıcı tarafından belirtilen ölçek birimine göre yeniden boyutlandırır ve ölçekler. Bağlantı, VPNSite olarak bilinen bir daldan/siteden ölçeklenebilir ağ geçidine yüklenebilir. Her bağlantı 2 Active-Active tünelden oluşur
...
Ağ Geçidi oluşturulduktan sonra, ağ geçidini 3 ölçekli birimlere güncellemek için Set-AzureRmVpnGateway kullanır.
