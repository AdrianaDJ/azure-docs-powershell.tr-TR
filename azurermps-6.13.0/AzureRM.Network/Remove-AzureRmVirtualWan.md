...
Bu örnekte, kaynak grubunda sanal bir WAN oluşturulur ve hemen silinir. Bu silme işlemi, yeni-AzureRmVirtualWan tarafından döndürülen sanal WAN nesnesini kullanıyor.
...
Bu örnekte, kaynak grubunda sanal bir WAN oluşturulur ve hemen silinir. Bu silme işlemi, yeni-AzureRmVirtualWan tarafından döndürülen sanal WAN kaynak kimliğini kullanarak yapılır.
Sanal WAN silinirken istemi bastırmak için,-Force bayrağını kullanın.
