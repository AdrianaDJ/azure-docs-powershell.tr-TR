...
## Tanım
**Add-AzureRmLoadBalancerOutboundRuleConfig** cmdlet 'i, bir Azure yük dengeleyicisine giden bir kural yapılandırması ekler.
...
İkinci komut, yük dengeleyiciyi bir giden kural yapılandırması ekleyen **-AzureRmLoadBalancerOutboundRuleConfig** öğesini $SLB
