...
## Tanım
**Remove-AzureRmNetworkProfile** cmdlet 'i, bir ağ profilini (konteyner ağı arabirim **yapılandırmasına** uygun bir şekilde) oluşturduysa bir ağ profilini kaldırır.
