...
Site oluşturulduktan sonra Remove-AzureRmVpnSite komutu kullanılarak hemen kaldırılır.
...
Örnek 1 ile aynıdır, ancak buradan kaldırma işlemi Get-AzureRmVpnSite tarafından yöneltilen çıkışı kullanarak yapılır.
