...
## Tanım
Get-AzureRmVpnClientConfiguration, VPN istemcisinin indirileceği URL 'YI döndürür.
...
Daha önce New-AzureRMVpnClientConfiguration komutu kullanılarak oluşturulan bir VpnClient profilini indirmek için URL 'YI alır.
