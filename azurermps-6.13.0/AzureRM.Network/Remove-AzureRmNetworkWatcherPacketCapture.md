...
## Tanım
Remove-AzureRmNetworkWatcherPacketCapture paket yakalama kaynağını kaldırır. Remove-AzureRmNetworkWatcherPacketCapture ' i çağırmadan önce Stop-AzureRmNetworkWatcherPacketCapture çağrı yapmanız önerilir. Remove-AzureRmNetworkWatcherPacketCapture çağrıldığında paket yakalama oturumu çalışıyorsa, paket yakalama kaydedilmez. Oturum kaldırılmadan önce durdurulmuşsa, yakalama verilerini içeren. cap dosyası kaldırılmaz. 

## ÖRNEKLERDEN

### Örnek 1: paket yakalama oturumunu kaldırma
```
Remove-AzureRmNetworkWatcherPacketCapture -NetworkWatcher $networkWatcher -PacketCaptureName "PacketCaptureTest"
```

Bu örnekte, "PacketCaptureTest" adlı bir paket yakalama oturumu kaldırdık.
...
## NOTLARıNDA
Anahtar sözcükler: Azure, azurerm, ARM, kaynak, yönetim, yönetici, ağ, ağ, Ağ İzleyicisi, paket, yakalama, trafik, kaldır
