...
## Tanım
**Set-AzureRmVirtualNetwork** cmdlet 'ı bir Azure sanal ağının hedef durumunu ayarlar.
...
Bu örnek iki alt ağı olan TestResourceGroup adlı sanal bir ağ oluşturur: Frontenvseçsubnet ve backendSubnet. Ardından, sanal ağın bellekteki gösteriminden backendSubnet alt ağını kaldırır. Ardından, hizmet tarafında değiştirilmiş sanal ağ durumunu yazmak için Set-AzureRmVirtualNetwork cmdlet 'i kullanılır. Set-AzureRmVirtualNetwork cmdlet 'i yürütüldüğünde backendSubnet öğesi kaldırılır.
