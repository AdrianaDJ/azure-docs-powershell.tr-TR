...
## Tanım
**Save-AzureRmResourceGroupDeploymentTemplate** cmdlet 'ı bir JSON dosyasına kaynak grubu dağıtım şablonunu kaydeder.

## ÖRNEKLERDEN

### Örnek 1: Dağıtım şablonunu kaydetme
```
