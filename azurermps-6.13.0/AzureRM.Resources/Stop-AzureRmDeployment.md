...
## Tanım
**Stop-AzureRmDeployment** cmdlet 'i, abonelik kapsamındaki ancak tamamlanmamış bir dağıtımı iptal eder.
...
Abonelik kapsamında dağıtım oluşturmak için New-AzureRmDeployment cmdlet 'ini kullanın.
