...
## Tanım
**Set-AzureRmPolicyDefinition** cmdlet 'i bir ilke tanımını değiştirir.
...
Bu komut, VMPolicyDefinition adındaki ilke tanımını, Mode özelliğini ' All ' olarak ayarlamak için Set-AzureRmPolicyDefinition cmdlet 'ini kullanarak güncelleştirir.
