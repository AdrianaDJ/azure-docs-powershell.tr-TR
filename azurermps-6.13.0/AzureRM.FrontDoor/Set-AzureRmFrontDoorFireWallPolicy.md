...
## Tanım
**Set-Azurermfrontkapısı** cmdlet 'i mevcut bir WAF ilkesini güncelleştirir. Giriş parametreleri sağlanmazsa, var olan WAF ilkesindeki eski parametreler kullanılır.

## ÖRNEKLERDEN

### Örnek 1: var olan WAF ilkesini güncelleştirme
```powershell
...
var olan WAF ilkesini güncelleştirme

### Örnek 2: var olan bir WAF ilkesini güncelleştirme
```powershell
...
### Örnek 3: var olan bir WAF ilkesini güncelleştirme
```powershell
...
### Örnek 4: $resourceGroup tüm WAF ilkelerini Güncelleştir
```powershell
...
$resourceGroup tüm WAF ilkelerini Güncelleştir
