...
## Tanım
**Get-AzureRmFrontDoorFireWallPolicy** cmdletGet, geçerli aboneliğin altındaki bir kaynak grubundaki WAF ilkesini alır

## ÖRNEKLERDEN

### Örnek 1: $resourceGroup $Name
```powershell
...
$resourceGroup $Name adındaki bir WAF ilkesi alın

### Örnek 2: $resourceGroup tüm WAF ilkesini alın
```powershell
...
$resourceGroup 'de tüm WAF ilkesini alın
