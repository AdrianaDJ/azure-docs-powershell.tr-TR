...
JSON dosyası, aşağıdakine benzer sözdizimi kullanan bir metin dosyasıdır: {  
    ...
    "Konum": "Batı ABD",  
} **Set-AzureRmNotificationHub** cmdlet 'i ile birlikte kullanıldığında, önceki JSON örneği ContosoNotificationHub adındaki bir Bildirim Hub 'ının konum DEĞERINI Batı ABD 'ye ayarlar.
