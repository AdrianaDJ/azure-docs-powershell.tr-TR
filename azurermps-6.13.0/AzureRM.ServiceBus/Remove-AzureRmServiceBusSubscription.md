...
## Tanım
**Remove-AzureRmServiceBusSubscription** cmdlet 'i, belirtilen hizmet veri yolu ad alanındaki bir konuya aboneliği kaldırır.
...
### Örnek 3,1-RESOURCEID-değişken kullanarak:
```
...
### Örnek 3,2-RESOURCEID-dize değeri kullanma:
```
