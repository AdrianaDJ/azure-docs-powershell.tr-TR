...
## Tanım
**Add-AzureRmKeyVaultNetworkRule** cmdlet 'ı, IP adresleriyle veya ait oldukları sanal ağla belirlenen bir arayan kümesi için Anahtar Kasası erişimine izin verir veya erişimi kısıtlar. Kuralın erişim ilkesi aracılığıyla izin verilen diğer kullanıcılar, uygulamalar veya güvenlik grupları için erişimi kısıtlama olasılığı vardır.
