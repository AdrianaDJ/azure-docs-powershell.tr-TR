...
## Tanım
**Yeni-Azurermöğretici ınitialveservicesaccountkey** cmdlet 'ı, öğretici bir hizmetler hesabı IÇIN bir API anahtarı oluşturur.
...
### -AnahtarAdı
Yeniden üretmek için anahtarın adını belirtir.
...
### Microsoft. Azure. Management. öğretici Bveservices. modeller. AnahtarAdı
