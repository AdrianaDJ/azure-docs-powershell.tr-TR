...
## Tanım
New-AzureRmContainerRegistryReplication cmdlet 'i yeni bir kapsayıcı kayıt defteri çoğaltması oluşturur.

## ÖRNEKLERDEN

### Örnek 1: yeni bir kapsayıcı kayıt defteri çoğaltması oluşturun.
```powershell
...
Yeni kapsayıcı kayıt defteri çoğaltması oluşturun.
...
### Etiketli
Kapsayıcı kayıt defteri etiketleri.
