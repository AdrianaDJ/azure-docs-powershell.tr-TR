...
## Tanım
**New-AzureRmDataFactoryHub** cmdlet 'ı belirtilen Azure Kaynak grubunda ve belirtilen veri fabrikası içinde belirtilen dosya tanımıyla Azure Veri Fabrikası için bir hub oluşturur.
