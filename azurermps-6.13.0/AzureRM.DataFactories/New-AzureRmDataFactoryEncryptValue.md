...
## Tanım
**Yeni-AzureRmDataFactoryEncryptValue** cmdlet 'i parola veya Microsoft SQL Server bağlantı dizesi gibi hassas verileri şifreler ve şifrelenmiş bir değer döndürür.
...
**Yeni-AzureRmDataFactoryEncryptValue** komutu, belirtilen veri fabrikası, ağ geçidi, kaynak grubu ve bağlantılı hizmet türü için $Credential depolanan nesne için şifrelenmiş bir değer oluşturur.
...
**ConvertTo-SecureString** komutu belirtilen dizeyi güvenli dizeye dönüştürür.
**Yeni-AzureRmDataFactoryEncryptValue** komutu, belirtilen veri fabrikası, ağ geçidi, kaynak grubu ve bağlantılı hizmet türü için $value depolanan nesne için şifrelenmiş bir değer oluşturur.
