...
## Tanım
**Set-AzureStorageShareQuota** cmdlet 'i belirtilen paylaşımın depolama kapasitesini ayarlar.

## ÖRNEKLERDEN

### Örnek 1: paylaşımın depolama kapasitesini ayarlama
```
PS C:\>Set-AzureStorageShareQuota -ShareName "ContosoShare01" -Quota 1024
```

Bu komut, ContosoShare01 adlı paylaşımın depolama kapasitesini 1024 GB olarak ayarlar.
...
### -Kota
Kota değerini gigabayt (GB) cinsinden belirtir.
Uygulamasındaki kota sınırlamasını görün https://docs.microsoft.com/en-us/azure/azure-subscription-service-limits#azure-files-limits . 
...
### -Paylaşım
Bu cmdlet 'lerin kota ayarladığı paylaşımı temsil eden bir **Cloudfileshare** nesnesi belirtir.
...
### -PaylaşımAdı
Kota ayarlanacak dosya paylaşımının adını belirtir.
...
### Microsoft. Windowsazde. Storage. File. FileShareProperties
