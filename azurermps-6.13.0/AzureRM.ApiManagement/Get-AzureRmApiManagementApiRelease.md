...
## Tanım
**Get-Azurermapımanagementapirelease** cmdlet 'ı, Azure API yönetim API 'sının bir veya daha fazla sürümünü alır.
...
[Yeni-Azurermapımanagementapirelease](./Get-AzureRmApiManagementApiRelease.md)
