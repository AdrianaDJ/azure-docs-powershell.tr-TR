...
**New-Azurermapımanagementapırelease** CMDLET 'ı API yönetim BAĞLAMıNDA bir API düzeltmesi IÇIN bir API sürümü oluşturur.
...
[Remove-Azurermapımanagementapirelease](./Remove-AzureRmApiManagementApiRelease.md)

[Set-Azurermapımanagementapirelease](./Set-AzureRmApiManagementApiRelease.md)
