...
## Tanım
**New-AzureRmApiManagementVirtualNetwork** cmdlet 'i, bir **PsApiManagementVirtualNetwork** örneği oluşturmak için yardımcı komuttur.
Bu komut **Update-Azurermapımanagementdeployment** cmdlet 'i ile kullanılır.
...
Bu örnekte sanal bir ağ oluşturulur ve ardından **-Azurermapımanagementdeployment** cmdlet 'ini arar.
...
### -Konum
API yönetim hizmeti için desteklenen bölge arasındaki konumu belirtir.
