...
## Tanım
**Get-AzureRmSchedulerJobCollection** cmdlet 'ı Azure Scheduler 'daki iş koleksiyonlarını alır.
...
### -ResourceGroupName
Bu cmdlet 'in iş koleksiyonlarını aldığı kaynak grubunu belirtir.
