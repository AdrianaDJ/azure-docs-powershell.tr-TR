...
## Tanım
Aboneliğin çalışma alanı ayarlarını güncelleştirir.
Yapılandırılmış çalışma alanı, bu aboneliğin içindeki VM 'Ler 'e yüklenen güvenlik Aracısı tarafından toplanan güvenlik verilerini tutar.
...
"MyWorkspace" çalışma alanını, güvenlik aracıları tarafından toplanan tüm güvenlik verilerini tutmak için ayarlar.
