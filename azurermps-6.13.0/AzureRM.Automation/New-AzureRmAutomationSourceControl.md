...
## Tanım
New-AzureRmAutomationSourceControl cmdlet, Azure Otomasyonu hesabımı VSTS TFVC, VSTS git veya GitHub 'my bağlantısı oluşturmak için bir yapılandırma oluşturur.
