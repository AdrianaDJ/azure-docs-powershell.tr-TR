...
## Tanım
**Remove-Azurermautomationkancası** cmdlet 'i, bir Azure Otomasyonu runbook 'tan bir Web kancasını kaldırır.
Web kancası silindi.

## ÖRNEKLERDEN

### Örnek 1: Web kancasını kaldırma
```
...
Bu komut, AutomationAccount01 adındaki Otomasyon hesabında Webhook11 adındaki Web kancasını kaldırır.
...
Bu cmdlet 'in Web kancası kaldırıldığı bir Otomasyon hesabının adını belirtir.
...
### -Ad
Bu cmdlet 'in kaldırdığı Web kancası adını belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in Web kancasını kaldırdığı kaynak grubunun adını belirtir.
