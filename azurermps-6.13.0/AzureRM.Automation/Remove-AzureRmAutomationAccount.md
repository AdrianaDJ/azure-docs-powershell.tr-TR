...
## Tanım
**Remove-AzureRmAutomationAccount** cmdlet 'i, bir kaynak grubundan Azure Otomasyonu hesabını kaldırır.
...
Bu komut, kullanıcı doğrulaması istemeden ContosoAutomationAccount adlı bir Otomasyon hesabını kaldırır.
...
### -Ad
Bu cmdlet 'in kaldırdığı Otomasyon hesabının adını belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in Otomasyon hesabını kaldırdığı kaynak grubunun adını belirtir.
