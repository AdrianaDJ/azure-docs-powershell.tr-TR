...
## Tanım
**Get-Azurermautomationdsccompilationjoi Input** cmdlet 'i, bir APS için
...
İlk komut, Get-AzureRmAutomationDscCompilationJob cmdlet 'ini kullanarak Contoso17 adlı Otomasyon hesabındaki derleme işlerini alır.
