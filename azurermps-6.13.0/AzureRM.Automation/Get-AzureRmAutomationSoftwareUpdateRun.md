...
## Tanım
Get-AzureRmAutomationSoftwareUpdateRun cmdlet 'i yazılım güncelleştirmesi çalıştırmalarının listesini döndürür. Yazılım güncelleştirme yapılandırmasının ilişkili zamanlaması olduğundan, birden çok kez tetiklenebilir. Zamanlamanın her tetiklenişinde, bir güncelleştirme çalıştırması oluşturulur. Güncelleştirme çalıştırması, tüm makine çalıştırmalarının sonucunun bir topladır. SoftwareUpdateConfigurationName parametresini geçirerek belirli yazılım güncelleştirme yapılandırması için çalışmalar yapabilirsiniz. Belirli bir çalıştırmalar edinmek için name parametresini geçirmeniz gerekir. Ayrıca, belirli bir durumla birlikte çalışan, belirli operatins sistem hedeflemesi çalıştıran ya da uygun parametreyi geçirerek belirli bir süre geçtikten sonra da çalıştırabilirsiniz.
