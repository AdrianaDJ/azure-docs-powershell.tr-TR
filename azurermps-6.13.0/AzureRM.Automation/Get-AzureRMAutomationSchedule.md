...
## Tanım
**Get-Azurermautomationzamanlama** cmdlet 'ı bir Azure Otomasyonu zamanlaması alır.
...
Bu cmdlet 'in zamanlama aldığı Otomasyon hesabının adını belirtir.
...
### -Ad
Bu cmdlet 'in aldığı zamanlamanın adını belirtir.
...
### -ResourceGroupName
Bu cmdlet 'in zamanlama aldığı kaynak grubunun adını belirtir.
