...
### -AzureToAzure
Oluşturulan çoğaltma ilkesinin Azure sanal makinelerini iki Azure bölgesi arasında çoğaltmada kullanılacağını belirten anahtar parametresi.
...
### -AzureToVMware
Oluşturulan çoğaltma ilkesinin, VMware sanal makinelerinin ve Azure 'da çalışan fiziksel sunucuların şirket içi bir VMware sitesine geri dönmek için kullanılacağını belirten Switch parametresi.
...
### -HyperVToAzure
Hyper-V sanal makinelerinin Azure 'a çoğaltılması
...
Verilen zaman için kurtarma noktalarını saat cinsinden tutma.
...
### -ReplicationProvider
İlkenin çoğaltma sağlayıcısını belirtir.
...
### -VmmToVmm
Bir VMM sunucusu tarafından yönetilen Hyper-V siteleri arasında çoğaltma için ilkeyi belirtecek şekilde değiştirin.
...
### -VMwareToAzure
Oluşturulan çoğaltma ilkesinin VMware sanal makinelerini ve/veya fiziksel sunucularını Azure 'a çoğaltmak için kullanılacağını belirten geçiş parametresi.
