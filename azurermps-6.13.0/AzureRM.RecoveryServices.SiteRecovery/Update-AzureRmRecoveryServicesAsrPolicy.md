...
### -AzureToAzure
İki Azure bölgesi arasında Azure sanal makinelerini çoğaltmak için kullanılan çoğaltma ilkesinin güncelleştirileceğini belirten Switch parametresi güncelleştirilir.
...
### -AzureToVMware
Azure 'da çalışan sanal makinelerin başarısız olduğunu bir şirket içi VMware sitesine geri döndürmek için, belirtilen ilkenin kullanıldığını belirten değer parametresi.
...
### -VmmToVmm
İki Hyper-V sitesi arasında VMM yönetilen Hyper-V sanal makinelerini çoğaltmak için belirtilen ilkenin kullanıldığını belirten Switch parametresi.
