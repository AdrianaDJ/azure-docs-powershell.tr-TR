...
## Tanım
Kümeye hizmet yapısı ayarları eklemek veya bunları güncelleştirmek için **set-AzureRmServiceFabricSetting** kullanın.
...
### System. String
Parametreler: Parameter (ByValue), Section (ByValue), değer (ByValue)
