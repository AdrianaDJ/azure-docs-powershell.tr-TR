...
## Tanım
Var olan bir kümeye yeni düğüm türü ekleme.
...
Bu komut, kapasitesi 5 olan ve VM Yöneticisi adı ' adminName ' olan yeni bir NodeType ' N2 '.
...
### -Dur, Itylevel
NodeType 'in dayanıklılık düzeyini belirtin.
...
### -VmUserName
VM için oturum açma Kullanıcı adı.
...
### System. String
Parametreler: NodeType (ByValue), katman (ByValue), VmSku (Bydeğeri), VmUserName (ByValue)

### System. Int32
Parametreler: kapasite (ByValue)

### System. Security. SecureString
Parametreler: VmPassword (ByValue)

### Microsoft. Azure. Commands. ServiceFabric. modeller. Durkomutlarıdüzey
Parametreler: Durumitylevel (ByValue)
