...
### System. String
Parametreler: SertifikaDosyası (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), KeyVaultName (ByValue), Keyvaulteucegroupname (ByValue), yer (ByValue), ad (Bydeğeri), parametredeğeri (ByValue), SecondaryCertificateFile (ByValue),

### System. Security. SecureString
Parametreler: Sertifikaparolası (ByValue), SecondaryCertificatePassword (ByValue)

### System. Int32
Parametreler: Kümeboyutu (ByValue)
