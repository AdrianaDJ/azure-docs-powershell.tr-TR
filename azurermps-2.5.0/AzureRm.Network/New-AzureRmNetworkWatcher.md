...
## Tanım
New-AzureRmNetworkWatcher cmdlet 'i yeni bir ağ Izleyici kaynağı oluşturur.

## ÖRNEKLERDEN

### Örnek 1: ağ Izleyicisi oluşturma
```
...
Bu örnek, yeni oluşturulan bir kaynak grubunun içinde yeni bir ağ Izleyicisi oluşturur. Her abonelik için bölge başına yalnızca bir ağ Izleyicisi oluşturulabiliriz.
