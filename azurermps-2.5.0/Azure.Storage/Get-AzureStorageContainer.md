...
## Tanım
**Get-AzureStorageContainer** cmdlet 'ı, Azure 'daki depolama hesabıyla ilişkilendirilmiş depolama kapsayıcılarını listeler.
...
Cmdlet, bir depolama hesabı anahtarı izni gerektiren kapsayıcı izinlerini sorgulayacağından SAS belirtecinden oluşturulan bir depolama bağlamını kullandığınızda cmdlet başarısız olur.
