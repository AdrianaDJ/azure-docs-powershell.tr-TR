...
### -CloudBlob
Azure depolama Istemci kitaplığından CloudBlob nesnesi. Bunu oluşturabilir veya Get-AzureStorageBlob cmdlet 'ini kullanabilirsiniz.
...
### -CloudBlobContainer
Azure depolama Istemci kitaplığından CloudBlobContainer nesnesi. Bunu oluşturabilir veya Get-AzureStorageContainer cmdlet 'ini kullanabilirsiniz.
...
### -Context
Kaynak Azure depolama bağlamı. Bunu New-AzureStorageContext cmdlet ile oluşturabilirsiniz.
...
### -DestContext
Hedef Azure depolama bağlamı. Bunu New-AzureStorageContext cmdlet ile oluşturabilirsiniz.
