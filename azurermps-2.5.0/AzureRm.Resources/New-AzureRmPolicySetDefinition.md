...
## Tanım
**New-AzureRmPolicySetDefinition** cmdlet 'i bir ilke kümesi tanımı oluşturur.

## ÖRNEKLERDEN

### Örnek 1: ilke kümesi dosyası kullanarak ilke kümesi tanımı oluşturma
```
[
   {
...
Bu komut, C:\VMPolicy.jsüzerinde belirtilen ilke tanımlarını içeren VMPolicyDefinition adlı bir ilke kümesi tanımı oluşturur. VMPolicy.jsörnek içeriği yukarıda verilmiştir.
...
Bu komut, C:\VMPolicy.jsüzerinde belirtilen ilke tanımlarını içeren, VMPolicyDefinition adlı parametreli bir ilke kümesi tanımı oluşturur. VMPolicy.jsörnek içeriği yukarıda verilmiştir.
...
### -Metadata
İlke kümesi tanımı için meta veriler. Bu, meta veri içeren bir dosya adının yolu veya dize olarak meta veri olabilir
...
Bu, Parameters bildirimini veya Parameters bildirimini içeren bir dosya adına yol olabilir.
