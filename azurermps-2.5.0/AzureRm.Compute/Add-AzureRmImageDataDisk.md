...
## Tanım
**Add-Azurermimagedatadısk** cmdlet 'i bir resim nesnesine veri diski ekler.
...
Sonraki üç komut, $osDiskVhdUri, $dataDiskVhdUri 1 ve $dataDiskVhdUri 2 değişkenine işletim sistemi diskinin ve iki veri diskinin yollarını atar.
...
Son komutu, kaynak grubunda ImageName01 adlı bir resim oluşturur.

## PARAMETRELERINE

### -BlobUri
Blob 'un bir URI 'SI olan bağlantısını belirtir.
...
### -DiskSizeGB
Diskin boyutunu gigabayt (GB) cinsinden belirtir.
...
### -StorageAccountType
Veri görüntüsü diskinin depolama hesabı türü
...
### Microsoft. Azure. Management. COMPUTE. modeller. Image
