...
## Tanım
**Get-AzureRmDataLakeStoreItemAclEntry** cmdlet 'ı, Data Lake Store 'daki bir dosyanın veya klasörün erişim denetim LISTESINDE (ACL) bir GIRDI (ACE) alır.
...
Belirtilen klasör veya dosya için ACL girişlerinin listesi.
