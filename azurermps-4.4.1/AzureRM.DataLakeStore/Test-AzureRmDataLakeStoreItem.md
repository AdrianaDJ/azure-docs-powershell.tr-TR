...
## Tanım
**Test-AzureRmDataLakeStoreItem** cmdlet 'ı Data Lake Store 'da bir dosya veya klasörün varlığını sınar.
...
### bool
Belirtilen dosya veya klasörün varlığını belirten doğru veya yanlış.
