...
## Tanım
Start-AzureRmNetworkWatcherResourceTroubleshooting cmdlet 'i Azure 'daki bir ağ kaynağında sorun gidermeyi başlatır ve olası sorunlar ve Azaltıcı Etkenler hakkında bilgi verir. Şu anda sanal ağ geçitleri ve bağlantılar desteklenir.

## ÖRNEKLERDEN

### ---Örnek 1: sanal ağ geçidinde sorun giderme---
```
