...
## Tanım
**Remove-AzureRmStreamAnalyticsFunction** cmdlet 'ı bir Azure Stream Analytics işinden zaman uyumsuz bir işlevi siler.

## ÖRNEKLERDEN

### Örnek 1: Stream Analytics işlevini kaldırma
```
...
Bu komut, StreamJob22 adındaki işten ScoreTweet adındaki işlevi kaldırır.

## PARAMETRELERINE

### -JobName
İşlevin ait olduğu akış analizi işinin adını belirtir.
Bu cmdlet, bu parametrenin belirttiği işten bir işlevi kaldırır.
...
### -Ad
Bu cmdlet 'in kaldırdığı Stream Analytics işlevinin adını belirtir.
...
### -ResourceGroupName
Bir Stream Analytics işlevinin ait olduğu kaynak grubunun adını belirtir.
Bu cmdlet, bu parametrenin belirttiği kaynak grubundaki bir işlevi siler.
