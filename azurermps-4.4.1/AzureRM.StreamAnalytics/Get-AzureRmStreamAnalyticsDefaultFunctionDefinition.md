...
## Tanım
**Get-AzureRmStreamAnalyticsDefaultFunctionDefinition** cmdlet 'ı, Azure Stream Analytics 'te bir işlevin varsayılan tanımını alır.
İşlev oluşturmak için varsayılan tanımı ve New-AzureRmStreamAnalyticsFunction cmdlet 'ini kullanabilirsiniz.
