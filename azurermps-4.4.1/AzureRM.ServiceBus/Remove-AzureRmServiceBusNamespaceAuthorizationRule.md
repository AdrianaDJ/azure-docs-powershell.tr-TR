...
## Tanım
**Remove-AzureRmServiceBusNamespaceAuthorizationRule** cmdlet 'i, belirtilen kaynak grubu Için bir hizmet veri yolu ad alanının yetkilendirme kuralını kaldırır.
...
### -Ad
Ad alanı AuthorizationRule adı.
