...
## Tanım
**Get-AzureRmServiceBusAuthorizationRule** cmdlet 'i, verilen ad alanında veya kuyrukta veya konuda belirtilen yetkilendirme kuralının açıklamasını alır.
...
### System. Koleksiyonlar. Generic. LIST ' 1 [[Microsoft. Azure. Commands. ServiceBus. modeller. SharedAccessAuthorizationRuleAttributes, Microsoft. Azure. Commands. ServiceBus, Version = 0.4.2.0, Culture = neutral, PublicKeyToken = null]]
