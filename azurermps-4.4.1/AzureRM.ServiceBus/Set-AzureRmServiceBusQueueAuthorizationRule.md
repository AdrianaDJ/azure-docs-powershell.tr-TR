...
## Tanım
**Set-Azurermservicebusiauthorizationrule** cmdlet 'i, verilen hizmet veri yolu sırasının belirtilen yetkilendirme kuralının açıklamasını güncelleştirir.
...
Kuyruktaki yetkilendirme kuralının erişim haklarına **Yönet** ekler `SBAuthoRule1` `SB-Queue_exampl1` .

## PARAMETRELERINE

### -AuthorizationRuleName
Yetkilendirme kuralı adı. Gerekli Eğer **-authruleobj** belirtilmemişse.
...
### -AuthRuleObj
Hizmet yol sırası yetkilendirme kuralı nesnesi.
...
### -Hak
Haklar; Örneğin @ ("Dinle", "Gönder", "Yönet"). ' AuthruleObj ' belirtilmemişse gereklidir.
