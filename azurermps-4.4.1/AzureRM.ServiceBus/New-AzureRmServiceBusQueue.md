...
`SB-Queue_exampl1`Belirtilen hizmet veri yolu ad boşluğunda yeni bir hizmet veri yolu kuyruğu oluşturur `SB-Example1` .
...
İletilerin süre bitime durumunda olup olmadığını belirtir.
...
Varsayılan ileti ömrünü (TTL) belirtir.
...
Sunucu tarafı toplu işlemlerinin etkinleştirilip etkinleştirilmediğini belirtir.
...
### -EnableExpress
Hızlı varlıkların etkinleştirilip etkinleştirilmediğini belirtir. Bir hızlı kuyruk, kalıcı depolama birimine yazmadan önce geçici olarak bellekte bir ileti tutar.
...
### -Enablebölümlendirme
Enablebölümlendirme özelliğinin etkinleştirilip etkinleştirilmediğini belirtir.
...
### -Isanonymouserişilebilirlik
İletinin anonim olarak erişilebilir olup olmadığını belirtir.
...
### -MaxDeliveryCount
En fazla teslim sayısını belirtir. Bu numaradan sonra otomatik olarak bir ileti verilir.
...
### -Maxsizeınmega
Sıra için ayrılan belleğin megabayt cinsinden megabayt cinsinden en büyük boyutunu belirtir.
...
### -MessageCount
Kuyruktaki iletilerin sayısını belirtir.
...
Kuyruğun yinelenen saptamayı gerektirip gerektirmediğini belirtir.
...
### -RequiresSession
Bu sıranın oturumları destekleyip desteklemediğini belirtir.
