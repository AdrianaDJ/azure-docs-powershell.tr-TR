...
## Tanım
**Get-AzureRmAutoscaleHistory** cmdlet 'ı otomatik ölçeklendirme ayarıyla ilgili olayların geçmişini alır.

## ÖRNEKLERDEN

### Örnek 1: abonelikle ilişkilendirilmiş tüm etkinlikleri alma
```
PS C:\>Get-AzureRmAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Bu komut, geçerli abonelikle ilişkili otomatik ölçeklendirme ile ilgili etkinlikleri alır.

### Örnek 2: belirli bir kaynak için GetAutoscaleHistory
```
...
Bu komut, kaynağın KIMLIĞI (Aslýnda, ResourceUri) tarafından tanımlanan belirli bir kaynakla ilişkili, otomatik ölçeklendirme ile ilgili tüm etkinlikleri alır.
...
### -DetailedOutput
Bu işlemin ayrıntılı çıktıya dahil olduğunu gösterir.
Bu parametreyi belirtmezseniz, çıkış özetlenir.
...
### -RESOURCEID
Otomatik ölçeklendirme ayarının ilişkilendirildiği kaynak KIMLIĞINI belirtir.
...
### -Durum
Duruma göre filtreleme belirtir.
Bu parametre isteğe bağlıdır.
Hata, boş bir dizedir (filtre yok)
...
### System. Koleksiyonlar. Generic. LIST ' 1 [Microsoft. Azure. Commands. Insights. OutputClasses. ıpseventdata]
