...
### Etkinlik günlüğü uyarısı ayarla uyarısı
```
...
### Kanaldan RESOURCEID değerini alan etkinlik günlüğü uyarılarını ayarlamak için parametreler
```
...
### Kanaldan değer alma etkinlik günlüğü uyarıları ayarlama
```
