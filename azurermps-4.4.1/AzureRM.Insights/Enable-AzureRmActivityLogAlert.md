...
### Etkinlik günlüğü uyarısını etkinleştirmek için varsayılan parametreler
```
Enable-AzureRmActivityLogAlert -Name <String> -ResourceGroupName <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Bir etkinlik günlüğü uyarılarını kanaldan etkinleştirme parametreleri
```
Enable-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Kanalın değerini kanaldan alan etkinlik günlüğü uyarılarını etkinleştiren parametreler
```
