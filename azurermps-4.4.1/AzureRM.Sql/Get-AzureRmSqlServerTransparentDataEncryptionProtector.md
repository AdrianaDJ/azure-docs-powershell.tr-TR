...
## Tanım
Get-AzureRmSqlServerTransparentDataEncryptionProtector cmdlet 'i, TDE koruyucusu hakkında bilgi alır.

## ÖRNEKLERDEN

### --------------------------Örnek 1: saydam veri şifreleme (TDE) koruyucusunu edinin--------------------------
```
