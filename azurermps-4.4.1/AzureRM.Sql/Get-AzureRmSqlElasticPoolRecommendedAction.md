...
## Tanım
**Get-AzureRmSqlElasticPoolRecommendedAction** cmdlet 'ı BIR Azure SQL esnek havuz Danışmanı için önerilen bir veya birden çok eylemi alır.

## ÖRNEKLERDEN

### Örnek 1: bir danışman için önerilen tüm eylemleri listeleme
```
...
Bu komut, WIRunnerPool adlı elastik havuz için sağlanan CreateIndex adındaki tüm önerilen eylemlerin listesini alır.

### Örnek 2: bir danışman için önerilen eylemi edinme
```
...
Bu komut, \[ CreateIndex adındaki test_schema IR_ \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 adlı önerilen eylemi alır.

## PARAMETRELERINE

### -Danışmanlar veya ad
Bu cmdlet 'in önerilen eylemleri istediği bir danışman adını belirtir.
...
### -Elana PoolName
Bu cmdlet 'in önerilen eylemleri istediği elastik havuzun adını belirtir.
...
Bu cmdlet 'in aldığı önerilen eylemin adını belirtir.
...
## NOTLARıNDA
* Anahtar sözcükler: Azure, azurerm, ARM, Resource, yönetim, Manager, SQL, elappool, MSSQL, danışman, recommendedaction
