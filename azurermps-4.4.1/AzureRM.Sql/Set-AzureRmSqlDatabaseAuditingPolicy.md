...
Veritabanı, bu cmdlet 'i çalıştırmadan önce denetimi için sunucunun ilkesini kullandıysa, denetim bu ilkeyi kullanmayı durdurur.
...
Varsayılan değer birincili değeridir.
