...
## Tanım
**Add-AzureRmServiceFabricClusterCertificate** öğesini kullanarak, var olan bir Azure Anahtar Kasası 'ndan veya varolan bir sertifikayı kullanarak varolan bir Azure Anahtar Kasası oluşturabilir Varsa ikincil kümeyi geçersiz kılacaktır.
...
Oluşturulacak yeni sertifikanın klasörü.
...
### -SecretIdentifier
Var olan Azure Key kasa gizli URL 'Si.
