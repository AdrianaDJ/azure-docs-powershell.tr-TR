...
## Tanım
**Start-AzureRmSiteRecoveryTestFailoverJob** cmdlet 'ı bir Azure Site Recovery koruma varlığının veya kurtarma planının yük devretmeyi başlatır.
...
### -VMNetwork
Site kurtarma sanal makine ağını belirtir.
