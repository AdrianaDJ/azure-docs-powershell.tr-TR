...
## Tanım
**New-AzureRmSiteRecoveryPolicy** cmdlet 'ı bir Azure Site Recovery çoğaltma ilkesi oluşturur.
...
### -Applicationpotentın
Uygulamayla tutarlı anlık görüntüsünün saat cinsinden sıklığını belirtir.
...
### -Ad
Site kurtarma çoğaltma ilkesini tanımlayan kolay bir ad belirtir.
...
Çoğaltma hedefinin Azure depolama hesabı KIMLIĞINI belirtir.
