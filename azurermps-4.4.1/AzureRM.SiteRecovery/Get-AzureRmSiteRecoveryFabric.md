...
## Tanım
**Get-AzureRmSiteRecoveryFabric** cmdlet 'ı, kurtarma hizmeti kasasındaki belirli bir Azure Site Recovery yapısı veya tüm Azure Site kurtarma yapılarını alır.
...
### -FriendlyName
Azure Site Recovery yapısı kolay adını belirtir.
...
### System. Koleksiyonlar. Generic. LIST ' 1 [[Microsoft. Azure. Commands. SiteRecovery. ASRFabric, Microsoft. Azure. Commands. SiteRecovery, Version = 2.0.1.0, Culture = neutral, PublicKeyToken = null]]
