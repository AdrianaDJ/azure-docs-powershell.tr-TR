...
## Tanım
**Import-AzureRmAutomationRunbook** cmdlet 'ı bir Azure Otomasyonu runbook 'unu içeri aktarır. Wps_2 ve wps_2 Iş akışı runbook 'ları veya grafik runbook 'lar için bir grafik runbook (. graphrunbook) dosyasının içeri aktarılacağı wps_2 komut dosyası (. ps1) dosyasının yolunu belirtin. Dosyanın adı, runbook 'un adı olur. Iş akışı runbook 'ları wps_2 için, betikte dosyanın adıyla eşleşen tek bir wps_2 Iş akışı tanımı bulunmalıdır.
