...
## Tanım
**Özgeçmiş-AzureRmAutomationJob** cmdlet 'i askıya alınmış bir Azure Otomasyonu işini sürdürür.
Askıya alınan işi belirtin.

Bir işi askıya almak için Suspend-AzureRmAutomationJob cmdlet 'ini kullanın.
