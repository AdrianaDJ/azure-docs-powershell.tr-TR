...
## Tanım
**Yeni-Azurermautomationzamanlama** cmdlet 'ı Azure Otomasyonu 'nda bir zamanlama oluşturur.
...
Son komutu, $StartDate uygulamasında depolanan zamandan başlayıp $EndDate içinde depolanan tarihte sona erecek şekilde Schedule01 adlı günlük bir zamanlama oluşturur.
...
### -ExpiryTime
Bir zamanlamanın sona erme zamanını **Datetimeoffest** nesnesi olarak belirtir.
