...
### Ana bilgisayar adını ve bağlantı noktasını belirtme (varsayılan)
```
...
### -DatabaseName
Veri Lake Analytics acoc, kimlik bilgisinin içinde saklanacağı veritabanının adını belirtir.
