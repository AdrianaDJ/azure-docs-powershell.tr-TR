...
### Tümü kaynak grubu ve hesabında (varsayılan)
```
...
### Jobınformation
Belirtilen iş bilgileri ayrıntıları

### Listeniz<JobInformation>
Belirtilen veri Lake Analytics hesabındaki işlerin listesi.
