...
### Tüm yönetilen uygulamalar parametre kümesi. Varsayýlan
```
Get-AzureRmManagedApplication [-ApiVersion <String>] [-Pre] [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### Yönetilen uygulama adı parametre kümesi.
```
...
## Tanım
**Get-AzureRmManagedApplication** cmdlet 'i yönetilen uygulamaları alır
