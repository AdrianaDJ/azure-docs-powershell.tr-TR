...
### Parametresiz ilke ataması (varsayılan)
```
...
### İlke parametresi nesnesi aracılığıyla parametrelere sahip ilke ataması
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
...
### İlke parametresi dizesi aracılığıyla parametrelere sahip ilke ataması
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] -PolicyDefinition <PSObject> [-PolicySetDefinition <PSObject>]
...
### İlke kümesi parametre nesnesi aracılığıyla parametre içeren ilke ataması
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameterObject <Hashtable> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
### İlke kümesi parametre dizesi aracılığıyla parametre içeren ilke ataması
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameter <String> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
İkinci komut, Get-AzureRmPolicyDefinition cmdlet 'ini kullanarak VirtualMachinePolicy adındaki ilke tanımını alır.
Komut bu nesneyi $Policy değişkeninde depolar.

Son komutu, ilkeyi bir kaynak grubu düzeyinde $Policy atar.
...
### -PolicyDefinition
İlke kuralını içeren bir **Psobject** nesnesi olarak bir ilke belirtir.
...
Örneğin, kaynak grubuna ilke atamak için aşağıdakileri belirtin:
...
### -SKU
SKU özelliklerini temsil eden karma bir tablo. Ücretsiz SKU için Varsayılanlar: ad = a0, katman = serbest
