...
## Tanım
**Start-AzureRMHDInsightJob** cmdlet 'i belirtilen bir kümede tanımlı bir Azure HDInsight işi başlatır.
Bu bir MapReduce işi, bir akış MapReduce işi, bir kovan işi veya bir domuz işi olabilir.

## ÖRNEKLERDEN

### Örnek 1: belirtilen kümede iş başlatma
```
PS C:\># Cluster info
...
Bu komut,-Hadoop-001 adlı kümede bir iş başlatır.
...
### -JobDefinition
Azure HDInsight kümesinde başlayacak işi belirtir.
...
' JobDefinition ' parametresi ardışık düzenin ' AzureHDInsightJobDefinition ' türünün değerini kabul eder
