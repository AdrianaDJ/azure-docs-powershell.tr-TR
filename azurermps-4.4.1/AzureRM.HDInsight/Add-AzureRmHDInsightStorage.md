...
## Tanım
**Add-AzureRmHDInsightStorage** cmdlet 'i, New-AzureRmHDInsightClusterConfig cmdlet 'i tarafından oluşturulan Azure HDInsight yapılandırma nesnesine bir Azure depolama hesabı girişi ekler.
...
Bu komut,-Hadoop-001 adlı HDInsight yapılandırmasına bir BLOB depolama hesabı girişi ekler.
...
### -StorageAccountKey
Depolama hesabının yeni kümeye ekleneceği depolama hesabı anahtarını belirtir.
