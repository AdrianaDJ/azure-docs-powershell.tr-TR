...
## Tanım
**New-AzureRmHDInsightStreamingMapReduceJobDefinition** cmdlet 'i, bir Azure HDInsight kümesiyle kullanılmak üzere bir akış MapReduce iş nesnesi tanımlar.

## ÖRNEKLERDEN

### Örnek 1: bir akış MapReduce iş tanımı oluşturma
```
PS C:\># Cluster info
...
Bu komut, bir akış MapReduce iş tanımı oluşturur.
...
### -CommandEnvironment
İş çalışan düğümlerinde çalıştığında ayarlanacak komut satırı ortam değişkenleri dizisini belirtir.
...
### -Inputpath
Giriş dosyalarının yolunu belirtir.
...
### -Reducer
Bir Reducer dosya adı belirtir.
...
### Microsoft. Azure. Commands. HDInsight. modeller. AzureHDInsightStreamingMapReduceJobDefinition
