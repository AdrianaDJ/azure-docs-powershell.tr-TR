...
## Tanım
New-AzureRmEventHubNamespaceAuthorizationRule cmdlet 'i belirtilen olay hub ad boşluğunda yeni bir yetkilendirme kuralı oluşturur.
...
\` \` \` \` Myresourcegroupname kaynak grubunda, Olay Hub 'ları ad alanı olan mynamespacename olan myauthrulename yetkilendirme kuralını oluşturur \` \` .
