...
## Tanım
New-AzureRmEventHubConsumerGroup cmdlet 'i belirtilen olay hub 'ı için yeni bir tüketici grubu oluşturur.
...
\` \` \` \` \` \` Myresourcegroupname kaynak grubuyla, mynamespacename ad alanı kapsamındaki Olay Hub myeventhubname ile tüketici \` \` grubu 'nu oluşturur.
...
### -UserMetadata
Tüketici grubu için Kullanıcı meta verileri.
...
### Microsoft. Azure. Commands. EventHub. model. ConsumerGroupAttributes
