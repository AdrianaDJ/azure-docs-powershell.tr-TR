...
## Tanım
**Remove-AzureBatchNodeFile** cmdlet 'i, görev veya hesaplama düğümü Için bir Azure toplu iş düğümü dosyasını siler.

## ÖRNEKLERDEN

### Örnek 1: görevle bir dosyayı silme
```
...
Bu komut **Get-AzureBatchNodeFile** kullanarak düğüm dosyasını alır.
Bu dosya, iş Işi-000001 altında KIMLIĞI Task26 olan görevle ilişkilendirilmiştir.
...
**Psnodefile** almak için Get-AzureBatchNodeFile cmdlet 'ini kullanın.
...
### -Ad
Bu cmdlet 'in sildiği düğüm dosyasının adını belirtir.
