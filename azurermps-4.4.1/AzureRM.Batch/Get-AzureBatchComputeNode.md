...
## Tanım
**Get-AzureBatchComputeNode** cmdlet 'i bir havuzdan Azure toplu işlem düğümlerini alır.
...
Bu komut, Get-AzureBatchPool cmdlet 'ini kullanarak KIMLIK Pool07 havuzunu alır.
...
**Pscses havuzu** nesnesi edinmek için Get-AzureBatchPool cmdlet 'ini kullanın.
