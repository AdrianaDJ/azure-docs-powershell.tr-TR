...
### Örnek 3: Azure kapsayıcısı kayıt defterinde resim kullanarak kapsayıcı grubu oluşturur
```
...
### Örnek 4: özel kapsayıcı görüntüsü kayıt defterinde resim kullanarak kapsayıcı grubu oluşturur
```
PS C:\> $secpasswd = ConvertTo-SecureString "PlainTextPassword" -AsPlainText -Force
