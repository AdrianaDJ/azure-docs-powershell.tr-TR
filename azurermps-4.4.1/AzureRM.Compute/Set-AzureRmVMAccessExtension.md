...
## Tanım
**Set-Azurermvmaccessextenma** cmdlet 'i sanal makine erişimi (VMAccess) sanal makine uzantısını bir sanal makineye ekler.
VMAccess sanal makine Kullanıcı adını ve parolasını sıfırlayabilir.
