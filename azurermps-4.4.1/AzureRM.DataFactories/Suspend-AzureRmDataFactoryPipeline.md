...
## Tanım
**Suspend-AzureRmDataFactoryPipeline** cmdlet 'ı Azure Veri Fabrikası 'nde bir ardışık düzeni askıya alır.
Resume-AzureRmDataFactoryPipeline cmdlet 'ini kullanarak ardışık düzene devam edebilirsiniz.

## ÖRNEKLERDEN

### Örnek 1: ardışık düzeni askıya alma
```
...
Bu cmdlet, bu parametrenin belirttiği veri fabrikasına ait olan bir ardışık düzeni askıya alır.
...
### -Ad
Askıya alınacak ardışık düzenin adını belirtir.
...
Bu cmdlet, bu parametrenin belirttiği gruba ait bir ardışık düzeni askıya alır.
