...
### Örnek 2: sertifikayı karşıya yükleme ve Web uygulamasına bağlama
```
...
Ayrıca, sertifika E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 sertifika.
Bu durumda, sertifika henüz Azure 'a yüklenmemiş.
Bu nedenle, sertifikanın yerel kopyasını belirtmek için *Certificatefilepath* parametresi kullanılır. PFX dosyası
Bu sertifika Azure 'a yüklenir ve ardından yeni SSL bağlamaları oluşturulur.
