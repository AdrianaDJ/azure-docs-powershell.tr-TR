...
Bir deneme ilgisi içermeyen bir PowerShell hatasıyla ilgili bilgiler.

### Microsoft. Azure. Commands. Profile. Errors. AzureExceptionRecord
Hatayı oluşturan özel durumla ilgili ayrıntılı bilgileri içeren hatayla ilgili bilgiler.

### Microsoft. Azure. Commands. Profile. Errors. AzureRestExceptionRecord
Cleınt/sunucu iletişimdeki hatalar hakkında bilgi.  Bu, genellikle sunucudan hata hakkında önemli bilgiler içerir.
