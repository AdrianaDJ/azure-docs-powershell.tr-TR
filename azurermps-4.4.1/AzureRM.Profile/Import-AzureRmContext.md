...
Azure ile iletişim kurmak için kullanılan kimlik bilgileri, hesaplar ve abonelikler kümesini içerir.

## ÇıKıŞLAR

### Microsoft. Azure. Commands. Profile. modeller. PSAzureProfile
Azure ile iletişim kurmak için kullanılabilecek kimlik bilgileri, hesaplar ve abonelikler kümesini içerir.
