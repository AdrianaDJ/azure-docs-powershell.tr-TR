...
### Örnek 1: Remove-AzsGalleryItem
```powershell
PS C:\> Remove-AzsGalleryItem -Name TestUbuntu.Test.1.0.0

```

Azure yığın galerisinden TestUbuntu. test. 1.0.0 siler.

### Örnek 2: ardışık düzen ile Remove-AzsGalleryItem
```powershell
PS C:\> Get-AzsGalleryItem -Name TestUbuntu.Test.1.0.0 | Remove-AzsGalleryItem

```

TestUbuntu. test. 1.0.0 ile ardışık düzeni siler.
