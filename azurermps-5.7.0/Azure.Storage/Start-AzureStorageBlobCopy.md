...
## Tanım
**Start-AzureStorageBlobCopy** cmdlet 'i bir blob kopyalamaya başlar.
...
Bu komut, **contoso-AzureStorageContainer** cmdlet 'ini kullanarak, contosoyüklemelerini ve ardından ardışık düzen işlecini kullanarak kapsayıcıyı geçerli cmdlet 'e geçirir.
...
Bu komut, Contosoyüklemelerini, **Get-AzureStorageBlob** cmdlet 'ini kullanarak ve ardından sonuçları ardışık düzen işlecini kullanarak geçerli cmdlet 'e iletir.
...
### -SrcFile
Azure depolama Istemci kitaplığından bir **Cloudfile** nesnesini belirtimi.
Bunu oluşturabilir veya Get-AzureStorageFile cmdlet 'ini kullanabilirsiniz.
...
Bunu oluşturabilir veya Get-AzureStorageShare cmdlet 'ini kullanabilirsiniz.
...
' CloudBlob ' parametresi ardışık düzenin ' CloudBlob ' türünün değerini kabul ediyor
...
' SrcFile ' parametresi ardışık düzen
