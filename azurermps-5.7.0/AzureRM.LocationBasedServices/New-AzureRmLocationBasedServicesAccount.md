...
## SYNOPSIS
Konum tabanlı hizmetler hesabı oluşturur.
...
## Tanım
**New-Azurermlocationbasevseçservicesaccount** cmdlet 'i belirtilen SKU 'ya sahip bir konum tabanlı hizmetler hesabı oluşturur.
...
MyResourceGroup kaynak grubunda MyAccount adlı yeni bir konum tabanlı hizmetler hesabı SKU S0 ve bir etiketle oluşturulur.
...
### -SkuName
Konum tabanlı hizmetler hesap SKU adı.
...
### Etiketli
Konum temelli hizmetler hesap etiketleri.
...
Konum tabanlı hizmetler hesabı oluşturmak, koşulları kabul etmek için bir istem yanıtlamayı gerektirir (bkz https://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/) .  -Force parametresi, terimlerin kabul edilmesi gerektiğini belirtmek için kullanılabilir.
