...
API Yönetim hizmetinde yapılandırılan OpenID Connect sağlayıcısının ayrıntısı.

### IList<Microsoft. Azure. Commands. Apsananad. ServiceManagement. modeller. Psapsananagementopenıdconnectprovider>
API Yönetim hizmetinde yapılandırılan OpenID Connect sağlayıcılarının listesi.
