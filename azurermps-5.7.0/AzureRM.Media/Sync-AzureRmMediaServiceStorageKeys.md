...
## Tanım
**Sync-AzureRmMediaServiceStorageKeys** cmdlet 'i, medya hizmetiyle ilişkili bir depolama hesabının depolama hesabı anahtarlarını eşitler.

## ÖRNEKLERDEN

### Örnek 1: medya hizmetiyle ilişkili bir depolama hesabı için depolama hesabı anahtarlarını eşitleme
```
...
İlk komut, Storage135 adındaki depolama hesabını almak için Get-AzureRmStorageAccount cmdlet 'ini kullanır ve sonucu $StorageAccount adlı değişkende depolar.

İkinci komut, $StorageAccount değişkeninde bulunan **ID** özelliğini kullanarak MediaService001 adındaki medya hizmeti için depolama hesabı anahtarlarını eşitler.

## PARAMETRELERINE

### -AccountName
Bu cmdlet 'in eşitlenei ortam hizmetinin adını belirtir.
...
### -Storageaccountıd
Medya Hizmeti hesabıyla ilişkili depolama hesabı KIMLIĞINI belirtir.
