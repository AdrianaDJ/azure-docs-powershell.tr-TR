...
## Tanım
**Remove-AzureRmDataFactoryV2Trigger** cmdlet 'i Veri Fabrikası 'ndan bir tetikleyiciyi kaldırır. _Force_ parametresi belirtilirse, cmdlet tetikleyiciyi kaldırmadan önce istemez.

## ÖRNEKLERDEN

### Örnek 1: tetikleyiciyi kaldırma
```
...
"ScheduledTrigger" adındaki tetiği "WikiADF" olarak kaldırın.
