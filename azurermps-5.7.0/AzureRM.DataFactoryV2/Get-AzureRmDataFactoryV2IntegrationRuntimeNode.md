...
## Tanım
**Get-AzureRmDataFactoryV2IntegrationRuntimeNode** cmdlet 'i Integration Runtime düğümünün ayrıntı bilgilerini alır.

## ÖRNEKLERDEN

### Örnek 1: Tümleştirme çalışma zamanı düğümünün ayrıntı bilgilerini alır.
```
...
Cmdlet, ' test-df-EU2 ' Veri Fabrikası ' test-Selfhost-IR ' ' Node_1 ' adlı düğümün bilgilerini alır.

### Örnek 2: Tümleştirme çalışma zamanı düğümünün adres bilgilerini IP adresiyle birlikte alır.
```
...
Cmdlet, IP adresi de içinde olmak üzere, ' test-df-EU2 ' Veri Fabrikası ' test-Selfhost-IR ' içinde ' Node_1 ' adlı düğümün bilgilerini alır.
...
### -IPAddress
Tümleştirme çalışma zamanı düğümünün IP adresi.
...
### Microsoft. Azure. Commands. DataFactoryV2. modeller. Psmanagedıntegrationruntimenode
Microsoft. Azure. Commands. DataFactoryV2. modeller. PSSelfHostedIntegrationRuntimeNode
