...
## Tanım
**Remove-AzureRmDataFactoryGateway** cmdlet 'ı Azure Veri Fabrikası 'ndan belirtilen ağ geçidini kaldırır.

## ÖRNEKLERDEN

### Örnek 1: ağ geçidini kaldırma
```
...
Bu cmdlet, bu parametrenin belirttiği veri fabrikaından gelen ağ geçidini kaldırır.
...
### -Force
Bu cmdlet 'in bir ağ geçidini onaylamanızı istemeden kaldırmadığını gösterir.
...
### -Ad
Kaldırılacak ağ geçidinin adını belirtir.
...
Bu cmdlet, bu parametrenin belirttiği gruba ait bir ağ geçidini kaldırır.
