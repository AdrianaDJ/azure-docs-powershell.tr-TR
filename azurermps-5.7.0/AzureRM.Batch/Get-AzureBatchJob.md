...
## Tanım
**Get-AzureBatchJob** cmdlet 'ı, *batchaccountcontext* parametresiyle belirtilen toplu hesap için Azure toplu işlemlerini alır.
...
Bu komut, Get-AzureBatchJobSchedule cmdlet 'ini kullanarak KIMLIĞI JobSchedule27 olan iş zamanlamasını alır.
...
**Pschoparlör** nesnesi almak için Get-AzureBatchJobSchedule cmdlet 'ini kullanın.
...
### Ek zamanlama
' Jobzamanlama ' parametresi ardışık düzenin ' Pscses Jobzamanlama ' türünün değerini kabul eder
