...
## Tanım
**Save-AzureRmServerManagementGatewayProfile** cmdlet 'i, bir Azure Server yönetim ağ geçidi profilini indirir ve yerel dosyaya depolar.
...
### -Ağ Geçidi
Bu cmdlet 'in profili aldığı ağ geçidini belirtir.

ResourceGroupName ve GatewayName belirtmek yerine kullanılabilir
...
### -GatewayName
Bu cmdlet 'in profili aldığı ağ geçidinin adını belirtir.
...
### -ÇıktıDosyası
Profil verilerinin kaydedileceği yerel dosyayı belirtir.
