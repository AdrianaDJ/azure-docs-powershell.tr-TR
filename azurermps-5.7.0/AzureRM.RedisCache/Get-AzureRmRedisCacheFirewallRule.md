...
## Tanım
If **RuleName** parametresi sağlanmışsa, **Get-AzureRmRedisCacheFirewallRule** cmdlet 'ı Azure Redis Cache 'de belirtilen güvenlik duvarı kuralı hakkında ayrıntılı bilgi alır. Yalnızca **ad** belirtilirse, bu, bu Red

## ÖRNEKLERDEN

### Örnek 1: tek bir güvenlik duvarı kuralı edinin
```
...
Bu komut myCache adlı Red, Cache 'den Rule adlı güvenlik duvarı kuralını alır.

### Örnek 2: tüm güvenlik duvarı kurallarını alma
```
...
Bu komut myCache adındaki tüm güvenlik duvarı kurallarını Redcache 'den alır.
...
### System. Koleksiyonlar. Generic. LIST ' 1 [[Microsoft. Azure. Commands. RedisCache. modeller. PSRedisFirewallRule, Microsoft. Azure. Commands. RedisCache, Version = 4.0.1.0, Culture = neutral, PublicKeyToken = null]]
