...
### CreateWithoutParameters (varsayılan)
```
...
Son komutu, yerel çalışma dizininde AllowedLocations.jsilke parametre dosyasını kullanarak bir kaynak grubunun düzeyindeki $Policy ilke atar.
$ResourceGroup **RESOURCEID** özelliği kaynak grubunu tanımlar.
...
### -SKU
SKU özelliklerini temsil eden karma bir tablo. Ücretsiz SKU için Varsayılanlar: ad = a0, katman = fre
