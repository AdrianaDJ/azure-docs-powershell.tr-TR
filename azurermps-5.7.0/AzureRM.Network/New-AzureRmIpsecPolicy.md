...
## Tanım
New-AzureRmIpsecPolicy cmdlet 'i sanal ağ geçidi bağlantısında kullanılacak bir IPSec ilkesi teklifi oluşturur.
...
### -Ikeencryption
IKE şifreleme algoritması (ıKE Phase 2)
...
### -Ikeıntegrity
IKE bütünlük algoritması (ıKE Phase 2)
...
### -Ipsecencryption
IPSec şifreleme algoritması (ıKE Aşama 1)
...
### -Ipsecıntegrity
IPSec bütünlük algoritması (ıKE Aşama 1)
