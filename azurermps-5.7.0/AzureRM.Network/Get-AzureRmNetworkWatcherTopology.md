...
## Tanım
Get-AzureRmNetworkWatcherTopology cmdlet 'i kaynak grubundaki kaynakların ve ilişkilerin ağ düzeyi görünümünü görüntüler. Not: birden çok bölgedeki kaynaklar kaynak grubunda bulunuyorsa, yalnızca ağ Izleyicisi ile aynı bölgedeki kaynaklar JSON çıktısına dahil edilir.
...
Bu örnekte, VM, NIC, NSG ve ortak IP içeren bir kaynak grubunda Get-AzureRmNetworkWatcherTopology cmdlet 'i çalıştırdık.
