...
## Tanım
Set-AzureRmNetworkWatcherConfigFlowLog hedef kaynağın akış günlüğünü yapılandırır. Yapılandırılacak Özellikler: sağlanan kaynak için akış günlüğünün etkinleştirilip etkinleştirilmeyeceği, günlükleri gönderecek yapılandırılmış depolama hesabı ve Günlükler için bekletme ilkesi. Ağ güvenlik grupları akış günlüğü için desteklenir. 

## ÖRNEKLERDEN

### ---Örnek 1: belirli bir NSG---akış günlüğünü yapılandırma
```
...
Bu örnekte, ağ güvenlik grubu için akış günlüğü durumunu yapılandırmamız. Yanıtta, belirtilen NSG 'da akış günlüğünün etkin olduğunu ve bekletme ilkesi ayarlanmamış olduğunu görüyoruz.
