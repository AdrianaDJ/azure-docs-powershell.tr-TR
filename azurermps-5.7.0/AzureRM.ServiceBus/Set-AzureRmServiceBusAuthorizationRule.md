...
## Tanım
**Set-AzureRmServiceBusAuthorizationRule** cmdlet 'i, verilen hizmet veri yolu ad alanında veya kuyrukta veya konuda belirtilen yetkilendirme kuralının açıklamasını güncelleştirir.
...
Ad alanındaki yetkilendirme kuralının erişim haklarıyla **yönetimi** kaldırır `AuthoRule1` `SB-Example1` .
...
Kuyruktaki yetkilendirme kuralının erişim haklarıyla **yönetimi** kaldırır `AuthoRule1` `SBQueue` .
...
Konudaki yetkilendirme kuralının erişim haklarıyla **yönetimi** kaldırır `AuthoRule1` `SBTopic` .
...
### System. String
Microsoft. Azure. Commands. ServiceBus. modeller. PSSharedAccessAuthorizationRuleAttributes System. String []
