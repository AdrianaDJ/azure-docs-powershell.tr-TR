...
## Tanım
**Set-AzureRmServiceBusRule** cmdlet 'i, verilen aboneliğin belirtilen kuralı için açıklama güncelleştirir.
...
Konudaki aboneliğin kuralındaki sqlexpression **mysqlexpression = ' Condition '** `SBEule` `SBSubscription``SBTopic`
