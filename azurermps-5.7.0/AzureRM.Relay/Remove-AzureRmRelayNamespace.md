...
## Tanım
**Remove-AzureRmRelayNamespace** cmdlet 'i belirtilen kaynak grubundaki ad alanını kaldırır.
...
Belirtilen kaynak grubundan geçiş ad alanını kaldırır `TestNameSpace-Relay1` `Default-ServiceBus-WestUS` .
