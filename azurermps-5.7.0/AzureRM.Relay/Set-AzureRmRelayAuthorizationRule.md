...
## Tanım
**Set-AzureRmRelayAuthorizationRule** cmdlet 'i, verilen geçiş varlıklarının (Namespace/WcfRelay/HybridConnection) belirtilen yetkilendirme kuralının açıklamasını güncelleştirir.

## ÖRNEKLERDEN

### Örnek 1,1-InputObject ile ad alanı
```
PS C:\>
...
Ad alanındaki yetkilendirme kuralının erişim haklarıyla **Gönder** 'i ekler `AuthoRule1` `TestNameSpace-Relay1` .

### Örnek 1,2-hak parametreli ad alanı
```
...
### Örnek 2,1-WcfRelay, InputObject ile
```
...
WcfRelay 'in yetkilendirme kuralının erişim haklarına **Gönder** öğesini ekler `AuthoRule1` `TestWCFRelay1` .

### Örnek 2,2-WcfRelay, hak parametresiyle
```
...
### Örnek 3,1-InputObject ile HybridConnection
```
...
HybridConnection 'un yetkilendirme kuralının erişim haklarına **Gönder** öğesini ekler `AuthoRule1` `TestHybridConnection` .

### Örnek 3,2-hak parametresiyle HybridConnection
```
...
### -InputObject
Geçiş AuthorizationRule nesnesi
...
### Örnek 1-ad alanı
Haklar: {Listen, gönder} ad: AuthoRule1 türü: Microsoft. Relay/AuthorizationRules ID:/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.Relay/namespaces/TestNameSpace-Relay1/AuthorizationRules/AuthoRule1

### Örnek 2-WcfRelay
Haklar: {Listen, gönder} ad: AuthoRule1 türü: Microsoft. Relay/AuthorizationRules ID:/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.Relay/namespaces/TestNameSpace-Relay1/WcfRelays/TestWCFRelay1/authorizationRules/AuthoRule1

### Örnek 3-HybridConnection
Haklar: {Listen, gönder} ad: AuthoRule1 türü: Microsoft. Relay/AuthorizationRules ID:/subscriptions/854d368f-1828-428f-8f3c-f2affa9b2f7d/resourceGroups/Default-ServiceBus-WestUS/providers/Microsoft.Relay/namespaces/TestNameSpace-Relay1/HybridConnections/TestHybridConnection/authorizationRules/AuthoRule1
