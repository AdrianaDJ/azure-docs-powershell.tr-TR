...
## Tanım
**New-AzureRmRecoveryServicesAsrFabric** cmdlet 'i belirtilen türde bir Azure Site kurtarma yapısı oluşturur.
...
Geçirilen adla yapı oluşturmayı başlatır ve doku oluşturma işlemini izlemek için kullanılan ASR işini döndürür.
...
Geçilen adla Azure Fabric oluşturmayı başlatır ve doku oluşturma işlemini izlemek için kullanılan ASR işini döndürür.

## PARAMETRELERINE

### -Azure
Switch parametresi, Azure Fabric oluşturmayı gösterir.
...
### -Konum
Oluşturulan Fabric nesnesine karşılık gelen Azure bölgesini belirtir. Azure Site Recovery Fabric nesnesi bir bölgeyi temsil eder. İki Azure bölgesi arasında çoğaltılan sanal makinelerin birincil yapısı birincil Azure bölgesini ve kurtarma yapınızı temsil eder.
