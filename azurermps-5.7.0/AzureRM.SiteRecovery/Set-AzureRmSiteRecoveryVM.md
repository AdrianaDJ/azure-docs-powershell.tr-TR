...
## Tanım
**Set-AzureRmSiteRecoveryVM** cmdlet 'ı, Azure Site Recovery koruma varlıkları için kurtarma sanal makine boyutu ve kurtarma sanal makine ağı gibi kurtarma tarafı koruma seçeneklerini ayarlar.
...
### -NicSelectionType
Ağ bağdaştırıcısı seçim özelliklerini belirtir.
...
Kurtarma sırasında birincil ağ bağdaştırıcısı denetleyicisine atanan statik IP adresini belirtir.
...
Kurtarma sırasında birincil ağ bağdaştırıcısı denetleyicisinin ekleneceği Azure sanal ağ alt ağı adını belirtir.
...
### ASRVirtualMachine
Parametre ' VirtualMachine ', ardışık düzen
