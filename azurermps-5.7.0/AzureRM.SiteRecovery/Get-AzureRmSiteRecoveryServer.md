...
## Tanım
**Get-AzureRmSiteRecoveryServer** cmdlet 'i, geçerli site kurtarma kasasına kaydedilen Azure Site Recovery sunucuları hakkında bilgi alır.
...
### -FriendlyName
Sunucunun kolay adını belirtir.
