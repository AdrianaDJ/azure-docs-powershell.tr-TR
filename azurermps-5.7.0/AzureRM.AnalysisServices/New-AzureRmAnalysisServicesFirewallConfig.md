...
## Tanım
New-AzureRmAnalysisServicesFirewallConfig yeni bir güvenlik duvarı yapılandırma nesnesi oluşturur
...
Power BI hizmetini etkinleştirmeden bir güvenlik duvarı kuralı yapılandırması oluşturur.

## PARAMETRELERINE

### -Enablepowerbıervice
PowerBI hizmeti 'ni etkinleştirir
...
### Microsoft. Azure. Commands. AnalysisServices. modeller. AzureAnalysisServicesFirewallConfig
