...
## Tanım
**Get-AzureRmVMSqlServerExtension** cmdlet 'ı, SQL Server altyapısının bir sanal makinede hizmet (IaaS) Aracısı olarak ayarlarını alır.
...
Bu komut, Get-AzureRmVM cmdlet 'ini kullanarak hizmet Service08 ContosoVM22 adındaki sanal makineyi alır.
