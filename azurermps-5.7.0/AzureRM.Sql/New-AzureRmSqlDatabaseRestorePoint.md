...
## Tanım
**New-AzureRmSqlDatabaseRestorePoint** cmdlet 'ı BIR Azure SQL veritabanının geri yüklenebileceğini belirten yeni bir geri yükleme noktası oluşturur.
...
Bu komut, Azure SQL veritabanı için geri yükleme noktası oluşturur ve geri yükleme noktasının ayrıntılarını döndürür.
