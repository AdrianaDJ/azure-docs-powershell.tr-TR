...
## Tanım
**Get-AzureRmSqlServerRecommendedAction** cmdlet 'ı BIR Azure SQL Server Danışmanı için önerilen bir veya birden çok eylemi alır.

## ÖRNEKLERDEN

### Örnek 1: belirli bir danışman için önerilen tüm eylemlerin listesini alma
```
...
Bu komut, Wi-Runner-Avustralya-Doğu adlı sunucuda bulunan CreateIndex adındaki SQL Server Danışmanı için önerilen tüm eylemlerin listesini alır.
...
Bu komut \[ \] \[ \] , createındex adındaki Advisor _6C7AE8CC9C87E7FD5893 test_table_0 test_schema IR_

## PARAMETRELERINE

### -Danışmanlar veya ad
Bu cmdlet 'in eylem istediği danışman adını belirtir.
...
### -ResourceGroupName
Bu sunucunun bulunduğu sunucunun kaynak grubunun adını belirtir.
...
### -ServerName
Danışmanın ait olduğu sunucunun adını belirtir.
