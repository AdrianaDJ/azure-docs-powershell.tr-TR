...
## Tanım
**Get-AzureRmSqlDatabaseLongTermRetentionBackup** cmdlet 'i bir konum, sunucu veya veritabanı için tüm uzun süreli bekletme yedeklemelerini alır veya belirli bir uzun süreli bekletme yedeğini alır.
...
Bu komut, northeurope 'de tüm veritabanları (canlı veya silinmiş olabilir) için tüm uzun süreli bekletme yedeklemelerini alır.

### Örnek 2: belirli bir uzun süreli bekletme yedeği alma
```powershell
...
### Örnek 3: veritabanı için tüm uzun süreli bekletme yedeklemelerini alma
```powershell
