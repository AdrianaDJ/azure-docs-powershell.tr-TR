...
- Hizmet olarak bir Azure altyapısı (IaaS) sanal makinesi

Yedekleme bir veri kaynağını veya öğeyi yedekleyebilmeniz için, bu kapsayıcıyı Azure yedekleme hizmeti ile tutan kapsayıcıyı kaydettirmelidir.
