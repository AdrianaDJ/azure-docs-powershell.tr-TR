...
## Tanım
**New-AzureRmHDInsightPigJobDefinition** cmdlet 'i, bir Azure HDInsight kümesiyle kullanılmak üzere bir domuz Job nesnesi tanımlar.

## ÖRNEKLERDEN

### Örnek 1: domuz iş tanımı oluşturma
```
PS C:\># Cluster info
...
Bu komut bir domuz iş tanımı oluşturur.
...
### Microsoft. Azure. Commands. HDInsight. modeller. AzureHDInsightPigJobDefinition
