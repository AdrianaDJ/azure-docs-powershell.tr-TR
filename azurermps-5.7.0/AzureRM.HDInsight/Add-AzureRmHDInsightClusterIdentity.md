...
## Tanım
**Add-AzureRmHDInsightClusterIdentity** cmdlet 'i, New-AzureRmHDInsightClusterConfig cmdlet 'i tarafından oluşturulan Azure HDInsight yapılandırma nesnesine bir küme kimliği ekler.
...
### 'Sine
' ObjectID ' parametresi ardışık düzenin ' Guid ' türünün değerini kabul eder
