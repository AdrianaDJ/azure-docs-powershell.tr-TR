...
Azure Resource Manager cmdlet istekleriyle kullanılmak üzere kimliği doğrulanmış bir hesapla Azure 'a bağlanır.
...
### [Bağlantının kesilmesi-AzureRmAccount](Disconnect-AzureRmAccount.md)
Bağlı bir Azure hesabından bağlantıyı keser ve bu hesapla ilişkili tüm kimlik bilgilerini ve bağlamları kaldırır.
