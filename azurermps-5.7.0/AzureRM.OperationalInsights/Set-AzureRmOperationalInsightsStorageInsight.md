...
## Tanım
**Set-Azurermoperationalınsightsstorageınsight** cmdlet 'ı bir depolama Insight yapılandırmasını değiştirir.

## ÖRNEKLERDEN

### Örnek 1: adla bir depolama kavramı değiştirme
```
...
Bu komut Mystorageınsight adındaki depolama kavramasındaki tabloları değiştirir.

### Örnek 2: çalışma alanı nesnesi kullanarak bir depolama anlayış değiştirme
```
...
İkinci komut Mystorageınsight adındaki depolama kavramasındaki kapsayıcıları değiştirir.

## PARAMETRELERINE

### -Kapsayıcılar
Verileri sağlayan kapsayıcıların listesini belirtir.
...
### -Ad
Bir depolama anlayış adını belirtir.
...
### -Tablolar
Verileri içeren tabloların listesini belirtir.
