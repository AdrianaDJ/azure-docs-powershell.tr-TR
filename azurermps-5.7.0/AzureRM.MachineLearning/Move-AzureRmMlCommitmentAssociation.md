...
## Tanım
Taahhüt ilişkisi kaynağını üst taahhüt planından başka bir taahhüt planına taşıma.

## ÖRNEKLERDEN

### --------------------------Örnek 1: bir taahhüt ilişkisi--------------------------taşıma
```
...
### -Destinationplanıd
Hedef Azure ML taahhüt planının Azure Kaynak KIMLIĞI.
