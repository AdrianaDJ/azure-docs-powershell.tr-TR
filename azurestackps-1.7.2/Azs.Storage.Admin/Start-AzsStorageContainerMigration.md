...
Geçiş için hedef paylaşımın UNC yolu.
...
### -ResourceGroupName
Depolama kaynak sağlayıcısının altında kaydedildiği kaynak grubu adı.
...
### -PaylaşımAdı
Geçiş için belirtilen kapsayıcıyı içeren paylaşımın adı.
...
### -StorageAccountName
Kapsayıcının konumunu bulan depolama hesabının adı.
